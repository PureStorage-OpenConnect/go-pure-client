...
// checks if the ObjectStoreAccessPolicyRuleGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectStoreAccessPolicyRuleGetResponse{}

// ObjectStoreAccessPolicyRuleGetResponse struct for ObjectStoreAccessPolicyRuleGetResponse
type ObjectStoreAccessPolicyRuleGetResponse struct {
	...
	Items  []PolicyRuleObjectStoreAccess `json:"items,omitempty"`
}
...
func NewObjectStoreAccessPolicyRuleGetResponse() *ObjectStoreAccessPolicyRuleGetResponse {
	this := ObjectStoreAccessPolicyRuleGetResponse{}
	return &this
}
...
// SetItems gets a reference to the given []PolicyRuleObjectStoreAccess and assigns it to the Items field.
func (o *ObjectStoreAccessPolicyRuleGetResponse) SetItems(v []PolicyRuleObjectStoreAccess) {
	o.Items = v
}

func (o ObjectStoreAccessPolicyRuleGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ObjectStoreAccessPolicyRuleGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableObjectStoreAccessPolicyRuleGetResponse struct {
	value *ObjectStoreAccessPolicyRuleGetResponse
	isSet bool
}

func (v NullableObjectStoreAccessPolicyRuleGetResponse) Get() *ObjectStoreAccessPolicyRuleGetResponse {
	return v.value
}

func (v *NullableObjectStoreAccessPolicyRuleGetResponse) Set(val *ObjectStoreAccessPolicyRuleGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStoreAccessPolicyRuleGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStoreAccessPolicyRuleGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStoreAccessPolicyRuleGetResponse(val *ObjectStoreAccessPolicyRuleGetResponse) *NullableObjectStoreAccessPolicyRuleGetResponse {
	return &NullableObjectStoreAccessPolicyRuleGetResponse{value: val, isSet: true}
}

func (v NullableObjectStoreAccessPolicyRuleGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStoreAccessPolicyRuleGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
