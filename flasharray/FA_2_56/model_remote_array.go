...
type RemoteArray struct {
	...
	Fleet       *RemoteArrayFleet `json:"fleet,omitempty"`
	// If set to `true`, this array is the current array.
	IsLocal *bool `json:"is_local,omitempty"`
	// The property that specifies the `array model`.
	Model *string `json:"model,omitempty"`
	// The property that specifies the `operating system`. Valid values include `Purity`, `Purity//FA`, and `Purity//FB`.
	Os *string `json:"os,omitempty"`
	// The `topology group` in which this `array` is a member.
	TopologyGroup *ReferenceWithType `json:"topology_group,omitempty"`
	// The property that specifies the `operating system version`.
...
// SetFleet gets a reference to the given RemoteArrayFleet and assigns it to the Fleet field.
