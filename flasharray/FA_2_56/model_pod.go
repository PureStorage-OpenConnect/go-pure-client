...
type Pod struct {
	...
	// The URL of the mediator for the pod. By default, the Pure1 Cloud Mediator (`purestorage`) serves as the mediator. For a pod in a stretched realm, the realm mediator takes precedence over the mediator of the pod.
