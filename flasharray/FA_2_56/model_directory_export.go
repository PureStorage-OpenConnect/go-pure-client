...
type DirectoryExport struct {
	...
	// Name of the export configuration object. Combines the export containment hierarchy (realm and server), the protocol (SMB or NFS) and the user-visible `export_name`.
