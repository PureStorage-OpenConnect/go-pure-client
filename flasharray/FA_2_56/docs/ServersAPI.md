...
------------- | ------------- | -------------
[**ServersDelete**](ServersAPI.md#ServersDelete) | **Delete** /api/2.56/servers | Delete server
[**ServersGet**](ServersAPI.md#ServersGet) | **Get** /api/2.56/servers | List servers
[**ServersPatch**](ServersAPI.md#ServersPatch) | **Patch** /api/2.56/servers | Modify server
[**ServersPoliciesTlsDelete**](ServersAPI.md#ServersPoliciesTlsDelete) | **Delete** /api/2.56/servers/policies/tls | Delete membership between TLS policies and attached object
[**ServersPoliciesTlsGet**](ServersAPI.md#ServersPoliciesTlsGet) | **Get** /api/2.56/servers/policies/tls | List TLS policies attached to servers
[**ServersPoliciesTlsPost**](ServersAPI.md#ServersPoliciesTlsPost) | **Post** /api/2.56/servers/policies/tls | Create a membership between a server and a TLS policy
[**ServersPost**](ServersAPI.md#ServersPost) | **Post** /api/2.56/servers | Create server
