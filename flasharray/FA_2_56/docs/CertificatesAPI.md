...
------------- | ------------- | -------------
[**CertificatesCertificateGroupsDelete**](CertificatesAPI.md#CertificatesCertificateGroupsDelete) | **Delete** /api/2.56/certificates/certificate-groups | Deletes certificates/certificate-groups
[**CertificatesCertificateGroupsGet**](CertificatesAPI.md#CertificatesCertificateGroupsGet) | **Get** /api/2.56/certificates/certificate-groups | List certificates and certificate-groups
[**CertificatesCertificateGroupsPost**](CertificatesAPI.md#CertificatesCertificateGroupsPost) | **Post** /api/2.56/certificates/certificate-groups | Create certificates orcertificate-groups
[**CertificatesCertificateSigningRequestsPost**](CertificatesAPI.md#CertificatesCertificateSigningRequestsPost) | **Post** /api/2.56/certificates/certificate-signing-requests | Create certificate-signing-requests
[**CertificatesDelete**](CertificatesAPI.md#CertificatesDelete) | **Delete** /api/2.56/certificates | Delete certificate
[**CertificatesGet**](CertificatesAPI.md#CertificatesGet) | **Get** /api/2.56/certificates | List certificate attributes
[**CertificatesPatch**](CertificatesAPI.md#CertificatesPatch) | **Patch** /api/2.56/certificates | Modify certificates
[**CertificatesPost**](CertificatesAPI.md#CertificatesPost) | **Post** /api/2.56/certificates | Create certificate
[**CertificatesUsesGet**](CertificatesAPI.md#CertificatesUsesGet) | **Get** /api/2.56/certificates/uses | List certificates uses
