...
**NamingPatterns** | Pointer to [**[]NamingPattern**](NamingPattern.md) | The naming pattern for the export used by clients to mount the file system or directory. The export name must be unique within the same protocol and server combination.  | [optional] 
**Servers** | Pointer to **[]string** | The optional reference to a parameterized server resource. The default is &#x60;_array_server&#x60; if no parameter is specified.  | [optional] 
