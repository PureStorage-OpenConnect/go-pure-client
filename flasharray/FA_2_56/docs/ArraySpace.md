...
**Capacity** | Pointer to **int64** | Currently entitled usable capacity.  | [optional] [readonly] 
**CapacityInstalled** | Pointer to **int64** | Usable capacity of the array if entitled to full capacity for all drives.  | [optional] 
...
### GetCapacityInstalled

`func (o *ArraySpace) GetCapacityInstalled() int64`

GetCapacityInstalled returns the CapacityInstalled field if non-nil, zero value otherwise.

### GetCapacityInstalledOk

`func (o *ArraySpace) GetCapacityInstalledOk() (*int64, bool)`

GetCapacityInstalledOk returns a tuple with the CapacityInstalled field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetCapacityInstalled

`func (o *ArraySpace) SetCapacityInstalled(v int64)`

SetCapacityInstalled sets CapacityInstalled field to given value.

### HasCapacityInstalled
