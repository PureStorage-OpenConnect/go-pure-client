...
------------- | ------------- | -------------
[**DirectoryGroupQuotasGet**](UserGroupQuotasAPI.md#DirectoryGroupQuotasGet) | **Get** /api/2.56/directory-group-quotas | List group quotas.
[**DirectoryUserQuotasGet**](UserGroupQuotasAPI.md#DirectoryUserQuotasGet) | **Get** /api/2.56/directory-user-quotas | List user quotas.
