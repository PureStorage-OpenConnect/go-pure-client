...
`func (o *Directory) GetRealms() []FixedReferenceWithType`

GetRealms returns the Realms field if non-nil, zero value otherwise.

### GetRealmsOk

`func (o *Directory) GetRealmsOk() (*[]FixedReferenceWithType, bool)`
...
`func (o *Directory) SetRealms(v []FixedReferenceWithType)`

SetRealms sets Realms field to given value.

### HasRealms

`func (o *Directory) HasRealms() bool`
...
`func (o *Directory) GetWorkload() WorkloadConfigurationReference`

GetWorkload returns the Workload field if non-nil, zero value otherwise.

### GetWorkloadOk

`func (o *Directory) GetWorkloadOk() (*WorkloadConfigurationReference, bool)`
...
`func (o *Directory) SetWorkload(v WorkloadConfigurationReference)`

SetWorkload sets Workload field to given value.

### HasWorkload

`func (o *Directory) HasWorkload() bool`
