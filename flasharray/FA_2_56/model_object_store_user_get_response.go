...
// checks if the ObjectStoreUserGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectStoreUserGetResponse{}

// ObjectStoreUserGetResponse struct for ObjectStoreUserGetResponse
...
func NewObjectStoreUserGetResponse() *ObjectStoreUserGetResponse {
	this := ObjectStoreUserGetResponse{}
	return &this
}
...
func (o ObjectStoreUserGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ObjectStoreUserGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableObjectStoreUserGetResponse struct {
	value *ObjectStoreUserGetResponse
	isSet bool
}

func (v NullableObjectStoreUserGetResponse) Get() *ObjectStoreUserGetResponse {
	return v.value
}

func (v *NullableObjectStoreUserGetResponse) Set(val *ObjectStoreUserGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStoreUserGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStoreUserGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStoreUserGetResponse(val *ObjectStoreUserGetResponse) *NullableObjectStoreUserGetResponse {
	return &NullableObjectStoreUserGetResponse{value: val, isSet: true}
}

func (v NullableObjectStoreUserGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStoreUserGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
