...
// checks if the HostGroupGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostGroupGetResponse{}

// HostGroupGetResponse struct for HostGroupGetResponse
...
func (o HostGroupGetResponse) MarshalJSON() ([]byte, error) {
...
func (o HostGroupGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableHostGroupGetResponse struct {
	value *HostGroupGetResponse
	isSet bool
}

func (v NullableHostGroupGetResponse) Get() *HostGroupGetResponse {
	return v.value
}

func (v *NullableHostGroupGetResponse) Set(val *HostGroupGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHostGroupGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHostGroupGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostGroupGetResponse(val *HostGroupGetResponse) *NullableHostGroupGetResponse {
	return &NullableHostGroupGetResponse{value: val, isSet: true}
}

func (v NullableHostGroupGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostGroupGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
