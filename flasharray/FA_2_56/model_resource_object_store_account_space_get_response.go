...
// checks if the ResourceObjectStoreAccountSpaceGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceObjectStoreAccountSpaceGetResponse{}

// ResourceObjectStoreAccountSpaceGetResponse struct for ResourceObjectStoreAccountSpaceGetResponse
type ResourceObjectStoreAccountSpaceGetResponse struct {
	...
	Items []ResourceObjectStoreAccountSpace `json:"items,omitempty"`
	...
	Total []ResourceObjectStoreAccountSpace `json:"total,omitempty"`
}
...
func NewResourceObjectStoreAccountSpaceGetResponse() *ResourceObjectStoreAccountSpaceGetResponse {
	this := ResourceObjectStoreAccountSpaceGetResponse{}
	return &this
}
...
func (o *ResourceObjectStoreAccountSpaceGetResponse) GetItems() []ResourceObjectStoreAccountSpace {
	if o == nil || IsNil(o.Items) {
		var ret []ResourceObjectStoreAccountSpace
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []ResourceObjectStoreAccountSpace and assigns it to the Items field.
...
// SetTotal gets a reference to the given []ResourceObjectStoreAccountSpace and assigns it to the Total field.
func (o *ResourceObjectStoreAccountSpaceGetResponse) SetTotal(v []ResourceObjectStoreAccountSpace) {
	o.Total = v
}

func (o ResourceObjectStoreAccountSpaceGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ResourceObjectStoreAccountSpaceGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResourceObjectStoreAccountSpaceGetResponse struct {
	value *ResourceObjectStoreAccountSpaceGetResponse
	isSet bool
}

func (v NullableResourceObjectStoreAccountSpaceGetResponse) Get() *ResourceObjectStoreAccountSpaceGetResponse {
	return v.value
}

func (v *NullableResourceObjectStoreAccountSpaceGetResponse) Set(val *ResourceObjectStoreAccountSpaceGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceObjectStoreAccountSpaceGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceObjectStoreAccountSpaceGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceObjectStoreAccountSpaceGetResponse(val *ResourceObjectStoreAccountSpaceGetResponse) *NullableResourceObjectStoreAccountSpaceGetResponse {
	return &NullableResourceObjectStoreAccountSpaceGetResponse{value: val, isSet: true}
}

func (v NullableResourceObjectStoreAccountSpaceGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceObjectStoreAccountSpaceGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
