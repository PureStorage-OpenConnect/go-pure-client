...
// checks if the ProtectionGroupSnapshotPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionGroupSnapshotPatch{}

// ProtectionGroupSnapshotPatch struct for ProtectionGroupSnapshotPatch
...
func NewProtectionGroupSnapshotPatch() *ProtectionGroupSnapshotPatch {
	this := ProtectionGroupSnapshotPatch{}
	return &this
}
...
func (o ProtectionGroupSnapshotPatch) MarshalJSON() ([]byte, error) {
...
func (o ProtectionGroupSnapshotPatch) ToMap() (map[string]interface{}, error) {
...
type NullableProtectionGroupSnapshotPatch struct {
	value *ProtectionGroupSnapshotPatch
	isSet bool
}

func (v NullableProtectionGroupSnapshotPatch) Get() *ProtectionGroupSnapshotPatch {
	return v.value
}

func (v *NullableProtectionGroupSnapshotPatch) Set(val *ProtectionGroupSnapshotPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionGroupSnapshotPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionGroupSnapshotPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionGroupSnapshotPatch(val *ProtectionGroupSnapshotPatch) *NullableProtectionGroupSnapshotPatch {
	return &NullableProtectionGroupSnapshotPatch{value: val, isSet: true}
}

func (v NullableProtectionGroupSnapshotPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionGroupSnapshotPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
