...
// checks if the DirectoriesPerformanceByArrayGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoriesPerformanceByArrayGetResponse{}

// DirectoriesPerformanceByArrayGetResponse struct for DirectoriesPerformanceByArrayGetResponse
type DirectoriesPerformanceByArrayGetResponse struct {
	...
	// The `performance data` broken down by `array`. If the `total_only` parameter is set to `true`, the `items` list will be empty.
	Items []DirectoriesPerformanceByArray `json:"items,omitempty"`
	...
	Total []DirectoriesPerformanceByArray `json:"total,omitempty"`
}
...
func NewDirectoriesPerformanceByArrayGetResponse() *DirectoriesPerformanceByArrayGetResponse {
	this := DirectoriesPerformanceByArrayGetResponse{}
	return &this
}
...
func (o *DirectoriesPerformanceByArrayGetResponse) GetItems() []DirectoriesPerformanceByArray {
	if o == nil || IsNil(o.Items) {
		var ret []DirectoriesPerformanceByArray
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []DirectoriesPerformanceByArray and assigns it to the Items field.
...
// SetTotal gets a reference to the given []DirectoriesPerformanceByArray and assigns it to the Total field.
func (o *DirectoriesPerformanceByArrayGetResponse) SetTotal(v []DirectoriesPerformanceByArray) {
	o.Total = v
}

func (o DirectoriesPerformanceByArrayGetResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectoriesPerformanceByArrayGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDirectoriesPerformanceByArrayGetResponse struct {
	value *DirectoriesPerformanceByArrayGetResponse
	isSet bool
}

func (v NullableDirectoriesPerformanceByArrayGetResponse) Get() *DirectoriesPerformanceByArrayGetResponse {
	return v.value
}

func (v *NullableDirectoriesPerformanceByArrayGetResponse) Set(val *DirectoriesPerformanceByArrayGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoriesPerformanceByArrayGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoriesPerformanceByArrayGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoriesPerformanceByArrayGetResponse(val *DirectoriesPerformanceByArrayGetResponse) *NullableDirectoriesPerformanceByArrayGetResponse {
	return &NullableDirectoriesPerformanceByArrayGetResponse{value: val, isSet: true}
}

func (v NullableDirectoriesPerformanceByArrayGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoriesPerformanceByArrayGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
