...
// checks if the VolumeSnapshotTransfer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeSnapshotTransfer{}

// VolumeSnapshotTransfer struct for VolumeSnapshotTransfer
...
func (o VolumeSnapshotTransfer) MarshalJSON() ([]byte, error) {
...
func (o VolumeSnapshotTransfer) ToMap() (map[string]interface{}, error) {
...
type NullableVolumeSnapshotTransfer struct {
	value *VolumeSnapshotTransfer
	isSet bool
}

func (v NullableVolumeSnapshotTransfer) Get() *VolumeSnapshotTransfer {
	return v.value
}

func (v *NullableVolumeSnapshotTransfer) Set(val *VolumeSnapshotTransfer) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeSnapshotTransfer) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeSnapshotTransfer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeSnapshotTransfer(val *VolumeSnapshotTransfer) *NullableVolumeSnapshotTransfer {
	return &NullableVolumeSnapshotTransfer{value: val, isSet: true}
}

func (v NullableVolumeSnapshotTransfer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeSnapshotTransfer) UnmarshalJSON(src []byte) error {
	v.isSet = true
