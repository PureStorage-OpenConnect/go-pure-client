...
// checks if the LocalGroupGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocalGroupGetResponse{}

// LocalGroupGetResponse struct for LocalGroupGetResponse
...
func (o LocalGroupGetResponse) MarshalJSON() ([]byte, error) {
...
func (o LocalGroupGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLocalGroupGetResponse struct {
	value *LocalGroupGetResponse
	isSet bool
}

func (v NullableLocalGroupGetResponse) Get() *LocalGroupGetResponse {
	return v.value
}

func (v *NullableLocalGroupGetResponse) Set(val *LocalGroupGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalGroupGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalGroupGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalGroupGetResponse(val *LocalGroupGetResponse) *NullableLocalGroupGetResponse {
	return &NullableLocalGroupGetResponse{value: val, isSet: true}
}

func (v NullableLocalGroupGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocalGroupGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
