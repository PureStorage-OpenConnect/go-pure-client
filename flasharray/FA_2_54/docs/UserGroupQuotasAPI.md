...
------------- | ------------- | -------------
[**DirectoryGroupQuotasGet**](UserGroupQuotasAPI.md#DirectoryGroupQuotasGet) | **Get** /api/2.54/directory-group-quotas | List group quotas.
[**DirectoryUserQuotasGet**](UserGroupQuotasAPI.md#DirectoryUserQuotasGet) | **Get** /api/2.54/directory-user-quotas | List user quotas.
