...
**Use** | Pointer to [**FixedReferenceWithType**](FixedReferenceWithType.md) | A reference to an object using this certificate group.  | [optional] 
...
`func (o *CertificateGroupUse) GetUse() FixedReferenceWithType`

GetUse returns the Use field if non-nil, zero value otherwise.

### GetUseOk

`func (o *CertificateGroupUse) GetUseOk() (*FixedReferenceWithType, bool)`
...
`func (o *CertificateGroupUse) SetUse(v FixedReferenceWithType)`
