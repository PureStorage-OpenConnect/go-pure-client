...
**Capacity** | Pointer to **int64** | Entitled capacity of individual drive in bytes.  | [optional] [readonly] 
**CapacityInstalled** | Pointer to **int64** | Raw capacity of individual drive in bytes.  | [optional] [readonly] 
