...
**LocalPodMembers** | Pointer to [**[]FixedReferenceWithType**](FixedReferenceWithType.md) | A list of arrays or realms that are members of the local pod.  | [optional] 
...
**Remotes** | Pointer to [**[]FixedReferenceWithType**](FixedReferenceWithType.md) | A list of remote arrays or realms that share this pod. | [optional] 
...
`func (o *PodReplicaLink) GetLocalPodMembers() []FixedReferenceWithType`

GetLocalPodMembers returns the LocalPodMembers field if non-nil, zero value otherwise.

### GetLocalPodMembersOk

`func (o *PodReplicaLink) GetLocalPodMembersOk() (*[]FixedReferenceWithType, bool)`

GetLocalPodMembersOk returns a tuple with the LocalPodMembers field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetLocalPodMembers

`func (o *PodReplicaLink) SetLocalPodMembers(v []FixedReferenceWithType)`

SetLocalPodMembers sets LocalPodMembers field to given value.

### HasLocalPodMembers

`func (o *PodReplicaLink) HasLocalPodMembers() bool`

HasLocalPodMembers returns a boolean if a field has been set.
...
`func (o *PodReplicaLink) GetRemotes() []FixedReferenceWithType`

GetRemotes returns the Remotes field if non-nil, zero value otherwise.

### GetRemotesOk

`func (o *PodReplicaLink) GetRemotesOk() (*[]FixedReferenceWithType, bool)`
...
`func (o *PodReplicaLink) SetRemotes(v []FixedReferenceWithType)`
