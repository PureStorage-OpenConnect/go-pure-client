...
**Fleet** | Pointer to [**RemoteArrayFleet**](RemoteArrayFleet.md) |  | [optional] 
**IsLocal** | Pointer to **bool** | If set to &#x60;true&#x60;, this array is the current array.  | [optional] 
**Model** | Pointer to **string** | The property that specifies the &#x60;array model&#x60;.  | [optional] 
**Os** | Pointer to **string** | The property that specifies the &#x60;operating system&#x60;. Valid values include &#x60;Purity&#x60;, &#x60;Purity//FA&#x60;, and &#x60;Purity//FB&#x60;.  | [optional] 
**TopologyGroup** | Pointer to [**ReferenceWithType**](ReferenceWithType.md) | The &#x60;topology group&#x60; in which this &#x60;array&#x60; is a member. | [optional] 
**Version** | Pointer to **string** | The property that specifies the &#x60;operating system version&#x60;.  | [optional] 
...
`func (o *RemoteArray) GetFleet() RemoteArrayFleet`

GetFleet returns the Fleet field if non-nil, zero value otherwise.

### GetFleetOk

`func (o *RemoteArray) GetFleetOk() (*RemoteArrayFleet, bool)`
...
`func (o *RemoteArray) SetFleet(v RemoteArrayFleet)`
...
`func (o *RemoteArray) GetTopologyGroup() ReferenceWithType`

GetTopologyGroup returns the TopologyGroup field if non-nil, zero value otherwise.

### GetTopologyGroupOk

`func (o *RemoteArray) GetTopologyGroupOk() (*ReferenceWithType, bool)`
...
`func (o *RemoteArray) SetTopologyGroup(v ReferenceWithType)`
