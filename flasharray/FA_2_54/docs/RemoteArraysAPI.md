...
------------- | ------------- | -------------
[**RemoteArraysGet**](RemoteArraysAPI.md#RemoteArraysGet) | **Get** /api/2.54/remote-arrays | List remote arrays
[**RemoteArraysPatch**](RemoteArraysAPI.md#RemoteArraysPatch) | **Patch** /api/2.54/remote-arrays | Modify remote arrays
