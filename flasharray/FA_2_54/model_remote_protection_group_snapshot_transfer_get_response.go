...
// checks if the RemoteProtectionGroupSnapshotTransferGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteProtectionGroupSnapshotTransferGetResponse{}

// RemoteProtectionGroupSnapshotTransferGetResponse struct for RemoteProtectionGroupSnapshotTransferGetResponse
...
func NewRemoteProtectionGroupSnapshotTransferGetResponse() *RemoteProtectionGroupSnapshotTransferGetResponse {
	this := RemoteProtectionGroupSnapshotTransferGetResponse{}
	return &this
}
...
// SetTotal gets a reference to the given []RemoteProtectionGroupSnapshotTransfer and assigns it to the Total field.
func (o *RemoteProtectionGroupSnapshotTransferGetResponse) SetTotal(v []RemoteProtectionGroupSnapshotTransfer) {
	o.Total = v
}

func (o RemoteProtectionGroupSnapshotTransferGetResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteProtectionGroupSnapshotTransferGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteProtectionGroupSnapshotTransferGetResponse struct {
	value *RemoteProtectionGroupSnapshotTransferGetResponse
	isSet bool
}

func (v NullableRemoteProtectionGroupSnapshotTransferGetResponse) Get() *RemoteProtectionGroupSnapshotTransferGetResponse {
	return v.value
}

func (v *NullableRemoteProtectionGroupSnapshotTransferGetResponse) Set(val *RemoteProtectionGroupSnapshotTransferGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteProtectionGroupSnapshotTransferGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteProtectionGroupSnapshotTransferGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteProtectionGroupSnapshotTransferGetResponse(val *RemoteProtectionGroupSnapshotTransferGetResponse) *NullableRemoteProtectionGroupSnapshotTransferGetResponse {
	return &NullableRemoteProtectionGroupSnapshotTransferGetResponse{value: val, isSet: true}
}

func (v NullableRemoteProtectionGroupSnapshotTransferGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteProtectionGroupSnapshotTransferGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
