...
type DirectoryServiceRole struct {
	...
	// A group name that contains users with the authority level of the specified role.
	Group *string `json:"group,omitempty"`
	// Specifies where the configured group is located in the directory tree.
	GroupBase *string `json:"group_base,omitempty"`
	// A reference to the role to be assigned. Can be any role that exists on the system.
