...
------------- | ------------- | -------------
[**DrivesGet**](DrivesAPI.md#DrivesGet) | **Get** /api/2.34/drives | List flash, NVRAM, and cache modules
[**DrivesPatch**](DrivesAPI.md#DrivesPatch) | **Patch** /api/2.34/drives | Modify flash and NVRAM modules
