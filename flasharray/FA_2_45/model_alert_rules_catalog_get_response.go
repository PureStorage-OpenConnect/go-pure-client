...
// checks if the AlertRulesCatalogGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertRulesCatalogGetResponse{}

// AlertRulesCatalogGetResponse struct for AlertRulesCatalogGetResponse
type AlertRulesCatalogGetResponse struct {
...
func NewAlertRulesCatalogGetResponse() *AlertRulesCatalogGetResponse {
	this := AlertRulesCatalogGetResponse{}
	return &this
}
...
func (o AlertRulesCatalogGetResponse) MarshalJSON() ([]byte, error) {
...
func (o AlertRulesCatalogGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAlertRulesCatalogGetResponse struct {
	value *AlertRulesCatalogGetResponse
	isSet bool
}

func (v NullableAlertRulesCatalogGetResponse) Get() *AlertRulesCatalogGetResponse {
	return v.value
}

func (v *NullableAlertRulesCatalogGetResponse) Set(val *AlertRulesCatalogGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertRulesCatalogGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertRulesCatalogGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertRulesCatalogGetResponse(val *AlertRulesCatalogGetResponse) *NullableAlertRulesCatalogGetResponse {
	return &NullableAlertRulesCatalogGetResponse{value: val, isSet: true}
}

func (v NullableAlertRulesCatalogGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertRulesCatalogGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
