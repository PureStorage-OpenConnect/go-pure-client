...
`func (o *DirectoryPerformance) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *DirectoryPerformance) GetContextOk() (*FixedReference, bool)`
...
`func (o *DirectoryPerformance) SetContext(v FixedReference)`
