...
`func (o *ProtectionGroupSnapshotReplica) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *ProtectionGroupSnapshotReplica) GetContextOk() (*FixedReference, bool)`
...
`func (o *ProtectionGroupSnapshotReplica) SetContext(v FixedReference)`
