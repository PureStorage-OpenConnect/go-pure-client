...
`func (o *ResourcePodSpace) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *ResourcePodSpace) GetContextOk() (*FixedReference, bool)`
...
`func (o *ResourcePodSpace) SetContext(v FixedReference)`
