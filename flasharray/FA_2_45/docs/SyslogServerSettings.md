...
`func (o *SyslogServerSettings) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *SyslogServerSettings) GetContextOk() (*FixedReference, bool)`
...
`func (o *SyslogServerSettings) SetContext(v FixedReference)`
