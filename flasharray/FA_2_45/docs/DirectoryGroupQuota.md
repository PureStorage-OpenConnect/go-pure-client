...
`func (o *DirectoryGroupQuota) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *DirectoryGroupQuota) GetContextOk() (*FixedReference, bool)`
...
`func (o *DirectoryGroupQuota) SetContext(v FixedReference)`
