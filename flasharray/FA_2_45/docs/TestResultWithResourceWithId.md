...
`func (o *TestResultWithResourceWithId) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *TestResultWithResourceWithId) GetContextOk() (*FixedReference, bool)`
...
`func (o *TestResultWithResourceWithId) SetContext(v FixedReference)`
