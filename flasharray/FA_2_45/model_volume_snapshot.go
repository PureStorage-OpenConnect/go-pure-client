...
func (o *VolumeSnapshot) GetContext() FixedReference {
...
// and a boolean to check if the value has been set.
func (o *VolumeSnapshot) GetContextOk() (*FixedReference, bool) {
	if o == nil || IsNil(o.Context) {
		return nil, false
	}
...
func (o *VolumeSnapshot) SetContext(v FixedReference) {
	o.Context = &v
}
