...
// checks if the FileSystemGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileSystemGetResponse{}

// FileSystemGetResponse struct for FileSystemGetResponse
...
func (o FileSystemGetResponse) MarshalJSON() ([]byte, error) {
...
func (o FileSystemGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFileSystemGetResponse struct {
	value *FileSystemGetResponse
	isSet bool
}

func (v NullableFileSystemGetResponse) Get() *FileSystemGetResponse {
	return v.value
}

func (v *NullableFileSystemGetResponse) Set(val *FileSystemGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileSystemGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileSystemGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileSystemGetResponse(val *FileSystemGetResponse) *NullableFileSystemGetResponse {
	return &NullableFileSystemGetResponse{value: val, isSet: true}
}

func (v NullableFileSystemGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileSystemGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
