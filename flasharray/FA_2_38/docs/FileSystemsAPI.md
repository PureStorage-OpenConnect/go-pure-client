...
------------- | ------------- | -------------
[**FileSystemsDelete**](FileSystemsAPI.md#FileSystemsDelete) | **Delete** /api/2.38/file-systems | Delete file system
[**FileSystemsGet**](FileSystemsAPI.md#FileSystemsGet) | **Get** /api/2.38/file-systems | List file systems
[**FileSystemsPatch**](FileSystemsAPI.md#FileSystemsPatch) | **Patch** /api/2.38/file-systems | Modify a file system
[**FileSystemsPost**](FileSystemsAPI.md#FileSystemsPost) | **Post** /api/2.38/file-systems | Create file system
...
> FileSystemResponse FileSystemsPost(ctx).Names(names).Authorization(authorization).XRequestID(xRequestID).ContextNames(contextNames).Execute()
