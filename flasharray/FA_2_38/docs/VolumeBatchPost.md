...
**AddToProtectionGroups** | Pointer to [**[]Reference**](Reference.md) | Specifies a list of protection groups that will protect the volume.  | [optional] 
**Name** | Pointer to **string** | Specifies the name of the volume.  | [optional] 
**Tags** | Pointer to [**[]Tag**](Tag.md) | Specifies the list of tags to be upserted on this volume.  | [optional] 
