...
`func (o *VolumeSnapshotTransfer) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *VolumeSnapshotTransfer) GetContextOk() (*FixedReference, bool)`
...
`func (o *VolumeSnapshotTransfer) SetContext(v FixedReference)`
