...
`func (o *ProtectionGroupPerformance) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *ProtectionGroupPerformance) GetContextOk() (*FixedReference, bool)`
...
`func (o *ProtectionGroupPerformance) SetContext(v FixedReference)`
