...
// checks if the PolicyNfsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyNfsGetResponse{}

// PolicyNfsGetResponse struct for PolicyNfsGetResponse
type PolicyNfsGetResponse struct {
...
func (o PolicyNfsGetResponse) MarshalJSON() ([]byte, error) {
...
func (o PolicyNfsGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyNfsGetResponse struct {
	value *PolicyNfsGetResponse
	isSet bool
}

func (v NullablePolicyNfsGetResponse) Get() *PolicyNfsGetResponse {
	return v.value
}

func (v *NullablePolicyNfsGetResponse) Set(val *PolicyNfsGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyNfsGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyNfsGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyNfsGetResponse(val *PolicyNfsGetResponse) *NullablePolicyNfsGetResponse {
	return &NullablePolicyNfsGetResponse{value: val, isSet: true}
}

func (v NullablePolicyNfsGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyNfsGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
