...
// checks if the PodPerformanceGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PodPerformanceGetResponse{}

// PodPerformanceGetResponse struct for PodPerformanceGetResponse
type PodPerformanceGetResponse struct {
...
func NewPodPerformanceGetResponse() *PodPerformanceGetResponse {
	this := PodPerformanceGetResponse{}
	return &this
}
...
// SetItems gets a reference to the given []PodPerformance and assigns it to the Items field.
...
// SetTotal gets a reference to the given []PodPerformance and assigns it to the Total field.
func (o *PodPerformanceGetResponse) SetTotal(v []PodPerformance) {
	o.Total = v
}

func (o PodPerformanceGetResponse) MarshalJSON() ([]byte, error) {
...
func (o PodPerformanceGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePodPerformanceGetResponse struct {
	value *PodPerformanceGetResponse
	isSet bool
}

func (v NullablePodPerformanceGetResponse) Get() *PodPerformanceGetResponse {
	return v.value
}

func (v *NullablePodPerformanceGetResponse) Set(val *PodPerformanceGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePodPerformanceGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePodPerformanceGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePodPerformanceGetResponse(val *PodPerformanceGetResponse) *NullablePodPerformanceGetResponse {
	return &NullablePodPerformanceGetResponse{value: val, isSet: true}
}

func (v NullablePodPerformanceGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePodPerformanceGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
