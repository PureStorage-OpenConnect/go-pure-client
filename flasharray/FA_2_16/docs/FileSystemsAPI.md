...
------------- | ------------- | -------------
[**FileSystemsDelete**](FileSystemsAPI.md#FileSystemsDelete) | **Delete** /api/2.16/file-systems | Delete file system
[**FileSystemsGet**](FileSystemsAPI.md#FileSystemsGet) | **Get** /api/2.16/file-systems | List file systems
[**FileSystemsPatch**](FileSystemsAPI.md#FileSystemsPatch) | **Patch** /api/2.16/file-systems | Modify a file system
[**FileSystemsPost**](FileSystemsAPI.md#FileSystemsPost) | **Post** /api/2.16/file-systems | Create file system



## FileSystemsDelete

> FileSystemsDelete(ctx).Authorization(authorization).XRequestID(xRequestID).Ids(ids).Names(names).Execute()
...
> FileSystemGetResponse FileSystemsGet(ctx).Authorization(authorization).XRequestID(xRequestID).ContinuationToken(continuationToken).Destroyed(destroyed).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).Execute()
...
> FileSystemResponse FileSystemsPatch(ctx).FileSystem(fileSystem).Authorization(authorization).XRequestID(xRequestID).Ids(ids).Names(names).Execute()
...
> FileSystemResponse FileSystemsPost(ctx).Names(names).Authorization(authorization).XRequestID(xRequestID).Execute()
