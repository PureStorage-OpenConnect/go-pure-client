...
------------- | ------------- | -------------
[**SyslogServersDelete**](SyslogAPI.md#SyslogServersDelete) | **Delete** /api/2.16/syslog-servers | Delete syslog server
[**SyslogServersGet**](SyslogAPI.md#SyslogServersGet) | **Get** /api/2.16/syslog-servers | List syslog servers
[**SyslogServersPatch**](SyslogAPI.md#SyslogServersPatch) | **Patch** /api/2.16/syslog-servers | Modify syslog server
[**SyslogServersPost**](SyslogAPI.md#SyslogServersPost) | **Post** /api/2.16/syslog-servers | Create syslog server
[**SyslogServersSettingsGet**](SyslogAPI.md#SyslogServersSettingsGet) | **Get** /api/2.16/syslog-servers/settings | List syslog settings
[**SyslogServersSettingsPatch**](SyslogAPI.md#SyslogServersSettingsPatch) | **Patch** /api/2.16/syslog-servers/settings | Modify syslog settings
[**SyslogServersTestGet**](SyslogAPI.md#SyslogServersTestGet) | **Get** /api/2.16/syslog-servers/test | List syslog server test results



## SyslogServersDelete

> SyslogServersDelete(ctx).Authorization(authorization).XRequestID(xRequestID).Names(names).Execute()
...
> SyslogServerGetResponse SyslogServersGet(ctx).Authorization(authorization).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Limit(limit).Names(names).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).Execute()
...
> SyslogServerResponse SyslogServersPatch(ctx).SyslogServer(syslogServer).Authorization(authorization).XRequestID(xRequestID).Names(names).Execute()
...
> SyslogServerResponse SyslogServersPost(ctx).SyslogServer(syslogServer).Authorization(authorization).XRequestID(xRequestID).Names(names).Execute()
...
> SyslogServerSettingsGetResponse SyslogServersSettingsGet(ctx).Authorization(authorization).XRequestID(xRequestID).Filter(filter).Limit(limit).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).Execute()
...
> SyslogServerSettingsResponse SyslogServersSettingsPatch(ctx).SyslogServerSettings(syslogServerSettings).Authorization(authorization).XRequestID(xRequestID).Execute()
...
> TestResultWithResourceGetResponse SyslogServersTestGet(ctx).Authorization(authorization).XRequestID(xRequestID).Filter(filter).Limit(limit).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).Execute()
