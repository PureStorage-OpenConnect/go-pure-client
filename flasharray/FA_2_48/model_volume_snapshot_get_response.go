...
// checks if the VolumeSnapshotGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeSnapshotGetResponse{}

// VolumeSnapshotGetResponse struct for VolumeSnapshotGetResponse
...
func NewVolumeSnapshotGetResponse() *VolumeSnapshotGetResponse {
	this := VolumeSnapshotGetResponse{}
	return &this
}
...
// SetTotal gets a reference to the given []VolumeSnapshot and assigns it to the Total field.
func (o *VolumeSnapshotGetResponse) SetTotal(v []VolumeSnapshot) {
	o.Total = v
}

func (o VolumeSnapshotGetResponse) MarshalJSON() ([]byte, error) {
...
func (o VolumeSnapshotGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableVolumeSnapshotGetResponse struct {
	value *VolumeSnapshotGetResponse
	isSet bool
}

func (v NullableVolumeSnapshotGetResponse) Get() *VolumeSnapshotGetResponse {
	return v.value
}

func (v *NullableVolumeSnapshotGetResponse) Set(val *VolumeSnapshotGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeSnapshotGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeSnapshotGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeSnapshotGetResponse(val *VolumeSnapshotGetResponse) *NullableVolumeSnapshotGetResponse {
	return &NullableVolumeSnapshotGetResponse{value: val, isSet: true}
}

func (v NullableVolumeSnapshotGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeSnapshotGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
