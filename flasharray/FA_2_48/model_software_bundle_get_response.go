...
// checks if the SoftwareBundleGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareBundleGetResponse{}

// SoftwareBundleGetResponse struct for SoftwareBundleGetResponse
type SoftwareBundleGetResponse struct {
...
func NewSoftwareBundleGetResponse() *SoftwareBundleGetResponse {
	this := SoftwareBundleGetResponse{}
	return &this
}
...
func (o SoftwareBundleGetResponse) MarshalJSON() ([]byte, error) {
...
func (o SoftwareBundleGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSoftwareBundleGetResponse struct {
	value *SoftwareBundleGetResponse
	isSet bool
}

func (v NullableSoftwareBundleGetResponse) Get() *SoftwareBundleGetResponse {
	return v.value
}

func (v *NullableSoftwareBundleGetResponse) Set(val *SoftwareBundleGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareBundleGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareBundleGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareBundleGetResponse(val *SoftwareBundleGetResponse) *NullableSoftwareBundleGetResponse {
	return &NullableSoftwareBundleGetResponse{value: val, isSet: true}
}

func (v NullableSoftwareBundleGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareBundleGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
