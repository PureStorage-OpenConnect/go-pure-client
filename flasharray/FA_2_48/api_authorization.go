...
func (r APILoginPostRequest) Execute() (*UsernameResponse, *http.Response, error) {
	return r.APIService.LoginPostExecute(r)
}

/*
LoginPost Create a user session
...
func (a *AuthorizationAPIService) LoginPostExecute(r APILoginPostRequest) (*UsernameResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UsernameResponse
	)
	...
	localVarPath := localBasePath + "/api/2.48/login"
...
func (r APILogoutPostRequest) XAuthToken(xAuthToken string) APILogoutPostRequest {
...
/*
LogoutPost POST logout (placeholder)
...
func (a *AuthorizationAPIService) LogoutPostExecute(r APILogoutPostRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/2.48/logout"
	...
	if r.xAuthToken != nil {
		parameterAddToHeaderOrQuery(localVarHeaderParams, http.CanonicalHeaderKey("x-auth-token"), r.xAuthToken, "")
	}
	if r.xRequestID != nil {
		parameterAddToHeaderOrQuery(localVarHeaderParams, http.CanonicalHeaderKey("X-Request-ID"), r.xRequestID, "")
	}
...
type APIApiAPIVersionGetRequest struct {
	ctx        context.Context
	APIService *AuthorizationAPIService
	xRequestID *string
}
...
// Supplied by client during request or generated by server.
func (r APIApiAPIVersionGetRequest) XRequestID(xRequestID string) APIApiAPIVersionGetRequest {
	r.xRequestID = &xRequestID
	return r
}

func (r APIApiAPIVersionGetRequest) Execute() (*APIVersionResponse, *http.Response, error) {
	return r.APIService.ApiAPIVersionGetExecute(r)
}

/*
ApiAPIVersionGet List available API versions

Returns a list of available API versions. No authentication is required to access this endpoint.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return APIApiAPIVersionGetRequest
*/
func (a *AuthorizationAPIService) ApiAPIVersionGet(ctx context.Context) APIApiAPIVersionGetRequest {
	return APIApiAPIVersionGetRequest{
		APIService: a,
		ctx:        ctx,
	}
...
func (a *AuthorizationAPIService) ApiAPIVersionGetExecute(r APIApiAPIVersionGetRequest) (*APIVersionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *APIVersionResponse
	)

	endpoint := "AuthorizationAPIService.ApiAPIVersionGet"
	localVarHeaderParams := make(map[string]string)
