...
`func (o *ProtectionGroupPerformanceArray) GetContext() FixedReferenceWithType`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *ProtectionGroupPerformanceArray) GetContextOk() (*FixedReferenceWithType, bool)`
...
`func (o *ProtectionGroupPerformanceArray) SetContext(v FixedReferenceWithType)`
