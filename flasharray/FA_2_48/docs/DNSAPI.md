...
------------- | ------------- | -------------
[**DnsDelete**](DNSAPI.md#DnsDelete) | **Delete** /api/2.48/dns | Delete DNS configuration
[**DnsGet**](DNSAPI.md#DnsGet) | **Get** /api/2.48/dns | List DNS parameters
[**DnsPatch**](DNSAPI.md#DnsPatch) | **Patch** /api/2.48/dns | Modify DNS parameters
[**DnsPost**](DNSAPI.md#DnsPost) | **Post** /api/2.48/dns | Create DNS configuration
