...
**AddToProtectionGroups** | Pointer to [**[]Reference**](Reference.md) | Specifies a list of protection groups that will compose the initial protection for the volume.  | [optional] 
