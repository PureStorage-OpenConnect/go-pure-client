...
// checks if the PodMemberGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PodMemberGetResponse{}

// PodMemberGetResponse struct for PodMemberGetResponse
type PodMemberGetResponse struct {
...
func (o PodMemberGetResponse) MarshalJSON() ([]byte, error) {
...
func (o PodMemberGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePodMemberGetResponse struct {
	value *PodMemberGetResponse
	isSet bool
}

func (v NullablePodMemberGetResponse) Get() *PodMemberGetResponse {
	return v.value
}

func (v *NullablePodMemberGetResponse) Set(val *PodMemberGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePodMemberGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePodMemberGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePodMemberGetResponse(val *PodMemberGetResponse) *NullablePodMemberGetResponse {
	return &NullablePodMemberGetResponse{value: val, isSet: true}
}

func (v NullablePodMemberGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePodMemberGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
