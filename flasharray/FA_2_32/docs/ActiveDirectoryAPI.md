...
------------- | ------------- | -------------
[**ActiveDirectoryDelete**](ActiveDirectoryAPI.md#ActiveDirectoryDelete) | **Delete** /api/2.32/active-directory | Delete Active Directory account
[**ActiveDirectoryGet**](ActiveDirectoryAPI.md#ActiveDirectoryGet) | **Get** /api/2.32/active-directory | List Active Directory accounts
[**ActiveDirectoryPatch**](ActiveDirectoryAPI.md#ActiveDirectoryPatch) | **Patch** /api/2.32/active-directory | Modify Active Directory account
[**ActiveDirectoryPost**](ActiveDirectoryAPI.md#ActiveDirectoryPost) | **Post** /api/2.32/active-directory | Create Active Directory account
