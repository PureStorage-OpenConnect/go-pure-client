...
------------- | ------------- | -------------
[**ArraysCloudCapacityGet**](ArraysAPI.md#ArraysCloudCapacityGet) | **Get** /api/2.32/arrays/cloud-capacity | List CBS array capacity status
[**ArraysCloudCapacityPatch**](ArraysAPI.md#ArraysCloudCapacityPatch) | **Patch** /api/2.32/arrays/cloud-capacity | Modify CBS array capacity
[**ArraysCloudCapacitySupportedStepsGet**](ArraysAPI.md#ArraysCloudCapacitySupportedStepsGet) | **Get** /api/2.32/arrays/cloud-capacity/supported-steps | List CBS array capacity steps
[**ArraysCloudProviderTagsBatchPut**](ArraysAPI.md#ArraysCloudProviderTagsBatchPut) | **Put** /api/2.32/arrays/cloud-provider-tags/batch | Update user tags on the cloud.
[**ArraysCloudProviderTagsDelete**](ArraysAPI.md#ArraysCloudProviderTagsDelete) | **Delete** /api/2.32/arrays/cloud-provider-tags | Delete user tags from the cloud.
[**ArraysCloudProviderTagsGet**](ArraysAPI.md#ArraysCloudProviderTagsGet) | **Get** /api/2.32/arrays/cloud-provider-tags | List user tags on the cloud.
[**ArraysDelete**](ArraysAPI.md#ArraysDelete) | **Delete** /api/2.32/arrays | Delete an array
[**ArraysEulaGet**](ArraysAPI.md#ArraysEulaGet) | **Get** /api/2.32/arrays/eula | List End User Agreement and signature
[**ArraysEulaPatch**](ArraysAPI.md#ArraysEulaPatch) | **Patch** /api/2.32/arrays/eula | Modify signature on the End User Agreement
[**ArraysFactoryResetTokenDelete**](ArraysAPI.md#ArraysFactoryResetTokenDelete) | **Delete** /api/2.32/arrays/factory-reset-token | Delete a factory reset token
[**ArraysFactoryResetTokenGet**](ArraysAPI.md#ArraysFactoryResetTokenGet) | **Get** /api/2.32/arrays/factory-reset-token | List factory reset tokens
[**ArraysFactoryResetTokenPost**](ArraysAPI.md#ArraysFactoryResetTokenPost) | **Post** /api/2.32/arrays/factory-reset-token | Create a factory reset token
[**ArraysGet**](ArraysAPI.md#ArraysGet) | **Get** /api/2.32/arrays | List arrays
[**ArraysNtpTestGet**](ArraysAPI.md#ArraysNtpTestGet) | **Get** /api/2.32/arrays/ntp-test | List NTP test results
[**ArraysPatch**](ArraysAPI.md#ArraysPatch) | **Patch** /api/2.32/arrays | Modify an array
[**ArraysPerformanceByLinkGet**](ArraysAPI.md#ArraysPerformanceByLinkGet) | **Get** /api/2.32/arrays/performance/by-link | List array front-end IO performance data by link
[**ArraysPerformanceGet**](ArraysAPI.md#ArraysPerformanceGet) | **Get** /api/2.32/arrays/performance | List array front-end performance data
[**ArraysSpaceGet**](ArraysAPI.md#ArraysSpaceGet) | **Get** /api/2.32/arrays/space | List array space information
