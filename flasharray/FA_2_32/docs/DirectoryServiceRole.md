...
**Group** | Pointer to **string** | A group name that contains users with the authority level of the specified role.  | [optional] 
**GroupBase** | Pointer to **string** | Specifies where the configured group is located in the directory tree.  | [optional] 
**Role** | Pointer to [**ReferenceNoId**](ReferenceNoId.md) | A reference to the role to be assigned. Can be any role that exists on the system.  | [optional] 
