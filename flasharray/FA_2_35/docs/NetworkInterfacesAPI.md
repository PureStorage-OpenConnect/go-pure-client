...
------------- | ------------- | -------------
[**NetworkInterfacesDelete**](NetworkInterfacesAPI.md#NetworkInterfacesDelete) | **Delete** /api/2.35/network-interfaces | Delete network interface
[**NetworkInterfacesGet**](NetworkInterfacesAPI.md#NetworkInterfacesGet) | **Get** /api/2.35/network-interfaces | List network interfaces
[**NetworkInterfacesNeighborsGet**](NetworkInterfacesAPI.md#NetworkInterfacesNeighborsGet) | **Get** /api/2.35/network-interfaces/neighbors | List network interface neighbors
[**NetworkInterfacesPatch**](NetworkInterfacesAPI.md#NetworkInterfacesPatch) | **Patch** /api/2.35/network-interfaces | Modify network interface
[**NetworkInterfacesPerformanceGet**](NetworkInterfacesAPI.md#NetworkInterfacesPerformanceGet) | **Get** /api/2.35/network-interfaces/performance | List network performance statistics
[**NetworkInterfacesPortDetailsGet**](NetworkInterfacesAPI.md#NetworkInterfacesPortDetailsGet) | **Get** /api/2.35/network-interfaces/port-details | List SFP port details
[**NetworkInterfacesPost**](NetworkInterfacesAPI.md#NetworkInterfacesPost) | **Post** /api/2.35/network-interfaces | Create network interface
