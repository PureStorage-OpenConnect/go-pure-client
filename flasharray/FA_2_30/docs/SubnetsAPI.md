...
------------- | ------------- | -------------
[**SubnetsDelete**](SubnetsAPI.md#SubnetsDelete) | **Delete** /api/2.30/subnets | Delete subnet
[**SubnetsGet**](SubnetsAPI.md#SubnetsGet) | **Get** /api/2.30/subnets | List subnets
[**SubnetsPatch**](SubnetsAPI.md#SubnetsPatch) | **Patch** /api/2.30/subnets | Modify subnet
[**SubnetsPost**](SubnetsAPI.md#SubnetsPost) | **Post** /api/2.30/subnets | Create subnet



## SubnetsDelete

> SubnetsDelete(ctx).Authorization(authorization).XRequestID(xRequestID).Names(names).Execute()
...
> SubnetGetResponse SubnetsGet(ctx).Authorization(authorization).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Limit(limit).Names(names).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).Execute()
...
> SubnetResponse SubnetsPatch(ctx).Subnet(subnet).Authorization(authorization).XRequestID(xRequestID).Names(names).Execute()
...
> SubnetResponse SubnetsPost(ctx).Names(names).Subnet(subnet).Authorization(authorization).XRequestID(xRequestID).Execute()
