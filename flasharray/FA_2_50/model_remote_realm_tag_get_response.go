...
// checks if the RemoteRealmTagGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteRealmTagGetResponse{}

// RemoteRealmTagGetResponse struct for RemoteRealmTagGetResponse
type RemoteRealmTagGetResponse struct {
	...
	Items          []StretchedTagRealm `json:"items,omitempty"`
}
...
func NewRemoteRealmTagGetResponse() *RemoteRealmTagGetResponse {
	this := RemoteRealmTagGetResponse{}
	return &this
}
...
// SetItems gets a reference to the given []StretchedTagRealm and assigns it to the Items field.
func (o *RemoteRealmTagGetResponse) SetItems(v []StretchedTagRealm) {
	o.Items = v
}

func (o RemoteRealmTagGetResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteRealmTagGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteRealmTagGetResponse struct {
	value *RemoteRealmTagGetResponse
	isSet bool
}

func (v NullableRemoteRealmTagGetResponse) Get() *RemoteRealmTagGetResponse {
	return v.value
}

func (v *NullableRemoteRealmTagGetResponse) Set(val *RemoteRealmTagGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteRealmTagGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteRealmTagGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteRealmTagGetResponse(val *RemoteRealmTagGetResponse) *NullableRemoteRealmTagGetResponse {
	return &NullableRemoteRealmTagGetResponse{value: val, isSet: true}
}

func (v NullableRemoteRealmTagGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteRealmTagGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
