...
// checks if the RemoteProtectionGroupSnapshot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteProtectionGroupSnapshot{}

// RemoteProtectionGroupSnapshot struct for RemoteProtectionGroupSnapshot
...
func NewRemoteProtectionGroupSnapshot() *RemoteProtectionGroupSnapshot {
	this := RemoteProtectionGroupSnapshot{}
	return &this
}
...
func (o RemoteProtectionGroupSnapshot) MarshalJSON() ([]byte, error) {
...
func (o RemoteProtectionGroupSnapshot) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteProtectionGroupSnapshot struct {
	value *RemoteProtectionGroupSnapshot
	isSet bool
}

func (v NullableRemoteProtectionGroupSnapshot) Get() *RemoteProtectionGroupSnapshot {
	return v.value
}

func (v *NullableRemoteProtectionGroupSnapshot) Set(val *RemoteProtectionGroupSnapshot) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteProtectionGroupSnapshot) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteProtectionGroupSnapshot) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteProtectionGroupSnapshot(val *RemoteProtectionGroupSnapshot) *NullableRemoteProtectionGroupSnapshot {
	return &NullableRemoteProtectionGroupSnapshot{value: val, isSet: true}
}

func (v NullableRemoteProtectionGroupSnapshot) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteProtectionGroupSnapshot) UnmarshalJSON(src []byte) error {
	v.isSet = true
