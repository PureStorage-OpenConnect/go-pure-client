...
type RetentionPolicy struct {
	...
	PerPeriod *int32 `json:"per_period,omitempty"`
	...
	PeriodLengthMs *int64 `json:"period_length_ms,omitempty"`
}
...
// GetPerPeriod returns the PerPeriod field value if set, zero value otherwise.
func (o *RetentionPolicy) GetPerPeriod() int32 {
	if o == nil || IsNil(o.PerPeriod) {
		var ret int32
		return ret
	}
	return *o.PerPeriod
...
// GetPerPeriodOk returns a tuple with the PerPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RetentionPolicy) GetPerPeriodOk() (*int32, bool) {
	if o == nil || IsNil(o.PerPeriod) {
		return nil, false
	}
	return o.PerPeriod, true
}
...
// SetPerPeriod gets a reference to the given int32 and assigns it to the PerPeriod field.
func (o *RetentionPolicy) SetPerPeriod(v int32) {
	o.PerPeriod = &v
}

// GetPeriodLengthMs returns the PeriodLengthMs field value if set, zero value otherwise.
func (o *RetentionPolicy) GetPeriodLengthMs() int64 {
	if o == nil || IsNil(o.PeriodLengthMs) {
		var ret int64
		return ret
	}
	return *o.PeriodLengthMs
}

// GetPeriodLengthMsOk returns a tuple with the PeriodLengthMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RetentionPolicy) GetPeriodLengthMsOk() (*int64, bool) {
	if o == nil || IsNil(o.PeriodLengthMs) {
		return nil, false
	}
	return o.PeriodLengthMs, true
}
...
// SetPeriodLengthMs gets a reference to the given int64 and assigns it to the PeriodLengthMs field.
...
func (o RetentionPolicy) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PerPeriod) {
		toSerialize["per_period"] = o.PerPeriod
	}
	if !IsNil(o.PeriodLengthMs) {
		toSerialize["period_length_ms"] = o.PeriodLengthMs
	}
