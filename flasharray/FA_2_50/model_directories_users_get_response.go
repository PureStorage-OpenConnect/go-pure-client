...
// checks if the DirectoriesUsersGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoriesUsersGetResponse{}

// DirectoriesUsersGetResponse struct for DirectoriesUsersGetResponse
type DirectoriesUsersGetResponse struct {
...
func NewDirectoriesUsersGetResponse() *DirectoriesUsersGetResponse {
	this := DirectoriesUsersGetResponse{}
	return &this
}
...
func (o DirectoriesUsersGetResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectoriesUsersGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDirectoriesUsersGetResponse struct {
	value *DirectoriesUsersGetResponse
	isSet bool
}

func (v NullableDirectoriesUsersGetResponse) Get() *DirectoriesUsersGetResponse {
	return v.value
}

func (v *NullableDirectoriesUsersGetResponse) Set(val *DirectoriesUsersGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoriesUsersGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoriesUsersGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoriesUsersGetResponse(val *DirectoriesUsersGetResponse) *NullableDirectoriesUsersGetResponse {
	return &NullableDirectoriesUsersGetResponse{value: val, isSet: true}
}

func (v NullableDirectoriesUsersGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoriesUsersGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
