...
// checks if the RemoteProtectionGroupSnapshotTransfer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteProtectionGroupSnapshotTransfer{}

// RemoteProtectionGroupSnapshotTransfer struct for RemoteProtectionGroupSnapshotTransfer
...
func NewRemoteProtectionGroupSnapshotTransfer() *RemoteProtectionGroupSnapshotTransfer {
	this := RemoteProtectionGroupSnapshotTransfer{}
	return &this
}
...
func (o RemoteProtectionGroupSnapshotTransfer) MarshalJSON() ([]byte, error) {
...
func (o RemoteProtectionGroupSnapshotTransfer) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteProtectionGroupSnapshotTransfer struct {
	value *RemoteProtectionGroupSnapshotTransfer
	isSet bool
}

func (v NullableRemoteProtectionGroupSnapshotTransfer) Get() *RemoteProtectionGroupSnapshotTransfer {
	return v.value
}

func (v *NullableRemoteProtectionGroupSnapshotTransfer) Set(val *RemoteProtectionGroupSnapshotTransfer) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteProtectionGroupSnapshotTransfer) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteProtectionGroupSnapshotTransfer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteProtectionGroupSnapshotTransfer(val *RemoteProtectionGroupSnapshotTransfer) *NullableRemoteProtectionGroupSnapshotTransfer {
	return &NullableRemoteProtectionGroupSnapshotTransfer{value: val, isSet: true}
}

func (v NullableRemoteProtectionGroupSnapshotTransfer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteProtectionGroupSnapshotTransfer) UnmarshalJSON(src []byte) error {
	v.isSet = true
