...
------------- | ------------- | -------------
[**ArraysCloudCapacityGet**](ArraysAPI.md#ArraysCloudCapacityGet) | **Get** /api/2.50/arrays/cloud-capacity | List CBS array capacity status
[**ArraysCloudCapacityPatch**](ArraysAPI.md#ArraysCloudCapacityPatch) | **Patch** /api/2.50/arrays/cloud-capacity | Modify CBS array capacity
[**ArraysCloudCapacitySupportedStepsGet**](ArraysAPI.md#ArraysCloudCapacitySupportedStepsGet) | **Get** /api/2.50/arrays/cloud-capacity/supported-steps | List CBS array capacity steps
[**ArraysCloudConfigGet**](ArraysAPI.md#ArraysCloudConfigGet) | **Get** /api/2.50/arrays/cloud-config | List CBS array configuration status
[**ArraysCloudConfigPatch**](ArraysAPI.md#ArraysCloudConfigPatch) | **Patch** /api/2.50/arrays/cloud-config | Modify CBS array configuration
[**ArraysCloudConfigSupportedConfigsGet**](ArraysAPI.md#ArraysCloudConfigSupportedConfigsGet) | **Get** /api/2.50/arrays/cloud-config/supported-configs | List CBS array supported upgrade target configs
[**ArraysCloudProviderTagsBatchPut**](ArraysAPI.md#ArraysCloudProviderTagsBatchPut) | **Put** /api/2.50/arrays/cloud-provider-tags/batch | Update user tags on the cloud.
[**ArraysCloudProviderTagsDelete**](ArraysAPI.md#ArraysCloudProviderTagsDelete) | **Delete** /api/2.50/arrays/cloud-provider-tags | Delete user tags from the cloud.
[**ArraysCloudProviderTagsGet**](ArraysAPI.md#ArraysCloudProviderTagsGet) | **Get** /api/2.50/arrays/cloud-provider-tags | List user tags on the cloud.
[**ArraysDelete**](ArraysAPI.md#ArraysDelete) | **Delete** /api/2.50/arrays | Delete an array
[**ArraysErasuresDelete**](ArraysAPI.md#ArraysErasuresDelete) | **Delete** /api/2.50/arrays/erasures | Delete factory reset
[**ArraysErasuresGet**](ArraysAPI.md#ArraysErasuresGet) | **Get** /api/2.50/arrays/erasures | List factory reset details
[**ArraysErasuresPatch**](ArraysAPI.md#ArraysErasuresPatch) | **Patch** /api/2.50/arrays/erasures | Update factory reset
[**ArraysErasuresPost**](ArraysAPI.md#ArraysErasuresPost) | **Post** /api/2.50/arrays/erasures | Create a process for factory reset
[**ArraysEulaGet**](ArraysAPI.md#ArraysEulaGet) | **Get** /api/2.50/arrays/eula | List End User Agreement and signature
[**ArraysEulaPatch**](ArraysAPI.md#ArraysEulaPatch) | **Patch** /api/2.50/arrays/eula | Modify signature on the End User Agreement
[**ArraysFactoryResetTokenDelete**](ArraysAPI.md#ArraysFactoryResetTokenDelete) | **Delete** /api/2.50/arrays/factory-reset-token | Delete a factory reset token
[**ArraysFactoryResetTokenGet**](ArraysAPI.md#ArraysFactoryResetTokenGet) | **Get** /api/2.50/arrays/factory-reset-token | List factory reset tokens
[**ArraysFactoryResetTokenPost**](ArraysAPI.md#ArraysFactoryResetTokenPost) | **Post** /api/2.50/arrays/factory-reset-token | Create a factory reset token
[**ArraysGet**](ArraysAPI.md#ArraysGet) | **Get** /api/2.50/arrays | List arrays
[**ArraysNtpTestGet**](ArraysAPI.md#ArraysNtpTestGet) | **Get** /api/2.50/arrays/ntp-test | List NTP test results
[**ArraysPatch**](ArraysAPI.md#ArraysPatch) | **Patch** /api/2.50/arrays | Modify an array
[**ArraysPerformanceByLinkGet**](ArraysAPI.md#ArraysPerformanceByLinkGet) | **Get** /api/2.50/arrays/performance/by-link | List array front-end IO performance data by link
[**ArraysPerformanceGet**](ArraysAPI.md#ArraysPerformanceGet) | **Get** /api/2.50/arrays/performance | List array front-end performance data
[**ArraysSpaceGet**](ArraysAPI.md#ArraysSpaceGet) | **Get** /api/2.50/arrays/space | List array space information
[**ArraysTagsBatchPut**](ArraysAPI.md#ArraysTagsBatchPut) | **Put** /api/2.50/arrays/tags/batch | Update tags
[**ArraysTagsDelete**](ArraysAPI.md#ArraysTagsDelete) | **Delete** /api/2.50/arrays/tags | Delete tags
[**ArraysTagsGet**](ArraysAPI.md#ArraysTagsGet) | **Get** /api/2.50/arrays/tags | List tags
