...
------------ | ------------- | ------------- | -------------
**PhonehomeEnabled** | Pointer to **bool** | If set to &#x60;true&#x60;, enables phonehome. If set to &#x60;false&#x60;, disables phonehome.  | [optional] 
**PhonehomeExcludes** | Pointer to **[]string** | A list of items that are excluded from phonehome data collection.  | [optional] 
...
**RemoteAssistActive** | Pointer to **bool** | If set to &#x60;true&#x60;, enables the remote assist session. If set to &#x60;false&#x60;, disables the remote assist session.  | [optional] 
...
### GetPhonehomeExcludes

`func (o *Support) GetPhonehomeExcludes() []string`

GetPhonehomeExcludes returns the PhonehomeExcludes field if non-nil, zero value otherwise.

### GetPhonehomeExcludesOk

`func (o *Support) GetPhonehomeExcludesOk() (*[]string, bool)`

GetPhonehomeExcludesOk returns a tuple with the PhonehomeExcludes field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetPhonehomeExcludes

`func (o *Support) SetPhonehomeExcludes(v []string)`

SetPhonehomeExcludes sets PhonehomeExcludes field to given value.

### HasPhonehomeExcludes

`func (o *Support) HasPhonehomeExcludes() bool`

HasPhonehomeExcludes returns a boolean if a field has been set.
