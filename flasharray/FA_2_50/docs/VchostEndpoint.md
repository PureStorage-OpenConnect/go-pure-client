...
**IsLocal** | Pointer to **bool** | Returns true if the vchost endpoint is local to the array, and false otherwise. | [optional] 
...
`func (o *VchostEndpoint) GetIsLocal() bool`

GetIsLocal returns the IsLocal field if non-nil, zero value otherwise.

### GetIsLocalOk

`func (o *VchostEndpoint) GetIsLocalOk() (*bool, bool)`
...
`func (o *VchostEndpoint) SetIsLocal(v bool)`

SetIsLocal sets IsLocal field to given value.

### HasIsLocal

`func (o *VchostEndpoint) HasIsLocal() bool`
