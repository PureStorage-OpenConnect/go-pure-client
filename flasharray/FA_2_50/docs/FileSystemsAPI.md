...
------------- | ------------- | -------------
[**FileSystemsDelete**](FileSystemsAPI.md#FileSystemsDelete) | **Delete** /api/2.50/file-systems | Delete file system
[**FileSystemsGet**](FileSystemsAPI.md#FileSystemsGet) | **Get** /api/2.50/file-systems | List file systems
[**FileSystemsPatch**](FileSystemsAPI.md#FileSystemsPatch) | **Patch** /api/2.50/file-systems | Modify a file system
[**FileSystemsPost**](FileSystemsAPI.md#FileSystemsPost) | **Post** /api/2.50/file-systems | Create file system
...
> FileSystemResponse FileSystemsPost(ctx).Names(names).Authorization(authorization).XRequestID(xRequestID).AddToPolicyIds(addToPolicyIds).AddToPolicyNames(addToPolicyNames).ContextNames(contextNames).WithDefaultProtection(withDefaultProtection).Execute()
