...
// checks if the HardwareGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HardwareGetResponse{}

// HardwareGetResponse struct for HardwareGetResponse
...
func (o HardwareGetResponse) MarshalJSON() ([]byte, error) {
...
func (o HardwareGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableHardwareGetResponse struct {
	value *HardwareGetResponse
	isSet bool
}

func (v NullableHardwareGetResponse) Get() *HardwareGetResponse {
	return v.value
}

func (v *NullableHardwareGetResponse) Set(val *HardwareGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHardwareGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHardwareGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHardwareGetResponse(val *HardwareGetResponse) *NullableHardwareGetResponse {
	return &NullableHardwareGetResponse{value: val, isSet: true}
}

func (v NullableHardwareGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHardwareGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
