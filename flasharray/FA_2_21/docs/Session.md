...
**EndTime** | Pointer to **int64** | Date and time the user logged out of the Purity//FA interface. Not set if the session is still active.  | [optional] [readonly] 
**Event** | Pointer to **string** | Description of session events such as login and user session. Valid values include &#x60;failed authentication&#x60;, &#x60;user session&#x60;, &#x60;login&#x60;, &#x60;logout&#x60;, &#x60;API token obtained&#x60;, and &#x60;request without session&#x60;.  | [optional] [readonly] 
...
**Method** | Pointer to **string** | Method by which the user attempted to log in. Valid values include &#x60;API token&#x60;, &#x60;JWT&#x60;, &#x60;password&#x60;, and &#x60;public key&#x60;.  | [optional] [readonly] 
**StartTime** | Pointer to **int64** | Date and time the user logged in to the Purity//FA interface. | [optional] [readonly] 
**User** | Pointer to **string** | Username of the Purity//FA user who triggered the user session event. | [optional] [readonly] 
