...
**SnapshotsEffective** | Pointer to **int64** | Deprecated. The effective space contributed by data unique to one or more snapshots, measured in bytes. Please use the &#x60;snapshots&#x60; field in the future, as it contains the same information for Evergreen//One arrays.  | [optional] [readonly] 
