...
------------- | ------------- | -------------
[**VolumesDelete**](VolumesAPI.md#VolumesDelete) | **Delete** /api/2.0/volumes | Eradicate a volume
[**VolumesGet**](VolumesAPI.md#VolumesGet) | **Get** /api/2.0/volumes | List volumes
[**VolumesPatch**](VolumesAPI.md#VolumesPatch) | **Patch** /api/2.0/volumes | Manage a volume
[**VolumesPerformanceByArrayGet**](VolumesAPI.md#VolumesPerformanceByArrayGet) | **Get** /api/2.0/volumes/performance/by-array | List volume performance data by array
[**VolumesPerformanceGet**](VolumesAPI.md#VolumesPerformanceGet) | **Get** /api/2.0/volumes/performance | List volume performance data
[**VolumesPost**](VolumesAPI.md#VolumesPost) | **Post** /api/2.0/volumes | Create a volume
[**VolumesSpaceGet**](VolumesAPI.md#VolumesSpaceGet) | **Get** /api/2.0/volumes/space | List volume space information
...
> VolumeGetResponse VolumesGet(ctx).Authorization(authorization).XRequestID(xRequestID).Destroyed(destroyed).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).TotalOnly(totalOnly).Execute()
