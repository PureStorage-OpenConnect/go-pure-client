...
------------- | ------------- | -------------
[**LoginPost**](AuthorizationAPI.md#LoginPost) | **Post** /api/2.0/login | POST login (placeholder)
[**LogoutPost**](AuthorizationAPI.md#LogoutPost) | **Post** /api/2.0/logout | POST logout (placeholder)
