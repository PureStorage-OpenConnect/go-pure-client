...
type Connection struct {
	...
	Host *FixedReferenceNoId `json:"host,omitempty"`
	// A virtual collection of hosts with common connectivity to volumes.
	HostGroup *FixedReferenceNoId `json:"host_group,omitempty"`
...
// SetHost gets a reference to the given FixedReferenceNoId and assigns it to the Host field.
...
// SetHostGroup gets a reference to the given FixedReferenceNoId and assigns it to the HostGroup field.
