...
------------- | ------------- | -------------
[**LoginPost**](AuthorizationAPI.md#LoginPost) | **Post** /api/2.47/login | Create a user session
[**LogoutPost**](AuthorizationAPI.md#LogoutPost) | **Post** /api/2.47/logout | POST logout (placeholder)
