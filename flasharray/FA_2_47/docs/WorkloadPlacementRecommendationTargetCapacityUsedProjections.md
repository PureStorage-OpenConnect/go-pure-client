...
**ProjectionBaseline** | Pointer to [**WorkloadPlacementRecommendationProjection**](WorkloadPlacementRecommendationProjection.md) | The projection of the baseline used capacity, without the workload on this target.  | [optional] 
