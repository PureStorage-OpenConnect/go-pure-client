...
// checks if the AppGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppGetResponse{}

// AppGetResponse struct for AppGetResponse
...
func (o AppGetResponse) MarshalJSON() ([]byte, error) {
...
func (o AppGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAppGetResponse struct {
	value *AppGetResponse
	isSet bool
}

func (v NullableAppGetResponse) Get() *AppGetResponse {
	return v.value
}

func (v *NullableAppGetResponse) Set(val *AppGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppGetResponse(val *AppGetResponse) *NullableAppGetResponse {
	return &NullableAppGetResponse{value: val, isSet: true}
}

func (v NullableAppGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
