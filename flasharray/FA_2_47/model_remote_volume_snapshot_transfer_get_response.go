...
// checks if the RemoteVolumeSnapshotTransferGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteVolumeSnapshotTransferGetResponse{}

// RemoteVolumeSnapshotTransferGetResponse struct for RemoteVolumeSnapshotTransferGetResponse
...
func NewRemoteVolumeSnapshotTransferGetResponse() *RemoteVolumeSnapshotTransferGetResponse {
	this := RemoteVolumeSnapshotTransferGetResponse{}
	return &this
}
...
// SetTotal gets a reference to the given []RemoteVolumeSnapshotTransfer and assigns it to the Total field.
func (o *RemoteVolumeSnapshotTransferGetResponse) SetTotal(v []RemoteVolumeSnapshotTransfer) {
	o.Total = v
}

func (o RemoteVolumeSnapshotTransferGetResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteVolumeSnapshotTransferGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteVolumeSnapshotTransferGetResponse struct {
	value *RemoteVolumeSnapshotTransferGetResponse
	isSet bool
}

func (v NullableRemoteVolumeSnapshotTransferGetResponse) Get() *RemoteVolumeSnapshotTransferGetResponse {
	return v.value
}

func (v *NullableRemoteVolumeSnapshotTransferGetResponse) Set(val *RemoteVolumeSnapshotTransferGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteVolumeSnapshotTransferGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteVolumeSnapshotTransferGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteVolumeSnapshotTransferGetResponse(val *RemoteVolumeSnapshotTransferGetResponse) *NullableRemoteVolumeSnapshotTransferGetResponse {
	return &NullableRemoteVolumeSnapshotTransferGetResponse{value: val, isSet: true}
}

func (v NullableRemoteVolumeSnapshotTransferGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteVolumeSnapshotTransferGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
