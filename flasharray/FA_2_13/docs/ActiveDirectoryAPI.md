...
------------- | ------------- | -------------
[**ActiveDirectoryDelete**](ActiveDirectoryAPI.md#ActiveDirectoryDelete) | **Delete** /api/2.13/active-directory | Delete Active Directory account
[**ActiveDirectoryGet**](ActiveDirectoryAPI.md#ActiveDirectoryGet) | **Get** /api/2.13/active-directory | List Active Directory attributes
[**ActiveDirectoryPost**](ActiveDirectoryAPI.md#ActiveDirectoryPost) | **Post** /api/2.13/active-directory | Create Active Directory account
...
> ActiveDirectoryResponse ActiveDirectoryPost(ctx).Names(names).ActiveDirectory(activeDirectory).Authorization(authorization).XRequestID(xRequestID).Execute()
