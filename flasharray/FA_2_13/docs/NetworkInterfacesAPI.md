...
------------- | ------------- | -------------
[**NetworkInterfacesDelete**](NetworkInterfacesAPI.md#NetworkInterfacesDelete) | **Delete** /api/2.13/network-interfaces | Delete network interface
[**NetworkInterfacesGet**](NetworkInterfacesAPI.md#NetworkInterfacesGet) | **Get** /api/2.13/network-interfaces | List network interfaces
[**NetworkInterfacesPatch**](NetworkInterfacesAPI.md#NetworkInterfacesPatch) | **Patch** /api/2.13/network-interfaces | Modify network interface
[**NetworkInterfacesPerformanceGet**](NetworkInterfacesAPI.md#NetworkInterfacesPerformanceGet) | **Get** /api/2.13/network-interfaces/performance | List network performance statistics
[**NetworkInterfacesPost**](NetworkInterfacesAPI.md#NetworkInterfacesPost) | **Post** /api/2.13/network-interfaces | Create network interface
