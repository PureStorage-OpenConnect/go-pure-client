...
**VolumeGroup** | Pointer to [**FixedReference**](FixedReference.md) | The volume group to which the volume that is the source of this volume snapshot belongs.  | [optional] 
