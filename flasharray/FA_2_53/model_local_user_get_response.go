...
// checks if the LocalUserGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocalUserGetResponse{}

// LocalUserGetResponse struct for LocalUserGetResponse
type LocalUserGetResponse struct {
	...
	Items []LocalUser `json:"items,omitempty"`
...
// SetItems gets a reference to the given []LocalUser and assigns it to the Items field.
...
func (o LocalUserGetResponse) MarshalJSON() ([]byte, error) {
...
func (o LocalUserGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLocalUserGetResponse struct {
	value *LocalUserGetResponse
	isSet bool
}

func (v NullableLocalUserGetResponse) Get() *LocalUserGetResponse {
	return v.value
}

func (v *NullableLocalUserGetResponse) Set(val *LocalUserGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalUserGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalUserGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalUserGetResponse(val *LocalUserGetResponse) *NullableLocalUserGetResponse {
	return &NullableLocalUserGetResponse{value: val, isSet: true}
}

func (v NullableLocalUserGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocalUserGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
