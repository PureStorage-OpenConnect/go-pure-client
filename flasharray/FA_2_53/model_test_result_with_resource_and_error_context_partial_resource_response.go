...
// checks if the TestResultWithResourceAndErrorContextPartialResourceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TestResultWithResourceAndErrorContextPartialResourceResponse{}

// TestResultWithResourceAndErrorContextPartialResourceResponse struct for TestResultWithResourceAndErrorContextPartialResourceResponse
type TestResultWithResourceAndErrorContextPartialResourceResponse struct {
...
func NewTestResultWithResourceAndErrorContextPartialResourceResponse() *TestResultWithResourceAndErrorContextPartialResourceResponse {
	this := TestResultWithResourceAndErrorContextPartialResourceResponse{}
	return &this
}
...
func (o TestResultWithResourceAndErrorContextPartialResourceResponse) MarshalJSON() ([]byte, error) {
...
func (o TestResultWithResourceAndErrorContextPartialResourceResponse) ToMap() (map[string]interface{}, error) {
...
type NullableTestResultWithResourceAndErrorContextPartialResourceResponse struct {
	value *TestResultWithResourceAndErrorContextPartialResourceResponse
	isSet bool
}

func (v NullableTestResultWithResourceAndErrorContextPartialResourceResponse) Get() *TestResultWithResourceAndErrorContextPartialResourceResponse {
	return v.value
}

func (v *NullableTestResultWithResourceAndErrorContextPartialResourceResponse) Set(val *TestResultWithResourceAndErrorContextPartialResourceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTestResultWithResourceAndErrorContextPartialResourceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTestResultWithResourceAndErrorContextPartialResourceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestResultWithResourceAndErrorContextPartialResourceResponse(val *TestResultWithResourceAndErrorContextPartialResourceResponse) *NullableTestResultWithResourceAndErrorContextPartialResourceResponse {
	return &NullableTestResultWithResourceAndErrorContextPartialResourceResponse{value: val, isSet: true}
}

func (v NullableTestResultWithResourceAndErrorContextPartialResourceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestResultWithResourceAndErrorContextPartialResourceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
