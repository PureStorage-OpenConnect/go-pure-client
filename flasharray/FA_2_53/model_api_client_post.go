...
type ApiClientPost struct {
	...
	AccessPolicies []ReferenceWithType `json:"access_policies,omitempty"`
...
// SetAccessPolicies gets a reference to the given []ReferenceWithType and assigns it to the AccessPolicies field.
