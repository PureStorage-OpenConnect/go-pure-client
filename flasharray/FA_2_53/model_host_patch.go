...
type HostPatch struct {
	...
	// Sets QoS limits.
	Qos *ContainerQosCeilingsPatch `json:"qos,omitempty"`
...
func (o *HostPatch) GetQos() ContainerQosCeilingsPatch {
	if o == nil || IsNil(o.Qos) {
		var ret ContainerQosCeilingsPatch
		return ret
	}
	return *o.Qos
}
...
// SetQos gets a reference to the given ContainerQosCeilingsPatch and assigns it to the Qos field.
