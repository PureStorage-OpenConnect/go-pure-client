...
// checks if the PolicyMemberObjectStoreAccessGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyMemberObjectStoreAccessGetResponse{}

// PolicyMemberObjectStoreAccessGetResponse struct for PolicyMemberObjectStoreAccessGetResponse
type PolicyMemberObjectStoreAccessGetResponse struct {
...
func NewPolicyMemberObjectStoreAccessGetResponse() *PolicyMemberObjectStoreAccessGetResponse {
	this := PolicyMemberObjectStoreAccessGetResponse{}
	return &this
}
...
func (o PolicyMemberObjectStoreAccessGetResponse) MarshalJSON() ([]byte, error) {
...
func (o PolicyMemberObjectStoreAccessGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyMemberObjectStoreAccessGetResponse struct {
	value *PolicyMemberObjectStoreAccessGetResponse
	isSet bool
}

func (v NullablePolicyMemberObjectStoreAccessGetResponse) Get() *PolicyMemberObjectStoreAccessGetResponse {
	return v.value
}

func (v *NullablePolicyMemberObjectStoreAccessGetResponse) Set(val *PolicyMemberObjectStoreAccessGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyMemberObjectStoreAccessGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyMemberObjectStoreAccessGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyMemberObjectStoreAccessGetResponse(val *PolicyMemberObjectStoreAccessGetResponse) *NullablePolicyMemberObjectStoreAccessGetResponse {
	return &NullablePolicyMemberObjectStoreAccessGetResponse{value: val, isSet: true}
}

func (v NullablePolicyMemberObjectStoreAccessGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyMemberObjectStoreAccessGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
