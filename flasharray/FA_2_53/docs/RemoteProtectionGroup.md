...
`func (o *RemoteProtectionGroup) GetContext() FixedReferenceWithType`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *RemoteProtectionGroup) GetContextOk() (*FixedReferenceWithType, bool)`
...
`func (o *RemoteProtectionGroup) SetContext(v FixedReferenceWithType)`
