...
------------- | ------------- | -------------
[**ServersDelete**](ServersAPI.md#ServersDelete) | **Delete** /api/2.53/servers | Delete server
[**ServersGet**](ServersAPI.md#ServersGet) | **Get** /api/2.53/servers | List servers
[**ServersPatch**](ServersAPI.md#ServersPatch) | **Patch** /api/2.53/servers | Modify server
[**ServersPost**](ServersAPI.md#ServersPost) | **Post** /api/2.53/servers | Create server
