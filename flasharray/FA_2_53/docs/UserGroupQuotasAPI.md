...
------------- | ------------- | -------------
[**DirectoryGroupQuotasGet**](UserGroupQuotasAPI.md#DirectoryGroupQuotasGet) | **Get** /api/2.53/directory-group-quotas | List group quotas.
[**DirectoryUserQuotasGet**](UserGroupQuotasAPI.md#DirectoryUserQuotasGet) | **Get** /api/2.53/directory-user-quotas | List user quotas.
