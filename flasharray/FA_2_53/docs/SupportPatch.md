...
**PhonehomeExcludes** | Pointer to **[]string** | A list of of items to exclude form phonehome. Valid values include &#x60;application-insights&#x60;.  | [optional] 
...
`func (o *SupportPatch) SetPhonehomeExcludes(v []string)`

SetPhonehomeExcludes sets PhonehomeExcludes field to given value.

### HasPhonehomeExcludes

`func (o *SupportPatch) HasPhonehomeExcludes() bool`
