...
------------- | ------------- | -------------
[**LoginPost**](AuthorizationAPI.md#LoginPost) | **Post** /api/2.53/login | Create a user session
[**LogoutPost**](AuthorizationAPI.md#LogoutPost) | **Post** /api/2.53/logout | POST logout (placeholder)
