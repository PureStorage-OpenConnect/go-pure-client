...
------------ | ------------- | ------------- | -------------
**ExportEnabled** | Pointer to **bool** | Indicates whether the export is enabled. If set to &#x60;true&#x60;, the export is enabled. If not specified, defaults to &#x60;true&#x60;.  | [optional] 
...
**Server** | Pointer to [**Reference**](Reference.md) | Server to which the directory export is attached to.  | [optional] 
