...
`func (o *ObjectStoreVirtualHost) GetContext() FixedReferenceWithType`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *ObjectStoreVirtualHost) GetContextOk() (*FixedReferenceWithType, bool)`
...
`func (o *ObjectStoreVirtualHost) SetContext(v FixedReferenceWithType)`
