...
// checks if the ObjectStoreAccessKeyGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectStoreAccessKeyGetResponse{}

// ObjectStoreAccessKeyGetResponse struct for ObjectStoreAccessKeyGetResponse
...
func NewObjectStoreAccessKeyGetResponse() *ObjectStoreAccessKeyGetResponse {
	this := ObjectStoreAccessKeyGetResponse{}
	return &this
}
...
// SetItems gets a reference to the given []ObjectStoreAccessKey and assigns it to the Items field.
func (o *ObjectStoreAccessKeyGetResponse) SetItems(v []ObjectStoreAccessKey) {
	o.Items = v
}

func (o ObjectStoreAccessKeyGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ObjectStoreAccessKeyGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableObjectStoreAccessKeyGetResponse struct {
	value *ObjectStoreAccessKeyGetResponse
	isSet bool
}

func (v NullableObjectStoreAccessKeyGetResponse) Get() *ObjectStoreAccessKeyGetResponse {
	return v.value
}

func (v *NullableObjectStoreAccessKeyGetResponse) Set(val *ObjectStoreAccessKeyGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectStoreAccessKeyGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectStoreAccessKeyGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectStoreAccessKeyGetResponse(val *ObjectStoreAccessKeyGetResponse) *NullableObjectStoreAccessKeyGetResponse {
	return &NullableObjectStoreAccessKeyGetResponse{value: val, isSet: true}
}

func (v NullableObjectStoreAccessKeyGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectStoreAccessKeyGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
