...
// checks if the ConnectionGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectionGetResponse{}

// ConnectionGetResponse struct for ConnectionGetResponse
...
func (o ConnectionGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ConnectionGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableConnectionGetResponse struct {
	value *ConnectionGetResponse
	isSet bool
}

func (v NullableConnectionGetResponse) Get() *ConnectionGetResponse {
	return v.value
}

func (v *NullableConnectionGetResponse) Set(val *ConnectionGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectionGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectionGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectionGetResponse(val *ConnectionGetResponse) *NullableConnectionGetResponse {
	return &NullableConnectionGetResponse{value: val, isSet: true}
}

func (v NullableConnectionGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectionGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
