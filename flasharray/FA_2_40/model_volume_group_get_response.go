...
// checks if the VolumeGroupGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeGroupGetResponse{}

// VolumeGroupGetResponse struct for VolumeGroupGetResponse
...
// SetTotal gets a reference to the given []VolumeGroup and assigns it to the Total field.
func (o *VolumeGroupGetResponse) SetTotal(v []VolumeGroup) {
	o.Total = v
}

func (o VolumeGroupGetResponse) MarshalJSON() ([]byte, error) {
...
func (o VolumeGroupGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableVolumeGroupGetResponse struct {
	value *VolumeGroupGetResponse
	isSet bool
}

func (v NullableVolumeGroupGetResponse) Get() *VolumeGroupGetResponse {
	return v.value
}

func (v *NullableVolumeGroupGetResponse) Set(val *VolumeGroupGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVolumeGroupGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVolumeGroupGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVolumeGroupGetResponse(val *VolumeGroupGetResponse) *NullableVolumeGroupGetResponse {
	return &NullableVolumeGroupGetResponse{value: val, isSet: true}
}

func (v NullableVolumeGroupGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVolumeGroupGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
