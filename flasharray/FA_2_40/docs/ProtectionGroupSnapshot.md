...
`func (o *ProtectionGroupSnapshot) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *ProtectionGroupSnapshot) GetContextOk() (*FixedReference, bool)`
...
`func (o *ProtectionGroupSnapshot) SetContext(v FixedReference)`
