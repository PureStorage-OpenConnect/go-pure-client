...
`func (o *RemoteVolumeSnapshot) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *RemoteVolumeSnapshot) GetContextOk() (*FixedReference, bool)`
...
`func (o *RemoteVolumeSnapshot) SetContext(v FixedReference)`
