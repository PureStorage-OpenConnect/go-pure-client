...
**Workload** | Pointer to [**ReferenceWithFixedType**](ReferenceWithFixedType.md) | Set the &#x60;id&#x60; or &#x60;name&#x60; of the workload to an empty string to remove the volume from the workload.  | [optional] 
...
`func (o *VolumePatch) GetWorkload() ReferenceWithFixedType`

GetWorkload returns the Workload field if non-nil, zero value otherwise.

### GetWorkloadOk

`func (o *VolumePatch) GetWorkloadOk() (*ReferenceWithFixedType, bool)`
...
`func (o *VolumePatch) SetWorkload(v ReferenceWithFixedType)`

SetWorkload sets Workload field to given value.

### HasWorkload

`func (o *VolumePatch) HasWorkload() bool`
