...
`func (o *RemoteVolumeSnapshotTransfer) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *RemoteVolumeSnapshotTransfer) GetContextOk() (*FixedReference, bool)`
...
`func (o *RemoteVolumeSnapshotTransfer) SetContext(v FixedReference)`
