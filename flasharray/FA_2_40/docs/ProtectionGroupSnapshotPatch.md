...
`func (o *ProtectionGroupSnapshotPatch) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *ProtectionGroupSnapshotPatch) GetContextOk() (*FixedReference, bool)`
...
`func (o *ProtectionGroupSnapshotPatch) SetContext(v FixedReference)`
