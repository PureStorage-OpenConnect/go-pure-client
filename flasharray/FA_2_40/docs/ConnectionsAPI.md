...
------------- | ------------- | -------------
[**ConnectionsDelete**](ConnectionsAPI.md#ConnectionsDelete) | **Delete** /api/2.40/connections | Delete a connection between a volume and its host or host group
[**ConnectionsGet**](ConnectionsAPI.md#ConnectionsGet) | **Get** /api/2.40/connections | List volume connections
[**ConnectionsPost**](ConnectionsAPI.md#ConnectionsPost) | **Post** /api/2.40/connections | Create a connection between a volume and host or host group
