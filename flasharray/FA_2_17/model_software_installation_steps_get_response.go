...
// checks if the SoftwareInstallationStepsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareInstallationStepsGetResponse{}

// SoftwareInstallationStepsGetResponse struct for SoftwareInstallationStepsGetResponse
...
func NewSoftwareInstallationStepsGetResponse() *SoftwareInstallationStepsGetResponse {
	this := SoftwareInstallationStepsGetResponse{}
	return &this
}
...
func (o SoftwareInstallationStepsGetResponse) MarshalJSON() ([]byte, error) {
...
func (o SoftwareInstallationStepsGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSoftwareInstallationStepsGetResponse struct {
	value *SoftwareInstallationStepsGetResponse
	isSet bool
}

func (v NullableSoftwareInstallationStepsGetResponse) Get() *SoftwareInstallationStepsGetResponse {
	return v.value
}

func (v *NullableSoftwareInstallationStepsGetResponse) Set(val *SoftwareInstallationStepsGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareInstallationStepsGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareInstallationStepsGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareInstallationStepsGetResponse(val *SoftwareInstallationStepsGetResponse) *NullableSoftwareInstallationStepsGetResponse {
	return &NullableSoftwareInstallationStepsGetResponse{value: val, isSet: true}
}

func (v NullableSoftwareInstallationStepsGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareInstallationStepsGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
