...
------------- | ------------- | -------------
[**RemoteArraysGet**](RemoteArraysAPI.md#RemoteArraysGet) | **Get** /api/2.55/remote-arrays | List remote arrays
[**RemoteArraysPatch**](RemoteArraysAPI.md#RemoteArraysPatch) | **Patch** /api/2.55/remote-arrays | Modify remote arrays
