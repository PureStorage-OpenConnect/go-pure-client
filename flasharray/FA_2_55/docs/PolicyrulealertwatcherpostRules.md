...
**MinimumNotificationSeverity** | Pointer to **string** | The minimum severity that an alert must have in order for emails to be sent to the recipient. Possible values include &#x60;info&#x60;, &#x60;warning&#x60;, and &#x60;critical&#x60;. If not specified, defaults to &#x60;info&#x60;.  | [optional] 

## Methods

### NewPolicyrulealertwatcherpostRules
...
### NewPolicyrulealertwatcherpostRulesWithDefaults
...
`func (o *PolicyrulealertwatcherpostRules) GetAlertClosureNotification() string`
...
`func (o *PolicyrulealertwatcherpostRules) GetAlertClosureNotificationOk() (*string, bool)`
...
`func (o *PolicyrulealertwatcherpostRules) SetAlertClosureNotification(v string)`

SetAlertClosureNotification sets AlertClosureNotification field to given value.

### HasAlertClosureNotification

`func (o *PolicyrulealertwatcherpostRules) HasAlertClosureNotification() bool`
