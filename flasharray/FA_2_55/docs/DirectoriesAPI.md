...
------------- | ------------- | -------------
[**DirectoriesDelete**](DirectoriesAPI.md#DirectoriesDelete) | **Delete** /api/2.55/directories | Delete managed directories
[**DirectoriesGet**](DirectoriesAPI.md#DirectoriesGet) | **Get** /api/2.55/directories | List directories
[**DirectoriesGroupsGet**](DirectoriesAPI.md#DirectoriesGroupsGet) | **Get** /api/2.55/directories/groups | List group with content in directories
[**DirectoriesLocksNlmReclamationsPost**](DirectoriesAPI.md#DirectoriesLocksNlmReclamationsPost) | **Post** /api/2.55/directories/locks/nlm-reclamations | Create NLM reclamation
[**DirectoriesPatch**](DirectoriesAPI.md#DirectoriesPatch) | **Patch** /api/2.55/directories | Modify a managed directory
[**DirectoriesPerformanceByArrayGet**](DirectoriesAPI.md#DirectoriesPerformanceByArrayGet) | **Get** /api/2.55/directories/performance/by-array | List directories performance data by array
[**DirectoriesPerformanceGet**](DirectoriesAPI.md#DirectoriesPerformanceGet) | **Get** /api/2.55/directories/performance | List directory performance data
[**DirectoriesPoliciesAuditFileDelete**](DirectoriesAPI.md#DirectoriesPoliciesAuditFileDelete) | **Delete** /api/2.55/directories/policies/audit-file | Delete a membership between a directory and one or more audit policies
[**DirectoriesPoliciesAuditFileGet**](DirectoriesAPI.md#DirectoriesPoliciesAuditFileGet) | **Get** /api/2.55/directories/policies/audit-file | List audit policies attached to a directory
[**DirectoriesPoliciesAuditFilePost**](DirectoriesAPI.md#DirectoriesPoliciesAuditFilePost) | **Post** /api/2.55/directories/policies/audit-file | Create a membership between a directory and one or more audit policies
[**DirectoriesPoliciesAutodirDelete**](DirectoriesAPI.md#DirectoriesPoliciesAutodirDelete) | **Delete** /api/2.55/directories/policies/autodir | Delete a membership between a directory and one or more auto managed directory policies
[**DirectoriesPoliciesAutodirGet**](DirectoriesAPI.md#DirectoriesPoliciesAutodirGet) | **Get** /api/2.55/directories/policies/autodir | List auto managed directory policies attached to a directory
[**DirectoriesPoliciesAutodirPost**](DirectoriesAPI.md#DirectoriesPoliciesAutodirPost) | **Post** /api/2.55/directories/policies/autodir | Create a membership between a directory with one or more auto managed directory policies
[**DirectoriesPoliciesGet**](DirectoriesAPI.md#DirectoriesPoliciesGet) | **Get** /api/2.55/directories/policies | List policies
[**DirectoriesPoliciesNfsDelete**](DirectoriesAPI.md#DirectoriesPoliciesNfsDelete) | **Delete** /api/2.55/directories/policies/nfs | Delete a membership between a directory and one or more NFS policies
[**DirectoriesPoliciesNfsGet**](DirectoriesAPI.md#DirectoriesPoliciesNfsGet) | **Get** /api/2.55/directories/policies/nfs | List NFS policies attached to a directory
[**DirectoriesPoliciesNfsPost**](DirectoriesAPI.md#DirectoriesPoliciesNfsPost) | **Post** /api/2.55/directories/policies/nfs | Create a membership between a directory and one or more NFS policies
[**DirectoriesPoliciesQosDelete**](DirectoriesAPI.md#DirectoriesPoliciesQosDelete) | **Delete** /api/2.55/directories/policies/qos | Delete a membership between a directory and one or more QoS policies
[**DirectoriesPoliciesQosGet**](DirectoriesAPI.md#DirectoriesPoliciesQosGet) | **Get** /api/2.55/directories/policies/qos | List QoS policies attached to a directory
[**DirectoriesPoliciesQosPost**](DirectoriesAPI.md#DirectoriesPoliciesQosPost) | **Post** /api/2.55/directories/policies/qos | Create a membership between a directory and one or more QoS policies
[**DirectoriesPoliciesQuotaDelete**](DirectoriesAPI.md#DirectoriesPoliciesQuotaDelete) | **Delete** /api/2.55/directories/policies/quota | Delete a membership between a directory and one or more quota policies
[**DirectoriesPoliciesQuotaGet**](DirectoriesAPI.md#DirectoriesPoliciesQuotaGet) | **Get** /api/2.55/directories/policies/quota | List quota policies attached to a directory
[**DirectoriesPoliciesQuotaPost**](DirectoriesAPI.md#DirectoriesPoliciesQuotaPost) | **Post** /api/2.55/directories/policies/quota | Create a membership between a directory and one or more quota policies
[**DirectoriesPoliciesSmbDelete**](DirectoriesAPI.md#DirectoriesPoliciesSmbDelete) | **Delete** /api/2.55/directories/policies/smb | Delete a membership between a directory and one or more SMB policies
[**DirectoriesPoliciesSmbGet**](DirectoriesAPI.md#DirectoriesPoliciesSmbGet) | **Get** /api/2.55/directories/policies/smb | List SMB policies attached to a directory
[**DirectoriesPoliciesSmbPost**](DirectoriesAPI.md#DirectoriesPoliciesSmbPost) | **Post** /api/2.55/directories/policies/smb | Create a membership between a directory and one or more SMB policies
[**DirectoriesPoliciesSnapshotDelete**](DirectoriesAPI.md#DirectoriesPoliciesSnapshotDelete) | **Delete** /api/2.55/directories/policies/snapshot | Delete a membership between a directory and one or more snapshot policies
[**DirectoriesPoliciesSnapshotGet**](DirectoriesAPI.md#DirectoriesPoliciesSnapshotGet) | **Get** /api/2.55/directories/policies/snapshot | List snapshot policies attached to a directory
[**DirectoriesPoliciesSnapshotPost**](DirectoriesAPI.md#DirectoriesPoliciesSnapshotPost) | **Post** /api/2.55/directories/policies/snapshot | Create a membership between a directory with one or more snapshot policies
[**DirectoriesPoliciesUserGroupQuotaDelete**](DirectoriesAPI.md#DirectoriesPoliciesUserGroupQuotaDelete) | **Delete** /api/2.55/directories/policies/user-group-quota | Delete a membership between a directory and one or more user-group-quota policies
[**DirectoriesPoliciesUserGroupQuotaGet**](DirectoriesAPI.md#DirectoriesPoliciesUserGroupQuotaGet) | **Get** /api/2.55/directories/policies/user-group-quota | List user-group-quota policies attached to a directory
[**DirectoriesPoliciesUserGroupQuotaPost**](DirectoriesAPI.md#DirectoriesPoliciesUserGroupQuotaPost) | **Post** /api/2.55/directories/policies/user-group-quota | Create a membership between a directory and one or more user-group-quota policies
[**DirectoriesPost**](DirectoriesAPI.md#DirectoriesPost) | **Post** /api/2.55/directories | Create or copy directory
[**DirectoriesQosGet**](DirectoriesAPI.md#DirectoriesQosGet) | **Get** /api/2.55/directories/qos | List directory QoS policy configurations
[**DirectoriesSpaceGet**](DirectoriesAPI.md#DirectoriesSpaceGet) | **Get** /api/2.55/directories/space | List directory space information
[**DirectoriesUsersGet**](DirectoriesAPI.md#DirectoriesUsersGet) | **Get** /api/2.55/directories/users | List users with content in directories
...
## DirectoriesGroupsGet

> DirectoriesGroupsGetResponse DirectoriesGroupsGet(ctx).Authorization(authorization).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Filter(filter).GroupIds(groupIds).GroupNames(groupNames).GroupSids(groupSids).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).Execute()
...
func main() {
    ...
    req := apiClient.DirectoriesAPI.DirectoriesGroupsGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DirectoriesAPI.DirectoriesGroupsGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DirectoriesGroupsGet`: DirectoriesGroupsGetResponse
    fmt.Fprintf(os.Stdout, "Response from `DirectoriesAPI.DirectoriesGroupsGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDirectoriesGroupsGetRequest struct via the builder pattern
...
[**DirectoriesGroupsGetResponse**](DirectoriesGroupsGetResponse.md)
...
## DirectoriesPerformanceByArrayGet

> DirectoriesPerformanceByArrayGetResponse DirectoriesPerformanceByArrayGet(ctx).Authorization(authorization).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Destroyed(destroyed).EndTime(endTime).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Protocol(protocol).Resolution(resolution).Sort(sort).StartTime(startTime).TotalItemCount(totalItemCount).TotalOnly(totalOnly).Execute()
...
func main() {
    ...
    req := apiClient.DirectoriesAPI.DirectoriesPerformanceByArrayGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DirectoriesAPI.DirectoriesPerformanceByArrayGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DirectoriesPerformanceByArrayGet`: DirectoriesPerformanceByArrayGetResponse
    fmt.Fprintf(os.Stdout, "Response from `DirectoriesAPI.DirectoriesPerformanceByArrayGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDirectoriesPerformanceByArrayGetRequest struct via the builder pattern
...
[**DirectoriesPerformanceByArrayGetResponse**](DirectoriesPerformanceByArrayGetResponse.md)
...
> DirectoriesPoliciesNfsDelete(ctx).Authorization(authorization).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).ServerIds(serverIds).ServerNames(serverNames).Execute()
...
## DirectoriesPoliciesQosDelete

> DirectoriesPoliciesQosDelete(ctx).Authorization(authorization).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
func main() {
    ...
    req := apiClient.DirectoriesAPI.DirectoriesPoliciesQosDelete(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DirectoriesAPI.DirectoriesPoliciesQosDelete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDirectoriesPoliciesQosDeleteRequest struct via the builder pattern
...
## DirectoriesPoliciesQosGet

> PolicyMemberGetResponse DirectoriesPoliciesQosGet(ctx).Authorization(authorization).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Destroyed(destroyed).Filter(filter).Limit(limit).MemberIds(memberIds).MemberNames(memberNames).Offset(offset).PolicyIds(policyIds).PolicyNames(policyNames).Sort(sort).TotalItemCount(totalItemCount).Execute()
...
func main() {
    ...
    req := apiClient.DirectoriesAPI.DirectoriesPoliciesQosGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DirectoriesAPI.DirectoriesPoliciesQosGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DirectoriesPoliciesQosGet`: PolicyMemberGetResponse
    fmt.Fprintf(os.Stdout, "Response from `DirectoriesAPI.DirectoriesPoliciesQosGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDirectoriesPoliciesQosGetRequest struct via the builder pattern
...
## DirectoriesPoliciesQosPost

> PolicyMemberResponse DirectoriesPoliciesQosPost(ctx).Policies(policies).Authorization(authorization).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).Execute()
...
func main() {
    ...
    req := apiClient.DirectoriesAPI.DirectoriesPoliciesQosPost(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DirectoriesAPI.DirectoriesPoliciesQosPost``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DirectoriesPoliciesQosPost`: PolicyMemberResponse
    fmt.Fprintf(os.Stdout, "Response from `DirectoriesAPI.DirectoriesPoliciesQosPost`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDirectoriesPoliciesQosPostRequest struct via the builder pattern
...
> DirectoriesPoliciesSmbDelete(ctx).Authorization(authorization).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).ServerIds(serverIds).ServerNames(serverNames).Execute()
...
## DirectoriesPoliciesUserGroupQuotaDelete

> DirectoriesPoliciesUserGroupQuotaDelete(ctx).Authorization(authorization).XRequestID(xRequestID).ContextNames(contextNames).IgnoreUsage(ignoreUsage).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
func main() {
    ...
    req := apiClient.DirectoriesAPI.DirectoriesPoliciesUserGroupQuotaDelete(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DirectoriesAPI.DirectoriesPoliciesUserGroupQuotaDelete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDirectoriesPoliciesUserGroupQuotaDeleteRequest struct via the builder pattern
...
## DirectoriesPoliciesUserGroupQuotaGet

> PolicyMemberGetResponse DirectoriesPoliciesUserGroupQuotaGet(ctx).Authorization(authorization).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Destroyed(destroyed).Filter(filter).Limit(limit).MemberIds(memberIds).MemberNames(memberNames).Offset(offset).PolicyIds(policyIds).PolicyNames(policyNames).Sort(sort).TotalItemCount(totalItemCount).Execute()
...
func main() {
    ...
    req := apiClient.DirectoriesAPI.DirectoriesPoliciesUserGroupQuotaGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DirectoriesAPI.DirectoriesPoliciesUserGroupQuotaGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DirectoriesPoliciesUserGroupQuotaGet`: PolicyMemberGetResponse
    fmt.Fprintf(os.Stdout, "Response from `DirectoriesAPI.DirectoriesPoliciesUserGroupQuotaGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDirectoriesPoliciesUserGroupQuotaGetRequest struct via the builder pattern
...
## DirectoriesPoliciesUserGroupQuotaPost

> PolicyMemberResponse DirectoriesPoliciesUserGroupQuotaPost(ctx).Policies(policies).Authorization(authorization).XRequestID(xRequestID).ContextNames(contextNames).IgnoreUsage(ignoreUsage).MemberIds(memberIds).MemberNames(memberNames).Execute()
...
func main() {
    ...
    req := apiClient.DirectoriesAPI.DirectoriesPoliciesUserGroupQuotaPost(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DirectoriesAPI.DirectoriesPoliciesUserGroupQuotaPost``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DirectoriesPoliciesUserGroupQuotaPost`: PolicyMemberResponse
    fmt.Fprintf(os.Stdout, "Response from `DirectoriesAPI.DirectoriesPoliciesUserGroupQuotaPost`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDirectoriesPoliciesUserGroupQuotaPostRequest struct via the builder pattern
...
> DirectoryResponse DirectoriesPost(ctx).Directory(directory).Authorization(authorization).XRequestID(xRequestID).AddToPolicyIds(addToPolicyIds).AddToPolicyNames(addToPolicyNames).ContextNames(contextNames).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).IgnoreUsage(ignoreUsage).Names(names).Overwrite(overwrite).WithDefaultProtection(withDefaultProtection).Execute()
 ...
 **authorization** | **string** | Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)  | 
 **xRequestID** | **string** | Supplied by client during request or generated by server.  | 
 **addToPolicyIds** | **[]string** | The managed directories will become members of the specified policies along with creation. Enter multiple ids in comma-separated format.  | 
 **addToPolicyNames** | **[]string** | The managed directories will become members of the specified policies along with creation. Enter multiple names in a comma-separated format.  | 
 **contextNames** | **[]string** | Performs the operation on the context specified.  If specified, the context names must be an array of size 1, and the single element must be the name of an array in the same fleet or the name of the fleet itself. If not specified, the context will default to the array that received this request.  Other parameters provided with the request, such as names of volumes or snapshots, are resolved relative to the provided &#x60;context&#x60;.  | 
 **fileSystemIds** | **[]string** | Performs the operation on the file system ID specified. Enter multiple file system IDs in comma-separated format. The &#x60;file_system_ids&#x60; or &#x60;file_system_names&#x60; parameter is required, but they cannot be set together.  | 
 **fileSystemNames** | **[]string** | Performs the operation on the file system name specified. Enter multiple file system names in comma-separated format. For example, &#x60;filesystem01,filesystem02&#x60;.  | 
 **ignoreUsage** | **bool** | Flag used to override checks for quota management operations. If set to &#x60;true&#x60;, directory usage is not checked against the &#x60;quota_limits&#x60; that are set. If set to &#x60;false&#x60;, the actual logical bytes in use are prevented from exceeding the limits set on the directory. Client operations might be impacted. If the limit exceeds the quota, the client operation is not allowed. If not specified, defaults to &#x60;false&#x60;.  | 
...
> DirectoryQosGetResponse DirectoriesQosGet(ctx).Authorization(authorization).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Destroyed(destroyed).EndTime(endTime).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Resolution(resolution).Sort(sort).StartTime(startTime).TotalItemCount(totalItemCount).Execute()
...
func main() {
    ...
    req := apiClient.DirectoriesAPI.DirectoriesQosGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DirectoriesAPI.DirectoriesQosGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DirectoriesQosGet`: DirectoryQosGetResponse
    fmt.Fprintf(os.Stdout, "Response from `DirectoriesAPI.DirectoriesQosGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDirectoriesQosGetRequest struct via the builder pattern
...
[**DirectoryQosGetResponse**](DirectoryQosGetResponse.md)
...
> DirectoriesUsersGetResponse DirectoriesUsersGet(ctx).Authorization(authorization).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).UserIds(userIds).UserNames(userNames).UserSids(userSids).Execute()
...
func main() {
    ...
    req := apiClient.DirectoriesAPI.DirectoriesUsersGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DirectoriesAPI.DirectoriesUsersGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DirectoriesUsersGet`: DirectoriesUsersGetResponse
    fmt.Fprintf(os.Stdout, "Response from `DirectoriesAPI.DirectoriesUsersGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDirectoriesUsersGetRequest struct via the builder pattern
...
[**DirectoriesUsersGetResponse**](DirectoriesUsersGetResponse.md)
