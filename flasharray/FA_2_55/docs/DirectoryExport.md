...
**Name** | Pointer to **string** | Name of the export configuration object. Combines the export containment hierarchy (realm and server), the protocol (SMB or NFS) and the user-visible &#x60;export_name&#x60;.  | [optional] 
...
`func (o *DirectoryExport) GetRealms() []FixedReferenceWithType`

GetRealms returns the Realms field if non-nil, zero value otherwise.

### GetRealmsOk

`func (o *DirectoryExport) GetRealmsOk() (*[]FixedReferenceWithType, bool)`
...
`func (o *DirectoryExport) SetRealms(v []FixedReferenceWithType)`

SetRealms sets Realms field to given value.

### HasRealms

`func (o *DirectoryExport) HasRealms() bool`
