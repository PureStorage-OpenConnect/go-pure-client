...
------------- | ------------- | -------------
[**DirectorySnapshotsDelete**](DirectorySnapshotsAPI.md#DirectorySnapshotsDelete) | **Delete** /api/2.55/directory-snapshots | Delete directory snapshot
[**DirectorySnapshotsGet**](DirectorySnapshotsAPI.md#DirectorySnapshotsGet) | **Get** /api/2.55/directory-snapshots | List directory snapshots
[**DirectorySnapshotsPatch**](DirectorySnapshotsAPI.md#DirectorySnapshotsPatch) | **Patch** /api/2.55/directory-snapshots | Modify directory snapshot
[**DirectorySnapshotsPost**](DirectorySnapshotsAPI.md#DirectorySnapshotsPost) | **Post** /api/2.55/directory-snapshots | Create directory snapshot
