...
------------- | ------------- | -------------
[**CertificateGroupsCertificatesDelete**](CertificateGroupsAPI.md#CertificateGroupsCertificatesDelete) | **Delete** /api/2.55/certificate-groups/certificates | Delete certificate-groups or certificates
[**CertificateGroupsCertificatesGet**](CertificateGroupsAPI.md#CertificateGroupsCertificatesGet) | **Get** /api/2.55/certificate-groups/certificates | List  certificate-groups and certificates
[**CertificateGroupsCertificatesPost**](CertificateGroupsAPI.md#CertificateGroupsCertificatesPost) | **Post** /api/2.55/certificate-groups/certificates | Create certificate-groups/certificates
[**CertificateGroupsDelete**](CertificateGroupsAPI.md#CertificateGroupsDelete) | **Delete** /api/2.55/certificate-groups | Delete certificate-groups
[**CertificateGroupsGet**](CertificateGroupsAPI.md#CertificateGroupsGet) | **Get** /api/2.55/certificate-groups | List certificate-groups
[**CertificateGroupsPost**](CertificateGroupsAPI.md#CertificateGroupsPost) | **Post** /api/2.55/certificate-groups | Create certificate-groups
[**CertificateGroupsUsesGet**](CertificateGroupsAPI.md#CertificateGroupsUsesGet) | **Get** /api/2.55/certificate-groups/uses | List  certificate-groups/uses
