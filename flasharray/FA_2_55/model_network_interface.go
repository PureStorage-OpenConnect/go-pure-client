...
type NetworkInterface struct {
	...
	AttachedServers []FixedReferenceWithType `json:"attached_servers,omitempty"`
...
// SetAttachedServers gets a reference to the given []FixedReferenceWithType and assigns it to the AttachedServers field.
