...
// checks if the HostPerformanceBalanceGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostPerformanceBalanceGetResponse{}

// HostPerformanceBalanceGetResponse struct for HostPerformanceBalanceGetResponse
...
func NewHostPerformanceBalanceGetResponse() *HostPerformanceBalanceGetResponse {
	this := HostPerformanceBalanceGetResponse{}
	return &this
}
...
func (o *HostPerformanceBalanceGetResponse) GetItems() []HostPerformanceBalance {
	if o == nil || IsNil(o.Items) {
		var ret []HostPerformanceBalance
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []HostPerformanceBalance and assigns it to the Items field.
func (o *HostPerformanceBalanceGetResponse) SetItems(v []HostPerformanceBalance) {
	o.Items = v
}

func (o HostPerformanceBalanceGetResponse) MarshalJSON() ([]byte, error) {
...
func (o HostPerformanceBalanceGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableHostPerformanceBalanceGetResponse struct {
	value *HostPerformanceBalanceGetResponse
	isSet bool
}

func (v NullableHostPerformanceBalanceGetResponse) Get() *HostPerformanceBalanceGetResponse {
	return v.value
}

func (v *NullableHostPerformanceBalanceGetResponse) Set(val *HostPerformanceBalanceGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHostPerformanceBalanceGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHostPerformanceBalanceGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostPerformanceBalanceGetResponse(val *HostPerformanceBalanceGetResponse) *NullableHostPerformanceBalanceGetResponse {
	return &NullableHostPerformanceBalanceGetResponse{value: val, isSet: true}
}

func (v NullableHostPerformanceBalanceGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostPerformanceBalanceGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
