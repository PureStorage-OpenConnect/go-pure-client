...
// checks if the CertificateUseGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificateUseGetResponse{}

// CertificateUseGetResponse struct for CertificateUseGetResponse
...
func NewCertificateUseGetResponse() *CertificateUseGetResponse {
	this := CertificateUseGetResponse{}
	return &this
}
...
// SetItems gets a reference to the given []CertificateUse and assigns it to the Items field.
func (o *CertificateUseGetResponse) SetItems(v []CertificateUse) {
	o.Items = v
}

func (o CertificateUseGetResponse) MarshalJSON() ([]byte, error) {
...
func (o CertificateUseGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCertificateUseGetResponse struct {
	value *CertificateUseGetResponse
	isSet bool
}

func (v NullableCertificateUseGetResponse) Get() *CertificateUseGetResponse {
	return v.value
}

func (v *NullableCertificateUseGetResponse) Set(val *CertificateUseGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateUseGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateUseGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateUseGetResponse(val *CertificateUseGetResponse) *NullableCertificateUseGetResponse {
	return &NullableCertificateUseGetResponse{value: val, isSet: true}
}

func (v NullableCertificateUseGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateUseGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
