...
`func (o *DirectoryServiceCommon) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *DirectoryServiceCommon) GetContextOk() (*FixedReference, bool)`
...
`func (o *DirectoryServiceCommon) SetContext(v FixedReference)`
