...
------------ | ------------- | ------------- | -------------
**AutomaticCapacityUpgrade** | Pointer to [**CloudConfigAutomaticCapacityUpgrade**](CloudConfigAutomaticCapacityUpgrade.md) | Automatic capacity upgrade configuration of the CBS array.  | [optional] 
