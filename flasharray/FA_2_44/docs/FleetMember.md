...
------------ | ------------- | ------------- | -------------
**CoordinatorOf** | Pointer to [**[]FixedReferenceWithType**](FixedReferenceWithType.md) | List of array groups that the member is the coordinator of.  | [optional] 
**Fleet** | Pointer to [**FixedReferenceWithTypeAndLocation**](FixedReferenceWithTypeAndLocation.md) |  | [optional] 
**Member** | Pointer to [**FixedReferenceWithTypeAndLocation**](FixedReferenceWithTypeAndLocation.md) |  | [optional] 
**Status** | Pointer to **string** | Current fleet membership status Valid values are one of &#x60;joining&#x60;, &#x60;joined&#x60;, or &#x60;removing&#x60;. A status of &#x60;joining&#x60; indicates that the member is attempting to join the fleet. A status of &#x60;joined&#x60; indicates that the member has joined the fleet. A status of &#x60;removing&#x60; indicates that the member is being removed from the fleet.  | [optional] 
...
`func (o *FleetMember) GetCoordinatorOf() []FixedReferenceWithType`

GetCoordinatorOf returns the CoordinatorOf field if non-nil, zero value otherwise.

### GetCoordinatorOfOk

`func (o *FleetMember) GetCoordinatorOfOk() (*[]FixedReferenceWithType, bool)`
...
`func (o *FleetMember) SetCoordinatorOf(v []FixedReferenceWithType)`
