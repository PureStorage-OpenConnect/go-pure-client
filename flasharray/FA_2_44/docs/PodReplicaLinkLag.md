...
`func (o *PodReplicaLinkLag) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *PodReplicaLinkLag) GetContextOk() (*FixedReference, bool)`
...
`func (o *PodReplicaLinkLag) SetContext(v FixedReference)`
