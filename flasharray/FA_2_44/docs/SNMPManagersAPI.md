...
------------- | ------------- | -------------
[**SnmpManagersDelete**](SNMPManagersAPI.md#SnmpManagersDelete) | **Delete** /api/2.44/snmp-managers | Delete SNMP manager
[**SnmpManagersGet**](SNMPManagersAPI.md#SnmpManagersGet) | **Get** /api/2.44/snmp-managers | List SNMP managers
[**SnmpManagersPatch**](SNMPManagersAPI.md#SnmpManagersPatch) | **Patch** /api/2.44/snmp-managers | Modify SNMP manager
[**SnmpManagersPost**](SNMPManagersAPI.md#SnmpManagersPost) | **Post** /api/2.44/snmp-managers | Create SNMP manager
[**SnmpManagersTestGet**](SNMPManagersAPI.md#SnmpManagersTestGet) | **Get** /api/2.44/snmp-managers/test | List SNMP manager test results
...
> TestResultWithResourceGetResponse SnmpManagersTestGet(ctx).Authorization(authorization).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Limit(limit).Names(names).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).Execute()
