...
`func (o *LocalGroupPatch) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *LocalGroupPatch) GetContextOk() (*FixedReference, bool)`
...
`func (o *LocalGroupPatch) SetContext(v FixedReference)`
