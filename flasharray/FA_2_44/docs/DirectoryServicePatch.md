...
`func (o *DirectoryServicePatch) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *DirectoryServicePatch) GetContextOk() (*FixedReference, bool)`
...
`func (o *DirectoryServicePatch) SetContext(v FixedReference)`
