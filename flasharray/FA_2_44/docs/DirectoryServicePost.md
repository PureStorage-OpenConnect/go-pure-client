...
`func (o *DirectoryServicePost) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *DirectoryServicePost) GetContextOk() (*FixedReference, bool)`
...
`func (o *DirectoryServicePost) SetContext(v FixedReference)`
