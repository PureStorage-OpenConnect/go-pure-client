...
`func (o *DirectoryService) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *DirectoryService) GetContextOk() (*FixedReference, bool)`
...
`func (o *DirectoryService) SetContext(v FixedReference)`
