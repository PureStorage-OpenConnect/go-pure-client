...
// checks if the ResourcePerformanceNoIdByArrayGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourcePerformanceNoIdByArrayGetResponse{}

// ResourcePerformanceNoIdByArrayGetResponse struct for ResourcePerformanceNoIdByArrayGetResponse
type ResourcePerformanceNoIdByArrayGetResponse struct {
	...
	Items []ResourcePerformanceNoIdByArray `json:"items,omitempty"`
	...
	Total []ResourcePerformanceNoIdByArray `json:"total,omitempty"`
}
...
func NewResourcePerformanceNoIdByArrayGetResponse() *ResourcePerformanceNoIdByArrayGetResponse {
	this := ResourcePerformanceNoIdByArrayGetResponse{}
	return &this
}
...
func (o *ResourcePerformanceNoIdByArrayGetResponse) GetItems() []ResourcePerformanceNoIdByArray {
	if o == nil || IsNil(o.Items) {
		var ret []ResourcePerformanceNoIdByArray
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []ResourcePerformanceNoIdByArray and assigns it to the Items field.
...
// SetTotal gets a reference to the given []ResourcePerformanceNoIdByArray and assigns it to the Total field.
func (o *ResourcePerformanceNoIdByArrayGetResponse) SetTotal(v []ResourcePerformanceNoIdByArray) {
	o.Total = v
}

func (o ResourcePerformanceNoIdByArrayGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ResourcePerformanceNoIdByArrayGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResourcePerformanceNoIdByArrayGetResponse struct {
	value *ResourcePerformanceNoIdByArrayGetResponse
	isSet bool
}

func (v NullableResourcePerformanceNoIdByArrayGetResponse) Get() *ResourcePerformanceNoIdByArrayGetResponse {
	return v.value
}

func (v *NullableResourcePerformanceNoIdByArrayGetResponse) Set(val *ResourcePerformanceNoIdByArrayGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResourcePerformanceNoIdByArrayGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResourcePerformanceNoIdByArrayGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourcePerformanceNoIdByArrayGetResponse(val *ResourcePerformanceNoIdByArrayGetResponse) *NullableResourcePerformanceNoIdByArrayGetResponse {
	return &NullableResourcePerformanceNoIdByArrayGetResponse{value: val, isSet: true}
}

func (v NullableResourcePerformanceNoIdByArrayGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourcePerformanceNoIdByArrayGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
