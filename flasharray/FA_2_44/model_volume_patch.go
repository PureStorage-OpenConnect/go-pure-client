...
type VolumePatch struct {
	...
	Workload *ReferenceWithFixedType `json:"workload,omitempty"`
}
...
// SetWorkload gets a reference to the given ReferenceWithFixedType and assigns it to the Workload field.
