...
// checks if the NonCopyableTagBatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NonCopyableTagBatch{}

// NonCopyableTagBatch struct for NonCopyableTagBatch
type NonCopyableTagBatch struct {
...
func (o NonCopyableTagBatch) MarshalJSON() ([]byte, error) {
...
func (o NonCopyableTagBatch) ToMap() (map[string]interface{}, error) {
...
type NullableNonCopyableTagBatch struct {
	value *NonCopyableTagBatch
	isSet bool
}

func (v NullableNonCopyableTagBatch) Get() *NonCopyableTagBatch {
	return v.value
}

func (v *NullableNonCopyableTagBatch) Set(val *NonCopyableTagBatch) {
	v.value = val
	v.isSet = true
}

func (v NullableNonCopyableTagBatch) IsSet() bool {
	return v.isSet
}

func (v *NullableNonCopyableTagBatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNonCopyableTagBatch(val *NonCopyableTagBatch) *NullableNonCopyableTagBatch {
	return &NullableNonCopyableTagBatch{value: val, isSet: true}
}

func (v NullableNonCopyableTagBatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNonCopyableTagBatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
