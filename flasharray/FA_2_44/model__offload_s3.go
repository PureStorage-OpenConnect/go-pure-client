...
// GetAuthRegion returns the AuthRegion field value if set, zero value otherwise.
func (o *OffloadS3) GetAuthRegion() string {
	if o == nil || IsNil(o.AuthRegion) {
		var ret string
		return ret
	}
	return *o.AuthRegion
...
// GetAuthRegionOk returns a tuple with the AuthRegion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OffloadS3) GetAuthRegionOk() (*string, bool) {
	if o == nil || IsNil(o.AuthRegion) {
		return nil, false
	}
	return o.AuthRegion, true
}
...
// SetAuthRegion gets a reference to the given string and assigns it to the AuthRegion field.
...
func (o OffloadS3) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AuthRegion) {
		toSerialize["auth_region"] = o.AuthRegion
	}
	if !IsNil(o.Bucket) {
