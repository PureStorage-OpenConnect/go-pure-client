...
// checks if the VirtualMachineVolumeSnapshotResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualMachineVolumeSnapshotResponse{}

// VirtualMachineVolumeSnapshotResponse struct for VirtualMachineVolumeSnapshotResponse
type VirtualMachineVolumeSnapshotResponse struct {
	...
	Items []VirtualMachineVolumeSnapshot `json:"items,omitempty"`
}
...
func NewVirtualMachineVolumeSnapshotResponse() *VirtualMachineVolumeSnapshotResponse {
	this := VirtualMachineVolumeSnapshotResponse{}
	return &this
}
...
func (o *VirtualMachineVolumeSnapshotResponse) GetItems() []VirtualMachineVolumeSnapshot {
	if o == nil || IsNil(o.Items) {
		var ret []VirtualMachineVolumeSnapshot
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []VirtualMachineVolumeSnapshot and assigns it to the Items field.
func (o *VirtualMachineVolumeSnapshotResponse) SetItems(v []VirtualMachineVolumeSnapshot) {
	o.Items = v
}

func (o VirtualMachineVolumeSnapshotResponse) MarshalJSON() ([]byte, error) {
...
func (o VirtualMachineVolumeSnapshotResponse) ToMap() (map[string]interface{}, error) {
...
type NullableVirtualMachineVolumeSnapshotResponse struct {
	value *VirtualMachineVolumeSnapshotResponse
	isSet bool
}

func (v NullableVirtualMachineVolumeSnapshotResponse) Get() *VirtualMachineVolumeSnapshotResponse {
	return v.value
}

func (v *NullableVirtualMachineVolumeSnapshotResponse) Set(val *VirtualMachineVolumeSnapshotResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualMachineVolumeSnapshotResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualMachineVolumeSnapshotResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualMachineVolumeSnapshotResponse(val *VirtualMachineVolumeSnapshotResponse) *NullableVirtualMachineVolumeSnapshotResponse {
	return &NullableVirtualMachineVolumeSnapshotResponse{value: val, isSet: true}
}

func (v NullableVirtualMachineVolumeSnapshotResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualMachineVolumeSnapshotResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
