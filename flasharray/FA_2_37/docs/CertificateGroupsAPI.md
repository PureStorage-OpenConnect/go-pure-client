...
------------- | ------------- | -------------
[**CertificateGroupsCertificatesDelete**](CertificateGroupsAPI.md#CertificateGroupsCertificatesDelete) | **Delete** /api/2.37/certificate-groups/certificates | Delete certificate-groups/certificates
[**CertificateGroupsCertificatesGet**](CertificateGroupsAPI.md#CertificateGroupsCertificatesGet) | **Get** /api/2.37/certificate-groups/certificates | List certificate-groups/certificates
[**CertificateGroupsCertificatesPost**](CertificateGroupsAPI.md#CertificateGroupsCertificatesPost) | **Post** /api/2.37/certificate-groups/certificates | Create certificate-groups/certificates
[**CertificateGroupsDelete**](CertificateGroupsAPI.md#CertificateGroupsDelete) | **Delete** /api/2.37/certificate-groups | Delete certificate-groups
[**CertificateGroupsGet**](CertificateGroupsAPI.md#CertificateGroupsGet) | **Get** /api/2.37/certificate-groups | List certificate-groups
[**CertificateGroupsPost**](CertificateGroupsAPI.md#CertificateGroupsPost) | **Post** /api/2.37/certificate-groups | Create certificate-groups



## CertificateGroupsCertificatesDelete

> CertificateGroupsCertificatesDelete(ctx).Authorization(authorization).XRequestID(xRequestID).CertificateGroupIds(certificateGroupIds).CertificateGroupNames(certificateGroupNames).CertificateNames(certificateNames).Execute()
...
> CertificateGroupCertificateGetResponse CertificateGroupsCertificatesGet(ctx).Authorization(authorization).XRequestID(xRequestID).CertificateGroupIds(certificateGroupIds).CertificateGroupNames(certificateGroupNames).CertificateNames(certificateNames).ContinuationToken(continuationToken).Filter(filter).Limit(limit).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).Execute()
...
> CertificateGroupCertificateResponse CertificateGroupsCertificatesPost(ctx).Authorization(authorization).XRequestID(xRequestID).CertificateGroupIds(certificateGroupIds).CertificateGroupNames(certificateGroupNames).CertificateNames(certificateNames).Execute()
