...
// checks if the ResourceSpaceGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceSpaceGetResponse{}

// ResourceSpaceGetResponse struct for ResourceSpaceGetResponse
type ResourceSpaceGetResponse struct {
	...
	Items []ResourceSpace `json:"items,omitempty"`
	...
	Total []ResourceSpace `json:"total,omitempty"`
}
...
// SetItems gets a reference to the given []ResourceSpace and assigns it to the Items field.
...
// SetTotal gets a reference to the given []ResourceSpace and assigns it to the Total field.
func (o *ResourceSpaceGetResponse) SetTotal(v []ResourceSpace) {
	o.Total = v
}

func (o ResourceSpaceGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ResourceSpaceGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResourceSpaceGetResponse struct {
	value *ResourceSpaceGetResponse
	isSet bool
}

func (v NullableResourceSpaceGetResponse) Get() *ResourceSpaceGetResponse {
	return v.value
}

func (v *NullableResourceSpaceGetResponse) Set(val *ResourceSpaceGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceSpaceGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceSpaceGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceSpaceGetResponse(val *ResourceSpaceGetResponse) *NullableResourceSpaceGetResponse {
	return &NullableResourceSpaceGetResponse{value: val, isSet: true}
}

func (v NullableResourceSpaceGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceSpaceGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
