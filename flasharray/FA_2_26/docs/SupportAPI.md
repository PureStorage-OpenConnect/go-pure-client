...
------------- | ------------- | -------------
[**SupportGet**](SupportAPI.md#SupportGet) | **Get** /api/2.26/support | List connection paths
[**SupportPatch**](SupportAPI.md#SupportPatch) | **Patch** /api/2.26/support | Create connection path
[**SupportTestGet**](SupportAPI.md#SupportTestGet) | **Get** /api/2.26/support/test | List Everpure Support connection data
