...
------------- | ------------- | -------------
[**ArraysCloudProviderTagsBatchPut**](ArraysAPI.md#ArraysCloudProviderTagsBatchPut) | **Put** /api/2.26/arrays/cloud-provider-tags/batch | Update user tags on the cloud.
[**ArraysCloudProviderTagsDelete**](ArraysAPI.md#ArraysCloudProviderTagsDelete) | **Delete** /api/2.26/arrays/cloud-provider-tags | Delete user tags from the cloud.
[**ArraysCloudProviderTagsGet**](ArraysAPI.md#ArraysCloudProviderTagsGet) | **Get** /api/2.26/arrays/cloud-provider-tags | List user tags on the cloud.
[**ArraysDelete**](ArraysAPI.md#ArraysDelete) | **Delete** /api/2.26/arrays | Delete an array
[**ArraysEulaGet**](ArraysAPI.md#ArraysEulaGet) | **Get** /api/2.26/arrays/eula | List End User Agreement and signature
[**ArraysEulaPatch**](ArraysAPI.md#ArraysEulaPatch) | **Patch** /api/2.26/arrays/eula | Modify signature on the End User Agreement
...
[**ArraysGet**](ArraysAPI.md#ArraysGet) | **Get** /api/2.26/arrays | List arrays
[**ArraysNtpTestGet**](ArraysAPI.md#ArraysNtpTestGet) | **Get** /api/2.26/arrays/ntp-test | List NTP test results
[**ArraysPatch**](ArraysAPI.md#ArraysPatch) | **Patch** /api/2.26/arrays | Modify an array
[**ArraysPerformanceByLinkGet**](ArraysAPI.md#ArraysPerformanceByLinkGet) | **Get** /api/2.26/arrays/performance/by-link | List array front-end IO performance data by link
[**ArraysPerformanceGet**](ArraysAPI.md#ArraysPerformanceGet) | **Get** /api/2.26/arrays/performance | List array front-end performance data
[**ArraysSpaceGet**](ArraysAPI.md#ArraysSpaceGet) | **Get** /api/2.26/arrays/space | List array space information
