...
// checks if the TagGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagGetResponse{}

// TagGetResponse struct for TagGetResponse
...
func (o TagGetResponse) MarshalJSON() ([]byte, error) {
...
func (o TagGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableTagGetResponse struct {
	value *TagGetResponse
	isSet bool
}

func (v NullableTagGetResponse) Get() *TagGetResponse {
	return v.value
}

func (v *NullableTagGetResponse) Set(val *TagGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTagGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTagGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagGetResponse(val *TagGetResponse) *NullableTagGetResponse {
	return &NullableTagGetResponse{value: val, isSet: true}
}

func (v NullableTagGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
