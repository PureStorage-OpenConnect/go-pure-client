...
type Audit struct {
	...
	// If set to `true`, the audit record represents a system-initiated event resulting from a previous configuration. If set to `false`, the audit record represents an event invoked directly by a user.
