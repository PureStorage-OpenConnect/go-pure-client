...
// checks if the RemoteVolumeSnapshotTransfer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteVolumeSnapshotTransfer{}

// RemoteVolumeSnapshotTransfer struct for RemoteVolumeSnapshotTransfer
...
func NewRemoteVolumeSnapshotTransfer() *RemoteVolumeSnapshotTransfer {
	this := RemoteVolumeSnapshotTransfer{}
	return &this
}
...
func (o RemoteVolumeSnapshotTransfer) MarshalJSON() ([]byte, error) {
...
func (o RemoteVolumeSnapshotTransfer) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteVolumeSnapshotTransfer struct {
	value *RemoteVolumeSnapshotTransfer
	isSet bool
}

func (v NullableRemoteVolumeSnapshotTransfer) Get() *RemoteVolumeSnapshotTransfer {
	return v.value
}

func (v *NullableRemoteVolumeSnapshotTransfer) Set(val *RemoteVolumeSnapshotTransfer) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteVolumeSnapshotTransfer) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteVolumeSnapshotTransfer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteVolumeSnapshotTransfer(val *RemoteVolumeSnapshotTransfer) *NullableRemoteVolumeSnapshotTransfer {
	return &NullableRemoteVolumeSnapshotTransfer{value: val, isSet: true}
}

func (v NullableRemoteVolumeSnapshotTransfer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteVolumeSnapshotTransfer) UnmarshalJSON(src []byte) error {
	v.isSet = true
