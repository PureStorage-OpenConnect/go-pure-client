...
**EradicationConfig** | Pointer to [**DirectorySnapshotEradicationConfig**](DirectorySnapshotEradicationConfig.md) |  | [optional] 
...
`func (o *DirectorySnapshot) GetEradicationConfig() DirectorySnapshotEradicationConfig`

GetEradicationConfig returns the EradicationConfig field if non-nil, zero value otherwise.

### GetEradicationConfigOk

`func (o *DirectorySnapshot) GetEradicationConfigOk() (*DirectorySnapshotEradicationConfig, bool)`
...
`func (o *DirectorySnapshot) SetEradicationConfig(v DirectorySnapshotEradicationConfig)`

SetEradicationConfig sets EradicationConfig field to given value.

### HasEradicationConfig

`func (o *DirectorySnapshot) HasEradicationConfig() bool`
