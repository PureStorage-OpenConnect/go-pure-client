...
**QuotaLimit** | Pointer to **string** | The logical space limit of the quota assigned by the rule, measured in bytes. The value cannot be &#x60;0&#x60;. It supports parameterization.  | [optional] 
