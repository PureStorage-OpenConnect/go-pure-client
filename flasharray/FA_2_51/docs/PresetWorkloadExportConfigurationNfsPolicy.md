...
**UserMappingEnabled** | Pointer to **string** | If set to \&quot;true\&quot;, queries the joined AD/OpenLDAP server to find the user corresponding to the incoming UID. If set to \&quot;false\&quot;, users are defined by UID/GID pair. It supports parameterization.  | [optional] 
