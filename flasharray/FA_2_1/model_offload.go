...
type Offload struct {
	// The Microsoft Azure Blob storage settings.
	Azure *OffloadAzure `json:"azure,omitempty"`
	// The NFS storage settings. Deprecated from version 6.6.0 onwards - Contact support for additional information.
	Nfs *OffloadNfs `json:"nfs,omitempty"`
	// The Amazon S3 storage settings.
	S3 *OffloadS3 `json:"s3,omitempty"`
	// A user-specified name. The name must be locally unique and can be changed.
	Name *string `json:"name,omitempty"`
	// The type of offload. Valid values are `nfs` for Network File System, `s3` for Amazon S3, and `azure` for Microsoft Azure.
