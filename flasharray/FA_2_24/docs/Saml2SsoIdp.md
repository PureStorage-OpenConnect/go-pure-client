...
**VerificationCertificate** | Pointer to **string** | The X509 certificate that the service provider uses to verify the SAML response signature from the identity provider.  | [optional] 
