...
------------- | ------------- | -------------
[**ApiClientsDelete**](APIClientsAPI.md#ApiClientsDelete) | **Delete** /api/2.24/api-clients | Delete an API client
[**ApiClientsGet**](APIClientsAPI.md#ApiClientsGet) | **Get** /api/2.24/api-clients | List API clients
[**ApiClientsPatch**](APIClientsAPI.md#ApiClientsPatch) | **Patch** /api/2.24/api-clients | Manage an API client
[**ApiClientsPost**](APIClientsAPI.md#ApiClientsPost) | **Post** /api/2.24/api-clients | Create an API client
