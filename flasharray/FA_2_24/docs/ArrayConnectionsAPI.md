...
------------- | ------------- | -------------
[**ArrayConnectionsConnectionKeyGet**](ArrayConnectionsAPI.md#ArrayConnectionsConnectionKeyGet) | **Get** /api/2.24/array-connections/connection-key | List connection key
[**ArrayConnectionsDelete**](ArrayConnectionsAPI.md#ArrayConnectionsDelete) | **Delete** /api/2.24/array-connections | Delete an array connection
[**ArrayConnectionsGet**](ArrayConnectionsAPI.md#ArrayConnectionsGet) | **Get** /api/2.24/array-connections | List connected arrays
[**ArrayConnectionsPatch**](ArrayConnectionsAPI.md#ArrayConnectionsPatch) | **Patch** /api/2.24/array-connections | Modify an array connection
[**ArrayConnectionsPathGet**](ArrayConnectionsAPI.md#ArrayConnectionsPathGet) | **Get** /api/2.24/array-connections/path | List connection path
[**ArrayConnectionsPost**](ArrayConnectionsAPI.md#ArrayConnectionsPost) | **Post** /api/2.24/array-connections | Create an array connection
