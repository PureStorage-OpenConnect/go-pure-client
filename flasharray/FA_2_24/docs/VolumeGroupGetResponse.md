...
**Total** | Pointer to [**[]VolumeGroup**](VolumeGroup.md) | The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicalbe, the values are displayed for each field.  | [optional] 
