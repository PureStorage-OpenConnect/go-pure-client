...
**Items** | Pointer to [**[]VolumeSpace**](VolumeSpace.md) | Displays a list of all items after filtering. The values are displayed for each name, if applicable. If &#x60;total_only&#x3D;true&#x60;, the &#x60;items&#x60; list will be empty.  | [optional] 
**Total** | Pointer to [**[]VolumeSpace**](VolumeSpace.md) | The aggregate value of all items after filtering. If applicable, the average value is displayed instead. If applicable, the values are displayed for each field.  | [optional] 
