...
------------- | ------------- | -------------
[**NetworkInterfacesDelete**](NetworkInterfacesAPI.md#NetworkInterfacesDelete) | **Delete** /api/2.24/network-interfaces | Delete network interface
[**NetworkInterfacesGet**](NetworkInterfacesAPI.md#NetworkInterfacesGet) | **Get** /api/2.24/network-interfaces | List network interfaces
...
[**NetworkInterfacesPatch**](NetworkInterfacesAPI.md#NetworkInterfacesPatch) | **Patch** /api/2.24/network-interfaces | Modify network interface
[**NetworkInterfacesPerformanceGet**](NetworkInterfacesAPI.md#NetworkInterfacesPerformanceGet) | **Get** /api/2.24/network-interfaces/performance | List network performance statistics
[**NetworkInterfacesPortDetailsGet**](NetworkInterfacesAPI.md#NetworkInterfacesPortDetailsGet) | **Get** /api/2.24/network-interfaces/port-details | List SFP port details
[**NetworkInterfacesPost**](NetworkInterfacesAPI.md#NetworkInterfacesPost) | **Post** /api/2.24/network-interfaces | Create network interface



## NetworkInterfacesDelete

> NetworkInterfacesDelete(ctx).Authorization(authorization).XRequestID(xRequestID).Names(names).Execute()
...
> NetworkInterfaceGetResponse NetworkInterfacesGet(ctx).Authorization(authorization).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Limit(limit).Names(names).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).Execute()
...
> NetworkInterfaceResponse NetworkInterfacesPatch(ctx).Network(network).Authorization(authorization).XRequestID(xRequestID).Names(names).Execute()
...
> NetworkInterfaceResponse NetworkInterfacesPost(ctx).Network(network).Authorization(authorization).XRequestID(xRequestID).Names(names).Execute()
