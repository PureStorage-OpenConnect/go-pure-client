...
// checks if the ResourceDirectorySpaceGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceDirectorySpaceGetResponse{}

// ResourceDirectorySpaceGetResponse struct for ResourceDirectorySpaceGetResponse
type ResourceDirectorySpaceGetResponse struct {
	...
	// Returns a list of all items after filtering. If applicable, the values are displayed for each name. If `total_only=true`, the `items` list will be empty.
	Items []ResourceDirectorySpace `json:"items,omitempty"`
	...
	Total []ResourceDirectorySpace `json:"total,omitempty"`
}
...
func NewResourceDirectorySpaceGetResponse() *ResourceDirectorySpaceGetResponse {
	this := ResourceDirectorySpaceGetResponse{}
	return &this
}
...
func (o *ResourceDirectorySpaceGetResponse) GetItems() []ResourceDirectorySpace {
	if o == nil || IsNil(o.Items) {
		var ret []ResourceDirectorySpace
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []ResourceDirectorySpace and assigns it to the Items field.
...
// SetTotal gets a reference to the given []ResourceDirectorySpace and assigns it to the Total field.
func (o *ResourceDirectorySpaceGetResponse) SetTotal(v []ResourceDirectorySpace) {
	o.Total = v
}

func (o ResourceDirectorySpaceGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ResourceDirectorySpaceGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResourceDirectorySpaceGetResponse struct {
	value *ResourceDirectorySpaceGetResponse
	isSet bool
}

func (v NullableResourceDirectorySpaceGetResponse) Get() *ResourceDirectorySpaceGetResponse {
	return v.value
}

func (v *NullableResourceDirectorySpaceGetResponse) Set(val *ResourceDirectorySpaceGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceDirectorySpaceGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceDirectorySpaceGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceDirectorySpaceGetResponse(val *ResourceDirectorySpaceGetResponse) *NullableResourceDirectorySpaceGetResponse {
	return &NullableResourceDirectorySpaceGetResponse{value: val, isSet: true}
}

func (v NullableResourceDirectorySpaceGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceDirectorySpaceGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
