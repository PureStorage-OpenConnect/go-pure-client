...
// checks if the SupportGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportGetResponse{}

// SupportGetResponse struct for SupportGetResponse
...
// SetItems gets a reference to the given []Support and assigns it to the Items field.
func (o *SupportGetResponse) SetItems(v []Support) {
	o.Items = v
}

func (o SupportGetResponse) MarshalJSON() ([]byte, error) {
...
func (o SupportGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSupportGetResponse struct {
	value *SupportGetResponse
	isSet bool
}

func (v NullableSupportGetResponse) Get() *SupportGetResponse {
	return v.value
}

func (v *NullableSupportGetResponse) Set(val *SupportGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportGetResponse(val *SupportGetResponse) *NullableSupportGetResponse {
	return &NullableSupportGetResponse{value: val, isSet: true}
}

func (v NullableSupportGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
