...
------------- | ------------- | -------------
[**ProtectionGroupsDelete**](ProtectionGroupsAPI.md#ProtectionGroupsDelete) | **Delete** /api/2.10/protection-groups | Eradicate a protection group
[**ProtectionGroupsGet**](ProtectionGroupsAPI.md#ProtectionGroupsGet) | **Get** /api/2.10/protection-groups | List protection groups
[**ProtectionGroupsHostGroupsDelete**](ProtectionGroupsAPI.md#ProtectionGroupsHostGroupsDelete) | **Delete** /api/2.10/protection-groups/host-groups | Remove a host group from a protection group
[**ProtectionGroupsHostGroupsGet**](ProtectionGroupsAPI.md#ProtectionGroupsHostGroupsGet) | **Get** /api/2.10/protection-groups/host-groups | List protection groups with host group members
[**ProtectionGroupsHostGroupsPost**](ProtectionGroupsAPI.md#ProtectionGroupsHostGroupsPost) | **Post** /api/2.10/protection-groups/host-groups | Add a host group to a protection group
[**ProtectionGroupsHostsDelete**](ProtectionGroupsAPI.md#ProtectionGroupsHostsDelete) | **Delete** /api/2.10/protection-groups/hosts | Remove a host from a protection group
[**ProtectionGroupsHostsGet**](ProtectionGroupsAPI.md#ProtectionGroupsHostsGet) | **Get** /api/2.10/protection-groups/hosts | List protection groups with host members
[**ProtectionGroupsHostsPost**](ProtectionGroupsAPI.md#ProtectionGroupsHostsPost) | **Post** /api/2.10/protection-groups/hosts | Add a host to a protection group
[**ProtectionGroupsPatch**](ProtectionGroupsAPI.md#ProtectionGroupsPatch) | **Patch** /api/2.10/protection-groups | Manage a protection group
[**ProtectionGroupsPerformanceReplicationByArrayGet**](ProtectionGroupsAPI.md#ProtectionGroupsPerformanceReplicationByArrayGet) | **Get** /api/2.10/protection-groups/performance/replication/by-array | List protection group replication performance data with array details
[**ProtectionGroupsPerformanceReplicationGet**](ProtectionGroupsAPI.md#ProtectionGroupsPerformanceReplicationGet) | **Get** /api/2.10/protection-groups/performance/replication | List protection group replication performance data
[**ProtectionGroupsPost**](ProtectionGroupsAPI.md#ProtectionGroupsPost) | **Post** /api/2.10/protection-groups | Create a protection group
[**ProtectionGroupsSpaceGet**](ProtectionGroupsAPI.md#ProtectionGroupsSpaceGet) | **Get** /api/2.10/protection-groups/space | List protection group space information
[**ProtectionGroupsTargetsDelete**](ProtectionGroupsAPI.md#ProtectionGroupsTargetsDelete) | **Delete** /api/2.10/protection-groups/targets | Removes a target from a protection group
[**ProtectionGroupsTargetsGet**](ProtectionGroupsAPI.md#ProtectionGroupsTargetsGet) | **Get** /api/2.10/protection-groups/targets | List protection groups with targets
[**ProtectionGroupsTargetsPatch**](ProtectionGroupsAPI.md#ProtectionGroupsTargetsPatch) | **Patch** /api/2.10/protection-groups/targets | Manage a protection group target
[**ProtectionGroupsTargetsPost**](ProtectionGroupsAPI.md#ProtectionGroupsTargetsPost) | **Post** /api/2.10/protection-groups/targets | Add a target to a protection group
[**ProtectionGroupsVolumesDelete**](ProtectionGroupsAPI.md#ProtectionGroupsVolumesDelete) | **Delete** /api/2.10/protection-groups/volumes | Delete a volume from a protection group
[**ProtectionGroupsVolumesGet**](ProtectionGroupsAPI.md#ProtectionGroupsVolumesGet) | **Get** /api/2.10/protection-groups/volumes | List protection groups with volume members
[**ProtectionGroupsVolumesPost**](ProtectionGroupsAPI.md#ProtectionGroupsVolumesPost) | **Post** /api/2.10/protection-groups/volumes | Create a volume and add it to a protection group
...
> ProtectionGroupsVolumesDelete(ctx).Authorization(authorization).XRequestID(xRequestID).GroupNames(groupNames).MemberIds(memberIds).MemberNames(memberNames).Execute()
...
> ProtectionGroupsVolumesGetResponse ProtectionGroupsVolumesGet(ctx).Authorization(authorization).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).GroupNames(groupNames).Limit(limit).MemberDestroyed(memberDestroyed).MemberIds(memberIds).MemberNames(memberNames).Offset(offset).Sort(sort).TotalItemCount(totalItemCount).Execute()
...
> ProtectionGroupsVolumesResponse ProtectionGroupsVolumesPost(ctx).Authorization(authorization).XRequestID(xRequestID).GroupNames(groupNames).MemberIds(memberIds).MemberNames(memberNames).Execute()
