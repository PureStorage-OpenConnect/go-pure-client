...
------------- | ------------- | -------------
[**LoginPost**](AuthorizationAPI.md#LoginPost) | **Post** /api/2.10/login | POST login (placeholder)
[**LogoutPost**](AuthorizationAPI.md#LogoutPost) | **Post** /api/2.10/logout | POST logout (placeholder)
