...
type VirtualMachinePost struct {
	// The ID of the virtual machine to recreate.
	Id *string `json:"id,omitempty"`
	// The protection group snapshot to recreate the virtual machine from.
	Source *Reference `json:"source,omitempty"`
	// The type of virtual machine. Currently, the only valid value is `vvol`.
