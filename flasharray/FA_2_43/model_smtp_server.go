...
// GetBodyPrefix returns the BodyPrefix field value if set, zero value otherwise.
func (o *SmtpServer) GetBodyPrefix() string {
	if o == nil || IsNil(o.BodyPrefix) {
		var ret string
		return ret
	}
	return *o.BodyPrefix
...
// GetBodyPrefixOk returns a tuple with the BodyPrefix field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SmtpServer) GetBodyPrefixOk() (*string, bool) {
	if o == nil || IsNil(o.BodyPrefix) {
		return nil, false
	}
	return o.BodyPrefix, true
}
...
// SetBodyPrefix gets a reference to the given string and assigns it to the BodyPrefix field.
...
func (o SmtpServer) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BodyPrefix) {
		toSerialize["body_prefix"] = o.BodyPrefix
	}
