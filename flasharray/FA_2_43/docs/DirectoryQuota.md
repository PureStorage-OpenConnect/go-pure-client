...
`func (o *DirectoryQuota) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *DirectoryQuota) GetContextOk() (*FixedReference, bool)`
...
`func (o *DirectoryQuota) SetContext(v FixedReference)`
