...
`func (o *PodPerformanceReplicationByArray) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *PodPerformanceReplicationByArray) GetContextOk() (*FixedReference, bool)`
...
`func (o *PodPerformanceReplicationByArray) SetContext(v FixedReference)`
