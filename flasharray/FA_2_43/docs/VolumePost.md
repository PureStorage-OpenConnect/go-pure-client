...
**Workload** | Pointer to [**WorkloadConfigurationReference**](WorkloadConfigurationReference.md) | The workload to which the volume is added. Set one of &#x60;id&#x60; or &#x60;name&#x60;, and &#x60;configuration&#x60; to add the volume to the workload and configure it based on the &#x60;configuration&#x60; from the preset the workload was originally provisioned from.  | [optional] 
