...
**Source** | Pointer to [**Reference**](Reference.md) | The recovery context for the virtual machine or virtual machine snapshot being modified.  | [optional] 
**VmId** | Pointer to **string** | The ID of the virtual machine to create or modify, as assigned by the external system.  | [optional] 
**VmType** | Pointer to **string** | The type of virtual machine. The only valid value is &#x60;vvol&#x60;.  | [optional] 
