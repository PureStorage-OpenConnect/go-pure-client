...
------------- | ------------- | -------------
[**SnmpAgentsGet**](SNMPAgentsAPI.md#SnmpAgentsGet) | **Get** /api/2.6/snmp-agents | List SNMP agent
[**SnmpAgentsMibGet**](SNMPAgentsAPI.md#SnmpAgentsMibGet) | **Get** /api/2.6/snmp-agents/mib | List SNMP agent MIB text
[**SnmpAgentsPatch**](SNMPAgentsAPI.md#SnmpAgentsPatch) | **Patch** /api/2.6/snmp-agents | Modify SNMP agent
