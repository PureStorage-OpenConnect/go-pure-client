...
// checks if the AdminGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminGetResponse{}

// AdminGetResponse struct for AdminGetResponse
...
func (o AdminGetResponse) MarshalJSON() ([]byte, error) {
...
func (o AdminGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAdminGetResponse struct {
	value *AdminGetResponse
	isSet bool
}

func (v NullableAdminGetResponse) Get() *AdminGetResponse {
	return v.value
}

func (v *NullableAdminGetResponse) Set(val *AdminGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminGetResponse(val *AdminGetResponse) *NullableAdminGetResponse {
	return &NullableAdminGetResponse{value: val, isSet: true}
}

func (v NullableAdminGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
