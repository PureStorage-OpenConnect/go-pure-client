...
// checks if the AlertRulesGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertRulesGetResponse{}

// AlertRulesGetResponse struct for AlertRulesGetResponse
...
func (o AlertRulesGetResponse) MarshalJSON() ([]byte, error) {
...
func (o AlertRulesGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAlertRulesGetResponse struct {
	value *AlertRulesGetResponse
	isSet bool
}

func (v NullableAlertRulesGetResponse) Get() *AlertRulesGetResponse {
	return v.value
}

func (v *NullableAlertRulesGetResponse) Set(val *AlertRulesGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertRulesGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertRulesGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertRulesGetResponse(val *AlertRulesGetResponse) *NullableAlertRulesGetResponse {
	return &NullableAlertRulesGetResponse{value: val, isSet: true}
}

func (v NullableAlertRulesGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertRulesGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
