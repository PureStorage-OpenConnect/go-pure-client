...
`func (o *RemoteProtectionGroupSnapshot) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *RemoteProtectionGroupSnapshot) GetContextOk() (*FixedReference, bool)`
...
`func (o *RemoteProtectionGroupSnapshot) SetContext(v FixedReference)`
