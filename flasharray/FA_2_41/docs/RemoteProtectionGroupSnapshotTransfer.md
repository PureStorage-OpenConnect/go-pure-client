...
`func (o *RemoteProtectionGroupSnapshotTransfer) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *RemoteProtectionGroupSnapshotTransfer) GetContextOk() (*FixedReference, bool)`
...
`func (o *RemoteProtectionGroupSnapshotTransfer) SetContext(v FixedReference)`
