...
**Items** | Pointer to [**[]Host**](Host.md) | Displays a list of all items after filtering. If applicable, the values are displayed for each name.  | [optional] 
...
`func (o *HostGetResponse) GetErrors() []ErrorcontextresponseErrors`

GetErrors returns the Errors field if non-nil, zero value otherwise.

### GetErrorsOk

`func (o *HostGetResponse) GetErrorsOk() (*[]ErrorcontextresponseErrors, bool)`
...
`func (o *HostGetResponse) SetErrors(v []ErrorcontextresponseErrors)`

SetErrors sets Errors field to given value.

### HasErrors

`func (o *HostGetResponse) HasErrors() bool`
