...
// checks if the MemberGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberGetResponse{}

// MemberGetResponse struct for MemberGetResponse
...
func (o MemberGetResponse) MarshalJSON() ([]byte, error) {
...
func (o MemberGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableMemberGetResponse struct {
	value *MemberGetResponse
	isSet bool
}

func (v NullableMemberGetResponse) Get() *MemberGetResponse {
	return v.value
}

func (v *NullableMemberGetResponse) Set(val *MemberGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberGetResponse(val *MemberGetResponse) *NullableMemberGetResponse {
	return &NullableMemberGetResponse{value: val, isSet: true}
}

func (v NullableMemberGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
