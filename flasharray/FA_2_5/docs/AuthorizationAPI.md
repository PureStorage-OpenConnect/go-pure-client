...
------------- | ------------- | -------------
[**LoginPost**](AuthorizationAPI.md#LoginPost) | **Post** /api/2.5/login | POST login (placeholder)
[**LogoutPost**](AuthorizationAPI.md#LogoutPost) | **Post** /api/2.5/logout | POST logout (placeholder)
