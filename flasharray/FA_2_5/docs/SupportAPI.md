...
------------- | ------------- | -------------
[**SupportGet**](SupportAPI.md#SupportGet) | **Get** /api/2.5/support | List connection paths
[**SupportPatch**](SupportAPI.md#SupportPatch) | **Patch** /api/2.5/support | Create connection path
[**SupportTestGet**](SupportAPI.md#SupportTestGet) | **Get** /api/2.5/support/test | List Everpure Support connection data
