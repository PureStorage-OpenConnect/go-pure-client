...
// checks if the KmipGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KmipGetResponse{}

// KmipGetResponse struct for KmipGetResponse
...
func (o KmipGetResponse) MarshalJSON() ([]byte, error) {
...
func (o KmipGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableKmipGetResponse struct {
	value *KmipGetResponse
	isSet bool
}

func (v NullableKmipGetResponse) Get() *KmipGetResponse {
	return v.value
}

func (v *NullableKmipGetResponse) Set(val *KmipGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKmipGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKmipGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKmipGetResponse(val *KmipGetResponse) *NullableKmipGetResponse {
	return &NullableKmipGetResponse{value: val, isSet: true}
}

func (v NullableKmipGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKmipGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
