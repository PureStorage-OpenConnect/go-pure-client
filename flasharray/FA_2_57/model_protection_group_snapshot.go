...
// checks if the ProtectionGroupSnapshot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionGroupSnapshot{}

// ProtectionGroupSnapshot struct for ProtectionGroupSnapshot
...
func (o ProtectionGroupSnapshot) MarshalJSON() ([]byte, error) {
...
func (o ProtectionGroupSnapshot) ToMap() (map[string]interface{}, error) {
...
type NullableProtectionGroupSnapshot struct {
	value *ProtectionGroupSnapshot
	isSet bool
}

func (v NullableProtectionGroupSnapshot) Get() *ProtectionGroupSnapshot {
	return v.value
}

func (v *NullableProtectionGroupSnapshot) Set(val *ProtectionGroupSnapshot) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionGroupSnapshot) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionGroupSnapshot) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionGroupSnapshot(val *ProtectionGroupSnapshot) *NullableProtectionGroupSnapshot {
	return &NullableProtectionGroupSnapshot{value: val, isSet: true}
}

func (v NullableProtectionGroupSnapshot) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionGroupSnapshot) UnmarshalJSON(src []byte) error {
	v.isSet = true
