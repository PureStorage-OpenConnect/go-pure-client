...
type DirectoryService struct {
	...
	// The base of the Distinguished Name (DN) of the directory service groups.
	BaseDn *string `json:"base_dn,omitempty"`
	// The masked password used to query the directory.
	BindPassword *string `json:"bind_password,omitempty"`
	// The username used to query the directory.
	BindUser *string `json:"bind_user,omitempty"`
	// The reference (`ID`, `name`, and `resource type`) of a certificate group containing CA certificates that can be used to validate the authenticity of the configured servers.
	CaCertificateGroup *ReferenceWithType `json:"ca_certificate_group,omitempty"`
	// The reference (`ID`, `name`, and `resource type`) of the Certificate Authority (CA) that signed the certificates of the directory servers, which is used to validate the authenticity of the configured servers.
	...
	// The services for which the directory service configuration is used.
	Services []string `json:"services,omitempty"`
	// A list of URIs for the configured directory servers.
