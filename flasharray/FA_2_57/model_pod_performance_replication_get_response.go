...
// checks if the PodPerformanceReplicationGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PodPerformanceReplicationGetResponse{}

// PodPerformanceReplicationGetResponse struct for PodPerformanceReplicationGetResponse
...
func NewPodPerformanceReplicationGetResponse() *PodPerformanceReplicationGetResponse {
	this := PodPerformanceReplicationGetResponse{}
	return &this
}
...
func (o PodPerformanceReplicationGetResponse) MarshalJSON() ([]byte, error) {
...
func (o PodPerformanceReplicationGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePodPerformanceReplicationGetResponse struct {
	value *PodPerformanceReplicationGetResponse
	isSet bool
}

func (v NullablePodPerformanceReplicationGetResponse) Get() *PodPerformanceReplicationGetResponse {
	return v.value
}

func (v *NullablePodPerformanceReplicationGetResponse) Set(val *PodPerformanceReplicationGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePodPerformanceReplicationGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePodPerformanceReplicationGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePodPerformanceReplicationGetResponse(val *PodPerformanceReplicationGetResponse) *NullablePodPerformanceReplicationGetResponse {
	return &NullablePodPerformanceReplicationGetResponse{value: val, isSet: true}
}

func (v NullablePodPerformanceReplicationGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePodPerformanceReplicationGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
