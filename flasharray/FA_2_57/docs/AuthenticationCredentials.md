...
------------ | ------------- | ------------- | -------------
**Password** | Pointer to **string** | The password used to authenticate to the array. | [optional] 
**Username** | Pointer to **string** | The username used to authenticate to the array. | [optional] 
