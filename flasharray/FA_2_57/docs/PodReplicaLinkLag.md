...
**Remotes** | Pointer to [**[]FixedReferenceWithType**](FixedReferenceWithType.md) | Reference to a remote array. | [optional] 
...
`func (o *PodReplicaLinkLag) GetLocalPodMembers() []FixedReferenceWithType`

GetLocalPodMembers returns the LocalPodMembers field if non-nil, zero value otherwise.

### GetLocalPodMembersOk

`func (o *PodReplicaLinkLag) GetLocalPodMembersOk() (*[]FixedReferenceWithType, bool)`
...
`func (o *PodReplicaLinkLag) SetLocalPodMembers(v []FixedReferenceWithType)`

SetLocalPodMembers sets LocalPodMembers field to given value.

### HasLocalPodMembers

`func (o *PodReplicaLinkLag) HasLocalPodMembers() bool`
...
`func (o *PodReplicaLinkLag) GetRemotes() []FixedReferenceWithType`

GetRemotes returns the Remotes field if non-nil, zero value otherwise.

### GetRemotesOk

`func (o *PodReplicaLinkLag) GetRemotesOk() (*[]FixedReferenceWithType, bool)`
...
`func (o *PodReplicaLinkLag) SetRemotes(v []FixedReferenceWithType)`
