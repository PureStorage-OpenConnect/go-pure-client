...
**IgnoreUsage** | Pointer to **bool** | Set to &#x60;true&#x60; to set a &#x60;quota_limit&#x60; that is lower than the existing usage. This ensures that no new volumes can be created until the existing usage drops below the &#x60;quota_limit&#x60;. If not specified, defaults to &#x60;false&#x60;.  | [optional] 
**Mediator** | Pointer to **string** | Sets the URL of the mediator for this pod, replacing the URL of the current mediator. By default, the Pure1 Cloud Mediator (&#x60;purestorage&#x60;) serves as the mediator. For a pod in a stretched realm, the realm mediator takes precedence over the mediator of the pod.  | [optional] 
...
GetIgnoreUsage returns the IgnoreUsage field if non-nil, zero value otherwise.

### GetIgnoreUsageOk

`func (o *PodPatch) GetIgnoreUsageOk() (*bool, bool)`

GetIgnoreUsageOk returns a tuple with the IgnoreUsage field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetIgnoreUsage sets IgnoreUsage field to given value.
