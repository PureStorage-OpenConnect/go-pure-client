...
------------ | ------------- | ------------- | -------------
**AuthenticationCredentials** | Pointer to [**AuthenticationCredentials**](AuthenticationCredentials.md) | The credentials used to authenticate to this remote array.  | [optional] 
**CaCertificate** | Pointer to [**ReferenceWithType**](ReferenceWithType.md) | The certificate used to verify the certificate presented by the remote target. If specified, the &#x60;resource_type&#x60; must be &#x60;certificates&#x60;. This field is mutually exclusive with &#x60;ca_certificate_group&#x60;.  | [optional] 
**CaCertificateGroup** | Pointer to [**ReferenceWithType**](ReferenceWithType.md) | The certificate group used to verify the certificate presented by the remote target. If specified, the &#x60;resource_type&#x60; must be &#x60;certificate-groups&#x60;. This field is mutually exclusive with &#x60;ca_certificate&#x60;.  | [optional] 
**ManagementAddress** | Pointer to **string** | The management address or host name of the remote array to be added to the fleet.  | [optional] 
...
`func (o *FleetMemberBatchPost) GetCaCertificate() ReferenceWithType`

GetCaCertificate returns the CaCertificate field if non-nil, zero value otherwise.

### GetCaCertificateOk

`func (o *FleetMemberBatchPost) GetCaCertificateOk() (*ReferenceWithType, bool)`
...
`func (o *FleetMemberBatchPost) SetCaCertificate(v ReferenceWithType)`
...
`func (o *FleetMemberBatchPost) GetCaCertificateGroup() ReferenceWithType`

GetCaCertificateGroup returns the CaCertificateGroup field if non-nil, zero value otherwise.

### GetCaCertificateGroupOk

`func (o *FleetMemberBatchPost) GetCaCertificateGroupOk() (*ReferenceWithType, bool)`
...
`func (o *FleetMemberBatchPost) SetCaCertificateGroup(v ReferenceWithType)`
