...
**LocalPort** | Pointer to [**FixedReferenceNoId**](FixedReferenceNoId.md) | A reference to the local network interface the neighbor is connected to.  | [optional] 
...
`func (o *NetworkInterfaceNeighbor) GetLocalPort() FixedReferenceNoId`

GetLocalPort returns the LocalPort field if non-nil, zero value otherwise.

### GetLocalPortOk

`func (o *NetworkInterfaceNeighbor) GetLocalPortOk() (*FixedReferenceNoId, bool)`
...
`func (o *NetworkInterfaceNeighbor) SetLocalPort(v FixedReferenceNoId)`
