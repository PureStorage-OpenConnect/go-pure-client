...
type VolumeGroupPost struct {
	...
	// Destroy or recover a volume group. To destroy a volume group, patch to `true`. To recover a destroyed volume group, patch to `false`. If not specified, defaults to `false`.
