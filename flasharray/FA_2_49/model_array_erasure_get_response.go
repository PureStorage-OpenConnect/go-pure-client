...
// checks if the ArrayErasureGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArrayErasureGetResponse{}

// ArrayErasureGetResponse struct for ArrayErasureGetResponse
type ArrayErasureGetResponse struct {
...
func (o ArrayErasureGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ArrayErasureGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableArrayErasureGetResponse struct {
	value *ArrayErasureGetResponse
	isSet bool
}

func (v NullableArrayErasureGetResponse) Get() *ArrayErasureGetResponse {
	return v.value
}

func (v *NullableArrayErasureGetResponse) Set(val *ArrayErasureGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableArrayErasureGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableArrayErasureGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArrayErasureGetResponse(val *ArrayErasureGetResponse) *NullableArrayErasureGetResponse {
	return &NullableArrayErasureGetResponse{value: val, isSet: true}
}

func (v NullableArrayErasureGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArrayErasureGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
