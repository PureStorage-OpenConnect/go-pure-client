...
type Controller struct {
	...
	ModeSince *int64  `json:"mode_since,omitempty"`
...
// GetModeSince returns the ModeSince field value if set, zero value otherwise.
func (o *Controller) GetModeSince() int64 {
	if o == nil || IsNil(o.ModeSince) {
		var ret int64
		return ret
	}
	return *o.ModeSince
...
// GetModeSinceOk returns a tuple with the ModeSince field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Controller) GetModeSinceOk() (*int64, bool) {
	if o == nil || IsNil(o.ModeSince) {
		return nil, false
	}
	return o.ModeSince, true
}
...
// SetModeSince gets a reference to the given int64 and assigns it to the ModeSince field.
...
func (o Controller) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ModeSince) {
		toSerialize["mode_since"] = o.ModeSince
	}
	if !IsNil(o.Model) {
