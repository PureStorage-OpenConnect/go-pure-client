...
// checks if the AppNodeGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppNodeGetResponse{}

// AppNodeGetResponse struct for AppNodeGetResponse
...
func (o AppNodeGetResponse) MarshalJSON() ([]byte, error) {
...
func (o AppNodeGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAppNodeGetResponse struct {
	value *AppNodeGetResponse
	isSet bool
}

func (v NullableAppNodeGetResponse) Get() *AppNodeGetResponse {
	return v.value
}

func (v *NullableAppNodeGetResponse) Set(val *AppNodeGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppNodeGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppNodeGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppNodeGetResponse(val *AppNodeGetResponse) *NullableAppNodeGetResponse {
	return &NullableAppNodeGetResponse{value: val, isSet: true}
}

func (v NullableAppNodeGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppNodeGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
