...
------------- | ------------- | -------------
[**HardwareGet**](HardwareAPI.md#HardwareGet) | **Get** /api/2.49/hardware | List hardware component information
[**HardwarePatch**](HardwareAPI.md#HardwarePatch) | **Patch** /api/2.49/hardware | Modify visual identification
