...
------------- | ------------- | -------------
[**LoginPost**](AuthorizationAPI.md#LoginPost) | **Post** /api/2.49/login | Create a user session
[**LogoutPost**](AuthorizationAPI.md#LogoutPost) | **Post** /api/2.49/logout | POST logout (placeholder)
