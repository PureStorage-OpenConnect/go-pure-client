...
`func (o *DirectoryQuota) GetContext() FixedReferenceWithType`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *DirectoryQuota) GetContextOk() (*FixedReferenceWithType, bool)`
...
`func (o *DirectoryQuota) SetContext(v FixedReferenceWithType)`

SetContext sets Context field to given value.

### HasContext

`func (o *DirectoryQuota) HasContext() bool`
