...
**AuthRegion** | Pointer to **string** | The region that will be used for initial authentication request. This parameter is optional and should be used only when region autodetection fails.  | [optional] 
...
**Profile** | Pointer to **string** | The offload target profile that will be selected for this target. This option allows more granular configuration for the target on top of the &#x60;protocol&#x60; parameter. Values include &#x60;s3-aws&#x60;, &#x60;s3-flashblade&#x60;, &#x60;s3-scality-ring&#x60;, &#x60;s3-wasabi-pay-as-you-go&#x60;, &#x60;s3-wasabi-rcs&#x60;, and &#x60;s3-other&#x60;.  | [optional] 
...
`func (o *OffloadS3) GetAuthRegion() string`

GetAuthRegion returns the AuthRegion field if non-nil, zero value otherwise.

### GetAuthRegionOk

`func (o *OffloadS3) GetAuthRegionOk() (*string, bool)`

GetAuthRegionOk returns a tuple with the AuthRegion field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAuthRegion

`func (o *OffloadS3) SetAuthRegion(v string)`

SetAuthRegion sets AuthRegion field to given value.

### HasAuthRegion

`func (o *OffloadS3) HasAuthRegion() bool`

HasAuthRegion returns a boolean if a field has been set.
...
`func (o *OffloadS3) GetProfile() string`

GetProfile returns the Profile field if non-nil, zero value otherwise.

### GetProfileOk

`func (o *OffloadS3) GetProfileOk() (*string, bool)`
...
`func (o *OffloadS3) SetProfile(v string)`

SetProfile sets Profile field to given value.

### HasProfile

`func (o *OffloadS3) HasProfile() bool`
