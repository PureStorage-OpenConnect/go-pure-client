...
**Targets** | Pointer to [**[]ReferenceWithType**](ReferenceWithType.md) | If specified, only consider these targets when computing placement recommendations. If not specified, the whole fleet is used to compute the recommendation.  | [optional] 
