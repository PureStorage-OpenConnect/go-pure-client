...
**Workload** | Pointer to [**WorkloadConfigurationFixedReferenceWorkload**](WorkloadConfigurationFixedReferenceWorkload.md) |  | [optional] 
...
`func (o *VolumeGroup) GetContext() FixedReferenceWithType`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *VolumeGroup) GetContextOk() (*FixedReferenceWithType, bool)`
...
`func (o *VolumeGroup) SetContext(v FixedReferenceWithType)`
...
`func (o *VolumeGroup) GetWorkload() WorkloadConfigurationFixedReferenceWorkload`

GetWorkload returns the Workload field if non-nil, zero value otherwise.

### GetWorkloadOk

`func (o *VolumeGroup) GetWorkloadOk() (*WorkloadConfigurationFixedReferenceWorkload, bool)`
...
`func (o *VolumeGroup) SetWorkload(v WorkloadConfigurationFixedReferenceWorkload)`

SetWorkload sets Workload field to given value.

### HasWorkload

`func (o *VolumeGroup) HasWorkload() bool`
