...
**Notifications** | Pointer to **string** | Targets to notify when usage approaches the quota limit. The list of notification targets is a comma-separated string. Valid values are one or more of &#x60;user&#x60; and &#x60;group&#x60;. To notify no targets, use &#x60;none&#x60;. If not specified, defaults to &#x60;none&#x60;.  | [optional] 
