...
type AdminSettings struct {
	...
	RequiredAuthenticationMethods *AdminSettingsRequiredAuthenticationMethods `json:"required_authentication_methods,omitempty"`
...
// GetRequiredAuthenticationMethods returns the RequiredAuthenticationMethods field value if set, zero value otherwise.
func (o *AdminSettings) GetRequiredAuthenticationMethods() AdminSettingsRequiredAuthenticationMethods {
	if o == nil || IsNil(o.RequiredAuthenticationMethods) {
		var ret AdminSettingsRequiredAuthenticationMethods
		return ret
	}
	return *o.RequiredAuthenticationMethods
}

// GetRequiredAuthenticationMethodsOk returns a tuple with the RequiredAuthenticationMethods field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AdminSettings) GetRequiredAuthenticationMethodsOk() (*AdminSettingsRequiredAuthenticationMethods, bool) {
	if o == nil || IsNil(o.RequiredAuthenticationMethods) {
		return nil, false
	}
	return o.RequiredAuthenticationMethods, true
}
...
// SetRequiredAuthenticationMethods gets a reference to the given AdminSettingsRequiredAuthenticationMethods and assigns it to the RequiredAuthenticationMethods field.
func (o *AdminSettings) SetRequiredAuthenticationMethods(v AdminSettingsRequiredAuthenticationMethods) {
	o.RequiredAuthenticationMethods = &v
}
...
func (o AdminSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RequiredAuthenticationMethods) {
		toSerialize["required_authentication_methods"] = o.RequiredAuthenticationMethods
	}
