...
// checks if the DnsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsGetResponse{}

// DnsGetResponse struct for DnsGetResponse
...
func (o DnsGetResponse) MarshalJSON() ([]byte, error) {
...
func (o DnsGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDnsGetResponse struct {
	value *DnsGetResponse
	isSet bool
}

func (v NullableDnsGetResponse) Get() *DnsGetResponse {
	return v.value
}

func (v *NullableDnsGetResponse) Set(val *DnsGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsGetResponse(val *DnsGetResponse) *NullableDnsGetResponse {
	return &NullableDnsGetResponse{value: val, isSet: true}
}

func (v NullableDnsGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
