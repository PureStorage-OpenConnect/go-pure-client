...
// checks if the AlertGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertGetResponse{}

// AlertGetResponse struct for AlertGetResponse
...
func (o AlertGetResponse) MarshalJSON() ([]byte, error) {
...
func (o AlertGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAlertGetResponse struct {
	value *AlertGetResponse
	isSet bool
}

func (v NullableAlertGetResponse) Get() *AlertGetResponse {
	return v.value
}

func (v *NullableAlertGetResponse) Set(val *AlertGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertGetResponse(val *AlertGetResponse) *NullableAlertGetResponse {
	return &NullableAlertGetResponse{value: val, isSet: true}
}

func (v NullableAlertGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
