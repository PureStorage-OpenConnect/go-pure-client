...
------------- | ------------- | -------------
[**KmipDelete**](KMIPAPI.md#KmipDelete) | **Delete** /api/2.33/kmip | Delete KMIP server object
[**KmipGet**](KMIPAPI.md#KmipGet) | **Get** /api/2.33/kmip | List KMIP server objects
[**KmipPatch**](KMIPAPI.md#KmipPatch) | **Patch** /api/2.33/kmip | Modify KMIP attributes
[**KmipPost**](KMIPAPI.md#KmipPost) | **Post** /api/2.33/kmip | Create KMIP server object
[**KmipTestGet**](KMIPAPI.md#KmipTestGet) | **Get** /api/2.33/kmip/test | Lists KMIP connection tests
