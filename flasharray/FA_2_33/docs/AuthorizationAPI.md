...
------------- | ------------- | -------------
[**LoginPost**](AuthorizationAPI.md#LoginPost) | **Post** /api/2.33/login | POST login (placeholder)
[**LogoutPost**](AuthorizationAPI.md#LogoutPost) | **Post** /api/2.33/logout | POST logout (placeholder)
