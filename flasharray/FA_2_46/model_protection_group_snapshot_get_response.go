...
// checks if the ProtectionGroupSnapshotGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionGroupSnapshotGetResponse{}

// ProtectionGroupSnapshotGetResponse struct for ProtectionGroupSnapshotGetResponse
...
func NewProtectionGroupSnapshotGetResponse() *ProtectionGroupSnapshotGetResponse {
	this := ProtectionGroupSnapshotGetResponse{}
	return &this
}
...
// SetTotal gets a reference to the given []ProtectionGroupSnapshot and assigns it to the Total field.
func (o *ProtectionGroupSnapshotGetResponse) SetTotal(v []ProtectionGroupSnapshot) {
	o.Total = v
}

func (o ProtectionGroupSnapshotGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ProtectionGroupSnapshotGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableProtectionGroupSnapshotGetResponse struct {
	value *ProtectionGroupSnapshotGetResponse
	isSet bool
}

func (v NullableProtectionGroupSnapshotGetResponse) Get() *ProtectionGroupSnapshotGetResponse {
	return v.value
}

func (v *NullableProtectionGroupSnapshotGetResponse) Set(val *ProtectionGroupSnapshotGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionGroupSnapshotGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionGroupSnapshotGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionGroupSnapshotGetResponse(val *ProtectionGroupSnapshotGetResponse) *NullableProtectionGroupSnapshotGetResponse {
	return &NullableProtectionGroupSnapshotGetResponse{value: val, isSet: true}
}

func (v NullableProtectionGroupSnapshotGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionGroupSnapshotGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
