...
// checks if the ProtectionGroupPerformanceArrayResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionGroupPerformanceArrayResponse{}

// ProtectionGroupPerformanceArrayResponse struct for ProtectionGroupPerformanceArrayResponse
type ProtectionGroupPerformanceArrayResponse struct {
	...
	Items []ProtectionGroupPerformanceArray `json:"items,omitempty"`
}
...
func NewProtectionGroupPerformanceArrayResponse() *ProtectionGroupPerformanceArrayResponse {
	this := ProtectionGroupPerformanceArrayResponse{}
	return &this
}
...
func (o *ProtectionGroupPerformanceArrayResponse) GetItems() []ProtectionGroupPerformanceArray {
	if o == nil || IsNil(o.Items) {
		var ret []ProtectionGroupPerformanceArray
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []ProtectionGroupPerformanceArray and assigns it to the Items field.
func (o *ProtectionGroupPerformanceArrayResponse) SetItems(v []ProtectionGroupPerformanceArray) {
	o.Items = v
}

func (o ProtectionGroupPerformanceArrayResponse) MarshalJSON() ([]byte, error) {
...
func (o ProtectionGroupPerformanceArrayResponse) ToMap() (map[string]interface{}, error) {
...
type NullableProtectionGroupPerformanceArrayResponse struct {
	value *ProtectionGroupPerformanceArrayResponse
	isSet bool
}

func (v NullableProtectionGroupPerformanceArrayResponse) Get() *ProtectionGroupPerformanceArrayResponse {
	return v.value
}

func (v *NullableProtectionGroupPerformanceArrayResponse) Set(val *ProtectionGroupPerformanceArrayResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionGroupPerformanceArrayResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionGroupPerformanceArrayResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionGroupPerformanceArrayResponse(val *ProtectionGroupPerformanceArrayResponse) *NullableProtectionGroupPerformanceArrayResponse {
	return &NullableProtectionGroupPerformanceArrayResponse{value: val, isSet: true}
}

func (v NullableProtectionGroupPerformanceArrayResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionGroupPerformanceArrayResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
