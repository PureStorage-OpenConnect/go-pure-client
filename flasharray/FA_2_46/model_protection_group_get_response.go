...
// checks if the ProtectionGroupGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionGroupGetResponse{}

// ProtectionGroupGetResponse struct for ProtectionGroupGetResponse
...
func NewProtectionGroupGetResponse() *ProtectionGroupGetResponse {
	this := ProtectionGroupGetResponse{}
	return &this
}
...
// SetItems gets a reference to the given []ProtectionGroup and assigns it to the Items field.
...
// SetTotal gets a reference to the given []ProtectionGroup and assigns it to the Total field.
func (o *ProtectionGroupGetResponse) SetTotal(v []ProtectionGroup) {
	o.Total = v
}

func (o ProtectionGroupGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ProtectionGroupGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableProtectionGroupGetResponse struct {
	value *ProtectionGroupGetResponse
	isSet bool
}

func (v NullableProtectionGroupGetResponse) Get() *ProtectionGroupGetResponse {
	return v.value
}

func (v *NullableProtectionGroupGetResponse) Set(val *ProtectionGroupGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProtectionGroupGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProtectionGroupGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtectionGroupGetResponse(val *ProtectionGroupGetResponse) *NullableProtectionGroupGetResponse {
	return &NullableProtectionGroupGetResponse{value: val, isSet: true}
}

func (v NullableProtectionGroupGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtectionGroupGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
