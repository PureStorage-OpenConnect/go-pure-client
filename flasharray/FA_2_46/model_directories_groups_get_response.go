...
// checks if the DirectoriesGroupsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoriesGroupsGetResponse{}

// DirectoriesGroupsGetResponse struct for DirectoriesGroupsGetResponse
type DirectoriesGroupsGetResponse struct {
...
func NewDirectoriesGroupsGetResponse() *DirectoriesGroupsGetResponse {
	this := DirectoriesGroupsGetResponse{}
	return &this
}
...
func (o DirectoriesGroupsGetResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectoriesGroupsGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDirectoriesGroupsGetResponse struct {
	value *DirectoriesGroupsGetResponse
	isSet bool
}

func (v NullableDirectoriesGroupsGetResponse) Get() *DirectoriesGroupsGetResponse {
	return v.value
}

func (v *NullableDirectoriesGroupsGetResponse) Set(val *DirectoriesGroupsGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoriesGroupsGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoriesGroupsGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoriesGroupsGetResponse(val *DirectoriesGroupsGetResponse) *NullableDirectoriesGroupsGetResponse {
	return &NullableDirectoriesGroupsGetResponse{value: val, isSet: true}
}

func (v NullableDirectoriesGroupsGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoriesGroupsGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
