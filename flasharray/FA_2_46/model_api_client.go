...
type ApiClient struct {
	...
	AccessPolicies []FixedReferenceWithType `json:"access_policies,omitempty"`
...
// SetAccessPolicies gets a reference to the given []FixedReferenceWithType and assigns it to the AccessPolicies field.
