...
**ContinuousAvailabilityEnabled** | Pointer to **bool** | If set to &#x60;true&#x60;, enables continuous availability on the policy. When continuous availability is enabled on a policy, file shares are accessible during otherwise disruptive scenarios such as temporary network outages, controller upgrades or failovers.  | [optional] 
...
`func (o *PolicySmbPatch) GetContinuousAvailabilityEnabled() bool`
...
`func (o *PolicySmbPatch) GetContinuousAvailabilityEnabledOk() (*bool, bool)`
...
`func (o *PolicySmbPatch) SetContinuousAvailabilityEnabled(v bool)`

SetContinuousAvailabilityEnabled sets ContinuousAvailabilityEnabled field to given value.

### HasContinuousAvailabilityEnabled

`func (o *PolicySmbPatch) HasContinuousAvailabilityEnabled() bool`
