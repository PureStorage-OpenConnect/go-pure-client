...
`func (o *TargetProtectionGroup) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *TargetProtectionGroup) GetContextOk() (*FixedReference, bool)`
...
`func (o *TargetProtectionGroup) SetContext(v FixedReference)`
