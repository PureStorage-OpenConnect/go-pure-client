...
`func (o *DirectoryGroup) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *DirectoryGroup) GetContextOk() (*FixedReference, bool)`
...
`func (o *DirectoryGroup) SetContext(v FixedReference)`
