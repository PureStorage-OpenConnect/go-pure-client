...
------------- | ------------- | -------------
[**ServersDelete**](ServersAPI.md#ServersDelete) | **Delete** /api/2.46/servers | Delete server
[**ServersGet**](ServersAPI.md#ServersGet) | **Get** /api/2.46/servers | List servers
[**ServersPatch**](ServersAPI.md#ServersPatch) | **Patch** /api/2.46/servers | Modify server
[**ServersPost**](ServersAPI.md#ServersPost) | **Post** /api/2.46/servers | Create server
