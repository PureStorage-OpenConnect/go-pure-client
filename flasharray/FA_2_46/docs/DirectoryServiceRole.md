...
`func (o *DirectoryServiceRole) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *DirectoryServiceRole) GetContextOk() (*FixedReference, bool)`
...
`func (o *DirectoryServiceRole) SetContext(v FixedReference)`
