...
`func (o *ContainerDefaultProtection) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *ContainerDefaultProtection) GetContextOk() (*FixedReference, bool)`
...
`func (o *ContainerDefaultProtection) SetContext(v FixedReference)`
