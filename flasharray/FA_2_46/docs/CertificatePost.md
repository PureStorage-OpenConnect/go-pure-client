...
**Key** | Pointer to **string** | The text of the private key. This field can only be specified when importing a certificate and key pair.  | [optional] 
**Passphrase** | Pointer to **string** | The passphrase used to encrypt &#x60;key&#x60;. This field can only be specified when importing a certificate and key pair.  | [optional] 
