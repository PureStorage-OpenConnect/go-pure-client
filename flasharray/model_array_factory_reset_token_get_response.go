...
// checks if the ArrayFactoryResetTokenGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArrayFactoryResetTokenGetResponse{}

// ArrayFactoryResetTokenGetResponse struct for ArrayFactoryResetTokenGetResponse
...
func NewArrayFactoryResetTokenGetResponse() *ArrayFactoryResetTokenGetResponse {
	this := ArrayFactoryResetTokenGetResponse{}
	return &this
}
...
func (o ArrayFactoryResetTokenGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ArrayFactoryResetTokenGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableArrayFactoryResetTokenGetResponse struct {
	value *ArrayFactoryResetTokenGetResponse
	isSet bool
}

func (v NullableArrayFactoryResetTokenGetResponse) Get() *ArrayFactoryResetTokenGetResponse {
	return v.value
}

func (v *NullableArrayFactoryResetTokenGetResponse) Set(val *ArrayFactoryResetTokenGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableArrayFactoryResetTokenGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableArrayFactoryResetTokenGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArrayFactoryResetTokenGetResponse(val *ArrayFactoryResetTokenGetResponse) *NullableArrayFactoryResetTokenGetResponse {
	return &NullableArrayFactoryResetTokenGetResponse{value: val, isSet: true}
}

func (v NullableArrayFactoryResetTokenGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArrayFactoryResetTokenGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
