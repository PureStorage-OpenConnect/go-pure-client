...
// checks if the PolicyRuleNfsClientGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyRuleNfsClientGetResponse{}

// PolicyRuleNfsClientGetResponse struct for PolicyRuleNfsClientGetResponse
...
func NewPolicyRuleNfsClientGetResponse() *PolicyRuleNfsClientGetResponse {
	this := PolicyRuleNfsClientGetResponse{}
	return &this
}
...
func (o PolicyRuleNfsClientGetResponse) MarshalJSON() ([]byte, error) {
...
func (o PolicyRuleNfsClientGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyRuleNfsClientGetResponse struct {
	value *PolicyRuleNfsClientGetResponse
	isSet bool
}

func (v NullablePolicyRuleNfsClientGetResponse) Get() *PolicyRuleNfsClientGetResponse {
	return v.value
}

func (v *NullablePolicyRuleNfsClientGetResponse) Set(val *PolicyRuleNfsClientGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyRuleNfsClientGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyRuleNfsClientGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyRuleNfsClientGetResponse(val *PolicyRuleNfsClientGetResponse) *NullablePolicyRuleNfsClientGetResponse {
	return &NullablePolicyRuleNfsClientGetResponse{value: val, isSet: true}
}

func (v NullablePolicyRuleNfsClientGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyRuleNfsClientGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
