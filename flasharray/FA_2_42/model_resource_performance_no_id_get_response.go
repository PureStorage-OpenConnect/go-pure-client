...
// checks if the ResourcePerformanceNoIdGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourcePerformanceNoIdGetResponse{}

// ResourcePerformanceNoIdGetResponse struct for ResourcePerformanceNoIdGetResponse
type ResourcePerformanceNoIdGetResponse struct {
	...
	Items []ResourcePerformanceNoId `json:"items,omitempty"`
	...
	Total []ResourcePerformanceNoId `json:"total,omitempty"`
}
...
func NewResourcePerformanceNoIdGetResponse() *ResourcePerformanceNoIdGetResponse {
	this := ResourcePerformanceNoIdGetResponse{}
	return &this
}
...
func (o *ResourcePerformanceNoIdGetResponse) GetItems() []ResourcePerformanceNoId {
	if o == nil || IsNil(o.Items) {
		var ret []ResourcePerformanceNoId
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []ResourcePerformanceNoId and assigns it to the Items field.
...
// SetTotal gets a reference to the given []ResourcePerformanceNoId and assigns it to the Total field.
func (o *ResourcePerformanceNoIdGetResponse) SetTotal(v []ResourcePerformanceNoId) {
	o.Total = v
}

func (o ResourcePerformanceNoIdGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ResourcePerformanceNoIdGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResourcePerformanceNoIdGetResponse struct {
	value *ResourcePerformanceNoIdGetResponse
	isSet bool
}

func (v NullableResourcePerformanceNoIdGetResponse) Get() *ResourcePerformanceNoIdGetResponse {
	return v.value
}

func (v *NullableResourcePerformanceNoIdGetResponse) Set(val *ResourcePerformanceNoIdGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResourcePerformanceNoIdGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResourcePerformanceNoIdGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourcePerformanceNoIdGetResponse(val *ResourcePerformanceNoIdGetResponse) *NullableResourcePerformanceNoIdGetResponse {
	return &NullableResourcePerformanceNoIdGetResponse{value: val, isSet: true}
}

func (v NullableResourcePerformanceNoIdGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourcePerformanceNoIdGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
