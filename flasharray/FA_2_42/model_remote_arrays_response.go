...
// checks if the RemoteArraysResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteArraysResponse{}

// RemoteArraysResponse struct for RemoteArraysResponse
...
func (o RemoteArraysResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteArraysResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteArraysResponse struct {
	value *RemoteArraysResponse
	isSet bool
}

func (v NullableRemoteArraysResponse) Get() *RemoteArraysResponse {
	return v.value
}

func (v *NullableRemoteArraysResponse) Set(val *RemoteArraysResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteArraysResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteArraysResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteArraysResponse(val *RemoteArraysResponse) *NullableRemoteArraysResponse {
	return &NullableRemoteArraysResponse{value: val, isSet: true}
}

func (v NullableRemoteArraysResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteArraysResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
