...
// checks if the FleetMemberGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FleetMemberGetResponse{}

// FleetMemberGetResponse struct for FleetMemberGetResponse
...
func (o FleetMemberGetResponse) MarshalJSON() ([]byte, error) {
...
func (o FleetMemberGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFleetMemberGetResponse struct {
	value *FleetMemberGetResponse
	isSet bool
}

func (v NullableFleetMemberGetResponse) Get() *FleetMemberGetResponse {
	return v.value
}

func (v *NullableFleetMemberGetResponse) Set(val *FleetMemberGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFleetMemberGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFleetMemberGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFleetMemberGetResponse(val *FleetMemberGetResponse) *NullableFleetMemberGetResponse {
	return &NullableFleetMemberGetResponse{value: val, isSet: true}
}

func (v NullableFleetMemberGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFleetMemberGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
