...
`func (o *PolicyMemberExport) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *PolicyMemberExport) GetContextOk() (*FixedReference, bool)`
...
`func (o *PolicyMemberExport) SetContext(v FixedReference)`
