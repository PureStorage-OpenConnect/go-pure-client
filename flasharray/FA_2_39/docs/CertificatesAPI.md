...
------------- | ------------- | -------------
[**CertificatesCertificateGroupsDelete**](CertificatesAPI.md#CertificatesCertificateGroupsDelete) | **Delete** /api/2.39/certificates/certificate-groups | Delete certificates/certificate-groups
[**CertificatesCertificateGroupsGet**](CertificatesAPI.md#CertificatesCertificateGroupsGet) | **Get** /api/2.39/certificates/certificate-groups | List certificates/certificate-groups
[**CertificatesCertificateGroupsPost**](CertificatesAPI.md#CertificatesCertificateGroupsPost) | **Post** /api/2.39/certificates/certificate-groups | Create certificates/certificate-groups
[**CertificatesCertificateSigningRequestsPost**](CertificatesAPI.md#CertificatesCertificateSigningRequestsPost) | **Post** /api/2.39/certificates/certificate-signing-requests | Create certificate signing request
[**CertificatesDelete**](CertificatesAPI.md#CertificatesDelete) | **Delete** /api/2.39/certificates | Delete certificate
[**CertificatesGet**](CertificatesAPI.md#CertificatesGet) | **Get** /api/2.39/certificates | List certificate attributes
[**CertificatesPatch**](CertificatesAPI.md#CertificatesPatch) | **Patch** /api/2.39/certificates | Modify certificates
[**CertificatesPost**](CertificatesAPI.md#CertificatesPost) | **Post** /api/2.39/certificates | Create certificate
