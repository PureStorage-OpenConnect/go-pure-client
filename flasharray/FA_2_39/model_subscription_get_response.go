...
// checks if the SubscriptionGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionGetResponse{}

// SubscriptionGetResponse struct for SubscriptionGetResponse
...
func (o SubscriptionGetResponse) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionGetResponse struct {
	value *SubscriptionGetResponse
	isSet bool
}

func (v NullableSubscriptionGetResponse) Get() *SubscriptionGetResponse {
	return v.value
}

func (v *NullableSubscriptionGetResponse) Set(val *SubscriptionGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionGetResponse(val *SubscriptionGetResponse) *NullableSubscriptionGetResponse {
	return &NullableSubscriptionGetResponse{value: val, isSet: true}
}

func (v NullableSubscriptionGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
