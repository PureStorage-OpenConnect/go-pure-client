...
**Capacity** | Pointer to **int64** | The usable capacity measured in bytes. If the user does not have sufficient access, this field will return &#x60;null&#x60;.  | [optional] [readonly] 
