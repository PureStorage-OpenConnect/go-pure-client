...
------------- | ------------- | -------------
[**AlertWatchersDelete**](AlertWatchersAPI.md#AlertWatchersDelete) | **Delete** /api/2.19/alert-watchers | Delete alert watcher
[**AlertWatchersGet**](AlertWatchersAPI.md#AlertWatchersGet) | **Get** /api/2.19/alert-watchers | List alert watchers
[**AlertWatchersPatch**](AlertWatchersAPI.md#AlertWatchersPatch) | **Patch** /api/2.19/alert-watchers | Modify alert watcher
[**AlertWatchersPost**](AlertWatchersAPI.md#AlertWatchersPost) | **Post** /api/2.19/alert-watchers | Create alert watcher
[**AlertWatchersTestGet**](AlertWatchersAPI.md#AlertWatchersTestGet) | **Get** /api/2.19/alert-watchers/test | List alert watcher test
