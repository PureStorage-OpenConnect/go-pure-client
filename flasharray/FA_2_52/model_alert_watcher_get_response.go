...
// checks if the AlertWatcherGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertWatcherGetResponse{}

// AlertWatcherGetResponse struct for AlertWatcherGetResponse
...
func (o AlertWatcherGetResponse) MarshalJSON() ([]byte, error) {
...
func (o AlertWatcherGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAlertWatcherGetResponse struct {
	value *AlertWatcherGetResponse
	isSet bool
}

func (v NullableAlertWatcherGetResponse) Get() *AlertWatcherGetResponse {
	return v.value
}

func (v *NullableAlertWatcherGetResponse) Set(val *AlertWatcherGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertWatcherGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertWatcherGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertWatcherGetResponse(val *AlertWatcherGetResponse) *NullableAlertWatcherGetResponse {
	return &NullableAlertWatcherGetResponse{value: val, isSet: true}
}

func (v NullableAlertWatcherGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlertWatcherGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
