...
type Saml2Sso struct {
	...
	Management *Saml2SsoManagement `json:"management,omitempty"`
	// The list of services for which `SAML2 SSO` `authentication` is enabled. The default value is `management`, indicating that the single sign-on configuration applies to the administrative interface of the system.
...
// SetManagement gets a reference to the given Saml2SsoManagement and assigns it to the Management field.
