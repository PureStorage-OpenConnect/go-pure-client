...
// checks if the SupportSystemManifestResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportSystemManifestResponse{}

// SupportSystemManifestResponse struct for SupportSystemManifestResponse
type SupportSystemManifestResponse struct {
	...
	Items          []SupportSystemManifest `json:"items,omitempty"`
}
...
func NewSupportSystemManifestResponse() *SupportSystemManifestResponse {
	this := SupportSystemManifestResponse{}
	return &this
}
...
// SetItems gets a reference to the given []SupportSystemManifest and assigns it to the Items field.
func (o *SupportSystemManifestResponse) SetItems(v []SupportSystemManifest) {
	o.Items = v
}

func (o SupportSystemManifestResponse) MarshalJSON() ([]byte, error) {
...
func (o SupportSystemManifestResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSupportSystemManifestResponse struct {
	value *SupportSystemManifestResponse
	isSet bool
}

func (v NullableSupportSystemManifestResponse) Get() *SupportSystemManifestResponse {
	return v.value
}

func (v *NullableSupportSystemManifestResponse) Set(val *SupportSystemManifestResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportSystemManifestResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportSystemManifestResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportSystemManifestResponse(val *SupportSystemManifestResponse) *NullableSupportSystemManifestResponse {
	return &NullableSupportSystemManifestResponse{value: val, isSet: true}
}

func (v NullableSupportSystemManifestResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportSystemManifestResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
