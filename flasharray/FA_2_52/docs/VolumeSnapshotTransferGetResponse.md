...
**Items** | Pointer to [**[]VolumeSnapshotTransfer**](VolumeSnapshotTransfer.md) | Displays a list of all items after filtering. The values are displayed for each name where meaningful. If &#x60;total_only&#x3D;true&#x60;, the &#x60;items&#x60; list will be empty.  | [optional] 
...
`func (o *VolumeSnapshotTransferGetResponse) GetErrors() []ErrorcontextresponseErrors`

GetErrors returns the Errors field if non-nil, zero value otherwise.

### GetErrorsOk

`func (o *VolumeSnapshotTransferGetResponse) GetErrorsOk() (*[]ErrorcontextresponseErrors, bool)`
...
`func (o *VolumeSnapshotTransferGetResponse) SetErrors(v []ErrorcontextresponseErrors)`

SetErrors sets Errors field to given value.

### HasErrors

`func (o *VolumeSnapshotTransferGetResponse) HasErrors() bool`
