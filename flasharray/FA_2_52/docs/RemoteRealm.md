...
**Arrays** | Pointer to [**[]ReferenceWithType**](ReferenceWithType.md) |  | [optional] 
...
`func (o *RemoteRealm) GetArrays() []ReferenceWithType`

GetArrays returns the Arrays field if non-nil, zero value otherwise.

### GetArraysOk

`func (o *RemoteRealm) GetArraysOk() (*[]ReferenceWithType, bool)`
...
`func (o *RemoteRealm) SetArrays(v []ReferenceWithType)`
