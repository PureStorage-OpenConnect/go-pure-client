...
**Items** | Pointer to [**[]PolicySmb**](PolicySmb.md) | Displays a list of all items after filtering. If applicable, the values are displayed for each name.  | [optional] 
...
`func (o *PolicySmbGetResponse) GetErrors() []ErrorcontextresponseErrors`

GetErrors returns the Errors field if non-nil, zero value otherwise.

### GetErrorsOk

`func (o *PolicySmbGetResponse) GetErrorsOk() (*[]ErrorcontextresponseErrors, bool)`
...
`func (o *PolicySmbGetResponse) SetErrors(v []ErrorcontextresponseErrors)`

SetErrors sets Errors field to given value.

### HasErrors

`func (o *PolicySmbGetResponse) HasErrors() bool`
