...
------------- | ------------- | -------------
[**LoginPost**](AuthorizationAPI.md#LoginPost) | **Post** /api/2.52/login | Create a user session
[**LogoutPost**](AuthorizationAPI.md#LogoutPost) | **Post** /api/2.52/logout | POST logout (placeholder)
...
> UsernameResponse LoginPost(ctx).APIToken(apiToken).XRequestID(xRequestID).Login(login).Execute()
