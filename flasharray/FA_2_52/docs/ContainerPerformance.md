...
`func (o *ContainerPerformance) GetCachedReadBytesPerSec() int64`
...
`func (o *ContainerPerformance) GetCachedReadBytesPerSecOk() (*int64, bool)`
...
`func (o *ContainerPerformance) SetCachedReadsPerSec(v int64)`

SetCachedReadsPerSec sets CachedReadsPerSec field to given value.

### HasCachedReadsPerSec

`func (o *ContainerPerformance) HasCachedReadsPerSec() bool`
...
`func (o *ContainerPerformance) GetNonCachedReadBytesPerSec() int64`
...
`func (o *ContainerPerformance) GetNonCachedReadBytesPerSecOk() (*int64, bool)`
...
`func (o *ContainerPerformance) SetNonCachedReadsPerSec(v int64)`

SetNonCachedReadsPerSec sets NonCachedReadsPerSec field to given value.

### HasNonCachedReadsPerSec

`func (o *ContainerPerformance) HasNonCachedReadsPerSec() bool`
...
`func (o *ContainerPerformance) GetReadCacheHitRatio() float32`

GetReadCacheHitRatio returns the ReadCacheHitRatio field if non-nil, zero value otherwise.

### GetReadCacheHitRatioOk

`func (o *ContainerPerformance) GetReadCacheHitRatioOk() (*float32, bool)`
...
`func (o *ContainerPerformance) SetReadCacheHitRatio(v float32)`

SetReadCacheHitRatio sets ReadCacheHitRatio field to given value.

### HasReadCacheHitRatio

`func (o *ContainerPerformance) HasReadCacheHitRatio() bool`
...
`func (o *ContainerPerformance) GetServiceUsecPerReadOpCached() int64`
...
`func (o *ContainerPerformance) GetServiceUsecPerReadOpCachedOk() (*int64, bool)`
...
`func (o *ContainerPerformance) GetServiceUsecPerReadOpNonCachedOk() (*int64, bool)`
...
`func (o *ContainerPerformance) SetServiceUsecPerReadOpNonCached(v int64)`

SetServiceUsecPerReadOpNonCached sets ServiceUsecPerReadOpNonCached field to given value.

### HasServiceUsecPerReadOpNonCached

`func (o *ContainerPerformance) HasServiceUsecPerReadOpNonCached() bool`
...
`func (o *ContainerPerformance) GetMirroredOthersPerSec() int64`

GetMirroredOthersPerSec returns the MirroredOthersPerSec field if non-nil, zero value otherwise.

### GetMirroredOthersPerSecOk

`func (o *ContainerPerformance) GetMirroredOthersPerSecOk() (*int64, bool)`
...
`func (o *ContainerPerformance) SetMirroredOthersPerSec(v int64)`

SetMirroredOthersPerSec sets MirroredOthersPerSec field to given value.

### HasMirroredOthersPerSec

`func (o *ContainerPerformance) HasMirroredOthersPerSec() bool`
...
`func (o *ContainerPerformance) GetUsecPerMirroredOtherOp() int64`
...
`func (o *ContainerPerformance) GetUsecPerMirroredOtherOpOk() (*int64, bool)`
...
`func (o *ContainerPerformance) SetUsecPerMirroredOtherOp(v int64)`

SetUsecPerMirroredOtherOp sets UsecPerMirroredOtherOp field to given value.

### HasUsecPerMirroredOtherOp

`func (o *ContainerPerformance) HasUsecPerMirroredOtherOp() bool`
