...
------------- | ------------- | -------------
[**LifecycleRulesDelete**](LifecycleRulesAPI.md#LifecycleRulesDelete) | **Delete** /api/2.52/lifecycle-rules | DELETE lifecycle-rules
[**LifecycleRulesGet**](LifecycleRulesAPI.md#LifecycleRulesGet) | **Get** /api/2.52/lifecycle-rules | GET lifecycle-rules
[**LifecycleRulesPatch**](LifecycleRulesAPI.md#LifecycleRulesPatch) | **Patch** /api/2.52/lifecycle-rules | PATCH lifecycle-rules
[**LifecycleRulesPost**](LifecycleRulesAPI.md#LifecycleRulesPost) | **Post** /api/2.52/lifecycle-rules | POST lifecycle-rules
