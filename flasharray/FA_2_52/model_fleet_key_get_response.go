...
// checks if the FleetKeyGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FleetKeyGetResponse{}

// FleetKeyGetResponse struct for FleetKeyGetResponse
...
func (o FleetKeyGetResponse) MarshalJSON() ([]byte, error) {
...
func (o FleetKeyGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFleetKeyGetResponse struct {
	value *FleetKeyGetResponse
	isSet bool
}

func (v NullableFleetKeyGetResponse) Get() *FleetKeyGetResponse {
	return v.value
}

func (v *NullableFleetKeyGetResponse) Set(val *FleetKeyGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFleetKeyGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFleetKeyGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFleetKeyGetResponse(val *FleetKeyGetResponse) *NullableFleetKeyGetResponse {
	return &NullableFleetKeyGetResponse{value: val, isSet: true}
}

func (v NullableFleetKeyGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFleetKeyGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
