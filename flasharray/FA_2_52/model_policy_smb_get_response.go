...
// checks if the PolicySmbGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicySmbGetResponse{}

// PolicySmbGetResponse struct for PolicySmbGetResponse
...
func (o PolicySmbGetResponse) MarshalJSON() ([]byte, error) {
...
func (o PolicySmbGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePolicySmbGetResponse struct {
	value *PolicySmbGetResponse
	isSet bool
}

func (v NullablePolicySmbGetResponse) Get() *PolicySmbGetResponse {
	return v.value
}

func (v *NullablePolicySmbGetResponse) Set(val *PolicySmbGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicySmbGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicySmbGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicySmbGetResponse(val *PolicySmbGetResponse) *NullablePolicySmbGetResponse {
	return &NullablePolicySmbGetResponse{value: val, isSet: true}
}

func (v NullablePolicySmbGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicySmbGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
