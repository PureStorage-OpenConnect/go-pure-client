...
func (r APISubscriptionsGetRequest) Authorization(authorization string) APISubscriptionsGetRequest {
	r.authorization = &authorization
	return r
}

// Supplied by client during request or generated by server.
func (r APISubscriptionsGetRequest) XRequestID(xRequestID string) APISubscriptionsGetRequest {
...
func (r APISubscriptionsGetRequest) ContinuationToken(continuationToken string) APISubscriptionsGetRequest {
	r.continuationToken = &continuationToken
	return r
}

// Narrows down the results to only the response objects that satisfy the filter criteria.
func (r APISubscriptionsGetRequest) Filter(filter string) APISubscriptionsGetRequest {
	r.filter = &filter
	return r
}
...
func (r APISubscriptionsGetRequest) Ids(ids []string) APISubscriptionsGetRequest {
	r.ids = &ids
	return r
}
...
func (r APISubscriptionsGetRequest) TotalItemCount(totalItemCount bool) APISubscriptionsGetRequest {
	r.totalItemCount = &totalItemCount
	return r
}

func (r APISubscriptionsGetRequest) Execute() (*SubscriptionGetResponse, *http.Response, error) {
...
*/
func (a *SubscriptionsAPIService) SubscriptionsGet(ctx context.Context) APISubscriptionsGetRequest {
	return APISubscriptionsGetRequest{
		APIService: a,
		ctx:        ctx,
	}
...
func (a *SubscriptionsAPIService) SubscriptionsGetExecute(r APISubscriptionsGetRequest) (*SubscriptionGetResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SubscriptionGetResponse
	)

	endpoint := "SubscriptionsAPIService.SubscriptionsGet"
	...
	localVarPath := localBasePath + "/api/2.52/subscriptions"
