...
------------- | ------------- | -------------
[**AdminsAPITokensDelete**](AdministratorsAPI.md#AdminsAPITokensDelete) | **Delete** /api/2.4/admins/api-tokens | Delete API tokens
[**AdminsAPITokensGet**](AdministratorsAPI.md#AdminsAPITokensGet) | **Get** /api/2.4/admins/api-tokens | List API tokens
[**AdminsAPITokensPost**](AdministratorsAPI.md#AdminsAPITokensPost) | **Post** /api/2.4/admins/api-tokens | Create API tokens
[**AdminsCacheDelete**](AdministratorsAPI.md#AdminsCacheDelete) | **Delete** /api/2.4/admins/cache | Delete cache entries
[**AdminsCacheGet**](AdministratorsAPI.md#AdminsCacheGet) | **Get** /api/2.4/admins/cache | List administrator cache entries
[**AdminsCachePut**](AdministratorsAPI.md#AdminsCachePut) | **Put** /api/2.4/admins/cache | Update or refresh entries in the administrator cache
[**AdminsDelete**](AdministratorsAPI.md#AdminsDelete) | **Delete** /api/2.4/admins | Deletes an administrator
[**AdminsGet**](AdministratorsAPI.md#AdminsGet) | **Get** /api/2.4/admins | List administrators
[**AdminsPatch**](AdministratorsAPI.md#AdminsPatch) | **Patch** /api/2.4/admins | Modify an administrator
[**AdminsPost**](AdministratorsAPI.md#AdminsPost) | **Post** /api/2.4/admins | Create an administrator
[**AdminsSettingsGet**](AdministratorsAPI.md#AdminsSettingsGet) | **Get** /api/2.4/admins/settings | List administrator settings
[**AdminsSettingsPatch**](AdministratorsAPI.md#AdminsSettingsPatch) | **Patch** /api/2.4/admins/settings | Modify administrator settings
