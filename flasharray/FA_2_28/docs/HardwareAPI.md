...
------------- | ------------- | -------------
[**HardwareGet**](HardwareAPI.md#HardwareGet) | **Get** /api/2.28/hardware | List hardware component information
[**HardwarePatch**](HardwareAPI.md#HardwarePatch) | **Patch** /api/2.28/hardware | Modify visual identification
