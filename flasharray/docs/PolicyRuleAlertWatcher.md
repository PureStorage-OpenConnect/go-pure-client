...
**AlertClosureNotification** | Pointer to **string** | The configuration for sending notifications when an alert is closed. Valid values include &#x60;enable&#x60;, which triggers a notification upon alert closure, and &#x60;disable&#x60;, which suppresses it.  | [optional] 
