...
------------ | ------------- | ------------- | -------------
**Member** | Pointer to [**FixedReferenceWithType**](FixedReferenceWithType.md) | A reference to the &#x60;storage class member&#x60;. | [optional] 
...
`func (o *StorageClassMember) GetMember() FixedReferenceWithType`

GetMember returns the Member field if non-nil, zero value otherwise.

### GetMemberOk

`func (o *StorageClassMember) GetMemberOk() (*FixedReferenceWithType, bool)`
...
`func (o *StorageClassMember) SetMember(v FixedReferenceWithType)`
