...
------------- | ------------- | -------------
[**LoginPost**](AuthorizationAPI.md#LoginPost) | **Post** /api/2.57/login | Create a user session
[**LogoutPost**](AuthorizationAPI.md#LogoutPost) | **Post** /api/2.57/logout | POST logout (placeholder)
