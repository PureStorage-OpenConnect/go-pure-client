...
// checks if the EulaGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EulaGetResponse{}

// EulaGetResponse struct for EulaGetResponse
...
func (o EulaGetResponse) MarshalJSON() ([]byte, error) {
...
func (o EulaGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableEulaGetResponse struct {
	value *EulaGetResponse
	isSet bool
}

func (v NullableEulaGetResponse) Get() *EulaGetResponse {
	return v.value
}

func (v *NullableEulaGetResponse) Set(val *EulaGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEulaGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEulaGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEulaGetResponse(val *EulaGetResponse) *NullableEulaGetResponse {
	return &NullableEulaGetResponse{value: val, isSet: true}
}

func (v NullableEulaGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEulaGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
