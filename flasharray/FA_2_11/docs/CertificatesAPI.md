...
------------- | ------------- | -------------
[**CertificatesCertificateSigningRequestsPost**](CertificatesAPI.md#CertificatesCertificateSigningRequestsPost) | **Post** /api/2.11/certificates/certificate-signing-requests | Create certificate signing request
[**CertificatesDelete**](CertificatesAPI.md#CertificatesDelete) | **Delete** /api/2.11/certificates | Delete certificate
[**CertificatesGet**](CertificatesAPI.md#CertificatesGet) | **Get** /api/2.11/certificates | List certificate attributes
[**CertificatesPatch**](CertificatesAPI.md#CertificatesPatch) | **Patch** /api/2.11/certificates | Modify certificates
[**CertificatesPost**](CertificatesAPI.md#CertificatesPost) | **Post** /api/2.11/certificates | Create certificate
