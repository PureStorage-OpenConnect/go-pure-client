...
type SoftwareInstallation struct {
	...
	// A list of upgrade checks whose failure will be overridden during the upgrade. If any optional `args` are provided, they are validated later when the corresponding check script runs.
