...
------------- | ------------- | -------------
[**LoginPost**](AuthorizationAPI.md#LoginPost) | **Post** /api/2.3/login | POST login (placeholder)
[**LogoutPost**](AuthorizationAPI.md#LogoutPost) | **Post** /api/2.3/logout | POST logout (placeholder)
