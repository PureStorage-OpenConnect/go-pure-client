...
**Items** | Pointer to [**[]ProtectionGroupSnapshot**](ProtectionGroupSnapshot.md) | Returns a list of all items after filtering. The values are displayed for each name where meaningful.  | [optional] 
**Total** | Pointer to [**[]ProtectionGroupSnapshot**](ProtectionGroupSnapshot.md) | The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful.  | [optional] 
