...
// checks if the FileSystemUserQuotaGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileSystemUserQuotaGetResponse{}

// FileSystemUserQuotaGetResponse struct for FileSystemUserQuotaGetResponse
type FileSystemUserQuotaGetResponse struct {
...
func NewFileSystemUserQuotaGetResponse() *FileSystemUserQuotaGetResponse {
	this := FileSystemUserQuotaGetResponse{}
	return &this
}
...
func (o FileSystemUserQuotaGetResponse) MarshalJSON() ([]byte, error) {
...
func (o FileSystemUserQuotaGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFileSystemUserQuotaGetResponse struct {
	value *FileSystemUserQuotaGetResponse
	isSet bool
}

func (v NullableFileSystemUserQuotaGetResponse) Get() *FileSystemUserQuotaGetResponse {
	return v.value
}

func (v *NullableFileSystemUserQuotaGetResponse) Set(val *FileSystemUserQuotaGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileSystemUserQuotaGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileSystemUserQuotaGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileSystemUserQuotaGetResponse(val *FileSystemUserQuotaGetResponse) *NullableFileSystemUserQuotaGetResponse {
	return &NullableFileSystemUserQuotaGetResponse{value: val, isSet: true}
}

func (v NullableFileSystemUserQuotaGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileSystemUserQuotaGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
