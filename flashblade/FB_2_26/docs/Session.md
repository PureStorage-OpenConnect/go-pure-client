...
**IdentifyingDetails** | Pointer to **string** | Additional details, depending on the authentication method used, which are necessary to uniquely identify who authenticated as a user. &#x60;null&#x60; if no additional details are needed.  | [optional] [readonly] 
...
**Method** | Pointer to **string** | Method by which the user attempted to log in. Valid values include &#x60;API token&#x60;, &#x60;password&#x60;, &#x60;ssh certificate&#x60;, and &#x60;public key&#x60;.  | [optional] [readonly] 
...
### GetIdentifyingDetails

`func (o *Session) GetIdentifyingDetails() string`

GetIdentifyingDetails returns the IdentifyingDetails field if non-nil, zero value otherwise.

### GetIdentifyingDetailsOk

`func (o *Session) GetIdentifyingDetailsOk() (*string, bool)`

GetIdentifyingDetailsOk returns a tuple with the IdentifyingDetails field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetIdentifyingDetails sets IdentifyingDetails field to given value.
