...
------------- | ------------- | -------------
[**AdminsSshCertificateAuthorityPoliciesDelete**](PoliciesSSHCertificateAuthorityAPI.md#AdminsSshCertificateAuthorityPoliciesDelete) | **Delete** /api/2.26/admins/ssh-certificate-authority-policies | DELETE admins/ssh-certificate-authority-policies
[**AdminsSshCertificateAuthorityPoliciesGet**](PoliciesSSHCertificateAuthorityAPI.md#AdminsSshCertificateAuthorityPoliciesGet) | **Get** /api/2.26/admins/ssh-certificate-authority-policies | GET admins/ssh-certificate-authority-policies
[**AdminsSshCertificateAuthorityPoliciesPost**](PoliciesSSHCertificateAuthorityAPI.md#AdminsSshCertificateAuthorityPoliciesPost) | **Post** /api/2.26/admins/ssh-certificate-authority-policies | POST admins/ssh-certificate-authority-policies
[**ArraysSshCertificateAuthorityPoliciesDelete**](PoliciesSSHCertificateAuthorityAPI.md#ArraysSshCertificateAuthorityPoliciesDelete) | **Delete** /api/2.26/arrays/ssh-certificate-authority-policies | DELETE admins/settings/ssh-certificate-authority-policies
[**ArraysSshCertificateAuthorityPoliciesGet**](PoliciesSSHCertificateAuthorityAPI.md#ArraysSshCertificateAuthorityPoliciesGet) | **Get** /api/2.26/arrays/ssh-certificate-authority-policies | GET admins/settings/ssh-certificate-authority-policies
[**ArraysSshCertificateAuthorityPoliciesPost**](PoliciesSSHCertificateAuthorityAPI.md#ArraysSshCertificateAuthorityPoliciesPost) | **Post** /api/2.26/arrays/ssh-certificate-authority-policies | POST admins/settings/ssh-certificate-authority-policies
[**SshCertificateAuthorityPoliciesAdminsDelete**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesAdminsDelete) | **Delete** /api/2.26/ssh-certificate-authority-policies/admins | DELETE ssh-certificate-authority-policies/admins
[**SshCertificateAuthorityPoliciesAdminsGet**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesAdminsGet) | **Get** /api/2.26/ssh-certificate-authority-policies/admins | GET ssh-certificate-authority-policies/admins
[**SshCertificateAuthorityPoliciesAdminsPost**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesAdminsPost) | **Post** /api/2.26/ssh-certificate-authority-policies/admins | POST ssh-certificate-authority-policies/admins
[**SshCertificateAuthorityPoliciesArraysDelete**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesArraysDelete) | **Delete** /api/2.26/ssh-certificate-authority-policies/arrays | DELETE ssh-certificate-authority-policies/arrays
[**SshCertificateAuthorityPoliciesArraysGet**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesArraysGet) | **Get** /api/2.26/ssh-certificate-authority-policies/arrays | GET ssh-certificate-authority-policies/arrays
[**SshCertificateAuthorityPoliciesArraysPost**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesArraysPost) | **Post** /api/2.26/ssh-certificate-authority-policies/arrays | POST ssh-certificate-authority-policies/arrays
[**SshCertificateAuthorityPoliciesDelete**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesDelete) | **Delete** /api/2.26/ssh-certificate-authority-policies | Delete SSH Certificate Authority configurations
[**SshCertificateAuthorityPoliciesGet**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesGet) | **Get** /api/2.26/ssh-certificate-authority-policies | List SSH Certificate Authority configurations
[**SshCertificateAuthorityPoliciesMembersGet**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesMembersGet) | **Get** /api/2.26/ssh-certificate-authority-policies/members | GET ssh-certificate-authority-policies/members
[**SshCertificateAuthorityPoliciesPatch**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesPatch) | **Patch** /api/2.26/ssh-certificate-authority-policies | Modify SSH Certificate Authority configurations
[**SshCertificateAuthorityPoliciesPost**](PoliciesSSHCertificateAuthorityAPI.md#SshCertificateAuthorityPoliciesPost) | **Post** /api/2.26/ssh-certificate-authority-policies | Create SSH Certificate Authority configurations



## AdminsSshCertificateAuthorityPoliciesDelete

> AdminsSshCertificateAuthorityPoliciesDelete(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
func main() {
    ...
    // response from `AdminsSshCertificateAuthorityPoliciesGet`: PolicyMemberContextGetResponse
...
> PolicyMemberContextResponse AdminsSshCertificateAuthorityPoliciesPost(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
func main() {
    ...
    // response from `AdminsSshCertificateAuthorityPoliciesPost`: PolicyMemberContextResponse
...
> ArraysSshCertificateAuthorityPoliciesDelete(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
> PolicyMemberContextGetResponse ArraysSshCertificateAuthorityPoliciesGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Limit(limit).MemberIds(memberIds).MemberNames(memberNames).Offset(offset).PolicyIds(policyIds).PolicyNames(policyNames).Sort(sort).Execute()
...
func main() {
    ...
    // response from `ArraysSshCertificateAuthorityPoliciesGet`: PolicyMemberContextGetResponse
...
> PolicyMemberContextResponse ArraysSshCertificateAuthorityPoliciesPost(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
func main() {
    ...
    // response from `ArraysSshCertificateAuthorityPoliciesPost`: PolicyMemberContextResponse
...
> SshCertificateAuthorityPoliciesAdminsDelete(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
> PolicyMemberContextGetResponse SshCertificateAuthorityPoliciesAdminsGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Limit(limit).MemberIds(memberIds).MemberNames(memberNames).Offset(offset).PolicyIds(policyIds).PolicyNames(policyNames).Sort(sort).Execute()
...
func main() {
    ...
    // response from `SshCertificateAuthorityPoliciesAdminsGet`: PolicyMemberContextGetResponse
...
> PolicyMemberContextResponse SshCertificateAuthorityPoliciesAdminsPost(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
func main() {
    ...
    // response from `SshCertificateAuthorityPoliciesAdminsPost`: PolicyMemberContextResponse
...
> SshCertificateAuthorityPoliciesArraysDelete(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
> PolicyMemberContextGetResponse SshCertificateAuthorityPoliciesArraysGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Limit(limit).MemberIds(memberIds).MemberNames(memberNames).Offset(offset).PolicyIds(policyIds).PolicyNames(policyNames).Sort(sort).Execute()
...
func main() {
    ...
    // response from `SshCertificateAuthorityPoliciesArraysGet`: PolicyMemberContextGetResponse
...
> PolicyMemberContextResponse SshCertificateAuthorityPoliciesArraysPost(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
func main() {
    ...
    // response from `SshCertificateAuthorityPoliciesArraysPost`: PolicyMemberContextResponse
...
> SshCertificateAuthorityPolicyGetResponse SshCertificateAuthorityPoliciesGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> PolicyMemberContextGetResponse SshCertificateAuthorityPoliciesMembersGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Limit(limit).MemberIds(memberIds).MemberNames(memberNames).Offset(offset).PolicyIds(policyIds).PolicyNames(policyNames).Sort(sort).Execute()
...
func main() {
    ...
    // response from `SshCertificateAuthorityPoliciesMembersGet`: PolicyMemberContextGetResponse
