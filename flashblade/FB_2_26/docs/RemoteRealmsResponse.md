...
**Items** | Pointer to [**[]RemoteRealm1**](RemoteRealm1.md) | Returns a list of all items after filtering. The values are displayed for each name where meaningful.  | [optional] 
...
`func (o *RemoteRealmsResponse) GetItems() []RemoteRealm1`

GetItems returns the Items field if non-nil, zero value otherwise.

### GetItemsOk

`func (o *RemoteRealmsResponse) GetItemsOk() (*[]RemoteRealm1, bool)`
...
`func (o *RemoteRealmsResponse) SetItems(v []RemoteRealm1)`
