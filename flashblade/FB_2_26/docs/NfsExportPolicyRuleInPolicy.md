...
`func (o *NfsExportPolicyRuleInPolicy) GetAnongid() int64`

GetAnongid returns the Anongid field if non-nil, zero value otherwise.

### GetAnongidOk

`func (o *NfsExportPolicyRuleInPolicy) GetAnongidOk() (*int64, bool)`
...
`func (o *NfsExportPolicyRuleInPolicy) SetAnongid(v int64)`
...
`func (o *NfsExportPolicyRuleInPolicy) GetAnonuid() int64`

GetAnonuid returns the Anonuid field if non-nil, zero value otherwise.

### GetAnonuidOk

`func (o *NfsExportPolicyRuleInPolicy) GetAnonuidOk() (*int64, bool)`
...
`func (o *NfsExportPolicyRuleInPolicy) SetAnonuid(v int64)`
