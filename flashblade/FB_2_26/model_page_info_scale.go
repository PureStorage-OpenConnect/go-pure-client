...
// checks if the PageInfoScale type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageInfoScale{}

// PageInfoScale struct for PageInfoScale
type PageInfoScale struct {
...
func (o PageInfoScale) MarshalJSON() ([]byte, error) {
...
func (o PageInfoScale) ToMap() (map[string]interface{}, error) {
...
type NullablePageInfoScale struct {
	value *PageInfoScale
	isSet bool
}

func (v NullablePageInfoScale) Get() *PageInfoScale {
	return v.value
}

func (v *NullablePageInfoScale) Set(val *PageInfoScale) {
	v.value = val
	v.isSet = true
}

func (v NullablePageInfoScale) IsSet() bool {
	return v.isSet
}

func (v *NullablePageInfoScale) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageInfoScale(val *PageInfoScale) *NullablePageInfoScale {
	return &NullablePageInfoScale{value: val, isSet: true}
}

func (v NullablePageInfoScale) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageInfoScale) UnmarshalJSON(src []byte) error {
	v.isSet = true
