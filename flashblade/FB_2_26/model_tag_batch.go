...
type TagBatch struct {
	...
	Resource *ReferenceWithoutType `json:"resource,omitempty"`
...
// SetResource gets a reference to the given ReferenceWithoutType and assigns it to the Resource field.
