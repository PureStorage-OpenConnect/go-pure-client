...
// checks if the ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse{}

// ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse struct for ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse
type ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse struct {
...
func NewManagementAccessPolicyRolePermissionSupportedResourcesGetResponse() *ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse {
	this := ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse{}
	return &this
}
...
func (o ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableManagementAccessPolicyRolePermissionSupportedResourcesGetResponse struct {
	value *ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse
	isSet bool
}

func (v NullableManagementAccessPolicyRolePermissionSupportedResourcesGetResponse) Get() *ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse {
	return v.value
}

func (v *NullableManagementAccessPolicyRolePermissionSupportedResourcesGetResponse) Set(val *ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableManagementAccessPolicyRolePermissionSupportedResourcesGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableManagementAccessPolicyRolePermissionSupportedResourcesGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManagementAccessPolicyRolePermissionSupportedResourcesGetResponse(val *ManagementAccessPolicyRolePermissionSupportedResourcesGetResponse) *NullableManagementAccessPolicyRolePermissionSupportedResourcesGetResponse {
	return &NullableManagementAccessPolicyRolePermissionSupportedResourcesGetResponse{value: val, isSet: true}
}

func (v NullableManagementAccessPolicyRolePermissionSupportedResourcesGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManagementAccessPolicyRolePermissionSupportedResourcesGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
