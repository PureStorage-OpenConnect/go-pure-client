...
func (r APIAPIVersionGetRequest) XRequestID(xRequestID string) APIAPIVersionGetRequest {
...
// Supplied by client during request or generated by server.
func (r APILoginBannerGetRequest) XRequestID(xRequestID string) APILoginBannerGetRequest {
	r.xRequestID = &xRequestID
	return r
}
...
// Supplied by client during request or generated by server.
func (r APILoginPostRequest) XRequestID(xRequestID string) APILoginPostRequest {
	r.xRequestID = &xRequestID
	return r
}

func (r APILoginPostRequest) Login(login LoginPost) APILoginPostRequest {
	r.login = &login
	return r
}

func (r APILoginPostRequest) AuthorizationHeader(authorizationHeader string) APILoginPostRequest {
...
/*
LoginPost Log in a user

Logs in a user and returns a session token, using either the user's API token or their username and password. `api-token` is passed in a header, with the request body empty. Otherwise `username` and `password` are passed in the request body, without an `api-token` header.
...
func (a *AuthorizationAPIService) LoginPostExecute(r APILoginPostRequest) (*Login, *http.Response, error) {
	...
	if r.apiToken != nil {
		parameterAddToHeaderOrQuery(localVarHeaderParams, http.CanonicalHeaderKey("api-token"), r.apiToken, "")
	}
	if r.xRequestID != nil {
		parameterAddToHeaderOrQuery(localVarHeaderParams, http.CanonicalHeaderKey("X-Request-ID"), r.xRequestID, "")
	}
...
// Supplied by client during request or generated by server.
func (r APILogoutPostRequest) XRequestID(xRequestID string) APILogoutPostRequest {
	r.xRequestID = &xRequestID
	return r
}
