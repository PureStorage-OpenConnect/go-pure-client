...
// checks if the NetworkInterfaceTrace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkInterfaceTrace{}

// NetworkInterfaceTrace Output from running the linux command 'traceroute' directly on the array with start and end location information.
...
func (o NetworkInterfaceTrace) MarshalJSON() ([]byte, error) {
...
func (o NetworkInterfaceTrace) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkInterfaceTrace struct {
	value *NetworkInterfaceTrace
	isSet bool
}

func (v NullableNetworkInterfaceTrace) Get() *NetworkInterfaceTrace {
	return v.value
}

func (v *NullableNetworkInterfaceTrace) Set(val *NetworkInterfaceTrace) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkInterfaceTrace) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkInterfaceTrace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkInterfaceTrace(val *NetworkInterfaceTrace) *NullableNetworkInterfaceTrace {
	return &NullableNetworkInterfaceTrace{value: val, isSet: true}
}

func (v NullableNetworkInterfaceTrace) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkInterfaceTrace) UnmarshalJSON(src []byte) error {
	v.isSet = true
