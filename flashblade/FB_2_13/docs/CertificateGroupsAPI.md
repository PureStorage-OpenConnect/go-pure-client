...
------------- | ------------- | -------------
[**CertificateGroupsCertificatesDelete**](CertificateGroupsAPI.md#CertificateGroupsCertificatesDelete) | **Delete** /api/2.13/certificate-groups/certificates | DELETE certificate-groups/certificates
[**CertificateGroupsCertificatesGet**](CertificateGroupsAPI.md#CertificateGroupsCertificatesGet) | **Get** /api/2.13/certificate-groups/certificates | GET certificate-groups/certificates
[**CertificateGroupsCertificatesPost**](CertificateGroupsAPI.md#CertificateGroupsCertificatesPost) | **Post** /api/2.13/certificate-groups/certificates | POST certificate-groups/certificates
[**CertificateGroupsDelete**](CertificateGroupsAPI.md#CertificateGroupsDelete) | **Delete** /api/2.13/certificate-groups | DELETE certificate-groups
[**CertificateGroupsGet**](CertificateGroupsAPI.md#CertificateGroupsGet) | **Get** /api/2.13/certificate-groups | GET certificate-groups
[**CertificateGroupsPost**](CertificateGroupsAPI.md#CertificateGroupsPost) | **Post** /api/2.13/certificate-groups | POST certificate-groups
[**CertificateGroupsUsesGet**](CertificateGroupsAPI.md#CertificateGroupsUsesGet) | **Get** /api/2.13/certificate-groups/uses | GET certificate-groups/uses
