...
------------- | ------------- | -------------
[**RapidDataLockingGet**](RDLAPI.md#RapidDataLockingGet) | **Get** /api/2.13/rapid-data-locking | Get the status of the Rapid Data Locking feature.
[**RapidDataLockingPatch**](RDLAPI.md#RapidDataLockingPatch) | **Patch** /api/2.13/rapid-data-locking | Modifies the Rapid Data Locking feature.
[**RapidDataLockingRotatePost**](RDLAPI.md#RapidDataLockingRotatePost) | **Post** /api/2.13/rapid-data-locking/rotate | Rotates the external keys on the associated EKM appliance.
[**RapidDataLockingTestGet**](RDLAPI.md#RapidDataLockingTestGet) | **Get** /api/2.13/rapid-data-locking/test | Displays Rapid Data Locking test results.
