...
**TimeRemaining** | Pointer to **int64** | Time in milliseconds before the bucket is eradicated. &#x60;null&#x60; if not destroyed or remaning time until eradication is not known yet.  | [optional] [readonly] 
