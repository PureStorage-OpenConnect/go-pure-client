...
------------- | ------------- | -------------
[**AdminsAPITokensDelete**](AdministratorsAPI.md#AdminsAPITokensDelete) | **Delete** /api/2.13/admins/api-tokens | DELETE admins/api-tokens
[**AdminsAPITokensGet**](AdministratorsAPI.md#AdminsAPITokensGet) | **Get** /api/2.13/admins/api-tokens | GET admins/api-tokens
[**AdminsAPITokensPost**](AdministratorsAPI.md#AdminsAPITokensPost) | **Post** /api/2.13/admins/api-tokens | POST admins/api-tokens
[**AdminsCacheDelete**](AdministratorsAPI.md#AdminsCacheDelete) | **Delete** /api/2.13/admins/cache | DELETE admins/cache
[**AdminsCacheGet**](AdministratorsAPI.md#AdminsCacheGet) | **Get** /api/2.13/admins/cache | GET admins/cache
[**AdminsGet**](AdministratorsAPI.md#AdminsGet) | **Get** /api/2.13/admins | GET admins
[**AdminsPatch**](AdministratorsAPI.md#AdminsPatch) | **Patch** /api/2.13/admins | PATCH admins
[**AdminsSettingsGet**](AdministratorsAPI.md#AdminsSettingsGet) | **Get** /api/2.13/admins/settings | List global admin settings
[**AdminsSettingsPatch**](AdministratorsAPI.md#AdminsSettingsPatch) | **Patch** /api/2.13/admins/settings | Update global admin settings
