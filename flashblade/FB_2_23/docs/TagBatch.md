...
**Resource** | Pointer to [**ReferenceWithoutType**](ReferenceWithoutType.md) | A reference to the parent object.  | [optional] 
...
`func (o *TagBatch) GetResource() ReferenceWithoutType`

GetResource returns the Resource field if non-nil, zero value otherwise.

### GetResourceOk

`func (o *TagBatch) GetResourceOk() (*ReferenceWithoutType, bool)`
...
`func (o *TagBatch) SetResource(v ReferenceWithoutType)`
