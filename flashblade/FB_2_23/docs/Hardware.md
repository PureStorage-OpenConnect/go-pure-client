...
**DataMac** | Pointer to **string** | Ethernet (data) MAC address  | [optional] [readonly] 
...
**ManagementMac** | Pointer to **string** | Hardware component (burned-in) MAC address  | [optional] [readonly] 
**Model** | Pointer to **string** | Model number of the hardware component. | [optional] [readonly] 
**PartNumber** | Pointer to **string** | Part number of the hardware component.  | [optional] [readonly] 
**SensorReadings** | Pointer to [**[]HardwareTemperatures**](HardwareTemperatures.md) |  | [optional] [readonly] 
...
**Type** | Pointer to **string** | Type of hardware component. Valid values are &#x60;bay&#x60;, &#x60;ch&#x60;, &#x60;eth&#x60;, &#x60;fan&#x60;, &#x60;fb&#x60;, &#x60;fm&#x60;, &#x60;pwr&#x60;, and &#x60;xfm&#x60;.  | [optional] [readonly] 
...
`func (o *Hardware) GetDataMac() string`

GetDataMac returns the DataMac field if non-nil, zero value otherwise.

### GetDataMacOk

`func (o *Hardware) GetDataMacOk() (*string, bool)`

GetDataMacOk returns a tuple with the DataMac field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetDataMac

`func (o *Hardware) SetDataMac(v string)`

SetDataMac sets DataMac field to given value.

### HasDataMac

`func (o *Hardware) HasDataMac() bool`

HasDataMac returns a boolean if a field has been set.
...
`func (o *Hardware) GetManagementMac() string`

GetManagementMac returns the ManagementMac field if non-nil, zero value otherwise.

### GetManagementMacOk

`func (o *Hardware) GetManagementMacOk() (*string, bool)`
...
`func (o *Hardware) SetManagementMac(v string)`

SetManagementMac sets ManagementMac field to given value.

### HasManagementMac

`func (o *Hardware) HasManagementMac() bool`
...
`func (o *Hardware) GetPartNumber() string`

GetPartNumber returns the PartNumber field if non-nil, zero value otherwise.

### GetPartNumberOk

`func (o *Hardware) GetPartNumberOk() (*string, bool)`
...
`func (o *Hardware) SetPartNumber(v string)`

SetPartNumber sets PartNumber field to given value.

### HasPartNumber

`func (o *Hardware) HasPartNumber() bool`

HasPartNumber returns a boolean if a field has been set.

### GetSensorReadings

`func (o *Hardware) GetSensorReadings() []HardwareTemperatures`

GetSensorReadings returns the SensorReadings field if non-nil, zero value otherwise.

### GetSensorReadingsOk

`func (o *Hardware) GetSensorReadingsOk() (*[]HardwareTemperatures, bool)`

GetSensorReadingsOk returns a tuple with the SensorReadings field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetSensorReadings

`func (o *Hardware) SetSensorReadings(v []HardwareTemperatures)`

SetSensorReadings sets SensorReadings field to given value.

### HasSensorReadings

`func (o *Hardware) HasSensorReadings() bool`

HasSensorReadings returns a boolean if a field has been set.
