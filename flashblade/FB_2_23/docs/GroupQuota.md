...
`func (o *GroupQuota) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *GroupQuota) GetContextOk() (*FixedReference, bool)`
...
`func (o *GroupQuota) SetContext(v FixedReference)`

SetContext sets Context field to given value.

### HasContext

`func (o *GroupQuota) HasContext() bool`
