...
**Parameters** | Pointer to [**[]WorkloadPlacementRecommendationParameter**](WorkloadPlacementRecommendationParameter.md) | The parameter values to pass to the preset when creating the recommendation. A value is required for all parameters that are not of the resource_reference type. Parameters of type resource_reference could be: set to a fixed value, or defined as a set of allowed values, or not set. If a resource_reference parameter is not set then allowed values will be taken from the preset definition.  | [optional] 
**PlacementNames** | Pointer to **[]string** |  | [optional] [readonly] 
**Preset** | Pointer to [**FixedReferenceWithoutType**](FixedReferenceWithoutType.md) |  | [optional] 
