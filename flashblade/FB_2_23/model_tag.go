...
type Tag struct {
	...
	Resource  *FixedReferenceWithoutType `json:"resource,omitempty"`
...
// SetResource gets a reference to the given FixedReferenceWithoutType and assigns it to the Resource field.
