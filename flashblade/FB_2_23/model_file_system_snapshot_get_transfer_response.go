...
// checks if the FileSystemSnapshotGetTransferResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileSystemSnapshotGetTransferResponse{}

// FileSystemSnapshotGetTransferResponse struct for FileSystemSnapshotGetTransferResponse
...
func NewFileSystemSnapshotGetTransferResponse() *FileSystemSnapshotGetTransferResponse {
	this := FileSystemSnapshotGetTransferResponse{}
	return &this
}
...
// SetTotal gets a reference to the given FileSystemSnapshotTransfer and assigns it to the Total field.
func (o *FileSystemSnapshotGetTransferResponse) SetTotal(v FileSystemSnapshotTransfer) {
	o.Total = &v
}

func (o FileSystemSnapshotGetTransferResponse) MarshalJSON() ([]byte, error) {
...
func (o FileSystemSnapshotGetTransferResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFileSystemSnapshotGetTransferResponse struct {
	value *FileSystemSnapshotGetTransferResponse
	isSet bool
}

func (v NullableFileSystemSnapshotGetTransferResponse) Get() *FileSystemSnapshotGetTransferResponse {
	return v.value
}

func (v *NullableFileSystemSnapshotGetTransferResponse) Set(val *FileSystemSnapshotGetTransferResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileSystemSnapshotGetTransferResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileSystemSnapshotGetTransferResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileSystemSnapshotGetTransferResponse(val *FileSystemSnapshotGetTransferResponse) *NullableFileSystemSnapshotGetTransferResponse {
	return &NullableFileSystemSnapshotGetTransferResponse{value: val, isSet: true}
}

func (v NullableFileSystemSnapshotGetTransferResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileSystemSnapshotGetTransferResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
