...
// checks if the PresetWorkloadGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PresetWorkloadGetResponse{}

// PresetWorkloadGetResponse struct for PresetWorkloadGetResponse
type PresetWorkloadGetResponse struct {
...
func NewPresetWorkloadGetResponse() *PresetWorkloadGetResponse {
	this := PresetWorkloadGetResponse{}
	return &this
}
...
func (o PresetWorkloadGetResponse) MarshalJSON() ([]byte, error) {
...
func (o PresetWorkloadGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePresetWorkloadGetResponse struct {
	value *PresetWorkloadGetResponse
	isSet bool
}

func (v NullablePresetWorkloadGetResponse) Get() *PresetWorkloadGetResponse {
	return v.value
}

func (v *NullablePresetWorkloadGetResponse) Set(val *PresetWorkloadGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePresetWorkloadGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePresetWorkloadGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePresetWorkloadGetResponse(val *PresetWorkloadGetResponse) *NullablePresetWorkloadGetResponse {
	return &NullablePresetWorkloadGetResponse{value: val, isSet: true}
}

func (v NullablePresetWorkloadGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePresetWorkloadGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
