...
// SetInterfaces gets a reference to the given []FixedReference and assigns it to the Interfaces field.
...
// SetLinkAggregationGroup gets a reference to the given Reference and assigns it to the LinkAggregationGroup field.
