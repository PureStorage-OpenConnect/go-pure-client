...
// checks if the RealmSpaceStorageClassGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RealmSpaceStorageClassGetResponse{}

// RealmSpaceStorageClassGetResponse struct for RealmSpaceStorageClassGetResponse
type RealmSpaceStorageClassGetResponse struct {
...
func NewRealmSpaceStorageClassGetResponse() *RealmSpaceStorageClassGetResponse {
	this := RealmSpaceStorageClassGetResponse{}
	return &this
}
...
func (o *RealmSpaceStorageClassGetResponse) GetItems() []RealmSpaceStorageClass {
	if o == nil || IsNil(o.Items) {
		var ret []RealmSpaceStorageClass
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []RealmSpaceStorageClass and assigns it to the Items field.
...
// SetTotal gets a reference to the given []RealmSpaceStorageClass and assigns it to the Total field.
func (o *RealmSpaceStorageClassGetResponse) SetTotal(v []RealmSpaceStorageClass) {
	o.Total = v
}

func (o RealmSpaceStorageClassGetResponse) MarshalJSON() ([]byte, error) {
...
func (o RealmSpaceStorageClassGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRealmSpaceStorageClassGetResponse struct {
	value *RealmSpaceStorageClassGetResponse
	isSet bool
}

func (v NullableRealmSpaceStorageClassGetResponse) Get() *RealmSpaceStorageClassGetResponse {
	return v.value
}

func (v *NullableRealmSpaceStorageClassGetResponse) Set(val *RealmSpaceStorageClassGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRealmSpaceStorageClassGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRealmSpaceStorageClassGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRealmSpaceStorageClassGetResponse(val *RealmSpaceStorageClassGetResponse) *NullableRealmSpaceStorageClassGetResponse {
	return &NullableRealmSpaceStorageClassGetResponse{value: val, isSet: true}
}

func (v NullableRealmSpaceStorageClassGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRealmSpaceStorageClassGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
