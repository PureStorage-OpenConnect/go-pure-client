...
// checks if the RealmDefaultsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RealmDefaultsGetResponse{}

// RealmDefaultsGetResponse struct for RealmDefaultsGetResponse
type RealmDefaultsGetResponse struct {
...
func (o RealmDefaultsGetResponse) MarshalJSON() ([]byte, error) {
...
func (o RealmDefaultsGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRealmDefaultsGetResponse struct {
	value *RealmDefaultsGetResponse
	isSet bool
}

func (v NullableRealmDefaultsGetResponse) Get() *RealmDefaultsGetResponse {
	return v.value
}

func (v *NullableRealmDefaultsGetResponse) Set(val *RealmDefaultsGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRealmDefaultsGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRealmDefaultsGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRealmDefaultsGetResponse(val *RealmDefaultsGetResponse) *NullableRealmDefaultsGetResponse {
	return &NullableRealmDefaultsGetResponse{value: val, isSet: true}
}

func (v NullableRealmDefaultsGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRealmDefaultsGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
