...
// checks if the ArrayS3SpecificPerformanceGetResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArrayS3SpecificPerformanceGetResp{}

// ArrayS3SpecificPerformanceGetResp struct for ArrayS3SpecificPerformanceGetResp
...
func NewArrayS3SpecificPerformanceGetResp() *ArrayS3SpecificPerformanceGetResp {
	this := ArrayS3SpecificPerformanceGetResp{}
	return &this
}
...
func (o *ArrayS3SpecificPerformanceGetResp) GetItems() []ArrayS3SpecificPerformance {
	if o == nil || IsNil(o.Items) {
		var ret []ArrayS3SpecificPerformance
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []ArrayS3SpecificPerformance and assigns it to the Items field.
func (o *ArrayS3SpecificPerformanceGetResp) SetItems(v []ArrayS3SpecificPerformance) {
	o.Items = v
}

func (o ArrayS3SpecificPerformanceGetResp) MarshalJSON() ([]byte, error) {
...
func (o ArrayS3SpecificPerformanceGetResp) ToMap() (map[string]interface{}, error) {
...
type NullableArrayS3SpecificPerformanceGetResp struct {
	value *ArrayS3SpecificPerformanceGetResp
	isSet bool
}

func (v NullableArrayS3SpecificPerformanceGetResp) Get() *ArrayS3SpecificPerformanceGetResp {
	return v.value
}

func (v *NullableArrayS3SpecificPerformanceGetResp) Set(val *ArrayS3SpecificPerformanceGetResp) {
	v.value = val
	v.isSet = true
}

func (v NullableArrayS3SpecificPerformanceGetResp) IsSet() bool {
	return v.isSet
}

func (v *NullableArrayS3SpecificPerformanceGetResp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArrayS3SpecificPerformanceGetResp(val *ArrayS3SpecificPerformanceGetResp) *NullableArrayS3SpecificPerformanceGetResp {
	return &NullableArrayS3SpecificPerformanceGetResp{value: val, isSet: true}
}

func (v NullableArrayS3SpecificPerformanceGetResp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArrayS3SpecificPerformanceGetResp) UnmarshalJSON(src []byte) error {
	v.isSet = true
