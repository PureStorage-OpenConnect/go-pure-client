...
------------- | ------------- | -------------
[**HardwareGet**](HardwareAPI.md#HardwareGet) | **Get** /api/2.19/hardware | GET hardware
[**HardwarePatch**](HardwareAPI.md#HardwarePatch) | **Patch** /api/2.19/hardware | PATCH hardware
