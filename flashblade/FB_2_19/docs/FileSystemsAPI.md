...
------------- | ------------- | -------------
[**FileSystemsAuditPoliciesDelete**](FileSystemsAPI.md#FileSystemsAuditPoliciesDelete) | **Delete** /api/2.19/file-systems/audit-policies | DELETE file-systems/audit-policies
[**FileSystemsAuditPoliciesGet**](FileSystemsAPI.md#FileSystemsAuditPoliciesGet) | **Get** /api/2.19/file-systems/audit-policies | GET file-systems/audit-policies
[**FileSystemsAuditPoliciesPost**](FileSystemsAPI.md#FileSystemsAuditPoliciesPost) | **Post** /api/2.19/file-systems/audit-policies | POST file-systems/audit-policies
[**FileSystemsDelete**](FileSystemsAPI.md#FileSystemsDelete) | **Delete** /api/2.19/file-systems | DELETE file-systems
[**FileSystemsGet**](FileSystemsAPI.md#FileSystemsGet) | **Get** /api/2.19/file-systems | GET file-systems
[**FileSystemsGroupsPerformanceGet**](FileSystemsAPI.md#FileSystemsGroupsPerformanceGet) | **Get** /api/2.19/file-systems/groups/performance | GET file-systems/groups/performance
[**FileSystemsLocksClientsGet**](FileSystemsAPI.md#FileSystemsLocksClientsGet) | **Get** /api/2.19/file-systems/locks/clients | Get a list of clients that hold active file locks
[**FileSystemsLocksDelete**](FileSystemsAPI.md#FileSystemsLocksDelete) | **Delete** /api/2.19/file-systems/locks | Invalidate file locks
[**FileSystemsLocksGet**](FileSystemsAPI.md#FileSystemsLocksGet) | **Get** /api/2.19/file-systems/locks | Get a list of active file locks
[**FileSystemsLocksNlmReclamationsPost**](FileSystemsAPI.md#FileSystemsLocksNlmReclamationsPost) | **Post** /api/2.19/file-systems/locks/nlm-reclamations | Initiate NLM reclamation.
[**FileSystemsOpenFilesDelete**](FileSystemsAPI.md#FileSystemsOpenFilesDelete) | **Delete** /api/2.19/file-systems/open-files | DELETE file-systems/open-files
[**FileSystemsOpenFilesGet**](FileSystemsAPI.md#FileSystemsOpenFilesGet) | **Get** /api/2.19/file-systems/open-files | GET file-systems/open-files
[**FileSystemsPatch**](FileSystemsAPI.md#FileSystemsPatch) | **Patch** /api/2.19/file-systems | PATCH file-systems
[**FileSystemsPerformanceGet**](FileSystemsAPI.md#FileSystemsPerformanceGet) | **Get** /api/2.19/file-systems/performance | GET file-systems/performance
[**FileSystemsPoliciesAllGet**](FileSystemsAPI.md#FileSystemsPoliciesAllGet) | **Get** /api/2.19/file-systems/policies-all | GET file-systems/policies-all
[**FileSystemsPoliciesDelete**](FileSystemsAPI.md#FileSystemsPoliciesDelete) | **Delete** /api/2.19/file-systems/policies | DELETE file-systems/policies
[**FileSystemsPoliciesGet**](FileSystemsAPI.md#FileSystemsPoliciesGet) | **Get** /api/2.19/file-systems/policies | GET file-systems/policies
[**FileSystemsPoliciesPost**](FileSystemsAPI.md#FileSystemsPoliciesPost) | **Post** /api/2.19/file-systems/policies | POST file-systems/policies
[**FileSystemsPost**](FileSystemsAPI.md#FileSystemsPost) | **Post** /api/2.19/file-systems | POST file-systems
[**FileSystemsSessionsDelete**](FileSystemsAPI.md#FileSystemsSessionsDelete) | **Delete** /api/2.19/file-systems/sessions | Delete sessions
[**FileSystemsSessionsGet**](FileSystemsAPI.md#FileSystemsSessionsGet) | **Get** /api/2.19/file-systems/sessions | Get a list of active sessions
[**FileSystemsSpaceStorageClassesGet**](FileSystemsAPI.md#FileSystemsSpaceStorageClassesGet) | **Get** /api/2.19/file-systems/space/storage-classes | GET file-systems/space/storage-classes
[**FileSystemsUsersPerformanceGet**](FileSystemsAPI.md#FileSystemsUsersPerformanceGet) | **Get** /api/2.19/file-systems/users/performance | GET file-systems/users/performance
[**FileSystemsWormDataPoliciesGet**](FileSystemsAPI.md#FileSystemsWormDataPoliciesGet) | **Get** /api/2.19/file-systems/worm-data-policies | GET file-systems/worm-data-policies
