...
------------- | ------------- | -------------
[**SupportVerificationKeysGet**](VerificationKeysAPI.md#SupportVerificationKeysGet) | **Get** /api/2.19/support/verification-keys | GET verification-keys
[**SupportVerificationKeysPatch**](VerificationKeysAPI.md#SupportVerificationKeysPatch) | **Patch** /api/2.19/support/verification-keys | PATCH verification-keys
