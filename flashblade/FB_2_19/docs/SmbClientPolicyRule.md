...
`func (o *SmbClientPolicyRule) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *SmbClientPolicyRule) GetContextOk() (*FixedReference, bool)`
...
`func (o *SmbClientPolicyRule) SetContext(v FixedReference)`

SetContext sets Context field to given value.

### HasContext

`func (o *SmbClientPolicyRule) HasContext() bool`
