...
**TotalPhysical** | Pointer to **int64** | Deprecated. See total_used for the newer functionality. The total physical space consumed by the file system, measured in bytes.  | [optional] [readonly] 
...
**TotalUsed** | Pointer to **int64** | The total space consumed by customer data, measured in bytes.  | [optional] [readonly] 
...
`func (o *Space) SetTotalUsed(v int64)`

SetTotalUsed sets TotalUsed field to given value.

### HasTotalUsed

`func (o *Space) HasTotalUsed() bool`
