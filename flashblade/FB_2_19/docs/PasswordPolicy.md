...
**MaxPasswordAge** | Pointer to **int64** | The maximum age of password before password change is required. Ranges from 1 day to 99999 days with 1 hour precision. 0ms value means password expiration is disabled. Maximum age is always greater than the minimum password age.  | [optional] 
...
`func (o *PasswordPolicy) GetRealms() []FixedReference`

GetRealms returns the Realms field if non-nil, zero value otherwise.

### GetRealmsOk

`func (o *PasswordPolicy) GetRealmsOk() (*[]FixedReference, bool)`
...
`func (o *PasswordPolicy) SetRealms(v []FixedReference)`

SetRealms sets Realms field to given value.

### HasRealms

`func (o *PasswordPolicy) HasRealms() bool`
