...
`func (o *Nfs) GetExportPolicy() ReferenceWritable`

GetExportPolicy returns the ExportPolicy field if non-nil, zero value otherwise.

### GetExportPolicyOk

`func (o *Nfs) GetExportPolicyOk() (*ReferenceWritable, bool)`
...
`func (o *Nfs) SetExportPolicy(v ReferenceWritable)`

SetExportPolicy sets ExportPolicy field to given value.

### HasExportPolicy

`func (o *Nfs) HasExportPolicy() bool`
