...
------------- | ------------- | -------------
[**UsageGroupsGet**](UsageAPI.md#UsageGroupsGet) | **Get** /api/2.3/usage/groups | GET usage/groups
[**UsageUsersGet**](UsageAPI.md#UsageUsersGet) | **Get** /api/2.3/usage/users | GET usage/users
