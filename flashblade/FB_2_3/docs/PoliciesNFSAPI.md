...
------------- | ------------- | -------------
[**NfsExportPoliciesDelete**](PoliciesNFSAPI.md#NfsExportPoliciesDelete) | **Delete** /api/2.3/nfs-export-policies | DELETE nfs-export-policies
[**NfsExportPoliciesGet**](PoliciesNFSAPI.md#NfsExportPoliciesGet) | **Get** /api/2.3/nfs-export-policies | GET nfs-export-policies
[**NfsExportPoliciesPatch**](PoliciesNFSAPI.md#NfsExportPoliciesPatch) | **Patch** /api/2.3/nfs-export-policies | PATCH nfs-export-policies
[**NfsExportPoliciesPost**](PoliciesNFSAPI.md#NfsExportPoliciesPost) | **Post** /api/2.3/nfs-export-policies | POST nfs-export-policies
[**NfsExportPoliciesRulesDelete**](PoliciesNFSAPI.md#NfsExportPoliciesRulesDelete) | **Delete** /api/2.3/nfs-export-policies/rules | DELETE nfs-export-policies/rules
[**NfsExportPoliciesRulesGet**](PoliciesNFSAPI.md#NfsExportPoliciesRulesGet) | **Get** /api/2.3/nfs-export-policies/rules | GET nfs-export-policies/rules
[**NfsExportPoliciesRulesPatch**](PoliciesNFSAPI.md#NfsExportPoliciesRulesPatch) | **Patch** /api/2.3/nfs-export-policies/rules | PATCH nfs-export-policies/rules
[**NfsExportPoliciesRulesPost**](PoliciesNFSAPI.md#NfsExportPoliciesRulesPost) | **Post** /api/2.3/nfs-export-policies/rules | POST nfs-export-policies/rules
