...
------------- | ------------- | -------------
[**PoliciesDelete**](PoliciesAPI.md#PoliciesDelete) | **Delete** /api/2.1/policies | DELETE policies
[**PoliciesFileSystemReplicaLinksDelete**](PoliciesAPI.md#PoliciesFileSystemReplicaLinksDelete) | **Delete** /api/2.1/policies/file-system-replica-links | DELETE policies/file-system-replica-links
[**PoliciesFileSystemReplicaLinksGet**](PoliciesAPI.md#PoliciesFileSystemReplicaLinksGet) | **Get** /api/2.1/policies/file-system-replica-links | GET policies/file-system-replica-links
[**PoliciesFileSystemReplicaLinksPost**](PoliciesAPI.md#PoliciesFileSystemReplicaLinksPost) | **Post** /api/2.1/policies/file-system-replica-links | POST policies/file-system-replica-links
[**PoliciesFileSystemSnapshotsDelete**](PoliciesAPI.md#PoliciesFileSystemSnapshotsDelete) | **Delete** /api/2.1/policies/file-system-snapshots | DELETE policies/file-system-snapshots
[**PoliciesFileSystemSnapshotsGet**](PoliciesAPI.md#PoliciesFileSystemSnapshotsGet) | **Get** /api/2.1/policies/file-system-snapshots | GET policies/file-system-snapshots
[**PoliciesFileSystemsDelete**](PoliciesAPI.md#PoliciesFileSystemsDelete) | **Delete** /api/2.1/policies/file-systems | DELETE policies/file-systems
[**PoliciesFileSystemsGet**](PoliciesAPI.md#PoliciesFileSystemsGet) | **Get** /api/2.1/policies/file-systems | GET policies/file-systems
[**PoliciesFileSystemsPost**](PoliciesAPI.md#PoliciesFileSystemsPost) | **Post** /api/2.1/policies/file-systems | POST policies/file-systems
[**PoliciesGet**](PoliciesAPI.md#PoliciesGet) | **Get** /api/2.1/policies | GET policies
[**PoliciesMembersGet**](PoliciesAPI.md#PoliciesMembersGet) | **Get** /api/2.1/policies/members | GET policies/members
[**PoliciesPatch**](PoliciesAPI.md#PoliciesPatch) | **Patch** /api/2.1/policies | PATCH policies
[**PoliciesPost**](PoliciesAPI.md#PoliciesPost) | **Post** /api/2.1/policies | POST policies
...
import (
    ...
    "fmt"
    "os"
    openapiclient "github.com/PureStorage-OpenConnect/go-pure-client/flashblade/FB_2_1"
)
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesDelete(context.Background())
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesFileSystemReplicaLinksDelete(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PoliciesAPI.PoliciesFileSystemReplicaLinksDelete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesFileSystemReplicaLinksGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PoliciesAPI.PoliciesFileSystemReplicaLinksGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PoliciesFileSystemReplicaLinksGet`: PolicyMemberWithRemoteGetResponse
    fmt.Fprintf(os.Stdout, "Response from `PoliciesAPI.PoliciesFileSystemReplicaLinksGet`: %v\n", resp)
}
```
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesFileSystemReplicaLinksPost(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PoliciesAPI.PoliciesFileSystemReplicaLinksPost``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PoliciesFileSystemReplicaLinksPost`: PolicyMemberWithRemoteResponse
    fmt.Fprintf(os.Stdout, "Response from `PoliciesAPI.PoliciesFileSystemReplicaLinksPost`: %v\n", resp)
}
```
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesFileSystemSnapshotsDelete(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PoliciesAPI.PoliciesFileSystemSnapshotsDelete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesFileSystemSnapshotsGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PoliciesAPI.PoliciesFileSystemSnapshotsGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PoliciesFileSystemSnapshotsGet`: PolicyFileSystemSnapshotGetResponse
    fmt.Fprintf(os.Stdout, "Response from `PoliciesAPI.PoliciesFileSystemSnapshotsGet`: %v\n", resp)
}
```
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesFileSystemsDelete(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PoliciesAPI.PoliciesFileSystemsDelete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesFileSystemsGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PoliciesAPI.PoliciesFileSystemsGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PoliciesFileSystemsGet`: PolicyMemberGetResponse
    fmt.Fprintf(os.Stdout, "Response from `PoliciesAPI.PoliciesFileSystemsGet`: %v\n", resp)
}
```
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesFileSystemsPost(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PoliciesAPI.PoliciesFileSystemsPost``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PoliciesFileSystemsPost`: PolicyMemberResponse
    fmt.Fprintf(os.Stdout, "Response from `PoliciesAPI.PoliciesFileSystemsPost`: %v\n", resp)
}
```
 ...
 **memberIds** | **[]string** | A comma-separated list of member IDs. If after filtering, there is not at least one resource that matches each of the elements of &#x60;member_ids&#x60;, then an error is returned. This cannot be provided together with the &#x60;member_names&#x60; query parameter.  | 
 **memberNames** | **[]string** | A comma-separated list of member names.  | 
 **memberTypes** | **[]string** | A comma-separated list of member types.  | 
 **offset** | **int32** | The offset of the first resource to return from a collection.  | 
 **policyIds** | **[]string** | A comma-separated list of policy IDs. If after filtering, there is not at least one resource that matches each of the elements of &#x60;policy_ids&#x60;, then an error is returned. This cannot be provided together with the &#x60;policy_names&#x60; query parameter.  | 
 **policyNames** | **[]string** | A comma-separated list of policy names.  | 
 **remoteFileSystemIds** | **[]string** | A comma-separated list of remote file system IDs. If there is not at least one resource that matches each of the elements, then an error is returned. This cannot be provided together with the &#x60;remote_file_system_names&#x60; query parameter.  | 
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesPatch(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `PoliciesAPI.PoliciesPatch``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PoliciesPatch`: PolicyResponse
    fmt.Fprintf(os.Stdout, "Response from `PoliciesAPI.PoliciesPatch`: %v\n", resp)
}
```
...
func main() {
    ...
    req := apiClient.PoliciesAPI.PoliciesPost(context.Background())
    // Set request parameters ...
