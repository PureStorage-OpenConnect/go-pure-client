...
`func (o *RelationshipPerformanceReplication) GetContinuous() ReplicationPerformance`

GetContinuous returns the Continuous field if non-nil, zero value otherwise.

### GetContinuousOk

`func (o *RelationshipPerformanceReplication) GetContinuousOk() (*ReplicationPerformance, bool)`
...
`func (o *RelationshipPerformanceReplication) SetContinuous(v ReplicationPerformance)`
