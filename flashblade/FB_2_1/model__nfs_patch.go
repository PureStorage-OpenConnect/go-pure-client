...
type NfsPatch struct {
	...
	// The rules which will be added to the existing NFS export rules for the file system.
	...
	// The rules which will be removed from the existing NFS export rules for the file system. Only the first occurrence of the `remove_rules` will be removed.
