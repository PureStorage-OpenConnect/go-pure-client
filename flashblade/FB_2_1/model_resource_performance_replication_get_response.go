...
// checks if the ResourcePerformanceReplicationGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourcePerformanceReplicationGetResponse{}

// ResourcePerformanceReplicationGetResponse struct for ResourcePerformanceReplicationGetResponse
...
func NewResourcePerformanceReplicationGetResponse() *ResourcePerformanceReplicationGetResponse {
	this := ResourcePerformanceReplicationGetResponse{}
	return &this
}
...
func (o *ResourcePerformanceReplicationGetResponse) GetItems() []ResourcePerformanceReplication {
	if o == nil || IsNil(o.Items) {
		var ret []ResourcePerformanceReplication
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []ResourcePerformanceReplication and assigns it to the Items field.
...
// SetTotal gets a reference to the given []ResourcePerformanceReplication and assigns it to the Total field.
func (o *ResourcePerformanceReplicationGetResponse) SetTotal(v []ResourcePerformanceReplication) {
	o.Total = v
}

func (o ResourcePerformanceReplicationGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ResourcePerformanceReplicationGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResourcePerformanceReplicationGetResponse struct {
	value *ResourcePerformanceReplicationGetResponse
	isSet bool
}

func (v NullableResourcePerformanceReplicationGetResponse) Get() *ResourcePerformanceReplicationGetResponse {
	return v.value
}

func (v *NullableResourcePerformanceReplicationGetResponse) Set(val *ResourcePerformanceReplicationGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResourcePerformanceReplicationGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResourcePerformanceReplicationGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourcePerformanceReplicationGetResponse(val *ResourcePerformanceReplicationGetResponse) *NullableResourcePerformanceReplicationGetResponse {
	return &NullableResourcePerformanceReplicationGetResponse{value: val, isSet: true}
}

func (v NullableResourcePerformanceReplicationGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourcePerformanceReplicationGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
