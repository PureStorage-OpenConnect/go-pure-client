...
**EngineId** | Pointer to **string** | An SNMP agent&#39;s adminstration domain unique name.  | [optional] [readonly] 
**V2c** | Pointer to [**SnmpV2c**](SnmpV2c.md) |  | [optional] 
**V3** | Pointer to [**SnmpV3**](SnmpV3.md) |  | [optional] 
**Version** | Pointer to **string** | Version of the SNMP protocol to be used by an SNMP manager in communications with Purity&#39;s SNMP agent. Valid values are &#x60;v2c&#x60; and &#x60;v3&#x60;.  | [optional] 
...
`func (o *SnmpAgent) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *SnmpAgent) GetIdOk() (*string, bool)`
...
`func (o *SnmpAgent) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *SnmpAgent) HasId() bool`
