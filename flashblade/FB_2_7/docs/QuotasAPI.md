...
------------- | ------------- | -------------
[**QuotasGroupsDelete**](QuotasAPI.md#QuotasGroupsDelete) | **Delete** /api/2.7/quotas/groups | DELETE quotas/groups
[**QuotasGroupsGet**](QuotasAPI.md#QuotasGroupsGet) | **Get** /api/2.7/quotas/groups | GET quotas/groups
[**QuotasGroupsPatch**](QuotasAPI.md#QuotasGroupsPatch) | **Patch** /api/2.7/quotas/groups | PATCH quotas/groups
[**QuotasGroupsPost**](QuotasAPI.md#QuotasGroupsPost) | **Post** /api/2.7/quotas/groups | POST quotas/groups
[**QuotasSettingsGet**](QuotasAPI.md#QuotasSettingsGet) | **Get** /api/2.7/quotas/settings | GET quotas-settings
[**QuotasSettingsPatch**](QuotasAPI.md#QuotasSettingsPatch) | **Patch** /api/2.7/quotas/settings | PATCH quotas-settings
[**QuotasUsersDelete**](QuotasAPI.md#QuotasUsersDelete) | **Delete** /api/2.7/quotas/users | DELETE quotas/users
[**QuotasUsersGet**](QuotasAPI.md#QuotasUsersGet) | **Get** /api/2.7/quotas/users | GET quotas/users
[**QuotasUsersPatch**](QuotasAPI.md#QuotasUsersPatch) | **Patch** /api/2.7/quotas/users | PATCH quotas/users
[**QuotasUsersPost**](QuotasAPI.md#QuotasUsersPost) | **Post** /api/2.7/quotas/users | POST quotas/users
