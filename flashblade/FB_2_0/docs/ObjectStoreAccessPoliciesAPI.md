...
------------- | ------------- | -------------
[**ObjectStoreAccessPoliciesGet**](ObjectStoreAccessPoliciesAPI.md#ObjectStoreAccessPoliciesGet) | **Get** /api/2.0/object-store-access-policies | GET object-store-access-policies
[**ObjectStoreAccessPoliciesObjectStoreUsersDelete**](ObjectStoreAccessPoliciesAPI.md#ObjectStoreAccessPoliciesObjectStoreUsersDelete) | **Delete** /api/2.0/object-store-access-policies/object-store-users | DELETE object-store-access-policies/object-store-users
[**ObjectStoreAccessPoliciesObjectStoreUsersGet**](ObjectStoreAccessPoliciesAPI.md#ObjectStoreAccessPoliciesObjectStoreUsersGet) | **Get** /api/2.0/object-store-access-policies/object-store-users | GET object-store-access-policies/object-store-users
[**ObjectStoreAccessPoliciesObjectStoreUsersPost**](ObjectStoreAccessPoliciesAPI.md#ObjectStoreAccessPoliciesObjectStoreUsersPost) | **Post** /api/2.0/object-store-access-policies/object-store-users | POST object-store-access-policies/object-store-users
