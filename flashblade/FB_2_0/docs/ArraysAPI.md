...
------------- | ------------- | -------------
[**ArraysEulaGet**](ArraysAPI.md#ArraysEulaGet) | **Get** /api/2.0/arrays/eula | GET arrays/eula
[**ArraysEulaPatch**](ArraysAPI.md#ArraysEulaPatch) | **Patch** /api/2.0/arrays/eula | PATCH arrays/eula
[**ArraysGet**](ArraysAPI.md#ArraysGet) | **Get** /api/2.0/arrays | GET arrays
[**ArraysHttpSpecificPerformanceGet**](ArraysAPI.md#ArraysHttpSpecificPerformanceGet) | **Get** /api/2.0/arrays/http-specific-performance | GET arrays/http-specific-performance
[**ArraysNfsSpecificPerformanceGet**](ArraysAPI.md#ArraysNfsSpecificPerformanceGet) | **Get** /api/2.0/arrays/nfs-specific-performance | GET arrays/nfs-specific-performance
[**ArraysPatch**](ArraysAPI.md#ArraysPatch) | **Patch** /api/2.0/arrays | PATCH arrays
[**ArraysPerformanceGet**](ArraysAPI.md#ArraysPerformanceGet) | **Get** /api/2.0/arrays/performance | GET arrays/performance
[**ArraysPerformanceReplicationGet**](ArraysAPI.md#ArraysPerformanceReplicationGet) | **Get** /api/2.0/arrays/performance/replication | GET arrays/performance/replication
[**ArraysS3SpecificPerformanceGet**](ArraysAPI.md#ArraysS3SpecificPerformanceGet) | **Get** /api/2.0/arrays/s3-specific-performance | GET arrays/s3-specific-performance
[**ArraysSpaceGet**](ArraysAPI.md#ArraysSpaceGet) | **Get** /api/2.0/arrays/space | GET arrays/space
[**ArraysSupportedTimeZonesGet**](ArraysAPI.md#ArraysSupportedTimeZonesGet) | **Get** /api/2.0/arrays/supported-time-zones | GET arrays/supported-time-zones
