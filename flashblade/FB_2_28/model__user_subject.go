...
// checks if the UserSubject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSubject{}

// UserSubject struct for UserSubject
type UserSubject struct {
	...
	// The SMB SID that represents the user's security identity in a WINDOWS system.
...
func (o UserSubject) MarshalJSON() ([]byte, error) {
...
func (o UserSubject) ToMap() (map[string]interface{}, error) {
...
type NullableUserSubject struct {
	value *UserSubject
	isSet bool
}

func (v NullableUserSubject) Get() *UserSubject {
	return v.value
}

func (v *NullableUserSubject) Set(val *UserSubject) {
	v.value = val
	v.isSet = true
}

func (v NullableUserSubject) IsSet() bool {
	return v.isSet
}

func (v *NullableUserSubject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserSubject(val *UserSubject) *NullableUserSubject {
	return &NullableUserSubject{value: val, isSet: true}
}

func (v NullableUserSubject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserSubject) UnmarshalJSON(src []byte) error {
	v.isSet = true
