...
type Hardware struct {
	...
	SensorReadings []HardwareTemperatures `json:"sensor_readings,omitempty"`
...
// GetDataMac returns the DataMac field value if set, zero value otherwise.
func (o *Hardware) GetDataMac() string {
	if o == nil || IsNil(o.DataMac) {
		var ret string
		return ret
	}
	return *o.DataMac
...
// GetDataMacOk returns a tuple with the DataMac field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Hardware) GetDataMacOk() (*string, bool) {
	if o == nil || IsNil(o.DataMac) {
		return nil, false
	}
	return o.DataMac, true
}
...
// SetDataMac gets a reference to the given string and assigns it to the DataMac field.
...
// GetSensorReadings returns the SensorReadings field value if set, zero value otherwise.
func (o *Hardware) GetSensorReadings() []HardwareTemperatures {
	if o == nil || IsNil(o.SensorReadings) {
		var ret []HardwareTemperatures
		return ret
	}
	return o.SensorReadings
}

// GetSensorReadingsOk returns a tuple with the SensorReadings field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Hardware) GetSensorReadingsOk() ([]HardwareTemperatures, bool) {
	if o == nil || IsNil(o.SensorReadings) {
		return nil, false
	}
	return o.SensorReadings, true
}
...
// SetSensorReadings gets a reference to the given []HardwareTemperatures and assigns it to the SensorReadings field.
...
func (o Hardware) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DataMac) {
		toSerialize["data_mac"] = o.DataMac
	}
	if !IsNil(o.Details) {
	...
	if !IsNil(o.ManagementMac) {
		toSerialize["management_mac"] = o.ManagementMac
	}
	if !IsNil(o.Model) {
	...
	if !IsNil(o.SensorReadings) {
		toSerialize["sensor_readings"] = o.SensorReadings
	}
	if !IsNil(o.Serial) {
