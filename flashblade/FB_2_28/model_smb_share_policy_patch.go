...
// checks if the SmbSharePolicyPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmbSharePolicyPatch{}

// SmbSharePolicyPatch struct for SmbSharePolicyPatch
...
func (o SmbSharePolicyPatch) MarshalJSON() ([]byte, error) {
...
func (o SmbSharePolicyPatch) ToMap() (map[string]interface{}, error) {
...
type NullableSmbSharePolicyPatch struct {
	value *SmbSharePolicyPatch
	isSet bool
}

func (v NullableSmbSharePolicyPatch) Get() *SmbSharePolicyPatch {
	return v.value
}

func (v *NullableSmbSharePolicyPatch) Set(val *SmbSharePolicyPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableSmbSharePolicyPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableSmbSharePolicyPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmbSharePolicyPatch(val *SmbSharePolicyPatch) *NullableSmbSharePolicyPatch {
	return &NullableSmbSharePolicyPatch{value: val, isSet: true}
}

func (v NullableSmbSharePolicyPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmbSharePolicyPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
