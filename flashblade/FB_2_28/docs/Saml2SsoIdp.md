...
**MetadataUrlCaCertificate** | Pointer to [**ReferenceWritable**](ReferenceWritable.md) | CA certificate used to validate the authenticity of the configured Identity Provider server.  | [optional] 
**MetadataUrlCaCertificateGroup** | Pointer to [**ReferenceWritable**](ReferenceWritable.md) | A certificate group containing CA certificates that can be used to validate the authenticity of the configured Identity Provider server.  | [optional] 
...
### GetMetadataUrlCaCertificate

`func (o *Saml2SsoIdp) GetMetadataUrlCaCertificate() ReferenceWritable`

GetMetadataUrlCaCertificate returns the MetadataUrlCaCertificate field if non-nil, zero value otherwise.

### GetMetadataUrlCaCertificateOk

`func (o *Saml2SsoIdp) GetMetadataUrlCaCertificateOk() (*ReferenceWritable, bool)`

GetMetadataUrlCaCertificateOk returns a tuple with the MetadataUrlCaCertificate field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetMetadataUrlCaCertificate

`func (o *Saml2SsoIdp) SetMetadataUrlCaCertificate(v ReferenceWritable)`

SetMetadataUrlCaCertificate sets MetadataUrlCaCertificate field to given value.

### HasMetadataUrlCaCertificate

`func (o *Saml2SsoIdp) HasMetadataUrlCaCertificate() bool`

HasMetadataUrlCaCertificate returns a boolean if a field has been set.

### GetMetadataUrlCaCertificateGroup

`func (o *Saml2SsoIdp) GetMetadataUrlCaCertificateGroup() ReferenceWritable`

GetMetadataUrlCaCertificateGroup returns the MetadataUrlCaCertificateGroup field if non-nil, zero value otherwise.

### GetMetadataUrlCaCertificateGroupOk

`func (o *Saml2SsoIdp) GetMetadataUrlCaCertificateGroupOk() (*ReferenceWritable, bool)`

GetMetadataUrlCaCertificateGroupOk returns a tuple with the MetadataUrlCaCertificateGroup field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetMetadataUrlCaCertificateGroup

`func (o *Saml2SsoIdp) SetMetadataUrlCaCertificateGroup(v ReferenceWritable)`

SetMetadataUrlCaCertificateGroup sets MetadataUrlCaCertificateGroup field to given value.

### HasMetadataUrlCaCertificateGroup

`func (o *Saml2SsoIdp) HasMetadataUrlCaCertificateGroup() bool`

HasMetadataUrlCaCertificateGroup returns a boolean if a field has been set.
