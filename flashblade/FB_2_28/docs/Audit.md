...
**CorrelationId** | Pointer to **string** | A unique identifier that connects user-triggered system actions to the user action that caused them. User actions that do not trigger other actions will not have a correlation ID.  | [optional] [readonly] 
...
**SystemEvent** | Pointer to **bool** | If true, then this audit record represents a system-initiated event. If false, it represents an event invoked directly by a user.  | [optional] [readonly] 
...
`func (o *Audit) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *Audit) GetContextOk() (*FixedReference, bool)`
...
`func (o *Audit) SetContext(v FixedReference)`
...
`func (o *Audit) GetCorrelationId() string`

GetCorrelationId returns the CorrelationId field if non-nil, zero value otherwise.

### GetCorrelationIdOk

`func (o *Audit) GetCorrelationIdOk() (*string, bool)`
...
`func (o *Audit) SetCorrelationId(v string)`

SetCorrelationId sets CorrelationId field to given value.

### HasCorrelationId

`func (o *Audit) HasCorrelationId() bool`
