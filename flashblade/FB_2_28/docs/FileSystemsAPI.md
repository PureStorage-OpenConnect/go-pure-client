...
------------- | ------------- | -------------
[**FileSystemsAuditPoliciesDelete**](FileSystemsAPI.md#FileSystemsAuditPoliciesDelete) | **Delete** /api/2.28/file-systems/audit-policies | DELETE file-systems/audit-policies
[**FileSystemsAuditPoliciesGet**](FileSystemsAPI.md#FileSystemsAuditPoliciesGet) | **Get** /api/2.28/file-systems/audit-policies | GET file-systems/audit-policies
[**FileSystemsAuditPoliciesPost**](FileSystemsAPI.md#FileSystemsAuditPoliciesPost) | **Post** /api/2.28/file-systems/audit-policies | POST file-systems/audit-policies
[**FileSystemsDataEvictionPoliciesDelete**](FileSystemsAPI.md#FileSystemsDataEvictionPoliciesDelete) | **Delete** /api/2.28/file-systems/data-eviction-policies | DELETE file-systems/data-eviction-policies
[**FileSystemsDataEvictionPoliciesGet**](FileSystemsAPI.md#FileSystemsDataEvictionPoliciesGet) | **Get** /api/2.28/file-systems/data-eviction-policies | GET file-systems/data-eviction-policies
[**FileSystemsDataEvictionPoliciesPost**](FileSystemsAPI.md#FileSystemsDataEvictionPoliciesPost) | **Post** /api/2.28/file-systems/data-eviction-policies | POST file-systems/data-eviction-policies
[**FileSystemsDelete**](FileSystemsAPI.md#FileSystemsDelete) | **Delete** /api/2.28/file-systems | DELETE file-systems
[**FileSystemsGet**](FileSystemsAPI.md#FileSystemsGet) | **Get** /api/2.28/file-systems | GET file-systems
[**FileSystemsGroupsGet**](FileSystemsAPI.md#FileSystemsGroupsGet) | **Get** /api/2.28/file-systems/groups | GET file-systems/groups
[**FileSystemsGroupsPerformanceGet**](FileSystemsAPI.md#FileSystemsGroupsPerformanceGet) | **Get** /api/2.28/file-systems/groups/performance | GET file-systems/groups/performance
[**FileSystemsLocksClientsGet**](FileSystemsAPI.md#FileSystemsLocksClientsGet) | **Get** /api/2.28/file-systems/locks/clients | Get a list of clients that hold active file locks
[**FileSystemsLocksDelete**](FileSystemsAPI.md#FileSystemsLocksDelete) | **Delete** /api/2.28/file-systems/locks | Invalidate file locks
[**FileSystemsLocksGet**](FileSystemsAPI.md#FileSystemsLocksGet) | **Get** /api/2.28/file-systems/locks | Get a list of active file locks
[**FileSystemsLocksNlmReclamationsPost**](FileSystemsAPI.md#FileSystemsLocksNlmReclamationsPost) | **Post** /api/2.28/file-systems/locks/nlm-reclamations | Initiate NLM reclamation.
[**FileSystemsOpenFilesDelete**](FileSystemsAPI.md#FileSystemsOpenFilesDelete) | **Delete** /api/2.28/file-systems/open-files | DELETE file-systems/open-files
[**FileSystemsOpenFilesGet**](FileSystemsAPI.md#FileSystemsOpenFilesGet) | **Get** /api/2.28/file-systems/open-files | GET file-systems/open-files
[**FileSystemsPatch**](FileSystemsAPI.md#FileSystemsPatch) | **Patch** /api/2.28/file-systems | PATCH file-systems
[**FileSystemsPerformanceGet**](FileSystemsAPI.md#FileSystemsPerformanceGet) | **Get** /api/2.28/file-systems/performance | GET file-systems/performance
[**FileSystemsPoliciesAllGet**](FileSystemsAPI.md#FileSystemsPoliciesAllGet) | **Get** /api/2.28/file-systems/policies-all | GET file-systems/policies-all
[**FileSystemsPoliciesDelete**](FileSystemsAPI.md#FileSystemsPoliciesDelete) | **Delete** /api/2.28/file-systems/policies | DELETE file-systems/policies
[**FileSystemsPoliciesGet**](FileSystemsAPI.md#FileSystemsPoliciesGet) | **Get** /api/2.28/file-systems/policies | GET file-systems/policies
[**FileSystemsPoliciesPost**](FileSystemsAPI.md#FileSystemsPoliciesPost) | **Post** /api/2.28/file-systems/policies | POST file-systems/policies
[**FileSystemsPost**](FileSystemsAPI.md#FileSystemsPost) | **Post** /api/2.28/file-systems | POST file-systems
[**FileSystemsSessionsDelete**](FileSystemsAPI.md#FileSystemsSessionsDelete) | **Delete** /api/2.28/file-systems/sessions | Delete sessions
[**FileSystemsSessionsGet**](FileSystemsAPI.md#FileSystemsSessionsGet) | **Get** /api/2.28/file-systems/sessions | Get a list of active sessions
[**FileSystemsSpaceStorageClassesGet**](FileSystemsAPI.md#FileSystemsSpaceStorageClassesGet) | **Get** /api/2.28/file-systems/space/storage-classes | GET file-systems/space/storage-classes
[**FileSystemsUserGroupQuotaPoliciesDelete**](FileSystemsAPI.md#FileSystemsUserGroupQuotaPoliciesDelete) | **Delete** /api/2.28/file-systems/user-group-quota-policies | DELETE file-systems/user-group-quota-policies
[**FileSystemsUserGroupQuotaPoliciesGet**](FileSystemsAPI.md#FileSystemsUserGroupQuotaPoliciesGet) | **Get** /api/2.28/file-systems/user-group-quota-policies | GET file-systems/user-group-quota-policies
[**FileSystemsUserGroupQuotaPoliciesPost**](FileSystemsAPI.md#FileSystemsUserGroupQuotaPoliciesPost) | **Post** /api/2.28/file-systems/user-group-quota-policies | POST file-systems/user-group-quota-policies
[**FileSystemsUsersGet**](FileSystemsAPI.md#FileSystemsUsersGet) | **Get** /api/2.28/file-systems/users | GET file-systems/users
[**FileSystemsUsersPerformanceGet**](FileSystemsAPI.md#FileSystemsUsersPerformanceGet) | **Get** /api/2.28/file-systems/users/performance | GET file-systems/users/performance
[**FileSystemsWormDataPoliciesGet**](FileSystemsAPI.md#FileSystemsWormDataPoliciesGet) | **Get** /api/2.28/file-systems/worm-data-policies | GET file-systems/worm-data-policies
...
## FileSystemsDataEvictionPoliciesDelete

> FileSystemsDataEvictionPoliciesDelete(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
func main() {
    ...
    req := apiClient.FileSystemsAPI.FileSystemsDataEvictionPoliciesDelete(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FileSystemsAPI.FileSystemsDataEvictionPoliciesDelete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiFileSystemsDataEvictionPoliciesDeleteRequest struct via the builder pattern
...
## FileSystemsDataEvictionPoliciesGet

> DataEvictionPoliciesMembersGetResponse FileSystemsDataEvictionPoliciesGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Limit(limit).MemberIds(memberIds).MemberNames(memberNames).Offset(offset).PolicyIds(policyIds).PolicyNames(policyNames).Sort(sort).Execute()
...
func main() {
    ...
    req := apiClient.FileSystemsAPI.FileSystemsDataEvictionPoliciesGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FileSystemsAPI.FileSystemsDataEvictionPoliciesGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `FileSystemsDataEvictionPoliciesGet`: DataEvictionPoliciesMembersGetResponse
    fmt.Fprintf(os.Stdout, "Response from `FileSystemsAPI.FileSystemsDataEvictionPoliciesGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFileSystemsDataEvictionPoliciesGetRequest struct via the builder pattern
...
## FileSystemsDataEvictionPoliciesPost

> DataEvictionPoliciesMembersResponse FileSystemsDataEvictionPoliciesPost(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
func main() {
    ...
    req := apiClient.FileSystemsAPI.FileSystemsDataEvictionPoliciesPost(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FileSystemsAPI.FileSystemsDataEvictionPoliciesPost``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `FileSystemsDataEvictionPoliciesPost`: DataEvictionPoliciesMembersResponse
    fmt.Fprintf(os.Stdout, "Response from `FileSystemsAPI.FileSystemsDataEvictionPoliciesPost`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFileSystemsDataEvictionPoliciesPostRequest struct via the builder pattern
...
> FileSystemGetResponse FileSystemsGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Destroyed(destroyed).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).TotalOnly(totalOnly).WorkloadIds(workloadIds).WorkloadNames(workloadNames).Execute()
...
## FileSystemsGroupsGet

> FileSystemGroupsGetResponse FileSystemsGroupsGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Filter(filter).Gids(gids).GroupNames(groupNames).Limit(limit).Offset(offset).Sort(sort).Execute()
...
func main() {
    ...
    req := apiClient.FileSystemsAPI.FileSystemsGroupsGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FileSystemsAPI.FileSystemsGroupsGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `FileSystemsGroupsGet`: FileSystemGroupsGetResponse
    fmt.Fprintf(os.Stdout, "Response from `FileSystemsAPI.FileSystemsGroupsGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFileSystemsGroupsGetRequest struct via the builder pattern
...
[**FileSystemGroupsGetResponse**](FileSystemGroupsGetResponse.md)
...
> FileSystemClientsGetResponse FileSystemsLocksClientsGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Limit(limit).Execute()
...
> FileSystemsLocksDelete(ctx).XRequestID(xRequestID).ClientNames(clientNames).ContextNames(contextNames).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Inodes(inodes).Names(names).Paths(paths).Recursive(recursive).Execute()
...
> FileLockGetResponse FileSystemsLocksGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ClientNames(clientNames).ContextNames(contextNames).ContinuationToken(continuationToken).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Filter(filter).Inodes(inodes).Limit(limit).Names(names).Paths(paths).Execute()
...
> FileLockNlmReclamationResponse FileSystemsLocksNlmReclamationsPost(ctx).XRequestID(xRequestID).ContextNames(contextNames).Execute()
...
> FileSystemResponse FileSystemsPost(ctx).FileSystem(fileSystem).XRequestID(xRequestID).ContextNames(contextNames).DefaultExports(defaultExports).DiscardNonSnapshottedData(discardNonSnapshottedData).IncludeSnapshot(includeSnapshot).Names(names).Overwrite(overwrite).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
 ...
 **discardNonSnapshottedData** | **bool** | This parameter must be set to &#x60;true&#x60; in order to restore a file system from a snapshot or to demote a file system (which restores the file system from the common baseline snapshot). Setting this parameter to &#x60;true&#x60; is acknowledgement that any non-snapshotted data currently in the file system will be irretrievably lost.  | 
 **includeSnapshot** | **bool** | This parameter must be set to &#x60;true&#x60; in order to copy an existing snapshot to a new file system. If not specified, the default value is &#x60;false&#x60;.  | 
 **names** | **[]string** | Performs the operation on the unique names specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.  If there is not at least one resource that matches each of the elements of &#x60;names&#x60;, then an error is returned, except when creating new resources.  | 
...
> FileSystemsSessionsDelete(ctx).XRequestID(xRequestID).ClientNames(clientNames).ContextNames(contextNames).Disruptive(disruptive).Names(names).Protocols(protocols).UserNames(userNames).Execute()
...
> FileSessionGetResponse FileSystemsSessionsGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ClientNames(clientNames).ContextNames(contextNames).ContinuationToken(continuationToken).Limit(limit).Names(names).Protocols(protocols).UserNames(userNames).Execute()
 ...
 **offset** | **int32** | The offset of the first resource to return from a collection.  | 
 **sort** | **[]string** | Sort the response by the specified fields (in descending order if &#39;-&#39; is appended to the field name). NOTE: If you provide a sort you will not get a &#x60;continuation_token&#x60; in the response.  | 
 **storageClassNames** | **[]string** | A comma-separated list of storage class names. Valid values include &#x60;S500X-S&#x60; (or &#x60;flashblade-s500x-s&#x60;) and &#x60;S500X-A&#x60; (or &#x60;flashblade-s500x-a&#x60;).  | 
 **totalOnly** | **bool** | If set to &#x60;true&#x60;, returns the aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each name where meaningful. If &#x60;total_only&#x3D;true&#x60;, the &#x60;items&#x60; list will be empty.  | 
...
## FileSystemsUserGroupQuotaPoliciesDelete

> FileSystemsUserGroupQuotaPoliciesDelete(ctx).XRequestID(xRequestID).ContextNames(contextNames).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
func main() {
    ...
    req := apiClient.FileSystemsAPI.FileSystemsUserGroupQuotaPoliciesDelete(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FileSystemsAPI.FileSystemsUserGroupQuotaPoliciesDelete``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiFileSystemsUserGroupQuotaPoliciesDeleteRequest struct via the builder pattern
...
## FileSystemsUserGroupQuotaPoliciesGet

> UserGroupQuotaPoliciesMembersGetResponse FileSystemsUserGroupQuotaPoliciesGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Limit(limit).MemberIds(memberIds).MemberNames(memberNames).Offset(offset).PolicyIds(policyIds).PolicyNames(policyNames).Sort(sort).Execute()
...
func main() {
    ...
    req := apiClient.FileSystemsAPI.FileSystemsUserGroupQuotaPoliciesGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FileSystemsAPI.FileSystemsUserGroupQuotaPoliciesGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `FileSystemsUserGroupQuotaPoliciesGet`: UserGroupQuotaPoliciesMembersGetResponse
    fmt.Fprintf(os.Stdout, "Response from `FileSystemsAPI.FileSystemsUserGroupQuotaPoliciesGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFileSystemsUserGroupQuotaPoliciesGetRequest struct via the builder pattern
...
func main() {
    ...
    req := apiClient.FileSystemsAPI.FileSystemsUserGroupQuotaPoliciesPost(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FileSystemsAPI.FileSystemsUserGroupQuotaPoliciesPost``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `FileSystemsUserGroupQuotaPoliciesPost`: UserGroupQuotaPoliciesMembersResponse
    fmt.Fprintf(os.Stdout, "Response from `FileSystemsAPI.FileSystemsUserGroupQuotaPoliciesPost`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFileSystemsUserGroupQuotaPoliciesPostRequest struct via the builder pattern
...
> FileSystemUsersGetResponse FileSystemsUsersGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Filter(filter).Limit(limit).Offset(offset).Sort(sort).Uids(uids).UserNames(userNames).UserSids(userSids).Execute()
...
func main() {
    ...
    req := apiClient.FileSystemsAPI.FileSystemsUsersGet(context.Background())
    // Set request parameters ...

    resp, r, err := req.Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FileSystemsAPI.FileSystemsUsersGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `FileSystemsUsersGet`: FileSystemUsersGetResponse
    fmt.Fprintf(os.Stdout, "Response from `FileSystemsAPI.FileSystemsUsersGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiFileSystemsUsersGetRequest struct via the builder pattern
 ...
 **userSids** | **[]string** | A comma-separated list of WINDOWS user SIDs. If there is not at least one resource that matches each of the elements of &#x60;user_sids&#x60;, then an error is returned. This cannot be provided together with &#x60;uids&#x60; or &#x60;user_names&#x60; query parameters.  | 

### Return type

[**FileSystemUsersGetResponse**](FileSystemUsersGetResponse.md)
