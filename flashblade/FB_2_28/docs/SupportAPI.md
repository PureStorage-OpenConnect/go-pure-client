...
------------- | ------------- | -------------
[**SupportGet**](SupportAPI.md#SupportGet) | **Get** /api/2.28/support | GET support
[**SupportPatch**](SupportAPI.md#SupportPatch) | **Patch** /api/2.28/support | PATCH support
[**SupportSystemManifestGet**](SupportAPI.md#SupportSystemManifestGet) | **Get** /api/2.28/support/system-manifest | List the system manifest
[**SupportTestGet**](SupportAPI.md#SupportTestGet) | **Get** /api/2.28/support/test | GET support-test
