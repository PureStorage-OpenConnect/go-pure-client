...
------------- | ------------- | -------------
[**TargetsDelete**](TargetsAPI.md#TargetsDelete) | **Delete** /api/2.28/targets | DELETE targets
[**TargetsGet**](TargetsAPI.md#TargetsGet) | **Get** /api/2.28/targets | GET targets
[**TargetsPatch**](TargetsAPI.md#TargetsPatch) | **Patch** /api/2.28/targets | PATCH targets
[**TargetsPerformanceReplicationGet**](TargetsAPI.md#TargetsPerformanceReplicationGet) | **Get** /api/2.28/targets/performance/replication | GET targets/performance/replication
[**TargetsPost**](TargetsAPI.md#TargetsPost) | **Post** /api/2.28/targets | POST targets
