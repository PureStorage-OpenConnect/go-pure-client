...
`func (o *BucketReplicaLink) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *BucketReplicaLink) GetContextOk() (*FixedReference, bool)`
...
`func (o *BucketReplicaLink) SetContext(v FixedReference)`

SetContext sets Context field to given value.

### HasContext

`func (o *BucketReplicaLink) HasContext() bool`
