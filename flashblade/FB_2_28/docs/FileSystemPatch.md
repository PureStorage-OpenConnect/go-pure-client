...
**AbortQuiesce** | Pointer to **bool** | This parameter must be set to &#x60;true&#x60; while trying to abort a planned failover and force promote a file system. This will cancel any on-going data transfer and the file system will transition to &#x60;promoted&#x60; state.  | [optional] 
...
**SkipQuiesce** | Pointer to **bool** | This parameter must be set to &#x60;true&#x60; while trying to skip a planned failover and force demote a file system. This will cancel any on-going data transfer and the file system will transition to &#x60;demoted&#x60; state.  | [optional] 
...
`func (o *FileSystemPatch) GetAbortQuiesce() bool`

GetAbortQuiesce returns the AbortQuiesce field if non-nil, zero value otherwise.

### GetAbortQuiesceOk

`func (o *FileSystemPatch) GetAbortQuiesceOk() (*bool, bool)`

GetAbortQuiesceOk returns a tuple with the AbortQuiesce field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAbortQuiesce

`func (o *FileSystemPatch) SetAbortQuiesce(v bool)`

SetAbortQuiesce sets AbortQuiesce field to given value.

### HasAbortQuiesce

`func (o *FileSystemPatch) HasAbortQuiesce() bool`

HasAbortQuiesce returns a boolean if a field has been set.
...
`func (o *FileSystemPatch) GetQuiesce() bool`

GetQuiesce returns the Quiesce field if non-nil, zero value otherwise.

### GetQuiesceOk

`func (o *FileSystemPatch) GetQuiesceOk() (*bool, bool)`
...
`func (o *FileSystemPatch) SetQuiesce(v bool)`

SetQuiesce sets Quiesce field to given value.

### HasQuiesce

`func (o *FileSystemPatch) HasQuiesce() bool`
...
`func (o *FileSystemPatch) GetSkipQuiesce() bool`

GetSkipQuiesce returns the SkipQuiesce field if non-nil, zero value otherwise.

### GetSkipQuiesceOk

`func (o *FileSystemPatch) GetSkipQuiesceOk() (*bool, bool)`

GetSkipQuiesceOk returns a tuple with the SkipQuiesce field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetSkipQuiesce

`func (o *FileSystemPatch) SetSkipQuiesce(v bool)`

SetSkipQuiesce sets SkipQuiesce field to given value.

### HasSkipQuiesce

`func (o *FileSystemPatch) HasSkipQuiesce() bool`

HasSkipQuiesce returns a boolean if a field has been set.
...
`func (o *FileSystemPatch) GetWorkload() WorkloadConfigurationReferencePatch`

GetWorkload returns the Workload field if non-nil, zero value otherwise.

### GetWorkloadOk

`func (o *FileSystemPatch) GetWorkloadOk() (*WorkloadConfigurationReferencePatch, bool)`
...
`func (o *FileSystemPatch) SetWorkload(v WorkloadConfigurationReferencePatch)`

SetWorkload sets Workload field to given value.

### HasWorkload

`func (o *FileSystemPatch) HasWorkload() bool`
