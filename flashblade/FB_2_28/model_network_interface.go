...
type NetworkInterface struct {
	...
	// List of servers that are using this interface for data ingress.
	AttachedServers []Reference `json:"attached_servers,omitempty"`
	// Indicates if the specified network interface is enabled (`true`) or disabled (`false`).
	...
	// If (`true`) indicated that RDMA is enabled on the network interface. If (`false`), RDMA is disabled on the network interface.
