...
type Audit struct {
	...
	// A unique identifier that connects user-triggered system actions to the user action that caused them. User actions that do not trigger other actions will not have a correlation ID.
	...
	Scopes     []FixedReference `json:"scopes,omitempty"`
	Subcommand *string          `json:"subcommand,omitempty"`
	// If true, then this audit record represents a system-initiated event. If false, it represents an event invoked directly by a user.
...
// SetScopes gets a reference to the given []FixedReference and assigns it to the Scopes field.
...
// SetSystemEvent gets a reference to the given bool and assigns it to the SystemEvent field.
