...
// checks if the FileSessionGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileSessionGetResponse{}

// FileSessionGetResponse struct for FileSessionGetResponse
...
func (o FileSessionGetResponse) MarshalJSON() ([]byte, error) {
...
func (o FileSessionGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFileSessionGetResponse struct {
	value *FileSessionGetResponse
	isSet bool
}

func (v NullableFileSessionGetResponse) Get() *FileSessionGetResponse {
	return v.value
}

func (v *NullableFileSessionGetResponse) Set(val *FileSessionGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileSessionGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileSessionGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileSessionGetResponse(val *FileSessionGetResponse) *NullableFileSessionGetResponse {
	return &NullableFileSessionGetResponse{value: val, isSet: true}
}

func (v NullableFileSessionGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileSessionGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
