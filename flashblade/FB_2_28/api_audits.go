...
func (r APIAuditsGetRequest) AuthorizationHeader(authorizationHeader string) APIAuditsGetRequest {
...
func (a *AuditsAPIService) AuditsGetExecute(r APIAuditsGetRequest) (*AuditGetResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/2.28/audits"
