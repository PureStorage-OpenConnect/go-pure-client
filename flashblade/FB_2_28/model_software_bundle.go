...
type SoftwareBundle struct {
	...
	// The detailed reason for the `status`. This field gets updated in real time independent of the `status`. It can be updated multiple times for the same `status`.
	...
	// The status of the software bundle. Valid values are `downloading`, `failed`, `ready`, and `verifying`. A status of `downloading` indicates that the appliance is downloading the upgrade bundle. A status of `failed` indicates that the appliance has failed to download the upgrade bundle. A status of `ready` indicates that the upgrade bundle is ready to be installed. A status of `verifying` indicates that the appliance is verifying the upgrade bundle.
