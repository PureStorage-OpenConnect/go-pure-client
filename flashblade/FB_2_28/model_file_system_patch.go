...
type FileSystemPatch struct {
	...
	// This parameter must be set to `true` while trying to abort a planned failover and force promote a file system. This will cancel any on-going data transfer and the file system will transition to `promoted` state.
	AbortQuiesce *bool `json:"abort_quiesce,omitempty"`
	...
	// This parameter must be set to `true` while trying to skip a planned failover and force demote a file system. This will cancel any on-going data transfer and the file system will transition to `demoted` state.
	SkipQuiesce *bool `json:"skip_quiesce,omitempty"`
	// SMB configuration.
	...
	Workload      *WorkloadConfigurationReferencePatch `json:"workload,omitempty"`
...
// GetAbortQuiesce returns the AbortQuiesce field value if set, zero value otherwise.
func (o *FileSystemPatch) GetAbortQuiesce() bool {
	if o == nil || IsNil(o.AbortQuiesce) {
		var ret bool
		return ret
	}
	return *o.AbortQuiesce
}

// GetAbortQuiesceOk returns a tuple with the AbortQuiesce field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FileSystemPatch) GetAbortQuiesceOk() (*bool, bool) {
	if o == nil || IsNil(o.AbortQuiesce) {
		return nil, false
	}
	return o.AbortQuiesce, true
}
...
// SetAbortQuiesce gets a reference to the given bool and assigns it to the AbortQuiesce field.
...
// SetQosPolicy gets a reference to the given Reference and assigns it to the QosPolicy field.
...
// GetSkipQuiesce returns the SkipQuiesce field value if set, zero value otherwise.
func (o *FileSystemPatch) GetSkipQuiesce() bool {
	if o == nil || IsNil(o.SkipQuiesce) {
		var ret bool
		return ret
	}
	return *o.SkipQuiesce
}

// GetSkipQuiesceOk returns a tuple with the SkipQuiesce field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FileSystemPatch) GetSkipQuiesceOk() (*bool, bool) {
	if o == nil || IsNil(o.SkipQuiesce) {
		return nil, false
	}
	return o.SkipQuiesce, true
}
...
// SetSkipQuiesce gets a reference to the given bool and assigns it to the SkipQuiesce field.
...
func (o *FileSystemPatch) GetWorkload() WorkloadConfigurationReferencePatch {
	if o == nil || IsNil(o.Workload) {
		var ret WorkloadConfigurationReferencePatch
		return ret
	}
	return *o.Workload
}
...
// SetWorkload gets a reference to the given WorkloadConfigurationReferencePatch and assigns it to the Workload field.
...
func (o FileSystemPatch) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AbortQuiesce) {
		toSerialize["abort_quiesce"] = o.AbortQuiesce
	}
	if !IsNil(o.Created) {
	...
	if !IsNil(o.SkipQuiesce) {
		toSerialize["skip_quiesce"] = o.SkipQuiesce
	}
	if !IsNil(o.Smb) {
