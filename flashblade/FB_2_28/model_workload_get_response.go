...
// checks if the WorkloadGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkloadGetResponse{}

// WorkloadGetResponse struct for WorkloadGetResponse
...
func (o WorkloadGetResponse) MarshalJSON() ([]byte, error) {
...
func (o WorkloadGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableWorkloadGetResponse struct {
	value *WorkloadGetResponse
	isSet bool
}

func (v NullableWorkloadGetResponse) Get() *WorkloadGetResponse {
	return v.value
}

func (v *NullableWorkloadGetResponse) Set(val *WorkloadGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkloadGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkloadGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkloadGetResponse(val *WorkloadGetResponse) *NullableWorkloadGetResponse {
	return &NullableWorkloadGetResponse{value: val, isSet: true}
}

func (v NullableWorkloadGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkloadGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
