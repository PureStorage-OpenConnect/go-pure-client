...
------------- | ------------- | -------------
[**BucketReplicaLinksDelete**](BucketReplicaLinksAPI.md#BucketReplicaLinksDelete) | **Delete** /api/2.21/bucket-replica-links | DELETE bucket-replica-links
[**BucketReplicaLinksGet**](BucketReplicaLinksAPI.md#BucketReplicaLinksGet) | **Get** /api/2.21/bucket-replica-links | GET bucket-replica-links
[**BucketReplicaLinksPatch**](BucketReplicaLinksAPI.md#BucketReplicaLinksPatch) | **Patch** /api/2.21/bucket-replica-links | PATCH bucket-replica-links
[**BucketReplicaLinksPost**](BucketReplicaLinksAPI.md#BucketReplicaLinksPost) | **Post** /api/2.21/bucket-replica-links | POST bucket-replica-links
