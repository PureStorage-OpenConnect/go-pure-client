...
------------- | ------------- | -------------
[**NodesBatchPost**](NodesAPI.md#NodesBatchPost) | **Post** /api/2.21/nodes/batch | POST nodes/batch
[**NodesGet**](NodesAPI.md#NodesGet) | **Get** /api/2.21/nodes | GET nodes
[**NodesPatch**](NodesAPI.md#NodesPatch) | **Patch** /api/2.21/nodes | PATCH nodes



## NodesBatchPost

> NodeResponse NodesBatchPost(ctx).Items(items).XRequestID(xRequestID).Execute()
