...
------------- | ------------- | -------------
[**NetworkAccessPoliciesGet**](PoliciesNetworkAccessAPI.md#NetworkAccessPoliciesGet) | **Get** /api/2.21/network-access-policies | GET network-access-policies
[**NetworkAccessPoliciesMembersGet**](PoliciesNetworkAccessAPI.md#NetworkAccessPoliciesMembersGet) | **Get** /api/2.21/network-access-policies/members | GET network-access-policies/members
[**NetworkAccessPoliciesPatch**](PoliciesNetworkAccessAPI.md#NetworkAccessPoliciesPatch) | **Patch** /api/2.21/network-access-policies | PATCH network-access-policies
[**NetworkAccessPoliciesRulesDelete**](PoliciesNetworkAccessAPI.md#NetworkAccessPoliciesRulesDelete) | **Delete** /api/2.21/network-access-policies/rules | DELETE network-access-policies/rules
[**NetworkAccessPoliciesRulesGet**](PoliciesNetworkAccessAPI.md#NetworkAccessPoliciesRulesGet) | **Get** /api/2.21/network-access-policies/rules | GET network-access-policies/rules
[**NetworkAccessPoliciesRulesPatch**](PoliciesNetworkAccessAPI.md#NetworkAccessPoliciesRulesPatch) | **Patch** /api/2.21/network-access-policies/rules | PATCH network-access-policies/rules
[**NetworkAccessPoliciesRulesPost**](PoliciesNetworkAccessAPI.md#NetworkAccessPoliciesRulesPost) | **Post** /api/2.21/network-access-policies/rules | POST network-access-policies/rules
