...
type FleetMember struct {
	...
	CoordinatorOf []FixedReference           `json:"coordinator_of,omitempty"`
...
// SetCoordinatorOf gets a reference to the given []FixedReference and assigns it to the CoordinatorOf field.
...
// SetMember gets a reference to the given FixedReferenceWithIsLocal and assigns it to the Member field.
