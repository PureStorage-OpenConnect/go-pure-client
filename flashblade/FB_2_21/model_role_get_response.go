...
// checks if the RoleGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleGetResponse{}

// RoleGetResponse struct for RoleGetResponse
...
func (o RoleGetResponse) MarshalJSON() ([]byte, error) {
...
func (o RoleGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRoleGetResponse struct {
	value *RoleGetResponse
	isSet bool
}

func (v NullableRoleGetResponse) Get() *RoleGetResponse {
	return v.value
}

func (v *NullableRoleGetResponse) Set(val *RoleGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRoleGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRoleGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoleGetResponse(val *RoleGetResponse) *NullableRoleGetResponse {
	return &NullableRoleGetResponse{value: val, isSet: true}
}

func (v NullableRoleGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoleGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
