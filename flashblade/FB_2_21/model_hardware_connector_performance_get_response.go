...
// checks if the HardwareConnectorPerformanceGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HardwareConnectorPerformanceGetResponse{}

// HardwareConnectorPerformanceGetResponse struct for HardwareConnectorPerformanceGetResponse
...
func NewHardwareConnectorPerformanceGetResponse() *HardwareConnectorPerformanceGetResponse {
	this := HardwareConnectorPerformanceGetResponse{}
	return &this
}
...
func (o *HardwareConnectorPerformanceGetResponse) GetItems() []HardwareConnectorPerformance {
	if o == nil || IsNil(o.Items) {
		var ret []HardwareConnectorPerformance
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []HardwareConnectorPerformance and assigns it to the Items field.
...
// SetTotal gets a reference to the given []HardwareConnectorPerformance and assigns it to the Total field.
func (o *HardwareConnectorPerformanceGetResponse) SetTotal(v []HardwareConnectorPerformance) {
	o.Total = v
}

func (o HardwareConnectorPerformanceGetResponse) MarshalJSON() ([]byte, error) {
...
func (o HardwareConnectorPerformanceGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableHardwareConnectorPerformanceGetResponse struct {
	value *HardwareConnectorPerformanceGetResponse
	isSet bool
}

func (v NullableHardwareConnectorPerformanceGetResponse) Get() *HardwareConnectorPerformanceGetResponse {
	return v.value
}

func (v *NullableHardwareConnectorPerformanceGetResponse) Set(val *HardwareConnectorPerformanceGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHardwareConnectorPerformanceGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHardwareConnectorPerformanceGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHardwareConnectorPerformanceGetResponse(val *HardwareConnectorPerformanceGetResponse) *NullableHardwareConnectorPerformanceGetResponse {
	return &NullableHardwareConnectorPerformanceGetResponse{value: val, isSet: true}
}

func (v NullableHardwareConnectorPerformanceGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHardwareConnectorPerformanceGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
