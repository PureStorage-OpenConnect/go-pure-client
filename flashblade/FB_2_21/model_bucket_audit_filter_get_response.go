...
// checks if the BucketAuditFilterGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BucketAuditFilterGetResponse{}

// BucketAuditFilterGetResponse struct for BucketAuditFilterGetResponse
type BucketAuditFilterGetResponse struct {
...
func NewBucketAuditFilterGetResponse() *BucketAuditFilterGetResponse {
	this := BucketAuditFilterGetResponse{}
	return &this
}
...
func (o BucketAuditFilterGetResponse) MarshalJSON() ([]byte, error) {
...
func (o BucketAuditFilterGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableBucketAuditFilterGetResponse struct {
	value *BucketAuditFilterGetResponse
	isSet bool
}

func (v NullableBucketAuditFilterGetResponse) Get() *BucketAuditFilterGetResponse {
	return v.value
}

func (v *NullableBucketAuditFilterGetResponse) Set(val *BucketAuditFilterGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBucketAuditFilterGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBucketAuditFilterGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBucketAuditFilterGetResponse(val *BucketAuditFilterGetResponse) *NullableBucketAuditFilterGetResponse {
	return &NullableBucketAuditFilterGetResponse{value: val, isSet: true}
}

func (v NullableBucketAuditFilterGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBucketAuditFilterGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
