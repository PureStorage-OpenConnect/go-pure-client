...
// checks if the FileSystemReplicaLinkGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileSystemReplicaLinkGetResponse{}

// FileSystemReplicaLinkGetResponse struct for FileSystemReplicaLinkGetResponse
...
func NewFileSystemReplicaLinkGetResponse() *FileSystemReplicaLinkGetResponse {
	this := FileSystemReplicaLinkGetResponse{}
	return &this
}
...
func (o FileSystemReplicaLinkGetResponse) MarshalJSON() ([]byte, error) {
...
func (o FileSystemReplicaLinkGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFileSystemReplicaLinkGetResponse struct {
	value *FileSystemReplicaLinkGetResponse
	isSet bool
}

func (v NullableFileSystemReplicaLinkGetResponse) Get() *FileSystemReplicaLinkGetResponse {
	return v.value
}

func (v *NullableFileSystemReplicaLinkGetResponse) Set(val *FileSystemReplicaLinkGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileSystemReplicaLinkGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileSystemReplicaLinkGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileSystemReplicaLinkGetResponse(val *FileSystemReplicaLinkGetResponse) *NullableFileSystemReplicaLinkGetResponse {
	return &NullableFileSystemReplicaLinkGetResponse{value: val, isSet: true}
}

func (v NullableFileSystemReplicaLinkGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileSystemReplicaLinkGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
