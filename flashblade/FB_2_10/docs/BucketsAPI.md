...
------------- | ------------- | -------------
[**BucketsDelete**](BucketsAPI.md#BucketsDelete) | **Delete** /api/2.10/buckets | DELETE buckets
[**BucketsGet**](BucketsAPI.md#BucketsGet) | **Get** /api/2.10/buckets | GET buckets
[**BucketsPatch**](BucketsAPI.md#BucketsPatch) | **Patch** /api/2.10/buckets | PATCH buckets
[**BucketsPerformanceGet**](BucketsAPI.md#BucketsPerformanceGet) | **Get** /api/2.10/buckets/performance | GET buckets/performance
[**BucketsPost**](BucketsAPI.md#BucketsPost) | **Post** /api/2.10/buckets | POST buckets
[**BucketsS3SpecificPerformanceGet**](BucketsAPI.md#BucketsS3SpecificPerformanceGet) | **Get** /api/2.10/buckets/s3-specific-performance | GET buckets/s3-specific-performance
