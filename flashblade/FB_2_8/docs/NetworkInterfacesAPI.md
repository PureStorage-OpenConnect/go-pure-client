...
------------- | ------------- | -------------
[**NetworkInterfacesDelete**](NetworkInterfacesAPI.md#NetworkInterfacesDelete) | **Delete** /api/2.8/network-interfaces | DELETE network-interfaces
[**NetworkInterfacesGet**](NetworkInterfacesAPI.md#NetworkInterfacesGet) | **Get** /api/2.8/network-interfaces | GET network-interfaces
[**NetworkInterfacesPatch**](NetworkInterfacesAPI.md#NetworkInterfacesPatch) | **Patch** /api/2.8/network-interfaces | PATCH network-interfaces
[**NetworkInterfacesPingGet**](NetworkInterfacesAPI.md#NetworkInterfacesPingGet) | **Get** /api/2.8/network-interfaces/ping | GET network-interfaces/ping
[**NetworkInterfacesPost**](NetworkInterfacesAPI.md#NetworkInterfacesPost) | **Post** /api/2.8/network-interfaces | POST network-interfaces
[**NetworkInterfacesTraceGet**](NetworkInterfacesAPI.md#NetworkInterfacesTraceGet) | **Get** /api/2.8/network-interfaces/trace | GET network-interfaces/trace
...
import (
    ...
    "fmt"
    "os"
    openapiclient "github.com/PureStorage-OpenConnect/go-pure-client/flashblade/FB_2_8"
)
