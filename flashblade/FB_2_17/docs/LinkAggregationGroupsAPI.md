...
------------- | ------------- | -------------
[**LinkAggregationGroupsDelete**](LinkAggregationGroupsAPI.md#LinkAggregationGroupsDelete) | **Delete** /api/2.17/link-aggregation-groups | DELETE link-aggregation-groups
[**LinkAggregationGroupsGet**](LinkAggregationGroupsAPI.md#LinkAggregationGroupsGet) | **Get** /api/2.17/link-aggregation-groups | GET link-aggregation-groups
[**LinkAggregationGroupsPatch**](LinkAggregationGroupsAPI.md#LinkAggregationGroupsPatch) | **Patch** /api/2.17/link-aggregation-groups | PATCH link-aggregation-groups
[**LinkAggregationGroupsPost**](LinkAggregationGroupsAPI.md#LinkAggregationGroupsPost) | **Post** /api/2.17/link-aggregation-groups | POST link-aggregation-groups



## LinkAggregationGroupsDelete

> LinkAggregationGroupsDelete(ctx).XRequestID(xRequestID).Ids(ids).Names(names).Execute()
...
> LinkAggregationGroupGetResponse LinkAggregationGroupsGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> LinkAggregationGroupResponse LinkAggregationGroupsPatch(ctx).XRequestID(xRequestID).Ids(ids).Names(names).LinkAggregationGroup(linkAggregationGroup).Execute()
...
> LinkAggregationGroupResponse LinkAggregationGroupsPost(ctx).Names(names).LinkAggregationGroup(linkAggregationGroup).XRequestID(xRequestID).Execute()
