...
**BytesPerOp** | Pointer to **float64** | Average operation size (read bytes+write bytes/read ops+write ops).  | [optional] 
**BytesPerRead** | Pointer to **float64** | Average read size in bytes per read operation. | [optional] 
**BytesPerWrite** | Pointer to **float64** | Average write size in bytes per write operation. | [optional] 
**OthersPerSec** | Pointer to **float64** | Other operations processed per second. | [optional] 
**ReadBytesPerSec** | Pointer to **float64** | Bytes read per second. | [optional] 
...
**WriteBytesPerSec** | Pointer to **float64** | Bytes written per second. | [optional] 
