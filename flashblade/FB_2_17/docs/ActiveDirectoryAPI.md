...
------------- | ------------- | -------------
[**ActiveDirectoryDelete**](ActiveDirectoryAPI.md#ActiveDirectoryDelete) | **Delete** /api/2.17/active-directory | DELETE active-directory
[**ActiveDirectoryGet**](ActiveDirectoryAPI.md#ActiveDirectoryGet) | **Get** /api/2.17/active-directory | GET active-directory
[**ActiveDirectoryPatch**](ActiveDirectoryAPI.md#ActiveDirectoryPatch) | **Patch** /api/2.17/active-directory | PATCH active-directory
[**ActiveDirectoryPost**](ActiveDirectoryAPI.md#ActiveDirectoryPost) | **Post** /api/2.17/active-directory | POST active-directory
[**ActiveDirectoryTestGet**](ActiveDirectoryAPI.md#ActiveDirectoryTestGet) | **Get** /api/2.17/active-directory/test | GET active-directory/test
