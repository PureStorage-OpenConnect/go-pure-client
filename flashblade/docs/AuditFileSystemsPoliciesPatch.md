...
`func (o *AuditFileSystemsPoliciesPatch) GetControlType() string`

GetControlType returns the ControlType field if non-nil, zero value otherwise.

### GetControlTypeOk

`func (o *AuditFileSystemsPoliciesPatch) GetControlTypeOk() (*string, bool)`
...
`func (o *AuditFileSystemsPoliciesPatch) SetControlType(v string)`

SetControlType sets ControlType field to given value.

### HasControlType

`func (o *AuditFileSystemsPoliciesPatch) HasControlType() bool`
