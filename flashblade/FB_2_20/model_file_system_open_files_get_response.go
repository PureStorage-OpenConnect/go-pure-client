...
// checks if the FileSystemOpenFilesGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileSystemOpenFilesGetResponse{}

// FileSystemOpenFilesGetResponse struct for FileSystemOpenFilesGetResponse
...
func NewFileSystemOpenFilesGetResponse() *FileSystemOpenFilesGetResponse {
	this := FileSystemOpenFilesGetResponse{}
	return &this
}
...
func (o FileSystemOpenFilesGetResponse) MarshalJSON() ([]byte, error) {
...
func (o FileSystemOpenFilesGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFileSystemOpenFilesGetResponse struct {
	value *FileSystemOpenFilesGetResponse
	isSet bool
}

func (v NullableFileSystemOpenFilesGetResponse) Get() *FileSystemOpenFilesGetResponse {
	return v.value
}

func (v *NullableFileSystemOpenFilesGetResponse) Set(val *FileSystemOpenFilesGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileSystemOpenFilesGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileSystemOpenFilesGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileSystemOpenFilesGetResponse(val *FileSystemOpenFilesGetResponse) *NullableFileSystemOpenFilesGetResponse {
	return &NullableFileSystemOpenFilesGetResponse{value: val, isSet: true}
}

func (v NullableFileSystemOpenFilesGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileSystemOpenFilesGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
