...
// checks if the SmbSharePolicyPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmbSharePolicyPost{}

// SmbSharePolicyPost struct for SmbSharePolicyPost
...
func (o *SmbSharePolicyPost) GetRules() []SmbSharePolicyRulePost {
	if o == nil || IsNil(o.Rules) {
		var ret []SmbSharePolicyRulePost
		return ret
	}
	return o.Rules
}
...
// SetRules gets a reference to the given []SmbSharePolicyRulePost and assigns it to the Rules field.
func (o *SmbSharePolicyPost) SetRules(v []SmbSharePolicyRulePost) {
	o.Rules = v
}

func (o SmbSharePolicyPost) MarshalJSON() ([]byte, error) {
...
func (o SmbSharePolicyPost) ToMap() (map[string]interface{}, error) {
...
type NullableSmbSharePolicyPost struct {
	value *SmbSharePolicyPost
	isSet bool
}

func (v NullableSmbSharePolicyPost) Get() *SmbSharePolicyPost {
	return v.value
}

func (v *NullableSmbSharePolicyPost) Set(val *SmbSharePolicyPost) {
	v.value = val
	v.isSet = true
}

func (v NullableSmbSharePolicyPost) IsSet() bool {
	return v.isSet
}

func (v *NullableSmbSharePolicyPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmbSharePolicyPost(val *SmbSharePolicyPost) *NullableSmbSharePolicyPost {
	return &NullableSmbSharePolicyPost{value: val, isSet: true}
}

func (v NullableSmbSharePolicyPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmbSharePolicyPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
