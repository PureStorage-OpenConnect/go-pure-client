...
// checks if the AuditObjectStorePoliciesPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditObjectStorePoliciesPatch{}

// AuditObjectStorePoliciesPatch struct for AuditObjectStorePoliciesPatch
type AuditObjectStorePoliciesPatch struct {
...
func NewAuditObjectStorePoliciesPatch() *AuditObjectStorePoliciesPatch {
	this := AuditObjectStorePoliciesPatch{}
	return &this
}
...
func (o AuditObjectStorePoliciesPatch) MarshalJSON() ([]byte, error) {
...
func (o AuditObjectStorePoliciesPatch) ToMap() (map[string]interface{}, error) {
...
type NullableAuditObjectStorePoliciesPatch struct {
	value *AuditObjectStorePoliciesPatch
	isSet bool
}

func (v NullableAuditObjectStorePoliciesPatch) Get() *AuditObjectStorePoliciesPatch {
	return v.value
}

func (v *NullableAuditObjectStorePoliciesPatch) Set(val *AuditObjectStorePoliciesPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditObjectStorePoliciesPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditObjectStorePoliciesPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditObjectStorePoliciesPatch(val *AuditObjectStorePoliciesPatch) *NullableAuditObjectStorePoliciesPatch {
	return &NullableAuditObjectStorePoliciesPatch{value: val, isSet: true}
}

func (v NullableAuditObjectStorePoliciesPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditObjectStorePoliciesPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
