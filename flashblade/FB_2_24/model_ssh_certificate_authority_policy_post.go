...
// checks if the SshCertificateAuthorityPolicyPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshCertificateAuthorityPolicyPost{}

// SshCertificateAuthorityPolicyPost struct for SshCertificateAuthorityPolicyPost
...
func NewSshCertificateAuthorityPolicyPost() *SshCertificateAuthorityPolicyPost {
	this := SshCertificateAuthorityPolicyPost{}
	return &this
}
...
func (o SshCertificateAuthorityPolicyPost) MarshalJSON() ([]byte, error) {
...
func (o SshCertificateAuthorityPolicyPost) ToMap() (map[string]interface{}, error) {
...
type NullableSshCertificateAuthorityPolicyPost struct {
	value *SshCertificateAuthorityPolicyPost
	isSet bool
}

func (v NullableSshCertificateAuthorityPolicyPost) Get() *SshCertificateAuthorityPolicyPost {
	return v.value
}

func (v *NullableSshCertificateAuthorityPolicyPost) Set(val *SshCertificateAuthorityPolicyPost) {
	v.value = val
	v.isSet = true
}

func (v NullableSshCertificateAuthorityPolicyPost) IsSet() bool {
	return v.isSet
}

func (v *NullableSshCertificateAuthorityPolicyPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshCertificateAuthorityPolicyPost(val *SshCertificateAuthorityPolicyPost) *NullableSshCertificateAuthorityPolicyPost {
	return &NullableSshCertificateAuthorityPolicyPost{value: val, isSet: true}
}

func (v NullableSshCertificateAuthorityPolicyPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshCertificateAuthorityPolicyPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
