...
// checks if the S3ExportPolicyRuleGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3ExportPolicyRuleGetResponse{}

// S3ExportPolicyRuleGetResponse struct for S3ExportPolicyRuleGetResponse
type S3ExportPolicyRuleGetResponse struct {
...
func NewS3ExportPolicyRuleGetResponse() *S3ExportPolicyRuleGetResponse {
	this := S3ExportPolicyRuleGetResponse{}
	return &this
}
...
func (o S3ExportPolicyRuleGetResponse) MarshalJSON() ([]byte, error) {
...
func (o S3ExportPolicyRuleGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableS3ExportPolicyRuleGetResponse struct {
	value *S3ExportPolicyRuleGetResponse
	isSet bool
}

func (v NullableS3ExportPolicyRuleGetResponse) Get() *S3ExportPolicyRuleGetResponse {
	return v.value
}

func (v *NullableS3ExportPolicyRuleGetResponse) Set(val *S3ExportPolicyRuleGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableS3ExportPolicyRuleGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableS3ExportPolicyRuleGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableS3ExportPolicyRuleGetResponse(val *S3ExportPolicyRuleGetResponse) *NullableS3ExportPolicyRuleGetResponse {
	return &NullableS3ExportPolicyRuleGetResponse{value: val, isSet: true}
}

func (v NullableS3ExportPolicyRuleGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableS3ExportPolicyRuleGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
