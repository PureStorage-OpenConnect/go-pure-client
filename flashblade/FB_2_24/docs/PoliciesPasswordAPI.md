...
------------- | ------------- | -------------
[**PasswordPoliciesGet**](PoliciesPasswordAPI.md#PasswordPoliciesGet) | **Get** /api/2.24/password-policies | List password policies
[**PasswordPoliciesPatch**](PoliciesPasswordAPI.md#PasswordPoliciesPatch) | **Patch** /api/2.24/password-policies | Modify password policies
