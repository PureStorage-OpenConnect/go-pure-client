...
**PeriodicReplicationConfigurations** | Pointer to **[]string** | The preset periodic replication configurations in which this array should be used.  | [optional] 
**PlacementConfigurations** | Pointer to **[]string** | The preset placement configurations in which this array should be used.  | [optional] 
