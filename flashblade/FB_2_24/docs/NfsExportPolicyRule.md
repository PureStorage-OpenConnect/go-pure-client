...
`func (o *NfsExportPolicyRule) GetAnongid() int64`

GetAnongid returns the Anongid field if non-nil, zero value otherwise.

### GetAnongidOk

`func (o *NfsExportPolicyRule) GetAnongidOk() (*int64, bool)`
...
`func (o *NfsExportPolicyRule) SetAnongid(v int64)`
...
`func (o *NfsExportPolicyRule) GetAnonuid() int64`

GetAnonuid returns the Anonuid field if non-nil, zero value otherwise.

### GetAnonuidOk

`func (o *NfsExportPolicyRule) GetAnonuidOk() (*int64, bool)`
...
`func (o *NfsExportPolicyRule) SetAnonuid(v int64)`
