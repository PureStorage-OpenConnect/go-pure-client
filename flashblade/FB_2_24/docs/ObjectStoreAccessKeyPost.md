...
------------ | ------------- | ------------- | -------------
**SecretAccessKey** | Pointer to **string** | The secret access key to import from another FlashBlade. To import a set of credentials, this field must be specified with the &#x60;names&#x60; query parameter where the &#x60;names&#x60; includes prefix of the realm where the user lives. If both of these are not specified, the system will generate a new set of credentials.  | [optional] 
