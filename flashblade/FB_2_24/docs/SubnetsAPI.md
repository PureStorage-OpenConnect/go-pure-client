...
------------- | ------------- | -------------
[**SubnetsDelete**](SubnetsAPI.md#SubnetsDelete) | **Delete** /api/2.24/subnets | DELETE subnets
[**SubnetsGet**](SubnetsAPI.md#SubnetsGet) | **Get** /api/2.24/subnets | GET subnets
[**SubnetsPatch**](SubnetsAPI.md#SubnetsPatch) | **Patch** /api/2.24/subnets | PATCH subnets
[**SubnetsPost**](SubnetsAPI.md#SubnetsPost) | **Post** /api/2.24/subnets | POST subnets



## SubnetsDelete

> SubnetsDelete(ctx).XRequestID(xRequestID).Ids(ids).Names(names).Execute()
...
> SubnetGetResponse SubnetsGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> SubnetResponse SubnetsPatch(ctx).Subnet(subnet).XRequestID(xRequestID).Ids(ids).Names(names).Execute()
...
> SubnetResponse SubnetsPost(ctx).Names(names).Subnet(subnet).XRequestID(xRequestID).Execute()
