...
------------- | ------------- | -------------
[**AdminsAPITokensDelete**](AdministratorsAPI.md#AdminsAPITokensDelete) | **Delete** /api/2.24/admins/api-tokens | DELETE admins/api-tokens
[**AdminsAPITokensGet**](AdministratorsAPI.md#AdminsAPITokensGet) | **Get** /api/2.24/admins/api-tokens | GET admins/api-tokens
[**AdminsAPITokensPost**](AdministratorsAPI.md#AdminsAPITokensPost) | **Post** /api/2.24/admins/api-tokens | POST admins/api-tokens
[**AdminsCacheDelete**](AdministratorsAPI.md#AdminsCacheDelete) | **Delete** /api/2.24/admins/cache | DELETE admins/cache
[**AdminsCacheGet**](AdministratorsAPI.md#AdminsCacheGet) | **Get** /api/2.24/admins/cache | GET admins/cache
[**AdminsDelete**](AdministratorsAPI.md#AdminsDelete) | **Delete** /api/2.24/admins | DELETE admins
[**AdminsGet**](AdministratorsAPI.md#AdminsGet) | **Get** /api/2.24/admins | GET admins
[**AdminsPatch**](AdministratorsAPI.md#AdminsPatch) | **Patch** /api/2.24/admins | PATCH admins
[**AdminsPost**](AdministratorsAPI.md#AdminsPost) | **Post** /api/2.24/admins | POST admins
[**AdminsSettingsGet**](AdministratorsAPI.md#AdminsSettingsGet) | **Get** /api/2.24/admins/settings | List global admin settings
[**AdminsSettingsPatch**](AdministratorsAPI.md#AdminsSettingsPatch) | **Patch** /api/2.24/admins/settings | Update global admin settings



## AdminsAPITokensDelete

> AdminsAPITokensDelete(ctx).XRequestID(xRequestID).AdminIds(adminIds).AdminNames(adminNames).ContextNames(contextNames).Execute()
...
> AdminAPITokenGetResponse AdminsAPITokensGet(ctx).XRequestID(xRequestID).AdminIds(adminIds).AdminNames(adminNames).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).ExposeAPIToken(exposeAPIToken).Filter(filter).Limit(limit).Offset(offset).Sort(sort).Execute()
...
> AdminAPITokenResponse AdminsAPITokensPost(ctx).XRequestID(xRequestID).AdminIds(adminIds).AdminNames(adminNames).ContextNames(contextNames).Timeout(timeout).Execute()
...
> AdminsCacheDelete(ctx).XRequestID(xRequestID).ContextNames(contextNames).Ids(ids).Names(names).Execute()
...
> AdminCacheGetResponse AdminsCacheGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Refresh(refresh).Sort(sort).Execute()
...
> AdminsDelete(ctx).XRequestID(xRequestID).ContextNames(contextNames).Ids(ids).Names(names).Execute()
...
> AdminGetResponse AdminsGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).ExposeAPIToken(exposeAPIToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> AdminResponse AdminsPatch(ctx).Admin(admin).XRequestID(xRequestID).ContextNames(contextNames).Ids(ids).Names(names).Execute()
...
> AdminResponse AdminsPost(ctx).Admin(admin).XRequestID(xRequestID).ContextNames(contextNames).Names(names).Execute()
