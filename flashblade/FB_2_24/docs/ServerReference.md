...
`func (o *ServerReference) GetServer() FixedReference`

GetServer returns the Server field if non-nil, zero value otherwise.

### GetServerOk

`func (o *ServerReference) GetServerOk() (*FixedReference, bool)`
...
`func (o *ServerReference) SetServer(v FixedReference)`
