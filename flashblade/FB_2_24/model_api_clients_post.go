...
type ApiClientsPost struct {
	...
	AccessPolicies []ReferenceWritable `json:"access_policies,omitempty"`
	...
	MaxRole *ReferenceWritable `json:"max_role,omitempty"`
...
// SetAccessPolicies gets a reference to the given []ReferenceWritable and assigns it to the AccessPolicies field.
...
// SetMaxRole gets a reference to the given ReferenceWritable and assigns it to the MaxRole field.
