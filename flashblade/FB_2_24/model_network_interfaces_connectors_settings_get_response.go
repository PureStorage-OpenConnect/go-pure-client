...
// checks if the NetworkInterfacesConnectorsSettingsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkInterfacesConnectorsSettingsGetResponse{}

// NetworkInterfacesConnectorsSettingsGetResponse struct for NetworkInterfacesConnectorsSettingsGetResponse
...
func NewNetworkInterfacesConnectorsSettingsGetResponse() *NetworkInterfacesConnectorsSettingsGetResponse {
	this := NetworkInterfacesConnectorsSettingsGetResponse{}
	return &this
}
...
func (o *NetworkInterfacesConnectorsSettingsGetResponse) GetItems() []NetworkInterfacesConnectorsSetting {
	if o == nil || IsNil(o.Items) {
		var ret []NetworkInterfacesConnectorsSetting
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []NetworkInterfacesConnectorsSetting and assigns it to the Items field.
func (o *NetworkInterfacesConnectorsSettingsGetResponse) SetItems(v []NetworkInterfacesConnectorsSetting) {
	o.Items = v
}

func (o NetworkInterfacesConnectorsSettingsGetResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworkInterfacesConnectorsSettingsGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkInterfacesConnectorsSettingsGetResponse struct {
	value *NetworkInterfacesConnectorsSettingsGetResponse
	isSet bool
}

func (v NullableNetworkInterfacesConnectorsSettingsGetResponse) Get() *NetworkInterfacesConnectorsSettingsGetResponse {
	return v.value
}

func (v *NullableNetworkInterfacesConnectorsSettingsGetResponse) Set(val *NetworkInterfacesConnectorsSettingsGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkInterfacesConnectorsSettingsGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkInterfacesConnectorsSettingsGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkInterfacesConnectorsSettingsGetResponse(val *NetworkInterfacesConnectorsSettingsGetResponse) *NullableNetworkInterfacesConnectorsSettingsGetResponse {
	return &NullableNetworkInterfacesConnectorsSettingsGetResponse{value: val, isSet: true}
}

func (v NullableNetworkInterfacesConnectorsSettingsGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkInterfacesConnectorsSettingsGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
