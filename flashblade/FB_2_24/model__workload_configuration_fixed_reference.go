...
// WorkloadConfigurationFixedReference A reference to the workload that is managing this resource. The `name` and `configuration` may show as the string \"(unknown)\" briefly after a failover.
