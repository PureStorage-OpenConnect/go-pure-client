...
// checks if the BladeGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BladeGetResponse{}

// BladeGetResponse struct for BladeGetResponse
...
// SetItems gets a reference to the given []Blade and assigns it to the Items field.
...
func (o BladeGetResponse) MarshalJSON() ([]byte, error) {
...
func (o BladeGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableBladeGetResponse struct {
	value *BladeGetResponse
	isSet bool
}

func (v NullableBladeGetResponse) Get() *BladeGetResponse {
	return v.value
}

func (v *NullableBladeGetResponse) Set(val *BladeGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBladeGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBladeGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBladeGetResponse(val *BladeGetResponse) *NullableBladeGetResponse {
	return &NullableBladeGetResponse{value: val, isSet: true}
}

func (v NullableBladeGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBladeGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
