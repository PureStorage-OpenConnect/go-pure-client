...
// checks if the LogTargetsFileSystemsPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogTargetsFileSystemsPost{}

// LogTargetsFileSystemsPost struct for LogTargetsFileSystemsPost
type LogTargetsFileSystemsPost struct {
...
func NewLogTargetsFileSystemsPost() *LogTargetsFileSystemsPost {
	this := LogTargetsFileSystemsPost{}
	return &this
}
...
func (o LogTargetsFileSystemsPost) MarshalJSON() ([]byte, error) {
...
func (o LogTargetsFileSystemsPost) ToMap() (map[string]interface{}, error) {
...
type NullableLogTargetsFileSystemsPost struct {
	value *LogTargetsFileSystemsPost
	isSet bool
}

func (v NullableLogTargetsFileSystemsPost) Get() *LogTargetsFileSystemsPost {
	return v.value
}

func (v *NullableLogTargetsFileSystemsPost) Set(val *LogTargetsFileSystemsPost) {
	v.value = val
	v.isSet = true
}

func (v NullableLogTargetsFileSystemsPost) IsSet() bool {
	return v.isSet
}

func (v *NullableLogTargetsFileSystemsPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogTargetsFileSystemsPost(val *LogTargetsFileSystemsPost) *NullableLogTargetsFileSystemsPost {
	return &NullableLogTargetsFileSystemsPost{value: val, isSet: true}
}

func (v NullableLogTargetsFileSystemsPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogTargetsFileSystemsPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
