...
// checks if the SshCertificateAuthorityPolicyGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshCertificateAuthorityPolicyGetResponse{}

// SshCertificateAuthorityPolicyGetResponse struct for SshCertificateAuthorityPolicyGetResponse
...
func NewSshCertificateAuthorityPolicyGetResponse() *SshCertificateAuthorityPolicyGetResponse {
	this := SshCertificateAuthorityPolicyGetResponse{}
	return &this
}
...
func (o SshCertificateAuthorityPolicyGetResponse) MarshalJSON() ([]byte, error) {
...
func (o SshCertificateAuthorityPolicyGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSshCertificateAuthorityPolicyGetResponse struct {
	value *SshCertificateAuthorityPolicyGetResponse
	isSet bool
}

func (v NullableSshCertificateAuthorityPolicyGetResponse) Get() *SshCertificateAuthorityPolicyGetResponse {
	return v.value
}

func (v *NullableSshCertificateAuthorityPolicyGetResponse) Set(val *SshCertificateAuthorityPolicyGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSshCertificateAuthorityPolicyGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSshCertificateAuthorityPolicyGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshCertificateAuthorityPolicyGetResponse(val *SshCertificateAuthorityPolicyGetResponse) *NullableSshCertificateAuthorityPolicyGetResponse {
	return &NullableSshCertificateAuthorityPolicyGetResponse{value: val, isSet: true}
}

func (v NullableSshCertificateAuthorityPolicyGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshCertificateAuthorityPolicyGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
