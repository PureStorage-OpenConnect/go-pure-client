...
type DirectoryServiceManagement struct {
	// SSH public key attribute in the structure of the configured LDAP servers. The attribute field holds the user's SSH public key. This attribute can represent a single-valued or multi-valued field. If this attribute resolves to a multi-valued field, all valid SSH keys will be used. If the user has specified keys under Admin endpoints, these are used as well.
...
// GetSshPublicKeyAttribute returns the SshPublicKeyAttribute field value if set, zero value otherwise.
func (o *DirectoryServiceManagement) GetSshPublicKeyAttribute() string {
	if o == nil || IsNil(o.SshPublicKeyAttribute) {
		var ret string
		return ret
	}
	return *o.SshPublicKeyAttribute
}

// GetSshPublicKeyAttributeOk returns a tuple with the SshPublicKeyAttribute field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DirectoryServiceManagement) GetSshPublicKeyAttributeOk() (*string, bool) {
	if o == nil || IsNil(o.SshPublicKeyAttribute) {
		return nil, false
	}
	return o.SshPublicKeyAttribute, true
}
...
// SetSshPublicKeyAttribute gets a reference to the given string and assigns it to the SshPublicKeyAttribute field.
func (o *DirectoryServiceManagement) SetSshPublicKeyAttribute(v string) {
	o.SshPublicKeyAttribute = &v
}
...
func (o DirectoryServiceManagement) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SshPublicKeyAttribute) {
		toSerialize["ssh_public_key_attribute"] = o.SshPublicKeyAttribute
	}
