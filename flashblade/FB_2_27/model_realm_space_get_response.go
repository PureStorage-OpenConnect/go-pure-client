...
// SetItems gets a reference to the given []RealmSpace and assigns it to the Items field.
...
// SetTotal gets a reference to the given []RealmSpace and assigns it to the Total field.
