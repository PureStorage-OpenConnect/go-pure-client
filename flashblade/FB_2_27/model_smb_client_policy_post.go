...
// checks if the SmbClientPolicyPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmbClientPolicyPost{}

// SmbClientPolicyPost struct for SmbClientPolicyPost
...
func (o *SmbClientPolicyPost) GetRules() []SmbClientPolicyRulePostInPolicy {
	if o == nil || IsNil(o.Rules) {
		var ret []SmbClientPolicyRulePostInPolicy
		return ret
	}
	return o.Rules
}
...
// SetRules gets a reference to the given []SmbClientPolicyRulePostInPolicy and assigns it to the Rules field.
func (o *SmbClientPolicyPost) SetRules(v []SmbClientPolicyRulePostInPolicy) {
	o.Rules = v
}

func (o SmbClientPolicyPost) MarshalJSON() ([]byte, error) {
...
func (o SmbClientPolicyPost) ToMap() (map[string]interface{}, error) {
...
type NullableSmbClientPolicyPost struct {
	value *SmbClientPolicyPost
	isSet bool
}

func (v NullableSmbClientPolicyPost) Get() *SmbClientPolicyPost {
	return v.value
}

func (v *NullableSmbClientPolicyPost) Set(val *SmbClientPolicyPost) {
	v.value = val
	v.isSet = true
}

func (v NullableSmbClientPolicyPost) IsSet() bool {
	return v.isSet
}

func (v *NullableSmbClientPolicyPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmbClientPolicyPost(val *SmbClientPolicyPost) *NullableSmbClientPolicyPost {
	return &NullableSmbClientPolicyPost{value: val, isSet: true}
}

func (v NullableSmbClientPolicyPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmbClientPolicyPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
