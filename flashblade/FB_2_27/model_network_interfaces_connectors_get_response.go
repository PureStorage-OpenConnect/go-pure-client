...
// checks if the NetworkInterfacesConnectorsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkInterfacesConnectorsGetResponse{}

// NetworkInterfacesConnectorsGetResponse struct for NetworkInterfacesConnectorsGetResponse
...
func NewNetworkInterfacesConnectorsGetResponse() *NetworkInterfacesConnectorsGetResponse {
	this := NetworkInterfacesConnectorsGetResponse{}
	return &this
}
...
func (o NetworkInterfacesConnectorsGetResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworkInterfacesConnectorsGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkInterfacesConnectorsGetResponse struct {
	value *NetworkInterfacesConnectorsGetResponse
	isSet bool
}

func (v NullableNetworkInterfacesConnectorsGetResponse) Get() *NetworkInterfacesConnectorsGetResponse {
	return v.value
}

func (v *NullableNetworkInterfacesConnectorsGetResponse) Set(val *NetworkInterfacesConnectorsGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkInterfacesConnectorsGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkInterfacesConnectorsGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkInterfacesConnectorsGetResponse(val *NetworkInterfacesConnectorsGetResponse) *NullableNetworkInterfacesConnectorsGetResponse {
	return &NullableNetworkInterfacesConnectorsGetResponse{value: val, isSet: true}
}

func (v NullableNetworkInterfacesConnectorsGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkInterfacesConnectorsGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
