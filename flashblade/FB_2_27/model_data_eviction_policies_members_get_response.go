...
// checks if the DataEvictionPoliciesMembersGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataEvictionPoliciesMembersGetResponse{}

// DataEvictionPoliciesMembersGetResponse struct for DataEvictionPoliciesMembersGetResponse
type DataEvictionPoliciesMembersGetResponse struct {
...
func NewDataEvictionPoliciesMembersGetResponse() *DataEvictionPoliciesMembersGetResponse {
	this := DataEvictionPoliciesMembersGetResponse{}
	return &this
}
...
func (o DataEvictionPoliciesMembersGetResponse) MarshalJSON() ([]byte, error) {
...
func (o DataEvictionPoliciesMembersGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDataEvictionPoliciesMembersGetResponse struct {
	value *DataEvictionPoliciesMembersGetResponse
	isSet bool
}

func (v NullableDataEvictionPoliciesMembersGetResponse) Get() *DataEvictionPoliciesMembersGetResponse {
	return v.value
}

func (v *NullableDataEvictionPoliciesMembersGetResponse) Set(val *DataEvictionPoliciesMembersGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDataEvictionPoliciesMembersGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDataEvictionPoliciesMembersGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataEvictionPoliciesMembersGetResponse(val *DataEvictionPoliciesMembersGetResponse) *NullableDataEvictionPoliciesMembersGetResponse {
	return &NullableDataEvictionPoliciesMembersGetResponse{value: val, isSet: true}
}

func (v NullableDataEvictionPoliciesMembersGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataEvictionPoliciesMembersGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
