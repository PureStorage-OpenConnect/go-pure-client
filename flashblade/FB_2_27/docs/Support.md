...
**EdgeAgentUpdateEnabled** | Pointer to **bool** | The switch to enable opt-in for edge agent updates. | [optional] 
**EdgeManagementEnabled** | Pointer to **bool** | The switch to enable opt-in for edge management. | [optional] 
**PhonehomeEnabled** | Pointer to **bool** | The switch to enable phonehome. | [optional] 
...
### GetEdgeAgentUpdateEnabled

`func (o *Support) GetEdgeAgentUpdateEnabled() bool`

GetEdgeAgentUpdateEnabled returns the EdgeAgentUpdateEnabled field if non-nil, zero value otherwise.

### GetEdgeAgentUpdateEnabledOk

`func (o *Support) GetEdgeAgentUpdateEnabledOk() (*bool, bool)`

GetEdgeAgentUpdateEnabledOk returns a tuple with the EdgeAgentUpdateEnabled field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEdgeAgentUpdateEnabled

`func (o *Support) SetEdgeAgentUpdateEnabled(v bool)`

SetEdgeAgentUpdateEnabled sets EdgeAgentUpdateEnabled field to given value.

### HasEdgeAgentUpdateEnabled

`func (o *Support) HasEdgeAgentUpdateEnabled() bool`

HasEdgeAgentUpdateEnabled returns a boolean if a field has been set.

### GetEdgeManagementEnabled

`func (o *Support) GetEdgeManagementEnabled() bool`

GetEdgeManagementEnabled returns the EdgeManagementEnabled field if non-nil, zero value otherwise.

### GetEdgeManagementEnabledOk

`func (o *Support) GetEdgeManagementEnabledOk() (*bool, bool)`

GetEdgeManagementEnabledOk returns a tuple with the EdgeManagementEnabled field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEdgeManagementEnabled

`func (o *Support) SetEdgeManagementEnabled(v bool)`

SetEdgeManagementEnabled sets EdgeManagementEnabled field to given value.

### HasEdgeManagementEnabled
