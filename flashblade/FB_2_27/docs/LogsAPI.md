...
------------- | ------------- | -------------
[**LogsAsyncDownloadGet**](LogsAPI.md#LogsAsyncDownloadGet) | **Get** /api/2.27/logs-async/download | GET logs-async/download
[**LogsAsyncGet**](LogsAPI.md#LogsAsyncGet) | **Get** /api/2.27/logs-async | GET logs-async
[**LogsAsyncPatch**](LogsAPI.md#LogsAsyncPatch) | **Patch** /api/2.27/logs-async | PATCH logs-async
[**LogsGet**](LogsAPI.md#LogsGet) | **Get** /api/2.27/logs | GET logs



## LogsAsyncDownloadGet

> *os.File LogsAsyncDownloadGet(ctx).XRequestID(xRequestID).Names(names).Execute()
...
> LogsAsyncGetResponse LogsAsyncGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> LogsAsyncResponse LogsAsyncPatch(ctx).LogsAsync(logsAsync).XRequestID(xRequestID).Execute()
...
> *os.File LogsGet(ctx).XRequestID(xRequestID).EndTime(endTime).StartTime(startTime).Execute()
