...
------------ | ------------- | ------------- | -------------
**Parameters** | Pointer to [**[]WorkloadParameter**](WorkloadParameter.md) | The parameter values to pass to the preset when creating the workload based on this recommendation result.  | [optional] 
...
**Targets** | Pointer to [**[]WorkloadPlacementRecommendationGenericTarget**](WorkloadPlacementRecommendationGenericTarget.md) | List of all recommended arrays.  | [optional] [readonly] 
