...
------------- | ------------- | -------------
[**DnsDelete**](DNSAPI.md#DnsDelete) | **Delete** /api/2.27/dns | DELETE dns
[**DnsGet**](DNSAPI.md#DnsGet) | **Get** /api/2.27/dns | GET dns
[**DnsPatch**](DNSAPI.md#DnsPatch) | **Patch** /api/2.27/dns | PATCH dns
[**DnsPost**](DNSAPI.md#DnsPost) | **Post** /api/2.27/dns | POST dns



## DnsDelete

> DnsDelete(ctx).XRequestID(xRequestID).ContextNames(contextNames).Ids(ids).Names(names).Execute()
...
> DnsGetResponse DnsGet(ctx).XRequestID(xRequestID).AllowErrors(allowErrors).ContextNames(contextNames).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> DnsResponse DnsPatch(ctx).Dns(dns).XRequestID(xRequestID).ContextNames(contextNames).Ids(ids).Names(names).Execute()
...
> DnsResponse DnsPost(ctx).Names(names).Dns(dns).XRequestID(xRequestID).ContextNames(contextNames).Execute()
