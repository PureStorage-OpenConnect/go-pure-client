...
------------- | ------------- | -------------
[**BucketReplicaLinksDelete**](BucketReplicaLinksAPI.md#BucketReplicaLinksDelete) | **Delete** /api/2.27/bucket-replica-links | DELETE bucket-replica-links
[**BucketReplicaLinksGet**](BucketReplicaLinksAPI.md#BucketReplicaLinksGet) | **Get** /api/2.27/bucket-replica-links | GET bucket-replica-links
[**BucketReplicaLinksPatch**](BucketReplicaLinksAPI.md#BucketReplicaLinksPatch) | **Patch** /api/2.27/bucket-replica-links | PATCH bucket-replica-links
[**BucketReplicaLinksPost**](BucketReplicaLinksAPI.md#BucketReplicaLinksPost) | **Post** /api/2.27/bucket-replica-links | POST bucket-replica-links



## BucketReplicaLinksDelete

> BucketReplicaLinksDelete(ctx).XRequestID(xRequestID).ContextNames(contextNames).Ids(ids).LocalBucketIds(localBucketIds).LocalBucketNames(localBucketNames).RemoteBucketNames(remoteBucketNames).RemoteIds(remoteIds).RemoteNames(remoteNames).Execute()
...
> BucketReplicaLinkResponse BucketReplicaLinksPatch(ctx).BucketReplicaLink(bucketReplicaLink).XRequestID(xRequestID).ContextNames(contextNames).Ids(ids).LocalBucketIds(localBucketIds).LocalBucketNames(localBucketNames).RemoteBucketNames(remoteBucketNames).RemoteIds(remoteIds).RemoteNames(remoteNames).Execute()
...
> BucketReplicaLinkResponse BucketReplicaLinksPost(ctx).BucketReplicaLink(bucketReplicaLink).XRequestID(xRequestID).ContextNames(contextNames).LocalBucketIds(localBucketIds).LocalBucketNames(localBucketNames).RemoteBucketNames(remoteBucketNames).RemoteCredentialsIds(remoteCredentialsIds).RemoteCredentialsNames(remoteCredentialsNames).Execute()
