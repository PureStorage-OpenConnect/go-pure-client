...
------------- | ------------- | -------------
[**BucketAuditFilterActionsGet**](BucketsAPI.md#BucketAuditFilterActionsGet) | **Get** /api/2.27/bucket-audit-filter-actions | GET bucket-audit-filter-actions
[**BucketsAuditFiltersDelete**](BucketsAPI.md#BucketsAuditFiltersDelete) | **Delete** /api/2.27/buckets/audit-filters | DELETE buckets/audit-filters
[**BucketsAuditFiltersGet**](BucketsAPI.md#BucketsAuditFiltersGet) | **Get** /api/2.27/buckets/audit-filters | GET buckets/audit-filters
[**BucketsAuditFiltersPatch**](BucketsAPI.md#BucketsAuditFiltersPatch) | **Patch** /api/2.27/buckets/audit-filters | PATCH buckets/audit-filters
[**BucketsAuditFiltersPost**](BucketsAPI.md#BucketsAuditFiltersPost) | **Post** /api/2.27/buckets/audit-filters | POST buckets/audit-filters
[**BucketsBucketAccessPoliciesDelete**](BucketsAPI.md#BucketsBucketAccessPoliciesDelete) | **Delete** /api/2.27/buckets/bucket-access-policies | DELETE buckets/bucket-access-policies
[**BucketsBucketAccessPoliciesGet**](BucketsAPI.md#BucketsBucketAccessPoliciesGet) | **Get** /api/2.27/buckets/bucket-access-policies | GET buckets/bucket-access-policies
[**BucketsBucketAccessPoliciesPost**](BucketsAPI.md#BucketsBucketAccessPoliciesPost) | **Post** /api/2.27/buckets/bucket-access-policies | POST buckets/bucket-access-policies
[**BucketsBucketAccessPoliciesRulesDelete**](BucketsAPI.md#BucketsBucketAccessPoliciesRulesDelete) | **Delete** /api/2.27/buckets/bucket-access-policies/rules | DELETE buckets/bucket-access-policies/rules
[**BucketsBucketAccessPoliciesRulesGet**](BucketsAPI.md#BucketsBucketAccessPoliciesRulesGet) | **Get** /api/2.27/buckets/bucket-access-policies/rules | GET buckets/bucket-access-policies/rules
[**BucketsBucketAccessPoliciesRulesPost**](BucketsAPI.md#BucketsBucketAccessPoliciesRulesPost) | **Post** /api/2.27/buckets/bucket-access-policies/rules | POST buckets/bucket-access-policies/rules
[**BucketsCrossOriginResourceSharingPoliciesDelete**](BucketsAPI.md#BucketsCrossOriginResourceSharingPoliciesDelete) | **Delete** /api/2.27/buckets/cross-origin-resource-sharing-policies | DELETE buckets/cross-origin-resource-sharing-policies
[**BucketsCrossOriginResourceSharingPoliciesGet**](BucketsAPI.md#BucketsCrossOriginResourceSharingPoliciesGet) | **Get** /api/2.27/buckets/cross-origin-resource-sharing-policies | GET buckets/cross-origin-resource-sharing-policies
[**BucketsCrossOriginResourceSharingPoliciesPost**](BucketsAPI.md#BucketsCrossOriginResourceSharingPoliciesPost) | **Post** /api/2.27/buckets/cross-origin-resource-sharing-policies | POST buckets/cross-origin-resource-sharing-policies
[**BucketsCrossOriginResourceSharingPoliciesRulesDelete**](BucketsAPI.md#BucketsCrossOriginResourceSharingPoliciesRulesDelete) | **Delete** /api/2.27/buckets/cross-origin-resource-sharing-policies/rules | DELETE buckets/cross-origin-resource-sharing-policies/rules
[**BucketsCrossOriginResourceSharingPoliciesRulesGet**](BucketsAPI.md#BucketsCrossOriginResourceSharingPoliciesRulesGet) | **Get** /api/2.27/buckets/cross-origin-resource-sharing-policies/rules | GET buckets/cross-origin-resource-sharing-policies/rules
[**BucketsCrossOriginResourceSharingPoliciesRulesPost**](BucketsAPI.md#BucketsCrossOriginResourceSharingPoliciesRulesPost) | **Post** /api/2.27/buckets/cross-origin-resource-sharing-policies/rules | POST buckets/cross-origin-resource-sharing-policies/rules
[**BucketsDelete**](BucketsAPI.md#BucketsDelete) | **Delete** /api/2.27/buckets | DELETE buckets
[**BucketsGet**](BucketsAPI.md#BucketsGet) | **Get** /api/2.27/buckets | GET buckets
[**BucketsPatch**](BucketsAPI.md#BucketsPatch) | **Patch** /api/2.27/buckets | PATCH buckets
[**BucketsPerformanceGet**](BucketsAPI.md#BucketsPerformanceGet) | **Get** /api/2.27/buckets/performance | GET buckets/performance
[**BucketsPost**](BucketsAPI.md#BucketsPost) | **Post** /api/2.27/buckets | POST buckets
[**BucketsS3SpecificPerformanceGet**](BucketsAPI.md#BucketsS3SpecificPerformanceGet) | **Get** /api/2.27/buckets/s3-specific-performance | GET buckets/s3-specific-performance
