...
------------ | ------------- | ------------- | -------------
**Certificate** | Pointer to [**Reference**](Reference.md) | The certificate object whose private key will be used for generating the CSR, and whose certificate will be overwritten if the CSR is signed and imported back into FlashBlade.  | [optional] 
**CommonName** | Pointer to **string** | The common name field to be listed in the certificate. | [optional] 
**Country** | Pointer to **string** | Two-letter country (ISO) code to be listed in the certificate. | [optional] 
**Email** | Pointer to **string** | The email field to be listed in the certificate. | [optional] 
**Locality** | Pointer to **string** | The locality field to be listed in the certificate. | [optional] 
**Organization** | Pointer to **string** | The organization field to be listed in the certificate. | [optional] 
**OrganizationalUnit** | Pointer to **string** | The organizational unit field to be listed in the certificate. | [optional] 
**State** | Pointer to **string** | The state/province field to be listed in the certificate. | [optional] 
**SubjectAlternativeNames** | Pointer to **[]string** | The alternative names that are secured by this certificate. Alternative names may be IP addresses, DNS names, or URIs. Specifying these will encode them in the certificate signing request; however, it is the decision of the signing authority as to whether or not they will be honored or ignored.  | [optional] 
