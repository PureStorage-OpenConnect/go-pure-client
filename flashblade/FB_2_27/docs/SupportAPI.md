...
------------- | ------------- | -------------
[**SupportGet**](SupportAPI.md#SupportGet) | **Get** /api/2.27/support | GET support
[**SupportPatch**](SupportAPI.md#SupportPatch) | **Patch** /api/2.27/support | PATCH support
[**SupportSystemManifestGet**](SupportAPI.md#SupportSystemManifestGet) | **Get** /api/2.27/support/system-manifest | List the system manifest
[**SupportTestGet**](SupportAPI.md#SupportTestGet) | **Get** /api/2.27/support/test | GET support-test
