...
// checks if the FileSystemGroupsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileSystemGroupsGetResponse{}

// FileSystemGroupsGetResponse struct for FileSystemGroupsGetResponse
type FileSystemGroupsGetResponse struct {
...
func NewFileSystemGroupsGetResponse() *FileSystemGroupsGetResponse {
	this := FileSystemGroupsGetResponse{}
	return &this
}
...
func (o FileSystemGroupsGetResponse) MarshalJSON() ([]byte, error) {
...
func (o FileSystemGroupsGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFileSystemGroupsGetResponse struct {
	value *FileSystemGroupsGetResponse
	isSet bool
}

func (v NullableFileSystemGroupsGetResponse) Get() *FileSystemGroupsGetResponse {
	return v.value
}

func (v *NullableFileSystemGroupsGetResponse) Set(val *FileSystemGroupsGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileSystemGroupsGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileSystemGroupsGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileSystemGroupsGetResponse(val *FileSystemGroupsGetResponse) *NullableFileSystemGroupsGetResponse {
	return &NullableFileSystemGroupsGetResponse{value: val, isSet: true}
}

func (v NullableFileSystemGroupsGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileSystemGroupsGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
