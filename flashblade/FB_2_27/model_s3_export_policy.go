...
// checks if the S3ExportPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3ExportPolicy{}

// S3ExportPolicy struct for S3ExportPolicy
type S3ExportPolicy struct {
	...
	Rules   []S3ExportPolicyAllOfRules `json:"rules,omitempty"`
}
...
func (o *S3ExportPolicy) GetRules() []S3ExportPolicyAllOfRules {
	if o == nil || IsNil(o.Rules) {
		var ret []S3ExportPolicyAllOfRules
		return ret
	}
	return o.Rules
}
...
// SetRules gets a reference to the given []S3ExportPolicyAllOfRules and assigns it to the Rules field.
func (o *S3ExportPolicy) SetRules(v []S3ExportPolicyAllOfRules) {
	o.Rules = v
}

func (o S3ExportPolicy) MarshalJSON() ([]byte, error) {
...
func (o S3ExportPolicy) ToMap() (map[string]interface{}, error) {
...
type NullableS3ExportPolicy struct {
	value *S3ExportPolicy
	isSet bool
}

func (v NullableS3ExportPolicy) Get() *S3ExportPolicy {
	return v.value
}

func (v *NullableS3ExportPolicy) Set(val *S3ExportPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableS3ExportPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableS3ExportPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableS3ExportPolicy(val *S3ExportPolicy) *NullableS3ExportPolicy {
	return &NullableS3ExportPolicy{value: val, isSet: true}
}

func (v NullableS3ExportPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableS3ExportPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
