...
// checks if the LegalHoldsHeldEntitiesGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LegalHoldsHeldEntitiesGetResponse{}

// LegalHoldsHeldEntitiesGetResponse struct for LegalHoldsHeldEntitiesGetResponse
...
func NewLegalHoldsHeldEntitiesGetResponse() *LegalHoldsHeldEntitiesGetResponse {
	this := LegalHoldsHeldEntitiesGetResponse{}
	return &this
}
...
func (o LegalHoldsHeldEntitiesGetResponse) MarshalJSON() ([]byte, error) {
...
func (o LegalHoldsHeldEntitiesGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLegalHoldsHeldEntitiesGetResponse struct {
	value *LegalHoldsHeldEntitiesGetResponse
	isSet bool
}

func (v NullableLegalHoldsHeldEntitiesGetResponse) Get() *LegalHoldsHeldEntitiesGetResponse {
	return v.value
}

func (v *NullableLegalHoldsHeldEntitiesGetResponse) Set(val *LegalHoldsHeldEntitiesGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLegalHoldsHeldEntitiesGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLegalHoldsHeldEntitiesGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLegalHoldsHeldEntitiesGetResponse(val *LegalHoldsHeldEntitiesGetResponse) *NullableLegalHoldsHeldEntitiesGetResponse {
	return &NullableLegalHoldsHeldEntitiesGetResponse{value: val, isSet: true}
}

func (v NullableLegalHoldsHeldEntitiesGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLegalHoldsHeldEntitiesGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
