...
**Remote** | Pointer to [**FixedReferenceNoResourceType**](FixedReferenceNoResourceType.md) | The array where the remote file system snapshot is located.  | [optional] 
...
`func (o *FileSystemSnapshotTransfer) GetRemote() FixedReferenceNoResourceType`

GetRemote returns the Remote field if non-nil, zero value otherwise.

### GetRemoteOk

`func (o *FileSystemSnapshotTransfer) GetRemoteOk() (*FixedReferenceNoResourceType, bool)`
...
`func (o *FileSystemSnapshotTransfer) SetRemote(v FixedReferenceNoResourceType)`
