...
------------- | ------------- | -------------
[**SmbClientPoliciesDelete**](PoliciesSMBClientAPI.md#SmbClientPoliciesDelete) | **Delete** /api/2.12/smb-client-policies | DELETE smb-client-policies
[**SmbClientPoliciesGet**](PoliciesSMBClientAPI.md#SmbClientPoliciesGet) | **Get** /api/2.12/smb-client-policies | GET smb-client-policies
[**SmbClientPoliciesPatch**](PoliciesSMBClientAPI.md#SmbClientPoliciesPatch) | **Patch** /api/2.12/smb-client-policies | PATCH smb-client-policies
[**SmbClientPoliciesPost**](PoliciesSMBClientAPI.md#SmbClientPoliciesPost) | **Post** /api/2.12/smb-client-policies | POST smb-client-policies
[**SmbClientPoliciesRulesDelete**](PoliciesSMBClientAPI.md#SmbClientPoliciesRulesDelete) | **Delete** /api/2.12/smb-client-policies/rules | DELETE smb-client-policies/rules
[**SmbClientPoliciesRulesGet**](PoliciesSMBClientAPI.md#SmbClientPoliciesRulesGet) | **Get** /api/2.12/smb-client-policies/rules | GET smb-client-policies/rules
[**SmbClientPoliciesRulesPatch**](PoliciesSMBClientAPI.md#SmbClientPoliciesRulesPatch) | **Patch** /api/2.12/smb-client-policies/rules | PATCH smb-client-policies/rules
[**SmbClientPoliciesRulesPost**](PoliciesSMBClientAPI.md#SmbClientPoliciesRulesPost) | **Post** /api/2.12/smb-client-policies/rules | POST smb-client-policies/rules
