...
------------- | ------------- | -------------
[**ArraysClientsPerformanceGet**](ClientsAPI.md#ArraysClientsPerformanceGet) | **Get** /api/2.12/arrays/clients/performance | GET clients-performance



## ArraysClientsPerformanceGet

> ClientPerformanceGetResponse ArraysClientsPerformanceGet(ctx).Filter(filter).Limit(limit).Names(names).Sort(sort).TotalOnly(totalOnly).Execute()
