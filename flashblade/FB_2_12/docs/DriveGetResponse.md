...
**Items** | Pointer to [**[]Drive**](Drive.md) | A list of drive objects. | [optional] 
...
`func (o *DriveGetResponse) GetTotal() map[string]interface{}`

GetTotal returns the Total field if non-nil, zero value otherwise.

### GetTotalOk

`func (o *DriveGetResponse) GetTotalOk() (*map[string]interface{}, bool)`
...
`func (o *DriveGetResponse) SetTotal(v map[string]interface{})`

SetTotal sets Total field to given value.

### HasTotal

`func (o *DriveGetResponse) HasTotal() bool`
