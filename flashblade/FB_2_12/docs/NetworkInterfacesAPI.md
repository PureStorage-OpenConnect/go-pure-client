...
------------- | ------------- | -------------
[**NetworkInterfacesDelete**](NetworkInterfacesAPI.md#NetworkInterfacesDelete) | **Delete** /api/2.12/network-interfaces | DELETE network-interfaces
[**NetworkInterfacesGet**](NetworkInterfacesAPI.md#NetworkInterfacesGet) | **Get** /api/2.12/network-interfaces | GET network-interfaces
[**NetworkInterfacesPatch**](NetworkInterfacesAPI.md#NetworkInterfacesPatch) | **Patch** /api/2.12/network-interfaces | PATCH network-interfaces
[**NetworkInterfacesPingGet**](NetworkInterfacesAPI.md#NetworkInterfacesPingGet) | **Get** /api/2.12/network-interfaces/ping | GET network-interfaces/ping
[**NetworkInterfacesPost**](NetworkInterfacesAPI.md#NetworkInterfacesPost) | **Post** /api/2.12/network-interfaces | POST network-interfaces
[**NetworkInterfacesTraceGet**](NetworkInterfacesAPI.md#NetworkInterfacesTraceGet) | **Get** /api/2.12/network-interfaces/trace | GET network-interfaces/trace
...
> NetworkInterfacePingGetResponse NetworkInterfacesPingGet(ctx).Destination(destination).ComponentName(componentName).Count(count).PacketSize(packetSize).PrintLatency(printLatency).ResolveHostname(resolveHostname).Source(source).Execute()
...
> NetworkInterfaceTraceGetResponse NetworkInterfacesTraceGet(ctx).Destination(destination).ComponentName(componentName).DiscoverMtu(discoverMtu).FragmentPacket(fragmentPacket).Method(method).Port(port).ResolveHostname(resolveHostname).Source(source).Execute()
