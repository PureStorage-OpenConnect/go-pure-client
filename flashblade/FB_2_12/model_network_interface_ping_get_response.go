...
// checks if the NetworkInterfacePingGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkInterfacePingGetResponse{}

// NetworkInterfacePingGetResponse struct for NetworkInterfacePingGetResponse
...
func NewNetworkInterfacePingGetResponse() *NetworkInterfacePingGetResponse {
	this := NetworkInterfacePingGetResponse{}
	return &this
}
...
func (o NetworkInterfacePingGetResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworkInterfacePingGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkInterfacePingGetResponse struct {
	value *NetworkInterfacePingGetResponse
	isSet bool
}

func (v NullableNetworkInterfacePingGetResponse) Get() *NetworkInterfacePingGetResponse {
	return v.value
}

func (v *NullableNetworkInterfacePingGetResponse) Set(val *NetworkInterfacePingGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkInterfacePingGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkInterfacePingGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkInterfacePingGetResponse(val *NetworkInterfacePingGetResponse) *NullableNetworkInterfacePingGetResponse {
	return &NullableNetworkInterfacePingGetResponse{value: val, isSet: true}
}

func (v NullableNetworkInterfacePingGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkInterfacePingGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
