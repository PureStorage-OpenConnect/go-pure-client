...
------------- | ------------- | -------------
[**FileSystemsDelete**](FileSystemsAPI.md#FileSystemsDelete) | **Delete** /api/2.9/file-systems | DELETE file-systems
[**FileSystemsGet**](FileSystemsAPI.md#FileSystemsGet) | **Get** /api/2.9/file-systems | GET file-systems
[**FileSystemsGroupsPerformanceGet**](FileSystemsAPI.md#FileSystemsGroupsPerformanceGet) | **Get** /api/2.9/file-systems/groups/performance | GET file-systems/groups/performance
[**FileSystemsLocksClientsGet**](FileSystemsAPI.md#FileSystemsLocksClientsGet) | **Get** /api/2.9/file-systems/locks/clients | Get a list of clients that hold active file locks
[**FileSystemsLocksDelete**](FileSystemsAPI.md#FileSystemsLocksDelete) | **Delete** /api/2.9/file-systems/locks | Invalidate file locks
[**FileSystemsLocksGet**](FileSystemsAPI.md#FileSystemsLocksGet) | **Get** /api/2.9/file-systems/locks | Get a list of active file locks
[**FileSystemsLocksNlmReclamationsPost**](FileSystemsAPI.md#FileSystemsLocksNlmReclamationsPost) | **Post** /api/2.9/file-systems/locks/nlm-reclamations | Initiate NLM reclamation.
[**FileSystemsPatch**](FileSystemsAPI.md#FileSystemsPatch) | **Patch** /api/2.9/file-systems | PATCH file-systems
[**FileSystemsPerformanceGet**](FileSystemsAPI.md#FileSystemsPerformanceGet) | **Get** /api/2.9/file-systems/performance | GET file-systems/performance
[**FileSystemsPoliciesAllGet**](FileSystemsAPI.md#FileSystemsPoliciesAllGet) | **Get** /api/2.9/file-systems/policies-all | GET file-systems/policies-all
[**FileSystemsPoliciesDelete**](FileSystemsAPI.md#FileSystemsPoliciesDelete) | **Delete** /api/2.9/file-systems/policies | DELETE file-systems/policies
[**FileSystemsPoliciesGet**](FileSystemsAPI.md#FileSystemsPoliciesGet) | **Get** /api/2.9/file-systems/policies | GET file-systems/policies
[**FileSystemsPoliciesPost**](FileSystemsAPI.md#FileSystemsPoliciesPost) | **Post** /api/2.9/file-systems/policies | POST file-systems/policies
[**FileSystemsPost**](FileSystemsAPI.md#FileSystemsPost) | **Post** /api/2.9/file-systems | POST file-systems
[**FileSystemsUsersPerformanceGet**](FileSystemsAPI.md#FileSystemsUsersPerformanceGet) | **Get** /api/2.9/file-systems/users/performance | GET file-systems/users/performance
