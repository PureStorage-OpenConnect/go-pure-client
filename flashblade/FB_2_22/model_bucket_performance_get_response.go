...
type BucketPerformanceGetResponse struct {
	...
	Items []BucketPerformanceItems `json:"items,omitempty"`
...
func (o *BucketPerformanceGetResponse) GetItems() []BucketPerformanceItems {
	if o == nil || IsNil(o.Items) {
		var ret []BucketPerformanceItems
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []BucketPerformanceItems and assigns it to the Items field.
