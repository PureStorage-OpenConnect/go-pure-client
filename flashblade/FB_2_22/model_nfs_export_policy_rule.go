...
// SetAnongid gets a reference to the given int64 and assigns it to the Anongid field.
...
// SetAnonuid gets a reference to the given int64 and assigns it to the Anonuid field.
