...
`func (o *UserQuota) GetContext() FixedReference`

GetContext returns the Context field if non-nil, zero value otherwise.

### GetContextOk

`func (o *UserQuota) GetContextOk() (*FixedReference, bool)`
...
`func (o *UserQuota) SetContext(v FixedReference)`

SetContext sets Context field to given value.

### HasContext

`func (o *UserQuota) HasContext() bool`
