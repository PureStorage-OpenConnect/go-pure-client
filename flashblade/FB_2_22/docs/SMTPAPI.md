...
------------- | ------------- | -------------
[**SmtpServersGet**](SMTPAPI.md#SmtpServersGet) | **Get** /api/2.22/smtp-servers | GET smtp-servers
[**SmtpServersPatch**](SMTPAPI.md#SmtpServersPatch) | **Patch** /api/2.22/smtp-servers | PATCH smtp-servers
