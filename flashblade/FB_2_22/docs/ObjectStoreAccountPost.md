...
------------ | ------------- | ------------- | -------------
**AccountExports** | Pointer to [**[]ServerForAccountExport**](ServerForAccountExport.md) | A list of exports to be created for the account.  If ommited or set to &#x60;null&#x60;, the default server for object store will be used. Use &#x60;[]&#x60; to create an account without any export.  | [optional] 
...
`func (o *ObjectStoreAccountPost) GetAccountExports() []ServerForAccountExport`

GetAccountExports returns the AccountExports field if non-nil, zero value otherwise.

### GetAccountExportsOk

`func (o *ObjectStoreAccountPost) GetAccountExportsOk() (*[]ServerForAccountExport, bool)`

GetAccountExportsOk returns a tuple with the AccountExports field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAccountExports

`func (o *ObjectStoreAccountPost) SetAccountExports(v []ServerForAccountExport)`

SetAccountExports sets AccountExports field to given value.

### HasAccountExports

`func (o *ObjectStoreAccountPost) HasAccountExports() bool`

HasAccountExports returns a boolean if a field has been set.
