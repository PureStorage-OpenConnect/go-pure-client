...
------------- | ------------- | -------------
[**NodesBatchPost**](NodesAPI.md#NodesBatchPost) | **Post** /api/2.22/nodes/batch | POST nodes/batch
[**NodesGet**](NodesAPI.md#NodesGet) | **Get** /api/2.22/nodes | GET nodes
[**NodesPatch**](NodesAPI.md#NodesPatch) | **Patch** /api/2.22/nodes | PATCH nodes
