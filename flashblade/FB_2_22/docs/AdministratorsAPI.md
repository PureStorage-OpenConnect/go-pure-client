...
------------- | ------------- | -------------
[**AdminsAPITokensDelete**](AdministratorsAPI.md#AdminsAPITokensDelete) | **Delete** /api/2.22/admins/api-tokens | DELETE admins/api-tokens
[**AdminsAPITokensGet**](AdministratorsAPI.md#AdminsAPITokensGet) | **Get** /api/2.22/admins/api-tokens | GET admins/api-tokens
[**AdminsAPITokensPost**](AdministratorsAPI.md#AdminsAPITokensPost) | **Post** /api/2.22/admins/api-tokens | POST admins/api-tokens
[**AdminsCacheDelete**](AdministratorsAPI.md#AdminsCacheDelete) | **Delete** /api/2.22/admins/cache | DELETE admins/cache
[**AdminsCacheGet**](AdministratorsAPI.md#AdminsCacheGet) | **Get** /api/2.22/admins/cache | GET admins/cache
[**AdminsDelete**](AdministratorsAPI.md#AdminsDelete) | **Delete** /api/2.22/admins | DELETE admins
[**AdminsGet**](AdministratorsAPI.md#AdminsGet) | **Get** /api/2.22/admins | GET admins
[**AdminsPatch**](AdministratorsAPI.md#AdminsPatch) | **Patch** /api/2.22/admins | PATCH admins
[**AdminsPost**](AdministratorsAPI.md#AdminsPost) | **Post** /api/2.22/admins | POST admins
[**AdminsSettingsGet**](AdministratorsAPI.md#AdminsSettingsGet) | **Get** /api/2.22/admins/settings | List global admin settings
[**AdminsSettingsPatch**](AdministratorsAPI.md#AdminsSettingsPatch) | **Patch** /api/2.22/admins/settings | Update global admin settings
