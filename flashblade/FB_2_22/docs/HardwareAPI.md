...
------------- | ------------- | -------------
[**HardwareGet**](HardwareAPI.md#HardwareGet) | **Get** /api/2.22/hardware | GET hardware
[**HardwarePatch**](HardwareAPI.md#HardwarePatch) | **Patch** /api/2.22/hardware | PATCH hardware
