...
// checks if the S3ExportPolicyGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3ExportPolicyGetResponse{}

// S3ExportPolicyGetResponse struct for S3ExportPolicyGetResponse
type S3ExportPolicyGetResponse struct {
...
func NewS3ExportPolicyGetResponse() *S3ExportPolicyGetResponse {
	this := S3ExportPolicyGetResponse{}
	return &this
}
...
func (o S3ExportPolicyGetResponse) MarshalJSON() ([]byte, error) {
...
func (o S3ExportPolicyGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableS3ExportPolicyGetResponse struct {
	value *S3ExportPolicyGetResponse
	isSet bool
}

func (v NullableS3ExportPolicyGetResponse) Get() *S3ExportPolicyGetResponse {
	return v.value
}

func (v *NullableS3ExportPolicyGetResponse) Set(val *S3ExportPolicyGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableS3ExportPolicyGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableS3ExportPolicyGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableS3ExportPolicyGetResponse(val *S3ExportPolicyGetResponse) *NullableS3ExportPolicyGetResponse {
	return &NullableS3ExportPolicyGetResponse{value: val, isSet: true}
}

func (v NullableS3ExportPolicyGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableS3ExportPolicyGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
