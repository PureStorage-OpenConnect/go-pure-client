...
// checks if the ArraySpaceStorageClassGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArraySpaceStorageClassGetResponse{}

// ArraySpaceStorageClassGetResponse struct for ArraySpaceStorageClassGetResponse
...
func NewArraySpaceStorageClassGetResponse() *ArraySpaceStorageClassGetResponse {
	this := ArraySpaceStorageClassGetResponse{}
	return &this
}
...
// SetItems gets a reference to the given []StorageClassSpace and assigns it to the Items field.
...
// SetTotal gets a reference to the given []StorageClassSpace and assigns it to the Total field.
func (o *ArraySpaceStorageClassGetResponse) SetTotal(v []StorageClassSpace) {
	o.Total = v
}

func (o ArraySpaceStorageClassGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ArraySpaceStorageClassGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableArraySpaceStorageClassGetResponse struct {
	value *ArraySpaceStorageClassGetResponse
	isSet bool
}

func (v NullableArraySpaceStorageClassGetResponse) Get() *ArraySpaceStorageClassGetResponse {
	return v.value
}

func (v *NullableArraySpaceStorageClassGetResponse) Set(val *ArraySpaceStorageClassGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableArraySpaceStorageClassGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableArraySpaceStorageClassGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArraySpaceStorageClassGetResponse(val *ArraySpaceStorageClassGetResponse) *NullableArraySpaceStorageClassGetResponse {
	return &NullableArraySpaceStorageClassGetResponse{value: val, isSet: true}
}

func (v NullableArraySpaceStorageClassGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArraySpaceStorageClassGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
