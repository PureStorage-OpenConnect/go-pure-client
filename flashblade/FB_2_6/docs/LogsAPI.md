...
------------- | ------------- | -------------
[**LogsAsyncDownloadGet**](LogsAPI.md#LogsAsyncDownloadGet) | **Get** /api/2.6/logs-async/download | GET logs-async/download
[**LogsAsyncGet**](LogsAPI.md#LogsAsyncGet) | **Get** /api/2.6/logs-async | GET logs-async
[**LogsAsyncPatch**](LogsAPI.md#LogsAsyncPatch) | **Patch** /api/2.6/logs-async | PATCH logs-async
[**LogsGet**](LogsAPI.md#LogsGet) | **Get** /api/2.6/logs | GET logs
