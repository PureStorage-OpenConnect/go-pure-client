...
------------- | ------------- | -------------
[**ArrayConnectionsConnectionKeyGet**](ArrayConnectionsAPI.md#ArrayConnectionsConnectionKeyGet) | **Get** /api/2.6/array-connections/connection-key | GET array-connections/connection-key
[**ArrayConnectionsConnectionKeyPost**](ArrayConnectionsAPI.md#ArrayConnectionsConnectionKeyPost) | **Post** /api/2.6/array-connections/connection-key | POST array-connections/connection-key
[**ArrayConnectionsDelete**](ArrayConnectionsAPI.md#ArrayConnectionsDelete) | **Delete** /api/2.6/array-connections | DELETE array-connections
[**ArrayConnectionsGet**](ArrayConnectionsAPI.md#ArrayConnectionsGet) | **Get** /api/2.6/array-connections | GET array-connections
[**ArrayConnectionsPatch**](ArrayConnectionsAPI.md#ArrayConnectionsPatch) | **Patch** /api/2.6/array-connections | PATCH array-connections
[**ArrayConnectionsPathGet**](ArrayConnectionsAPI.md#ArrayConnectionsPathGet) | **Get** /api/2.6/array-connections/path | GET array-connections/path
[**ArrayConnectionsPerformanceReplicationGet**](ArrayConnectionsAPI.md#ArrayConnectionsPerformanceReplicationGet) | **Get** /api/2.6/array-connections/performance/replication | GET array-connections/performance/replication
[**ArrayConnectionsPost**](ArrayConnectionsAPI.md#ArrayConnectionsPost) | **Post** /api/2.6/array-connections | POST array-connections
