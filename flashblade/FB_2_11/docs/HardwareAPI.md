...
------------- | ------------- | -------------
[**HardwareGet**](HardwareAPI.md#HardwareGet) | **Get** /api/2.11/hardware | GET hardware
[**HardwarePatch**](HardwareAPI.md#HardwarePatch) | **Patch** /api/2.11/hardware | PATCH hardware
...
> HardwareResponse HardwarePatch(ctx).Hardware(hardware).Ids(ids).Names(names).Execute()
