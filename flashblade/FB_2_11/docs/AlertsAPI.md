...
------------- | ------------- | -------------
[**AlertsGet**](AlertsAPI.md#AlertsGet) | **Get** /api/2.11/alerts | GET alerts
[**AlertsPatch**](AlertsAPI.md#AlertsPatch) | **Patch** /api/2.11/alerts | PATCH alerts



## AlertsGet

> AlertGetResponse AlertsGet(ctx).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> AlertResponse AlertsPatch(ctx).AlertsSettings(alertsSettings).Ids(ids).Names(names).Execute()
