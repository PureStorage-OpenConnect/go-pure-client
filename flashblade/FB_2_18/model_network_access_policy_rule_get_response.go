...
// checks if the NetworkAccessPolicyRuleGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkAccessPolicyRuleGetResponse{}

// NetworkAccessPolicyRuleGetResponse struct for NetworkAccessPolicyRuleGetResponse
...
func NewNetworkAccessPolicyRuleGetResponse() *NetworkAccessPolicyRuleGetResponse {
	this := NetworkAccessPolicyRuleGetResponse{}
	return &this
}
...
func (o NetworkAccessPolicyRuleGetResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworkAccessPolicyRuleGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkAccessPolicyRuleGetResponse struct {
	value *NetworkAccessPolicyRuleGetResponse
	isSet bool
}

func (v NullableNetworkAccessPolicyRuleGetResponse) Get() *NetworkAccessPolicyRuleGetResponse {
	return v.value
}

func (v *NullableNetworkAccessPolicyRuleGetResponse) Set(val *NetworkAccessPolicyRuleGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkAccessPolicyRuleGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkAccessPolicyRuleGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkAccessPolicyRuleGetResponse(val *NetworkAccessPolicyRuleGetResponse) *NullableNetworkAccessPolicyRuleGetResponse {
	return &NullableNetworkAccessPolicyRuleGetResponse{value: val, isSet: true}
}

func (v NullableNetworkAccessPolicyRuleGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkAccessPolicyRuleGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
