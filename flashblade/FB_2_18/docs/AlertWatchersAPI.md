...
------------- | ------------- | -------------
[**AlertWatchersDelete**](AlertWatchersAPI.md#AlertWatchersDelete) | **Delete** /api/2.18/alert-watchers | DELETE alert-watchers
[**AlertWatchersGet**](AlertWatchersAPI.md#AlertWatchersGet) | **Get** /api/2.18/alert-watchers | GET alert-watchers
[**AlertWatchersPatch**](AlertWatchersAPI.md#AlertWatchersPatch) | **Patch** /api/2.18/alert-watchers | PATCH alert-watchers
[**AlertWatchersPost**](AlertWatchersAPI.md#AlertWatchersPost) | **Post** /api/2.18/alert-watchers | POST alert-watchers
[**AlertWatchersTestGet**](AlertWatchersAPI.md#AlertWatchersTestGet) | **Get** /api/2.18/alert-watchers/test | GET alert-watchers/test
