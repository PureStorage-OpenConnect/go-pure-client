...
------------ | ------------- | ------------- | -------------
**Group** | Pointer to [**Reference**](Reference.md) | A reference to a group object that has the referenced member object as a member.  | [optional] 
**Member** | Pointer to [**Reference**](Reference.md) | A reference to an object that is a member of the referenced group.  | [optional] 
