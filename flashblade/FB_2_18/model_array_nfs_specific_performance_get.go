...
// checks if the ArrayNfsSpecificPerformanceGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArrayNfsSpecificPerformanceGet{}

// ArrayNfsSpecificPerformanceGet struct for ArrayNfsSpecificPerformanceGet
...
func NewArrayNfsSpecificPerformanceGet() *ArrayNfsSpecificPerformanceGet {
	this := ArrayNfsSpecificPerformanceGet{}
	return &this
}
...
func (o *ArrayNfsSpecificPerformanceGet) GetItems() []ArrayNfsSpecificPerformance {
	if o == nil || IsNil(o.Items) {
		var ret []ArrayNfsSpecificPerformance
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []ArrayNfsSpecificPerformance and assigns it to the Items field.
func (o *ArrayNfsSpecificPerformanceGet) SetItems(v []ArrayNfsSpecificPerformance) {
	o.Items = v
}

func (o ArrayNfsSpecificPerformanceGet) MarshalJSON() ([]byte, error) {
...
func (o ArrayNfsSpecificPerformanceGet) ToMap() (map[string]interface{}, error) {
...
type NullableArrayNfsSpecificPerformanceGet struct {
	value *ArrayNfsSpecificPerformanceGet
	isSet bool
}

func (v NullableArrayNfsSpecificPerformanceGet) Get() *ArrayNfsSpecificPerformanceGet {
	return v.value
}

func (v *NullableArrayNfsSpecificPerformanceGet) Set(val *ArrayNfsSpecificPerformanceGet) {
	v.value = val
	v.isSet = true
}

func (v NullableArrayNfsSpecificPerformanceGet) IsSet() bool {
	return v.isSet
}

func (v *NullableArrayNfsSpecificPerformanceGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArrayNfsSpecificPerformanceGet(val *ArrayNfsSpecificPerformanceGet) *NullableArrayNfsSpecificPerformanceGet {
	return &NullableArrayNfsSpecificPerformanceGet{value: val, isSet: true}
}

func (v NullableArrayNfsSpecificPerformanceGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArrayNfsSpecificPerformanceGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
