...
// checks if the DriveGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DriveGetResponse{}

// DriveGetResponse struct for DriveGetResponse
...
func (o DriveGetResponse) MarshalJSON() ([]byte, error) {
...
func (o DriveGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDriveGetResponse struct {
	value *DriveGetResponse
	isSet bool
}

func (v NullableDriveGetResponse) Get() *DriveGetResponse {
	return v.value
}

func (v *NullableDriveGetResponse) Set(val *DriveGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDriveGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDriveGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDriveGetResponse(val *DriveGetResponse) *NullableDriveGetResponse {
	return &NullableDriveGetResponse{value: val, isSet: true}
}

func (v NullableDriveGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDriveGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
