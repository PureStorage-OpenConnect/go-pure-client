...
// checks if the PublicKeyUseGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicKeyUseGetResponse{}

// PublicKeyUseGetResponse struct for PublicKeyUseGetResponse
...
func (o PublicKeyUseGetResponse) MarshalJSON() ([]byte, error) {
...
func (o PublicKeyUseGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePublicKeyUseGetResponse struct {
	value *PublicKeyUseGetResponse
	isSet bool
}

func (v NullablePublicKeyUseGetResponse) Get() *PublicKeyUseGetResponse {
	return v.value
}

func (v *NullablePublicKeyUseGetResponse) Set(val *PublicKeyUseGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePublicKeyUseGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePublicKeyUseGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublicKeyUseGetResponse(val *PublicKeyUseGetResponse) *NullablePublicKeyUseGetResponse {
	return &NullablePublicKeyUseGetResponse{value: val, isSet: true}
}

func (v NullablePublicKeyUseGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePublicKeyUseGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
