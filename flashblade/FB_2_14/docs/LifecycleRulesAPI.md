...
------------- | ------------- | -------------
[**LifecycleRulesDelete**](LifecycleRulesAPI.md#LifecycleRulesDelete) | **Delete** /api/2.14/lifecycle-rules | DELETE lifecycle-rules
[**LifecycleRulesGet**](LifecycleRulesAPI.md#LifecycleRulesGet) | **Get** /api/2.14/lifecycle-rules | GET lifecycle-rules
[**LifecycleRulesPatch**](LifecycleRulesAPI.md#LifecycleRulesPatch) | **Patch** /api/2.14/lifecycle-rules | PATCH lifecycle-rules
[**LifecycleRulesPost**](LifecycleRulesAPI.md#LifecycleRulesPost) | **Post** /api/2.14/lifecycle-rules | POST lifecycle-rules



## LifecycleRulesDelete

> LifecycleRulesDelete(ctx).XRequestID(xRequestID).BucketIds(bucketIds).BucketNames(bucketNames).Ids(ids).Names(names).Execute()
...
> LifecycleRuleGetResponse LifecycleRulesGet(ctx).XRequestID(xRequestID).BucketIds(bucketIds).BucketNames(bucketNames).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> LifecycleRuleResponse LifecycleRulesPatch(ctx).Lifecycle(lifecycle).XRequestID(xRequestID).BucketIds(bucketIds).BucketNames(bucketNames).ConfirmDate(confirmDate).Ids(ids).Names(names).Execute()
...
> LifecycleRuleResponse LifecycleRulesPost(ctx).Rule(rule).XRequestID(xRequestID).ConfirmDate(confirmDate).Execute()
