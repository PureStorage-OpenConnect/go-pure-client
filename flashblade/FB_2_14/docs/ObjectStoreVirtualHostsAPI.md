...
------------- | ------------- | -------------
[**ObjectStoreVirtualHostsDelete**](ObjectStoreVirtualHostsAPI.md#ObjectStoreVirtualHostsDelete) | **Delete** /api/2.14/object-store-virtual-hosts | DELETE object-store-virtual-hosts
[**ObjectStoreVirtualHostsGet**](ObjectStoreVirtualHostsAPI.md#ObjectStoreVirtualHostsGet) | **Get** /api/2.14/object-store-virtual-hosts | GET object-store-virtual-hosts
[**ObjectStoreVirtualHostsPost**](ObjectStoreVirtualHostsAPI.md#ObjectStoreVirtualHostsPost) | **Post** /api/2.14/object-store-virtual-hosts | POST object-store-virtual-hosts



## ObjectStoreVirtualHostsDelete

> ObjectStoreVirtualHostsDelete(ctx).XRequestID(xRequestID).Ids(ids).Names(names).Execute()
...
> ObjectStoreVirtualHostGetResponse ObjectStoreVirtualHostsGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> ObjectStoreVirtualHostResponse ObjectStoreVirtualHostsPost(ctx).Names(names).XRequestID(xRequestID).Execute()
