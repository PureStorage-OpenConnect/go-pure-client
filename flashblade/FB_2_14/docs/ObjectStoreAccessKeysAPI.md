...
------------- | ------------- | -------------
[**ObjectStoreAccessKeysDelete**](ObjectStoreAccessKeysAPI.md#ObjectStoreAccessKeysDelete) | **Delete** /api/2.14/object-store-access-keys | DELETE object-store-access-keys
[**ObjectStoreAccessKeysGet**](ObjectStoreAccessKeysAPI.md#ObjectStoreAccessKeysGet) | **Get** /api/2.14/object-store-access-keys | GET object-store-access-keys
[**ObjectStoreAccessKeysPatch**](ObjectStoreAccessKeysAPI.md#ObjectStoreAccessKeysPatch) | **Patch** /api/2.14/object-store-access-keys | PATCH object-store-access-keys
[**ObjectStoreAccessKeysPost**](ObjectStoreAccessKeysAPI.md#ObjectStoreAccessKeysPost) | **Post** /api/2.14/object-store-access-keys | POST object-store-access-keys



## ObjectStoreAccessKeysDelete

> ObjectStoreAccessKeysDelete(ctx).Names(names).XRequestID(xRequestID).Execute()
...
> ObjectStoreAccessKeyGetResponse ObjectStoreAccessKeysGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> ObjectStoreAccessKeyResponse ObjectStoreAccessKeysPatch(ctx).Names(names).ObjectStoreAccessKey(objectStoreAccessKey).XRequestID(xRequestID).Execute()
...
> ObjectStoreAccessKeyResponse ObjectStoreAccessKeysPost(ctx).ObjectStoreAccessKey(objectStoreAccessKey).XRequestID(xRequestID).Names(names).Execute()
