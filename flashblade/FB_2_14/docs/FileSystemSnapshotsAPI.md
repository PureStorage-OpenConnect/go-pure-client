...
------------- | ------------- | -------------
[**FileSystemSnapshotsDelete**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsDelete) | **Delete** /api/2.14/file-system-snapshots | DELETE file-system-snapshots
[**FileSystemSnapshotsGet**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsGet) | **Get** /api/2.14/file-system-snapshots | GET file-system-snapshots
[**FileSystemSnapshotsPatch**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsPatch) | **Patch** /api/2.14/file-system-snapshots | PATCH file-system-snapshots
[**FileSystemSnapshotsPoliciesDelete**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsPoliciesDelete) | **Delete** /api/2.14/file-system-snapshots/policies | DELETE file-system-snapshots/policies
[**FileSystemSnapshotsPoliciesGet**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsPoliciesGet) | **Get** /api/2.14/file-system-snapshots/policies | GET file-system-snapshots/policies
[**FileSystemSnapshotsPost**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsPost) | **Post** /api/2.14/file-system-snapshots | POST file-system-snapshots
[**FileSystemSnapshotsTransferDelete**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsTransferDelete) | **Delete** /api/2.14/file-system-snapshots/transfer | DELETE file-system-snapshots/transfer
[**FileSystemSnapshotsTransferGet**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsTransferGet) | **Get** /api/2.14/file-system-snapshots/transfer | GET file-system-snapshots/transfer



## FileSystemSnapshotsDelete

> FileSystemSnapshotsDelete(ctx).XRequestID(xRequestID).Ids(ids).Names(names).Execute()
...
> FileSystemSnapshotGetResponse FileSystemSnapshotsGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).Destroyed(destroyed).Filter(filter).Ids(ids).Limit(limit).NamesOrOwnerNames(namesOrOwnerNames).Offset(offset).OwnerIds(ownerIds).Sort(sort).TotalOnly(totalOnly).Execute()
...
> FileSystemSnapshotResponse FileSystemSnapshotsPatch(ctx).FileSystemSnapshot(fileSystemSnapshot).XRequestID(xRequestID).Ids(ids).LatestReplica(latestReplica).Names(names).Execute()
...
> FileSystemSnapshotsPoliciesDelete(ctx).XRequestID(xRequestID).MemberIds(memberIds).MemberNames(memberNames).PolicyIds(policyIds).PolicyNames(policyNames).Execute()
...
> PolicyFileSystemSnapshotGetResponse FileSystemSnapshotsPoliciesGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Limit(limit).MemberIds(memberIds).MemberNames(memberNames).Offset(offset).PolicyIds(policyIds).PolicyNames(policyNames).Sort(sort).Execute()
...
> FileSystemSnapshotResponse FileSystemSnapshotsPost(ctx).XRequestID(xRequestID).Send(send).SourceIds(sourceIds).SourceNames(sourceNames).Targets(targets).FileSystemSnapshot(fileSystemSnapshot).Execute()
...
> FileSystemSnapshotsTransferDelete(ctx).XRequestID(xRequestID).Ids(ids).Names(names).RemoteIds(remoteIds).RemoteNames(remoteNames).Execute()
...
> FileSystemSnapshotGetTransferResponse FileSystemSnapshotsTransferGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).NamesOrOwnerNames(namesOrOwnerNames).Offset(offset).Sort(sort).TotalOnly(totalOnly).Execute()
