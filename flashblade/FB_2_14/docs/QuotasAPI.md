...
------------- | ------------- | -------------
[**QuotasGroupsDelete**](QuotasAPI.md#QuotasGroupsDelete) | **Delete** /api/2.14/quotas/groups | DELETE quotas/groups
[**QuotasGroupsGet**](QuotasAPI.md#QuotasGroupsGet) | **Get** /api/2.14/quotas/groups | GET quotas/groups
[**QuotasGroupsPatch**](QuotasAPI.md#QuotasGroupsPatch) | **Patch** /api/2.14/quotas/groups | PATCH quotas/groups
[**QuotasGroupsPost**](QuotasAPI.md#QuotasGroupsPost) | **Post** /api/2.14/quotas/groups | POST quotas/groups
[**QuotasSettingsGet**](QuotasAPI.md#QuotasSettingsGet) | **Get** /api/2.14/quotas/settings | GET quotas-settings
[**QuotasSettingsPatch**](QuotasAPI.md#QuotasSettingsPatch) | **Patch** /api/2.14/quotas/settings | PATCH quotas-settings
[**QuotasUsersDelete**](QuotasAPI.md#QuotasUsersDelete) | **Delete** /api/2.14/quotas/users | DELETE quotas/users
[**QuotasUsersGet**](QuotasAPI.md#QuotasUsersGet) | **Get** /api/2.14/quotas/users | GET quotas/users
[**QuotasUsersPatch**](QuotasAPI.md#QuotasUsersPatch) | **Patch** /api/2.14/quotas/users | PATCH quotas/users
[**QuotasUsersPost**](QuotasAPI.md#QuotasUsersPost) | **Post** /api/2.14/quotas/users | POST quotas/users



## QuotasGroupsDelete

> QuotasGroupsDelete(ctx).XRequestID(xRequestID).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Gids(gids).GroupNames(groupNames).Names(names).Execute()
...
> GroupQuotaGetResponse QuotasGroupsGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Filter(filter).Gids(gids).GroupNames(groupNames).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
...
> GroupQuotaResponse QuotasGroupsPatch(ctx).XRequestID(xRequestID).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Gids(gids).GroupNames(groupNames).Names(names).Quota(quota).Execute()
...
> GroupQuotaResponse QuotasGroupsPost(ctx).XRequestID(xRequestID).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Gids(gids).GroupNames(groupNames).Quota(quota).Execute()
...
> QuotasUsersDelete(ctx).XRequestID(xRequestID).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Names(names).Uids(uids).UserNames(userNames).Execute()
...
> UserQuotaGetResponse QuotasUsersGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Filter(filter).Limit(limit).Names(names).Offset(offset).Sort(sort).Uids(uids).UserNames(userNames).Execute()
...
> UserQuotaResponse QuotasUsersPatch(ctx).XRequestID(xRequestID).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Names(names).Uids(uids).UserNames(userNames).Quota(quota).Execute()
...
> UserQuotaResponse QuotasUsersPost(ctx).XRequestID(xRequestID).FileSystemIds(fileSystemIds).FileSystemNames(fileSystemNames).Uids(uids).UserNames(userNames).Quota(quota).Execute()
