...
------------- | ------------- | -------------
[**KmipDelete**](KMIPAPI.md#KmipDelete) | **Delete** /api/2.15/kmip | Delete a KMIP server configuration
[**KmipGet**](KMIPAPI.md#KmipGet) | **Get** /api/2.15/kmip | List KMIP server configurations
[**KmipPatch**](KMIPAPI.md#KmipPatch) | **Patch** /api/2.15/kmip | Modify a KMIP server configuration
[**KmipPost**](KMIPAPI.md#KmipPost) | **Post** /api/2.15/kmip | Create a KMIP server configuration
[**KmipTestGet**](KMIPAPI.md#KmipTestGet) | **Get** /api/2.15/kmip/test | Displays KMIP server test results
