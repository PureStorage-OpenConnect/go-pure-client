...
**AssertionConsumerUrl** | Pointer to **string** | The URL where the identity provider will send its SAML response after authenticating a user.  | [optional] [readonly] 
**EntityId** | Pointer to **string** | A globally unique name for the service provider. | [optional] [readonly] 
**MetadataUrl** | Pointer to **string** | The URL of the service provider metadata. | [optional] [readonly] 
...
`func (o *Saml2SsoSp) GetDecryptionCredential() ReferenceWritable`

GetDecryptionCredential returns the DecryptionCredential field if non-nil, zero value otherwise.

### GetDecryptionCredentialOk

`func (o *Saml2SsoSp) GetDecryptionCredentialOk() (*ReferenceWritable, bool)`
...
`func (o *Saml2SsoSp) SetDecryptionCredential(v ReferenceWritable)`
...
`func (o *Saml2SsoSp) GetSigningCredential() ReferenceWritable`

GetSigningCredential returns the SigningCredential field if non-nil, zero value otherwise.

### GetSigningCredentialOk

`func (o *Saml2SsoSp) GetSigningCredentialOk() (*ReferenceWritable, bool)`
...
`func (o *Saml2SsoSp) SetSigningCredential(v ReferenceWritable)`
