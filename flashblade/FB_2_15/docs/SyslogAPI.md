...
------------- | ------------- | -------------
[**SyslogServersDelete**](SyslogAPI.md#SyslogServersDelete) | **Delete** /api/2.15/syslog-servers | DELETE syslog-servers
[**SyslogServersGet**](SyslogAPI.md#SyslogServersGet) | **Get** /api/2.15/syslog-servers | GET syslog-servers
[**SyslogServersPatch**](SyslogAPI.md#SyslogServersPatch) | **Patch** /api/2.15/syslog-servers | PATCH syslog-servers
[**SyslogServersPost**](SyslogAPI.md#SyslogServersPost) | **Post** /api/2.15/syslog-servers | POST syslog-servers
[**SyslogServersSettingsGet**](SyslogAPI.md#SyslogServersSettingsGet) | **Get** /api/2.15/syslog-servers/settings | GET syslog-servers/settings
[**SyslogServersSettingsPatch**](SyslogAPI.md#SyslogServersSettingsPatch) | **Patch** /api/2.15/syslog-servers/settings | PATCH syslog-servers/settings
[**SyslogServersTestGet**](SyslogAPI.md#SyslogServersTestGet) | **Get** /api/2.15/syslog-servers/test | GET syslog-servers/test
...
> SyslogServerGetResponse SyslogServersGet(ctx).XRequestID(xRequestID).ContinuationToken(continuationToken).Filter(filter).Ids(ids).Limit(limit).Names(names).Offset(offset).Sort(sort).Execute()
