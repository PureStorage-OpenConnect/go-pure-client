...
`func (o *TestResult) GetResource() FixedReference`

GetResource returns the Resource field if non-nil, zero value otherwise.

### GetResourceOk

`func (o *TestResult) GetResourceOk() (*FixedReference, bool)`
...
`func (o *TestResult) SetResource(v FixedReference)`

SetResource sets Resource field to given value.

### HasResource

`func (o *TestResult) HasResource() bool`
