...
------------- | ------------- | -------------
[**SoftwareCheckGet**](SoftwareAPI.md#SoftwareCheckGet) | **Get** /api/2.16/software-check | List software check tasks
[**SoftwareCheckPost**](SoftwareAPI.md#SoftwareCheckPost) | **Post** /api/2.16/software-check | Create a software check task
