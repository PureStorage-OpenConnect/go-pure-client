...
------------- | ------------- | -------------
[**SmtpServersGet**](SMTPAPI.md#SmtpServersGet) | **Get** /api/2.16/smtp-servers | GET smtp-servers
[**SmtpServersPatch**](SMTPAPI.md#SmtpServersPatch) | **Patch** /api/2.16/smtp-servers | PATCH smtp-servers
