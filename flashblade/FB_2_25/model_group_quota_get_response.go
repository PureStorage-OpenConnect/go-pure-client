...
// checks if the GroupQuotaGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupQuotaGetResponse{}

// GroupQuotaGetResponse struct for GroupQuotaGetResponse
...
func (o GroupQuotaGetResponse) MarshalJSON() ([]byte, error) {
...
func (o GroupQuotaGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableGroupQuotaGetResponse struct {
	value *GroupQuotaGetResponse
	isSet bool
}

func (v NullableGroupQuotaGetResponse) Get() *GroupQuotaGetResponse {
	return v.value
}

func (v *NullableGroupQuotaGetResponse) Set(val *GroupQuotaGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupQuotaGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupQuotaGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupQuotaGetResponse(val *GroupQuotaGetResponse) *NullableGroupQuotaGetResponse {
	return &NullableGroupQuotaGetResponse{value: val, isSet: true}
}

func (v NullableGroupQuotaGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupQuotaGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
