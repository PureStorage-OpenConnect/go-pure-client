...
// checks if the DataEvictionPolicyPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataEvictionPolicyPost{}

// DataEvictionPolicyPost struct for DataEvictionPolicyPost
type DataEvictionPolicyPost struct {
...
func (o DataEvictionPolicyPost) MarshalJSON() ([]byte, error) {
...
func (o DataEvictionPolicyPost) ToMap() (map[string]interface{}, error) {
...
type NullableDataEvictionPolicyPost struct {
	value *DataEvictionPolicyPost
	isSet bool
}

func (v NullableDataEvictionPolicyPost) Get() *DataEvictionPolicyPost {
	return v.value
}

func (v *NullableDataEvictionPolicyPost) Set(val *DataEvictionPolicyPost) {
	v.value = val
	v.isSet = true
}

func (v NullableDataEvictionPolicyPost) IsSet() bool {
	return v.isSet
}

func (v *NullableDataEvictionPolicyPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataEvictionPolicyPost(val *DataEvictionPolicyPost) *NullableDataEvictionPolicyPost {
	return &NullableDataEvictionPolicyPost{value: val, isSet: true}
}

func (v NullableDataEvictionPolicyPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataEvictionPolicyPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
