...
// checks if the FileSystemJunctionsGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileSystemJunctionsGetResponse{}

// FileSystemJunctionsGetResponse struct for FileSystemJunctionsGetResponse
type FileSystemJunctionsGetResponse struct {
...
func NewFileSystemJunctionsGetResponse() *FileSystemJunctionsGetResponse {
	this := FileSystemJunctionsGetResponse{}
	return &this
}
...
func (o FileSystemJunctionsGetResponse) MarshalJSON() ([]byte, error) {
...
func (o FileSystemJunctionsGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFileSystemJunctionsGetResponse struct {
	value *FileSystemJunctionsGetResponse
	isSet bool
}

func (v NullableFileSystemJunctionsGetResponse) Get() *FileSystemJunctionsGetResponse {
	return v.value
}

func (v *NullableFileSystemJunctionsGetResponse) Set(val *FileSystemJunctionsGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFileSystemJunctionsGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFileSystemJunctionsGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileSystemJunctionsGetResponse(val *FileSystemJunctionsGetResponse) *NullableFileSystemJunctionsGetResponse {
	return &NullableFileSystemJunctionsGetResponse{value: val, isSet: true}
}

func (v NullableFileSystemJunctionsGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileSystemJunctionsGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
