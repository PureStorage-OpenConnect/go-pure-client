...
// checks if the LogTargetsObjectStoreGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogTargetsObjectStoreGetResponse{}

// LogTargetsObjectStoreGetResponse struct for LogTargetsObjectStoreGetResponse
type LogTargetsObjectStoreGetResponse struct {
...
func NewLogTargetsObjectStoreGetResponse() *LogTargetsObjectStoreGetResponse {
	this := LogTargetsObjectStoreGetResponse{}
	return &this
}
...
func (o LogTargetsObjectStoreGetResponse) MarshalJSON() ([]byte, error) {
...
func (o LogTargetsObjectStoreGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableLogTargetsObjectStoreGetResponse struct {
	value *LogTargetsObjectStoreGetResponse
	isSet bool
}

func (v NullableLogTargetsObjectStoreGetResponse) Get() *LogTargetsObjectStoreGetResponse {
	return v.value
}

func (v *NullableLogTargetsObjectStoreGetResponse) Set(val *LogTargetsObjectStoreGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLogTargetsObjectStoreGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLogTargetsObjectStoreGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogTargetsObjectStoreGetResponse(val *LogTargetsObjectStoreGetResponse) *NullableLogTargetsObjectStoreGetResponse {
	return &NullableLogTargetsObjectStoreGetResponse{value: val, isSet: true}
}

func (v NullableLogTargetsObjectStoreGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogTargetsObjectStoreGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
