...
// checks if the ResiliencyGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResiliencyGroup{}

// ResiliencyGroup struct for ResiliencyGroup
type ResiliencyGroup struct {
	...
	// The status of the resiliency group. Valid values include `critical`, `healthy`, and `unhealthy`.
	Status *string `json:"status,omitempty"`
	// The description of the status of the resiliency group if not healthy.
...
func (o ResiliencyGroup) MarshalJSON() ([]byte, error) {
...
func (o ResiliencyGroup) ToMap() (map[string]interface{}, error) {
...
type NullableResiliencyGroup struct {
	value *ResiliencyGroup
	isSet bool
}

func (v NullableResiliencyGroup) Get() *ResiliencyGroup {
	return v.value
}

func (v *NullableResiliencyGroup) Set(val *ResiliencyGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableResiliencyGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableResiliencyGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResiliencyGroup(val *ResiliencyGroup) *NullableResiliencyGroup {
	return &NullableResiliencyGroup{value: val, isSet: true}
}

func (v NullableResiliencyGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResiliencyGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
