...
// checks if the SmbClientPolicyRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmbClientPolicyRule{}

// SmbClientPolicyRule struct for SmbClientPolicyRule
...
func (o SmbClientPolicyRule) MarshalJSON() ([]byte, error) {
...
func (o SmbClientPolicyRule) ToMap() (map[string]interface{}, error) {
...
type NullableSmbClientPolicyRule struct {
	value *SmbClientPolicyRule
	isSet bool
}

func (v NullableSmbClientPolicyRule) Get() *SmbClientPolicyRule {
	return v.value
}

func (v *NullableSmbClientPolicyRule) Set(val *SmbClientPolicyRule) {
	v.value = val
	v.isSet = true
}

func (v NullableSmbClientPolicyRule) IsSet() bool {
	return v.isSet
}

func (v *NullableSmbClientPolicyRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSmbClientPolicyRule(val *SmbClientPolicyRule) *NullableSmbClientPolicyRule {
	return &NullableSmbClientPolicyRule{value: val, isSet: true}
}

func (v NullableSmbClientPolicyRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSmbClientPolicyRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
