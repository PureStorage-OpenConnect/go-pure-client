...
// checks if the RemoteRealmsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteRealmsResponse{}

// RemoteRealmsResponse struct for RemoteRealmsResponse
type RemoteRealmsResponse struct {
	...
	Items []RemoteRealm1 `json:"items,omitempty"`
}
...
// SetItems gets a reference to the given []RemoteRealm1 and assigns it to the Items field.
func (o *RemoteRealmsResponse) SetItems(v []RemoteRealm1) {
	o.Items = v
}

func (o RemoteRealmsResponse) MarshalJSON() ([]byte, error) {
...
func (o RemoteRealmsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRemoteRealmsResponse struct {
	value *RemoteRealmsResponse
	isSet bool
}

func (v NullableRemoteRealmsResponse) Get() *RemoteRealmsResponse {
	return v.value
}

func (v *NullableRemoteRealmsResponse) Set(val *RemoteRealmsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoteRealmsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoteRealmsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoteRealmsResponse(val *RemoteRealmsResponse) *NullableRemoteRealmsResponse {
	return &NullableRemoteRealmsResponse{value: val, isSet: true}
}

func (v NullableRemoteRealmsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoteRealmsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
