...
------------- | ------------- | -------------
[**LinkAggregationGroupsDelete**](LinkAggregationGroupsAPI.md#LinkAggregationGroupsDelete) | **Delete** /api/2.25/link-aggregation-groups | DELETE link-aggregation-groups
[**LinkAggregationGroupsGet**](LinkAggregationGroupsAPI.md#LinkAggregationGroupsGet) | **Get** /api/2.25/link-aggregation-groups | GET link-aggregation-groups
[**LinkAggregationGroupsPatch**](LinkAggregationGroupsAPI.md#LinkAggregationGroupsPatch) | **Patch** /api/2.25/link-aggregation-groups | PATCH link-aggregation-groups
[**LinkAggregationGroupsPost**](LinkAggregationGroupsAPI.md#LinkAggregationGroupsPost) | **Post** /api/2.25/link-aggregation-groups | POST link-aggregation-groups
...
> LinkAggregationGroupResponse LinkAggregationGroupsPatch(ctx).LinkAggregationGroup(linkAggregationGroup).XRequestID(xRequestID).Ids(ids).Names(names).Execute()
