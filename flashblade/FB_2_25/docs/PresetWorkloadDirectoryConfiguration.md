...
**Exports** | Pointer to [**[]PresetWorkloadDirectoryConfigurationExports**](PresetWorkloadDirectoryConfigurationExports.md) | File system or directory exports to be created as part of the workload. A maximum of four exports can be created per file system or directory across NFS and SMB.  | [optional] 
...
**SpecialDirectories** | Pointer to [**PresetWorkloadDirectoryConfigurationSpecialDirectories**](PresetWorkloadDirectoryConfigurationSpecialDirectories.md) | Special directory configuration. | [optional] 
