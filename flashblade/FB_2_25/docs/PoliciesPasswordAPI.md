...
------------- | ------------- | -------------
[**PasswordPoliciesGet**](PoliciesPasswordAPI.md#PasswordPoliciesGet) | **Get** /api/2.25/password-policies | List password policies
[**PasswordPoliciesPatch**](PoliciesPasswordAPI.md#PasswordPoliciesPatch) | **Patch** /api/2.25/password-policies | Modify password policies
