...
`func (o *Server) GetLocalDirectoryService() Reference`
...
`func (o *Server) GetLocalDirectoryServiceOk() (*Reference, bool)`
...
`func (o *Server) SetLocalDirectoryService(v Reference)`
