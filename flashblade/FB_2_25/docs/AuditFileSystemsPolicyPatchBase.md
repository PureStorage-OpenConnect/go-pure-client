...
**ControlType** | Pointer to **string** | Specifies the evaluation mode for auditing in this policy. Valid values are \&quot;policy\&quot;, \&quot;sacl\&quot;.  | [optional] 
...
`func (o *AuditFileSystemsPolicyPatchBase) GetControlType() string`

GetControlType returns the ControlType field if non-nil, zero value otherwise.

### GetControlTypeOk

`func (o *AuditFileSystemsPolicyPatchBase) GetControlTypeOk() (*string, bool)`
...
`func (o *AuditFileSystemsPolicyPatchBase) SetControlType(v string)`

SetControlType sets ControlType field to given value.

### HasControlType

`func (o *AuditFileSystemsPolicyPatchBase) HasControlType() bool`
