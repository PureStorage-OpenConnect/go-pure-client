...
**ConnectorType** | Pointer to **string** | Form-factor of the interface. Valid values include QSFP, QSFP+, QSFP28, QSFP56, QSFP-DD, RJ-45, and -.  | [optional] [readonly] 
**LaneSpeed** | Pointer to **int64** | Configured speed of each lane in the connector in bits-per-second.  | [optional] 
**LanesPerPort** | Pointer to **int64** | Configured number of lanes comprising each port in the connector. | [optional] 
**PortCount** | Pointer to **int64** | Configured number of ports in the connector (1/2/4 for QSFP).  | [optional] 
**PortSpeed** | Pointer to **int64** | Configured speed of each port in the connector in bits-per-second. | [optional] 
...
GetLanesPerPort returns the LanesPerPort field if non-nil, zero value otherwise.

### GetLanesPerPortOk

`func (o *HardwareConnector) GetLanesPerPortOk() (*int64, bool)`

GetLanesPerPortOk returns a tuple with the LanesPerPort field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetLanesPerPort sets LanesPerPort field to given value.
