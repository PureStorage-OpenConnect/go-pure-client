...
------------- | ------------- | -------------
[**FileSystemGroupQuotasGet**](UserGroupQuotasAPI.md#FileSystemGroupQuotasGet) | **Get** /api/2.25/file-system-group-quotas | GET /file-system-group-quotas
[**FileSystemUserQuotasGet**](UserGroupQuotasAPI.md#FileSystemUserQuotasGet) | **Get** /api/2.25/file-system-user-quotas | GET /file-system-user-quotas
