...
------------- | ------------- | -------------
[**FileSystemSnapshotsDelete**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsDelete) | **Delete** /api/2.25/file-system-snapshots | DELETE file-system-snapshots
[**FileSystemSnapshotsGet**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsGet) | **Get** /api/2.25/file-system-snapshots | GET file-system-snapshots
[**FileSystemSnapshotsPatch**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsPatch) | **Patch** /api/2.25/file-system-snapshots | PATCH file-system-snapshots
[**FileSystemSnapshotsPoliciesDelete**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsPoliciesDelete) | **Delete** /api/2.25/file-system-snapshots/policies | DELETE file-system-snapshots/policies
[**FileSystemSnapshotsPoliciesGet**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsPoliciesGet) | **Get** /api/2.25/file-system-snapshots/policies | GET file-system-snapshots/policies
[**FileSystemSnapshotsPost**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsPost) | **Post** /api/2.25/file-system-snapshots | POST file-system-snapshots
[**FileSystemSnapshotsTransferDelete**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsTransferDelete) | **Delete** /api/2.25/file-system-snapshots/transfer | DELETE file-system-snapshots/transfer
[**FileSystemSnapshotsTransferGet**](FileSystemSnapshotsAPI.md#FileSystemSnapshotsTransferGet) | **Get** /api/2.25/file-system-snapshots/transfer | GET file-system-snapshots/transfer
