...
// checks if the DataEvictionPoliciesGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataEvictionPoliciesGetResponse{}

// DataEvictionPoliciesGetResponse struct for DataEvictionPoliciesGetResponse
type DataEvictionPoliciesGetResponse struct {
...
func NewDataEvictionPoliciesGetResponse() *DataEvictionPoliciesGetResponse {
	this := DataEvictionPoliciesGetResponse{}
	return &this
}
...
func (o DataEvictionPoliciesGetResponse) MarshalJSON() ([]byte, error) {
...
func (o DataEvictionPoliciesGetResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDataEvictionPoliciesGetResponse struct {
	value *DataEvictionPoliciesGetResponse
	isSet bool
}

func (v NullableDataEvictionPoliciesGetResponse) Get() *DataEvictionPoliciesGetResponse {
	return v.value
}

func (v *NullableDataEvictionPoliciesGetResponse) Set(val *DataEvictionPoliciesGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDataEvictionPoliciesGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDataEvictionPoliciesGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataEvictionPoliciesGetResponse(val *DataEvictionPoliciesGetResponse) *NullableDataEvictionPoliciesGetResponse {
	return &NullableDataEvictionPoliciesGetResponse{value: val, isSet: true}
}

func (v NullableDataEvictionPoliciesGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataEvictionPoliciesGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
