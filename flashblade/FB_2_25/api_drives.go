...
func (r APIDrivesGetRequest) Ids(ids []string) APIDrivesGetRequest {
	r.ids = &ids
	return r
}
...
func (r APIDrivesGetRequest) TotalOnly(totalOnly bool) APIDrivesGetRequest {
	r.totalOnly = &totalOnly
	return r
}

func (r APIDrivesGetRequest) AuthorizationHeader(authorizationHeader string) APIDrivesGetRequest {
