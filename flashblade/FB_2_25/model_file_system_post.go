...
type FileSystemPost struct {
	...
	NodeGroup *Reference `json:"node_group,omitempty"`
...
// SetNodeGroup gets a reference to the given Reference and assigns it to the NodeGroup field.
...
// SetSmb gets a reference to the given SmbPost and assigns it to the Smb field.
